/*****************************************************************************
 ...
 @(#) $RCSfile: log.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2004/05/08 19:21:14 $
...
#ident "@(#) $RCSfile: log.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2004/05/08 19:21:14 $"
...
#define LOG_REVISION	"LfS $RCSFile$ $Name:  $($Revision: 0.9.2.9 $) $Date: 2004/05/08 19:21:14 $"
