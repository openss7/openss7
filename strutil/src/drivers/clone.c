/*****************************************************************************
 ...
 @(#) $RCSfile: clone.c,v $ $Name:  $($Revision: 0.9.2.49 $) $Date: 2008-10-30 18:31:45 $
 ...
 $Log: clone.c,v $
 Revision 0.9.2.49  2008-10-30 18:31:45  brian
 - rationalized drivers, modules and test programs

 Revision 0.9.2.48  2008-09-22 20:31:43  brian
...
#ident "@(#) $RCSfile: clone.c,v $ $Name:  $($Revision: 0.9.2.49 $) $Date: 2008-10-30 18:31:45 $"
...
#define CLONE_REVISION	"LfS $RCSfile: clone.c,v $ $Name:  $($Revision: 0.9.2.49 $) $Date: 2008-10-30 18:31:45 $"
...
EXPORT_SYMBOL_GPL(_register_clone);
...
EXPORT_SYMBOL_GPL(_unregister_clone);
...
EXPORT_SYMBOL_GPL(_register_strdev);
...
EXPORT_SYMBOL_GPL(_unregister_strdev);
#endif
