/*****************************************************************************
 ...
 @(#) $RCSfile: pipe.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2004/06/01 12:04:34 $
...
#ident "@(#) $RCSfile: pipe.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2004/06/01 12:04:34 $"
...
#define PIPE_REVISION	"LfS $RCSFile$ $Name:  $($Revision: 0.9.2.9 $) $Date: 2004/06/01 12:04:34 $"
