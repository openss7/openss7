/*****************************************************************************
 ...
 @(#) $RCSfile: pipe.c,v $ $Name:  $($Revision: 0.9.2.31 $) $Date: 2007/03/25 19:02:29 $
...
#ident "@(#) $RCSfile: pipe.c,v $ $Name:  $($Revision: 0.9.2.31 $) $Date: 2007/03/25 19:02:29 $"
...
#define PIPE_REVISION	"LfS $RCSfile: pipe.c,v $ $Name:  $($Revision: 0.9.2.31 $) $Date: 2007/03/25 19:02:29 $"
