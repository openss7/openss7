/*****************************************************************************
 ...
 @(#) $RCSfile: pipe.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2004/05/08 19:21:14 $
...
#ident "@(#) $RCSfile: pipe.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2004/05/08 19:21:14 $"
...
#define PIPE_REVISION	"LfS $RCSFile$ $Name:  $($Revision: 0.9.2.5 $) $Date: 2004/05/08 19:21:14 $"
