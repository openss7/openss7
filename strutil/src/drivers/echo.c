/*****************************************************************************
 ...
 @(#) $RCSfile: echo.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2004/03/07 23:39:10 $
...
#ident "@(#) $RCSfile: echo.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2004/03/07 23:39:10 $"

static char const ident[] = "$RCSfile: echo.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2004/03/07 23:39:10 $";
...
#define ECHO_REVISION	"LfS $RCSFile$ $Name:  $($Revision: 0.9.2.6 $) $Date: 2004/03/07 23:39:10 $"
