/*****************************************************************************
 ...
 @(#) $RCSfile: sfx.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2004/05/08 19:21:14 $
...
#ident "@(#) $RCSfile: sfx.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2004/05/08 19:21:14 $"
...
#define SFX_REVISION	"LfS $RCSFile$ $Name:  $($Revision: 0.9.2.5 $) $Date: 2004/05/08 19:21:14 $"
