/*****************************************************************************
 ...
 @(#) $RCSfile: test-streams.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2004/06/09 08:32:59 $
...
#ident "@(#) $RCSfile: test-streams.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2004/06/09 08:32:59 $"

static char const ident[] = "$RCSfile: test-streams.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2004/06/09 08:32:59 $";
