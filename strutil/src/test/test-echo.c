/*****************************************************************************
 ...
 @(#) $RCSfile: test-echo.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2005/05/14 08:39:36 $
...
#ident "@(#) $RCSfile: test-echo.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2005/05/14 08:39:36 $"

static char const ident[] = "$RCSfile: test-echo.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2005/05/14 08:39:36 $";
