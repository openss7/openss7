/*****************************************************************************
 ...
 @(#) $RCSfile: test-nsdev.c,v $ $Name:  $($Revision: 0.9.2.16 $) $Date: 2008-10-30 18:31:47 $
 ...
 $Log: test-nsdev.c,v $
 Revision 0.9.2.16  2008-10-30 18:31:47  brian
 ...
 Revision 0.9.2.13  2007/03/15 10:24:01  brian
 ...
 Revision 0.9.2.11  2006/03/03 12:17:37  brian
 - 64-bit and SMP compatibility

 Revision 0.9.2.10  2005/12/28 10:01:23  brian
...
#ident "@(#) $RCSfile: test-nsdev.c,v $ $Name:  $($Revision: 0.9.2.16 $) $Date: 2008-10-30 18:31:47 $"

static char const ident[] = "$RCSfile: test-nsdev.c,v $ $Name:  $($Revision: 0.9.2.16 $) $Date: 2008-10-30 18:31:47 $";
...
struct test_case {
	...
	test_case_1_1_stream_0, test_case_1_1_stream_1, test_case_1_1_stream_2}, &begin_tests, &end_tests, 0, 0, __RESULT_FAILURE}, {
		numb_case_1_2, tgrp_case_1_2, sgrp_case_1_2, name_case_1_2, xtra_case_1_2, desc_case_1_2, sref_case_1_2, {
	test_case_1_2_stream_0, test_case_1_2_stream_1, test_case_1_2_stream_2}, &begin_tests, &end_tests, 0, 0, __RESULT_FAILURE}, {
	NULL,}
};
