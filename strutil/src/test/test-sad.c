/*****************************************************************************
 ...
 @(#) $RCSfile: test-sad.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2004/08/22 06:17:56 $
...
#ident "@(#) $RCSfile: test-sad.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2004/08/22 06:17:56 $"

static char const ident[] = "$RCSfile: test-sad.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2004/08/22 06:17:56 $";
