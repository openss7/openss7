/*****************************************************************************
 ...
 @(#) $RCSfile: test-sad.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2005/05/14 08:39:37 $
...
#ident "@(#) $RCSfile: test-sad.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2005/05/14 08:39:37 $"

static char const ident[] = "$RCSfile: test-sad.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2005/05/14 08:39:37 $";
