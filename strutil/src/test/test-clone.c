/*****************************************************************************
 ...
 @(#) $RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.15 $) $Date: 2007/08/14 12:58:06 $
...
#ident "@(#) $RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.15 $) $Date: 2007/08/14 12:58:06 $"

static char const ident[] = "$RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.15 $) $Date: 2007/08/14 12:58:06 $";
