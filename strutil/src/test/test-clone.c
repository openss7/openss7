/*****************************************************************************
 ...
 @(#) $RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.10 $) $Date: 2005/12/28 10:01:22 $
...
#ident "@(#) $RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.10 $) $Date: 2005/12/28 10:01:22 $"

static char const ident[] = "$RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.10 $) $Date: 2005/12/28 10:01:22 $";
