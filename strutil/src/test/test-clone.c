/*****************************************************************************
 ...
 @(#) $RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2005/07/18 12:38:49 $
...
#ident "@(#) $RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2005/07/18 12:38:49 $"

static char const ident[] = "$RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2005/07/18 12:38:49 $";
