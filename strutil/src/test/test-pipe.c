/*****************************************************************************
 ...
 @(#) $RCSfile: test-pipe.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2006/03/10 07:24:17 $
...
#ident "@(#) $RCSfile: test-pipe.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2006/03/10 07:24:17 $"

static char const ident[] = "$RCSfile: test-pipe.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2006/03/10 07:24:17 $";
