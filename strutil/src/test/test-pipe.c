/*****************************************************************************
 ...
 @(#) $RCSfile: test-pipe.c,v $ $Name:  $($Revision: 0.9.2.10 $) $Date: 2007/03/15 10:24:01 $
 ...
 Last Modified $Date: 2007/03/15 10:24:01 $ by $Author: brian $
...
#ident "@(#) $RCSfile: test-pipe.c,v $ $Name:  $($Revision: 0.9.2.10 $) $Date: 2007/03/15 10:24:01 $"

static char const ident[] = "$RCSfile: test-pipe.c,v $ $Name:  $($Revision: 0.9.2.10 $) $Date: 2007/03/15 10:24:01 $";
