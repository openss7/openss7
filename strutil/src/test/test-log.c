/*****************************************************************************
 ...
 @(#) $RCSfile: test-log.c,v $ $Name:  $($Revision: 0.9.2.14 $) $Date: 2007/03/15 10:24:00 $
...
#ident "@(#) $RCSfile: test-log.c,v $ $Name:  $($Revision: 0.9.2.14 $) $Date: 2007/03/15 10:24:00 $"

static char const ident[] = "$RCSfile: test-log.c,v $ $Name:  $($Revision: 0.9.2.14 $) $Date: 2007/03/15 10:24:00 $";
