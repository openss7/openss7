/*****************************************************************************
 ...
 @(#) $RCSfile: test-log.c,v $ $Name:  $($Revision: 0.9.2.11 $) $Date: 2006/03/03 12:17:36 $
...
#ident "@(#) $RCSfile: test-log.c,v $ $Name:  $($Revision: 0.9.2.11 $) $Date: 2006/03/03 12:17:36 $"

static char const ident[] = "$RCSfile: test-log.c,v $ $Name:  $($Revision: 0.9.2.11 $) $Date: 2006/03/03 12:17:36 $";
