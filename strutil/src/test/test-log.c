/*****************************************************************************
 ...
 @(#) $RCSfile: test-log.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2004/06/09 08:32:58 $
...
#ident "@(#) $RCSfile: test-log.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2004/06/09 08:32:58 $"

static char const ident[] = "$RCSfile: test-log.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2004/06/09 08:32:58 $";
