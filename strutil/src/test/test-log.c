/*****************************************************************************
 ...
 @(#) $RCSfile: test-log.c,v $ $Name:  $($Revision: 0.9.2.15 $) $Date: 2007/08/14 12:58:07 $
 ...
 $Log: test-log.c,v $
 Revision 0.9.2.15  2007/08/14 12:58:07  brian
...
#ident "@(#) $RCSfile: test-log.c,v $ $Name:  $($Revision: 0.9.2.15 $) $Date: 2007/08/14 12:58:07 $"

static char const ident[] = "$RCSfile: test-log.c,v $ $Name:  $($Revision: 0.9.2.15 $) $Date: 2007/08/14 12:58:07 $";
...
#ifdef LFS
static char devname[256] = "/dev/streams/clone/slog";
#else
