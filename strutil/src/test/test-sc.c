/*****************************************************************************
 ...
 @(#) $RCSfile: test-sc.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2005/07/18 12:38:50 $
...
#ident "@(#) $RCSfile: test-sc.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2005/07/18 12:38:50 $"

static char const ident[] = "$RCSfile: test-sc.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2005/07/18 12:38:50 $";
