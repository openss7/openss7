...
# =============================================================================
# 
# @(#) $RCSfile: acinclude.m4,v $ $Name: OpenSS7-0_9_2 $($Revision: 0.9.2.71 $) $Date: 2008-10-31 07:24:44 $
#
# -----------------------------------------------------------------------------
#
...
AC_DEFUN([_XNS_STRCONF], [dnl
    ...
    AC_CACHE_CHECK([for xns module id base], [xns_cv_midbase], [dnl
	if test ${streams_cv_midbase-0} -gt 0 ; then
	    ((xns_cv_midbase=streams_cv_midbase+10))
	else
	    xns_cv_midbase=50
	    if test ${streams_cv_package:-LfS} = LfS ; then
		if test ${linux_cv_minorbits:-8} -gt 8 ; then
    ...
    _STRCONF
    ((xns_cv_majlast=xns_cv_majbase+10))
    ((xns_cv_midlast=xns_cv_midbase+10))
])# _XNS_STRCONF
# =============================================================================
...
#
# Revision 0.9.2.65  2008-09-10 03:50:06  brian
# - changes to accomodate FC9, SUSE 11.0 and Ubuntu 8.04
#
# Revision 0.9.2.64  2008-08-11 22:27:24  brian
# - added makefile variables for modules to acinclude
#
# Revision 0.9.2.63  2008-07-23 08:29:18  brian
