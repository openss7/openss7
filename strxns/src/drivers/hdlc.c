/*****************************************************************************
 ...
 @(#) $RCSfile: hdlc.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2007/03/25 19:02:46 $
...
#ident "@(#) $RCSfile: hdlc.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2007/03/25 19:02:46 $"

static char const ident[] = "$RCSfile: hdlc.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2007/03/25 19:02:46 $";
...
#define HDLC_REVISION	"OpenSS7 $RCSfile: hdlc.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2007/03/25 19:02:46 $"
