/*****************************************************************************
 ...
 @(#) $RCSfile: np.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/04/12 20:36:03 $
...
#ident "@(#) $RCSfile: np.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/04/12 20:36:03 $"

static char const ident[] = "$RCSfile: np.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/04/12 20:36:03 $";

/*
 *  This module is a master device driver for Network Provider Streams presenting a Network Provider
 *  Interface (NPI Revision 2.0.0) Service Interface at the upper boundary.  It collects a wide
 *  range of NPI drivers into a single device hierarchy as well as providing some exported functions
 *  that can be used by registering drivers.
 */
