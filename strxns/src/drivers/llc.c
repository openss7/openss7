/*****************************************************************************
 ...
 @(#) $RCSfile: llc.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2007/08/12 15:20:26 $
 ...
 Last Modified $Date: 2007/08/12 15:20:26 $ by $Author: brian $
...
#ident "@(#) $RCSfile: llc.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2007/08/12 15:20:26 $"

static char const ident[] = "$RCSfile: llc.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2007/08/12 15:20:26 $";
...
#define DL_REVISION	"OpenSS7 $RCSfile: llc.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2007/08/12 15:20:26 $"
