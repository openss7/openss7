...
init_llcMIB_simple(void)
{
	...
	REGISTER_MIB("llcMIB_simple", llcMIB_simple_variables, variable7,
		     llcMIB_simple_variables_oid);
 ...
 */
unsigned char *
var_llcMIB_simple(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len,
...
int
write_mACDLELocalSapNames(int action, unsigned char *var_val, unsigned char var_val_type,
...
int
write_mACDLEProviderEntityNames(int action, unsigned char *var_val, unsigned char var_val_type,
...
int
write_dLSAPSap1Address(int action, unsigned char *var_val, unsigned char var_val_type,
		       size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_dLSAPUserEntityNames(int action, unsigned char *var_val, unsigned char var_val_type,
			   size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static oid *objid;
	int size;
...
int
write_lLCDLELocalSapNames(int action, unsigned char *var_val, unsigned char var_val_type,
			  size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static oid *objid;
	int size;
...
int
write_lLCDLEProviderEntityNames(int action, unsigned char *var_val, unsigned char var_val_type,
				size_t var_val_len, unsigned char *statP, oid * name,
				size_t name_len)
{
	static oid *objid;
...
int
write_lLCConnection2RemoteBusy(int action, unsigned char *var_val, unsigned char var_val_type,
			       size_t var_val_len, unsigned char *statP, oid * name,
			       size_t name_len)
{
	static long *long_ret;
...
int
write_lLCConnection2RemoteReset(int action, unsigned char *var_val, unsigned char var_val_type,
				size_t var_val_len, unsigned char *statP, oid * name,
				size_t name_len)
{
	static long *long_ret;
...
int
write_lLCConnection2LocalReset(int action, unsigned char *var_val, unsigned char var_val_type,
			       size_t var_val_len, unsigned char *statP, oid * name,
			       size_t name_len)
{
	static long *long_ret;
...
int
write_lLCConnection2ProviderReset(int action, unsigned char *var_val, unsigned char var_val_type,
				  size_t var_val_len, unsigned char *statP, oid * name,
				  size_t name_len)
{
	static long *long_ret;
...
int
write_lLCConnection2SentAcks(int action, unsigned char *var_val, unsigned char var_val_type,
			     size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_lLCConnection2ReceivedAcks(int action, unsigned char *var_val, unsigned char var_val_type,
				 size_t var_val_len, unsigned char *statP, oid * name,
				 size_t name_len)
{
	static long *long_ret;
...
int
write_lLCConnection2ReceivedFRMR(int action, unsigned char *var_val, unsigned char var_val_type,
				 size_t var_val_len, unsigned char *statP, oid * name,
				 size_t name_len)
{
	static long *long_ret;
...
int
write_lLCConnection2SentFRMR(int action, unsigned char *var_val, unsigned char var_val_type,
			     size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_lLCConnection2ReceivedRR(int action, unsigned char *var_val, unsigned char var_val_type,
			       size_t var_val_len, unsigned char *statP, oid * name,
			       size_t name_len)
{
	static long *long_ret;
...
int
write_lLCConnection2SentRR(int action, unsigned char *var_val, unsigned char var_val_type,
			   size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_lLCConnection2ReceivedRNR(int action, unsigned char *var_val, unsigned char var_val_type,
				size_t var_val_len, unsigned char *statP, oid * name,
				size_t name_len)
{
	static long *long_ret;
...
int
write_lLCConnection2SentRNR(int action, unsigned char *var_val, unsigned char var_val_type,
			    size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_lLCConnection2ReceivedREJ(int action, unsigned char *var_val, unsigned char var_val_type,
				size_t var_val_len, unsigned char *statP, oid * name,
				size_t name_len)
{
	static long *long_ret;
...
int
write_lLCConnection2SentREJ(int action, unsigned char *var_val, unsigned char var_val_type,
			    size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_lLCConnection2ReceivedSABME(int action, unsigned char *var_val, unsigned char var_val_type,
				  size_t var_val_len, unsigned char *statP, oid * name,
				  size_t name_len)
{
	static long *long_ret;
...
int
write_lLCConnection2SentSABME(int action, unsigned char *var_val, unsigned char var_val_type,
			      size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_lLCConnection2ReceivedUA(int action, unsigned char *var_val, unsigned char var_val_type,
			       size_t var_val_len, unsigned char *statP, oid * name,
			       size_t name_len)
{
	static long *long_ret;
...
int
write_lLCConnection2SentUA(int action, unsigned char *var_val, unsigned char var_val_type,
			   size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_lLCConnection2ReceivedDISC(int action, unsigned char *var_val, unsigned char var_val_type,
				 size_t var_val_len, unsigned char *statP, oid * name,
				 size_t name_len)
{
	static long *long_ret;
...
int
write_lLCConnection2SentDISC(int action, unsigned char *var_val, unsigned char var_val_type,
			     size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_lLCConnection2ReceivedDM(int action, unsigned char *var_val, unsigned char var_val_type,
			       size_t var_val_len, unsigned char *statP, oid * name,
			       size_t name_len)
{
	static long *long_ret;
...
int
write_lLCConnection2SentDM(int action, unsigned char *var_val, unsigned char var_val_type,
			   size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_lLCConnection2PDUsDiscarded1(int action, unsigned char *var_val, unsigned char var_val_type,
				   size_t var_val_len, unsigned char *statP, oid * name,
				   size_t name_len)
{
	static long *long_ret;
...
int
write_lLCConnection2PDUsDiscarded2(int action, unsigned char *var_val, unsigned char var_val_type,
				   size_t var_val_len, unsigned char *statP, oid * name,
				   size_t name_len)
{
	static long *long_ret;
...
int
write_lLCConnection2PDURetransmissions(int action, unsigned char *var_val,
				       unsigned char var_val_type, size_t var_val_len,
				       unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_lLCConnection2DuplicateIPDUsReceived(int action, unsigned char *var_val,
					   unsigned char var_val_type, size_t var_val_len,
					   unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	...
	case RESERVE1:
		...
		if (var_val_len > sizeof(long_ret)) {
			fprintf(stderr,
				"write to lLCConnection2DuplicateIPDUsReceived: bad length\n");
			return SNMP_ERR_WRONGLENGTH;
		}
		break;
...
int
write_lLCConnection2Violation(int action, unsigned char *var_val, unsigned char var_val_type,
			      size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
