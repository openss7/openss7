/*****************************************************************************
 ...
 @(#) $RCSfile: lapbMIB.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2009-01-02 15:04:23 $
...
#ident "@(#) $RCSfile: lapbMIB.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2009-01-02 15:04:23 $"

static char const ident[] = "$RCSfile: lapbMIB.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2009-01-02 15:04:23 $";
...
write_lAPBDLEoperationalState(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE1:
		...
		if (1 > var_val_len || var_val_len > sizeof(int32_t)) {
