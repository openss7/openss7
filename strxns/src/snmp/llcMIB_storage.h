...
struct lLCConnection2Table_data {
	...
	long lLCConnection2RemoteBusy;	/* ReadWrite */
	long lLCConnection2RemoteReset;	/* ReadWrite */
	long lLCConnection2LocalReset;	/* ReadWrite */
	long lLCConnection2ProviderReset;	/* ReadWrite */
	...
	long lLCConnection2SentAcks;	/* ReadWrite */
	long lLCConnection2ReceivedAcks;	/* ReadWrite */
	long lLCConnection2ReceivedFRMR;	/* ReadWrite */
	long lLCConnection2SentFRMR;	/* ReadWrite */
	long lLCConnection2ReceivedRR;	/* ReadWrite */
	long lLCConnection2SentRR;	/* ReadWrite */
	long lLCConnection2ReceivedRNR;	/* ReadWrite */
	long lLCConnection2SentRNR;	/* ReadWrite */
	long lLCConnection2ReceivedREJ;	/* ReadWrite */
	long lLCConnection2SentREJ;	/* ReadWrite */
	long lLCConnection2ReceivedSABME;	/* ReadWrite */
	long lLCConnection2SentSABME;	/* ReadWrite */
	long lLCConnection2ReceivedUA;	/* ReadWrite */
	long lLCConnection2SentUA;	/* ReadWrite */
	long lLCConnection2ReceivedDISC;	/* ReadWrite */
	long lLCConnection2SentDISC;	/* ReadWrite */
	long lLCConnection2ReceivedDM;	/* ReadWrite */
	long lLCConnection2SentDM;	/* ReadWrite */
	long lLCConnection2PDUsDiscarded1;	/* ReadWrite */
	long lLCConnection2PDUsDiscarded2;	/* ReadWrite */
	long lLCConnection2PDURetransmissions;	/* ReadWrite */
	long lLCConnection2OptionalTolerationIPDUs;	/* ReadWrite */
	long lLCConnection2DuplicateIPDUsReceived;	/* ReadWrite */
	long lLCConnection2Violation;	/* ReadWrite */
