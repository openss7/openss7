/*****************************************************************************
 ...
 @(#) $Id: dlMIB.h,v 0.9.2.1 2008-12-27 15:42:07 brian Exp $
...
#ident "@(#) $RCSfile: dlMIB.h,v $ $Name: OpenSS7-0_9_2 $($Revision: 0.9.2.1 $) Copyright (c) 2001-2008 OpenSS7 Corporation."
...
struct networkEntityTable_data {
	...
	char *communicationsEntityId;
	int communicationsEntityIdLen;
	char *networkEntityTitles;
	int networkEntityTitlesLen;
	char *networkEntitySystemTypes;
...
struct cLNSTable_data {
	...
	char *cLNSSupportedProtocols;
	int cLNSSupportedProtocolsLen;
	char *cLNSOperationalSystemType;
...
struct cLNSISISTable_data {
	...
	char *cLNSISISmanualAreaAddresses;
	...
	char *cLNSISISareaTransmitPassword;
	int cLNSISISareaTransmitPasswordLen;
	char *cLNSISISareaReceivePasswords;
...
struct cLNSISISLevel2Table_data {
	...
	char *cLNSISISLevel2partitionAreaAddresses;
	int cLNSISISLevel2partitionAreaAddressesLen;
	char *cLNSISISLevel2partitionDesignatedL2IntermediateSystem;
	...
	char *cLNSISISLevel2domainTransmitPassword;
	int cLNSISISLevel2domainTransmitPasswordLen;
	char *cLNSISISLevel2domainReceivePasswords;
...
struct linkageTable_data {
	...
	char *linkageInitialMinimumTimer;
	int linkageInitialMinimumTimerLen;
	char *linkageReserveTimer;
	int linkageReserveTimerLen;
	char *linkageIdleTimer;
	...
	char *linkageISISType;
	int linkageISISTypeLen;
	char *linkageISISiSISHelloTimer;
	int linkageISISiSISHelloTimerLen;
	char *linkageISISl1DefaultMetric;
	int linkageISISl1DefaultMetricLen;
	char *linkageISISl1DelayMetric;
	int linkageISISl1DelayMetricLen;
	char *linkageISISl1ExpenseMetric;
	int linkageISISl1ExpenseMetricLen;
	char *linkageISISl1ErrorMetric;
	int linkageISISl1ErrorMetricLen;
	char *linkageISISexternalDomain;
...
struct cONSTable_data {
	...
	char *cONSOperationalSystemType;
...
struct networkConnectionTable_data {
	...
	char *connectionId;
	int connectionIdLen;
	char *networkConnectionLocalNSAPMO;
	int networkConnectionLocalNSAPMOLen;
	char *networkConnectionRemoteNSAPAddress;
...
struct x25PLE -DTETable_data {
	...
	char *x25PLE - DTEcallRequestResponseTimer;
	int x25PLE - DTEcallRequestResponseTimerLen;
	char *x25PLE - DTEextendedPacketSequenceNumbering;
	int x25PLE - DTEextendedPacketSequenceNumberingLen;
	char *x25PLE - DTEmaxActiveCircuits;
	int x25PLE - DTEmaxActiveCircuitsLen;
	char *x25PLE - DTEminimumRecallTimer;
	int x25PLE - DTEminimumRecallTimerLen;
	char *x25PLE - DTEresetRequestResponseTimer;
	int x25PLE - DTEresetRequestResponseTimerLen;
	char *x25PLE - DTErestartRequestRetransmissionCount;
	int x25PLE - DTErestartRequestRetransmissionCountLen;
	char *x25PLE - DTErestartRequestResponseTimer;
	int x25PLE - DTErestartRequestResponseTimerLen;
	char *x25PLE - DTEclearRequestResponseTimer;
	int x25PLE - DTEclearRequestResponseTimerLen;
	char *x25PLE - DTEinterruptResponseTimer;
	int x25PLE - DTEinterruptResponseTimerLen;
	char *x25PLE - DTEresetRequestRetransmissionCount;
	int x25PLE - DTEresetRequestRetransmissionCountLen;
	char *x25PLE - DTEclearRequestRetransmissionCount;
	...
	char *x25PLE - DTEwindowStatusTransmissionTimer;
	int x25PLE - DTEwindowStatusTransmissionTimerLen;
	char *x25PLE - DTEwindowRotationTimer;
	int x25PLE - DTEwindowRotationTimerLen;
	char *x25PLE - DTEdataPacketRetransmissionCount;
	int x25PLE - DTEdataPacketRetransmissionCountLen;
	char *x25PLE - DTErejectResponseTimer;
	int x25PLE - DTErejectResponseTimerLen;
	char *x25PLE - DTErejectRetransmissionCount;
	int x25PLE - DTErejectRetransmissionCountLen;
	char *x25PLE - DTEregistrationRequestResponseTimer;
	int x25PLE - DTEregistrationRequestResponseTimerLen;
	char *x25PLE - DTEregistrationRequestRetransmissionCount;
...
struct x25PLE -DCETable_data {
	...
	char *x25PLE - DCEdefaultThroughputClassesAssignment;
	int x25PLE - DCEdefaultThroughputClassesAssignmentLen;
	char *x25PLE - DCEextendedPacketSequenceNumbering;
	...
	char *x25PLE - DCEnonStandardDefaultPacketSizes;
	int x25PLE - DCEnonStandardDefaultPacketSizesLen;
	char *x25PLE - DCEnonStandardDefaultWindowSizes;
	...
	char *x25PLE - DCEincomingCall;
	int x25PLE - DCEincomingCallLen;
	char *x25PLE - DCEresetIndication;
	int x25PLE - DCEresetIndicationLen;
	char *x25PLE - DCErestartIndication;
...
struct x25PLEIVMO -DTETable_data {
	...
	char *x25PLEIVMO - DTEcallRequestResponseTimer;
	int x25PLEIVMO - DTEcallRequestResponseTimerLen;
	char *x25PLEIVMO - DTEextendedPacketSequenceNumbering;
	int x25PLEIVMO - DTEextendedPacketSequenceNumberingLen;
	char *x25PLEIVMO - DTEmaxActiveCircuits;
	int x25PLEIVMO - DTEmaxActiveCircuitsLen;
	char *x25PLEIVMO - DTEminimumRecallTimer;
	int x25PLEIVMO - DTEminimumRecallTimerLen;
	char *x25PLEIVMO - DTEresetRequestResponseTimer;
	int x25PLEIVMO - DTEresetRequestResponseTimerLen;
	char *x25PLEIVMO - DTErestartRequestRetransmissionCount;
	int x25PLEIVMO - DTErestartRequestRetransmissionCountLen;
	char *x25PLEIVMO - DTErestartRequestResponseTimer;
	int x25PLEIVMO - DTErestartRequestResponseTimerLen;
	char *x25PLEIVMO - DTEclearRequestResponseTimer;
	int x25PLEIVMO - DTEclearRequestResponseTimerLen;
	char *x25PLEIVMO - DTEinterruptResponseTimer;
	int x25PLEIVMO - DTEinterruptResponseTimerLen;
	char *x25PLEIVMO - DTEresetRequestRetransmissionCount;
	int x25PLEIVMO - DTEresetRequestRetransmissionCountLen;
	char *x25PLEIVMO - DTEclearRequestRetransmissionCount;
	int x25PLEIVMO - DTEclearRequestRetransmissionCountLen;
	char *x25PLEIVMO - DTEcallAttempts;
	int x25PLEIVMO - DTEcallAttemptsLen;
	char *x25PLEIVMO - DTEprotocolErrorsDetectedLocally;
	int x25PLEIVMO - DTEprotocolErrorsDetectedLocallyLen;
	char *x25PLEIVMO - DTEprotocolErrorsAccusedOf;
	int x25PLEIVMO - DTEprotocolErrorsAccusedOfLen;
	char *x25PLEIVMO - DTEcallEstablishmentRetryCountsExceeded;
	...
	char *x25PLEIVMO - DTEwindowStatusTransmissionTimer;
	int x25PLEIVMO - DTEwindowStatusTransmissionTimerLen;
	char *x25PLEIVMO - DTEwindowRotationTimer;
	int x25PLEIVMO - DTEwindowRotationTimerLen;
	char *x25PLEIVMO - DTEdataPacketRetransmissionCount;
	int x25PLEIVMO - DTEdataPacketRetransmissionCountLen;
	char *x25PLEIVMO - DTErejectResponseTimer;
	int x25PLEIVMO - DTErejectResponseTimerLen;
	char *x25PLEIVMO - DTErejectRetransmissionCount;
	int x25PLEIVMO - DTErejectRetransmissionCountLen;
	char *x25PLEIVMO - DTEregistrationRequestResponseTimer;
	int x25PLEIVMO - DTEregistrationRequestResponseTimerLen;
	char *x25PLEIVMO - DTEregistrationRequestRetransmissionCount;
...
struct permanentVirtualCircuitTable_data {
	...
	char *virtualCallId;
	int virtualCallIdLen;
	char *permanentVirtualCircuitChannel;
...
struct permanentVirtualCircuit -DTETable_data {
	...
	char *virtualCircuitId;
	int virtualCircuitIdLen;
	char *permanentVirtualCircuit - DTElogicalChannel;
	int permanentVirtualCircuit - DTElogicalChannelLen;
	char *permanentVirtualCircuit - DTEpacketSizes;
	int permanentVirtualCircuit - DTEpacketSizesLen;
	char *permanentVirtualCircuit - DTEthroughputClasses;
	int permanentVirtualCircuit - DTEthroughputClassesLen;
	char *permanentVirtualCircuit - DTEwindowSizes;
...
struct switchedVirtualCallTable_data {
	...
	char *virtualCallId;
	int virtualCallIdLen;
	char *switchedVirtualCalldirection;
	int switchedVirtualCalldirectionLen;
	char *switchedVirtualCallremoteDTEAddress;
	int switchedVirtualCallremoteDTEAddressLen;
	char *switchedVirtualCallthroughputClass;
	int switchedVirtualCallthroughputClassLen;
	char *switchedVirtualCallredirectReason;
	int switchedVirtualCallredirectReasonLen;
	char *switchedVirtualCalloriginallyCalledAddress;
	int switchedVirtualCalloriginallyCalledAddressLen;
	char *switchedVirtualCallcallingAddressExtension;
	int switchedVirtualCallcallingAddressExtensionLen;
	char *switchedVirtualCallcalledAddressExtension;
...
struct virtualCall -DCETable_data {
	...
	char *virtualCall - DCEcUGWithOutgoingAccessSelection;
	int virtualCall - DCEcUGWithOutgoingAccessSelectionLen;
	char *virtualCall - DCEnUISelection;
	int virtualCall - DCEnUISelectionLen;
	char *virtualCall - DCEreverseCharging;
	int virtualCall - DCEreverseChargingLen;
	char *virtualCall - DCErOASelection;
...
struct virtualAdjacencyTable_data {
	...
	char *clProtocolMachineId;
	int clProtocolMachineIdLen;
	char *virtualAdjacencyNetworkEntityTitle;
...
struct destinationSystemTable_data {
	...
	char *clProtocolMachineId;
	int clProtocolMachineIdLen;
	char *destinationSystemNetworkEntityTitle;
...
struct reachableAddressTable_data {
	...
	char *reachableAddressSNPAAddresses;
	int reachableAddressSNPAAddressesLen;
	char *reachableAddressSNPAMask;
	int reachableAddressSNPAMaskLen;
	char *reachableAddressSNPAPrefix;
