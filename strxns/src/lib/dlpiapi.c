/*****************************************************************************
 ...
 @(#) $RCSfile: dlpiapi.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2007/01/05 06:14:55 $
...
#ident "@(#) $RCSfile: dlpiapi.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2007/01/05 06:14:55 $"

static char const ident[] = "$RCSfile: dlpiapi.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2007/01/05 06:14:55 $";
