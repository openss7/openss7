...
# =============================================================================
# 
# @(#) $RCSfile: sock.m4,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2009-07-21 11:06:13 $
#
# -----------------------------------------------------------------------------
#
...
AC_DEFUN([_SOCK_OPTIONS], [dnl
	...
	[AS_HELP_STRING([--with-sock=HEADERS],
	    [SOCK header directory @<:@default=INCLUDEDIR/strsock@:>@])],
	[for s in ${!sock_cv_*} ; do eval "unset $s" ; done])
])# _SOCK_OPTIONS
# =============================================================================
...
#
# Revision 0.9.2.31  2008-10-30 11:36:16  brian
...
#
# Revision 0.9.2.25  2008-04-28 09:41:03  brian
# - updated headers for release
#
# Revision 0.9.2.24  2007/08/12 19:05:32  brian
