dnl =========================================================================
dnl
dnl @(#) $Id: xti.m4,v 0.9.2.2 2004/08/21 11:04:32 brian Exp $
dnl
dnl =========================================================================
dnl
...
dnl =========================================================================
dnl
dnl Last Modified $Date: 2004/08/21 11:04:32 $ by $Author: brian $
dnl 
dnl =========================================================================
...
AC_DEFUN([_XTI_CHECK_HEADERS], [dnl
    ...
    if test :"${with_xti:-no}" != :no -a :"${with_xti:-no}" != :yes ; then
        ...
        for xti_dir in $xti_search_path ; do
            AC_MSG_CHECKING([for xns include directory $xti_dir])
