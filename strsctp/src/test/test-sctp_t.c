/*****************************************************************************
 ...
 @(#) $RCSfile: test-sctp_t.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2005/06/07 00:52:20 $
 ...
 Last Modified $Date: 2005/06/07 00:52:20 $ by $Author: brian $
...
#ident "@(#) $RCSfile: test-sctp_t.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2005/06/07 00:52:20 $"

static char const ident[] = "$RCSfile: test-sctp_t.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2005/06/07 00:52:20 $";
