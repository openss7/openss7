/*****************************************************************************
 ...
 @(#) $RCSfile: test-sctp.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2005/07/18 12:53:09 $
...
#ident "@(#) $RCSfile: test-sctp.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2005/07/18 12:53:09 $"

static char const ident[] = "$RCSfile: test-sctp.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2005/07/18 12:53:09 $";
