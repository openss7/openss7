/*****************************************************************************
 ...
 @(#) $RCSfile: test-sctp.c,v $ $Name:  $($Revision: 0.9.2.10 $) $Date: 2007/08/14 06:22:36 $
 ...
 $Log: test-sctp.c,v $
 Revision 0.9.2.10  2007/08/14 06:22:36  brian
 - GPLv3 header update

 Revision 0.9.2.9  2007/03/12 09:35:02  brian
...
#ident "@(#) $RCSfile: test-sctp.c,v $ $Name:  $($Revision: 0.9.2.10 $) $Date: 2007/08/14 06:22:36 $"

static char const ident[] = "$RCSfile: test-sctp.c,v $ $Name:  $($Revision: 0.9.2.10 $) $Date: 2007/08/14 06:22:36 $";
