/*****************************************************************************
 ...
 @(#) $RCSfile: test-etsi_t.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2006/05/08 12:48:21 $
...
#ident "@(#) $RCSfile: test-etsi_t.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2006/05/08 12:48:21 $"

static char const ident[] = "$RCSfile: test-etsi_t.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2006/05/08 12:48:21 $";
