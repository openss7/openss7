/*****************************************************************************
 ...
 @(#) $RCSfile: sctp_sha1.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2005/03/14 01:20:59 $
...
#ident "@(#) $RCSfile: sctp_sha1.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2005/03/14 01:20:59 $"

static char const ident[] = "$RCSfile: sctp_sha1.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2005/03/14 01:20:59 $";
