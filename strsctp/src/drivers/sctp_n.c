/*****************************************************************************
 ...
 @(#) $RCSfile: sctp_n.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/03/08 19:32:04 $
 ...
 Last Modified $Date: 2005/03/08 19:32:04 $ by $Author: brian $

 *****************************************************************************/

#ident "@(#) $RCSfile: sctp_n.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/03/08 19:32:04 $"

static char const ident[] = "$RCSfile: sctp_n.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/03/08 19:32:04 $";
