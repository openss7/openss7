/*****************************************************************************
 ...
 @(#) $RCSfile: sctp_n.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2004/08/21 11:04:33 $
...
#ident "@(#) $RCSfile: sctp_n.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2004/08/21 11:04:33 $"

static char const ident[] = "$RCSfile: sctp_n.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2004/08/21 11:04:33 $";
