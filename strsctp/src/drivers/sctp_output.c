/*****************************************************************************
 ...
 @(#) $RCSfile: sctp_output.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2004/08/23 11:44:04 $
...
#ident "@(#) $RCSfile: sctp_output.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2004/08/23 11:44:04 $"

static char const ident[] = "$RCSfile: sctp_output.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2004/08/23 11:44:04 $";
