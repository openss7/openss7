/*****************************************************************************
 ...
 @(#) $RCSfile: sctp_hash.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2005/05/14 08:29:18 $
...
#ident "@(#) $RCSfile: sctp_hash.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2005/05/14 08:29:18 $"

static char const ident[] = "$RCSfile: sctp_hash.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2005/05/14 08:29:18 $";
