/*****************************************************************************
 ...
 @(#) $RCSfile: sctp_crc32c.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2005/03/14 01:20:59 $
...
#ident "@(#) $RCSfile: sctp_crc32c.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2005/03/14 01:20:59 $"

static char const ident[] = "$RCSfile: sctp_crc32c.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2005/03/14 01:20:59 $";
