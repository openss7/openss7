/*****************************************************************************
 ...
 @(#) $RCSfile: sctp_hmac_sha1.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/03/09 08:03:38 $
...
#ident "@(#) $RCSfile: sctp_hmac_sha1.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/03/09 08:03:38 $"

static char const ident[] = "$RCSfile: sctp_hmac_sha1.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/03/09 08:03:38 $";
