...
plot \
     ...
     'netperf_fc6.dat' using 1:(($6/$6)*100) smooth unique title "TCP Sockets Tx" with linespoints lt 4 lw 0.5,\
     'netperf_fc6.dat' using 1:(($7/$7)*100) smooth unique title "TCP Sockets Rx" with linespoints lt 3 lw 0.5,\
