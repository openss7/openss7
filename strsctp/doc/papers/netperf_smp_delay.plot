...
plot \
     ...
     'netperf_smp.dat' using 1:(10/$6) smooth unique title "TCP Sockets Tx" with linespoints lt 4,\
     'netperf_smp.dat' using 1:(10/$7) smooth unique title "TCP Sockets Rx" with linespoints lt 3,\
     'netperf_smp.dat' using 1:(10/$8) smooth unique title "TCP Sockets Tx" with linespoints lt 11,\
     'netperf_smp.dat' using 1:(10/$9) smooth unique title "TCP Sockets Rx" with linespoints lt 10,\
