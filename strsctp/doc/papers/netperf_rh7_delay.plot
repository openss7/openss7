...
plot \
     ...
     'netperf_rh7.dat' using 1:(10/$6) smooth unique title "TCP Sockets Tx (N)" with linespoints lt 4,\
     'netperf_rh7.dat' using 1:(10/$7) smooth unique title "TCP Sockets Rx (N)" with linespoints lt 3,\
     'netperf_rh7.dat' using 1:(10/$8) smooth unique title "TCP Sockets Tx (A)" with linespoints lt 11,\
     'netperf_rh7.dat' using 1:(10/$9) smooth unique title "TCP Sockets Rx (A)" with linespoints lt 10,\
