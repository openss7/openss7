...
plot \
     ...
     'netperf_fc6.dat' using 1:($6/10) smooth unique title "TCP Sockets Tx (N)" with linespoints lt 4,\
     'netperf_fc6.dat' using 1:($7/10) smooth unique title "TCP Sockets Rx (N)" with linespoints lt 3,\
     'netperf_fc6.dat' using 1:($8/10) smooth unique title "TCP Sockets Tx (A)" with linespoints lt 11,\
     'netperf_fc6.dat' using 1:($9/10) smooth unique title "TCP Sockets Rx (A)" with linespoints lt 10,\
