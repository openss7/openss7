...
plot \
     ...
     'netperf_nb.dat' using 1:($1*$6*8/10) smooth unique title "TCP Sockets Tx" with linespoints lt 4,\
     'netperf_nb.dat' using 1:($1*$7*8/10) smooth unique title "TCP Sockets Rx" with linespoints lt 3,\
     'netperf_nb.dat' using 1:($1*$8*8/10) smooth unique title "TCP Sockets Tx" with linespoints lt 11,\
     'netperf_nb.dat' using 1:($1*$9*8/10) smooth unique title "TCP Sockets Rx" with linespoints lt 10,\
