...
plot \
     ...
     'netperf_suse.dat' using 1:($6/10) smooth unique title "TCP Sockets Tx" with linespoints lt 4,\
     'netperf_suse.dat' using 1:($7/10) smooth unique title "TCP Sockets Rx" with linespoints lt 3,\
