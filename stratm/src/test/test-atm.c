/*****************************************************************************
 ...
 @(#) $Id: test-atm.c,v 0.9.2.1 2008-12-06 12:56:38 brian Exp $
 ...
 Last Modified $Date: 2008-12-06 12:56:38 $ by $Author: brian $

 -----------------------------------------------------------------------------

 $Log: test-atm.c,v $
 Revision 0.9.2.1  2008-12-06 12:56:38  brian
 - add test file

 *****************************************************************************/

#ident "@(#) $RCSfile: test-atm.c,v $ $Name: OpenSS7-0_9_2 $($Revision: 0.9.2.1 $) $Date: 2008-12-06 12:56:38 $"

static char const ident[] = "$RCSfile: test-atm.c,v $ $Name: OpenSS7-0_9_2 $($Revision: 0.9.2.1 $) $Date: 2008-12-06 12:56:38 $";
