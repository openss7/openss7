/*****************************************************************************
 ...
 @(#) $RCSfile: test-ch-pmod.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2007/08/12 15:20:21 $
 ...
 Last Modified $Date: 2007/08/12 15:20:21 $ by $Author: brian $
...
#ident "@(#) $RCSfile: test-ch-pmod.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2007/08/12 15:20:21 $"

static char const ident[] = "$RCSfile: test-ch-pmod.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2007/08/12 15:20:21 $";
