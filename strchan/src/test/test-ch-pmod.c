/*****************************************************************************
 ...
 @(#) $RCSfile: test-ch-pmod.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2008-04-28 23:40:00 $
 ...
 Last Modified $Date: 2008-04-28 23:40:00 $ by $Author: brian $

 -----------------------------------------------------------------------------

 $Log: test-ch-pmod.c,v $
 Revision 0.9.2.3  2008-04-28 23:40:00  brian
 - updated headers for release

 Revision 0.9.2.2  2007/08/14 06:47:41  brian
 - GPLv3 header update

 Revision 0.9.2.1  2007/08/12 15:20:21  brian
 - added new files
...
#ident "@(#) $RCSfile: test-ch-pmod.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2008-04-28 23:40:00 $"

static char const ident[] = "$RCSfile: test-ch-pmod.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2008-04-28 23:40:00 $";
