/*****************************************************************************
 ...
 @(#) $RCSfile: test-mx-pmod.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2007/08/14 06:47:41 $
...
#ident "@(#) $RCSfile: test-mx-pmod.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2007/08/14 06:47:41 $"

static char const ident[] = "$RCSfile: test-mx-pmod.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2007/08/14 06:47:41 $";
