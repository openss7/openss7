/*****************************************************************************
 ...
 @(#) $Id: x400pMIB.h,v 0.9.2.11 2009-01-14 14:31:22 brian Exp $
...
struct x400pSyncTable_data {
	...
	long x400pSyncGroup;		/* NoAccess */
	long x400pSyncIndex;		/* NoAccess */
...
struct x400pCardTable_data {
	...
	long x400pCardIndex;		/* NoAccess */
	long x400pCardType;		/* ReadOnly */
	long x400pCardIdentifier;	/* ReadOnly */
	uint8_t *x400pCardRevision;	/* ReadOnly */
	size_t x400pCardRevisionLen;
	long x400pCardChipType;		/* ReadOnly */
	uint8_t *x400pCardChipRevision;	/* ReadOnly */
	size_t x400pCardChipRevisionLen;
	long x400pCardPciBus;		/* ReadOnly */
	long x400pCardPciSlot;		/* ReadOnly */
	long x400pCardPciIrq;		/* ReadOnly */
	...
	long x400pCardSyncGroup;	/* Create */
