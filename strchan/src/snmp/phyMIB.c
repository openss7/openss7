/*****************************************************************************
 ...
 @(#) $RCSfile: phyMIB.c,v $ $Name:  $($Revision: 0.9.2.11 $) $Date: 2009-01-04 13:16:12 $
...
#ident "@(#) $RCSfile: phyMIB.c,v $ $Name:  $($Revision: 0.9.2.11 $) $Date: 2009-01-04 13:16:12 $"

static char const ident[] = "$RCSfile: phyMIB.c,v $ $Name:  $($Revision: 0.9.2.11 $) $Date: 2009-01-04 13:16:12 $";
 ...
 */
#if 0
oid phyBasicCompliance_oid[11] = { 1, 3, 6, 1, 4, 1, 29591, 1, 100, 2, 1 };
oid physicalGroup_oid[11] = { 1, 3, 6, 1, 4, 1, 29591, 1, 100, 2, 2 };
oid dataCircuitGroup_oid[11] = { 1, 3, 6, 1, 4, 1, 29591, 1, 100, 2, 2 };
oid physicalConnectionGroup_oid[11] = { 1, 3, 6, 1, 4, 1, 29591, 1, 100, 2, 2 };
#endif
...
#if defined MODULE
	if (sa_readfd != 0) {
		register_readfd(sa_readfd, phyMIB_fd_handler, (void *) 0);
		register_exceptfd(sa_readfd, phyMIB_fd_handler, (void *) 1);
	}
#if defined MASTER
	phyMIBold_signal_handler = external_signal_handler[0];
	external_signal_handler[0] = &phyMIB_loop_handler;
...
#if defined MODULE
#if defined MASTER
	external_signal_handler[0] = phyMIBold_signal_handler;
#endif				/* defined MASTER */
	if (sa_readfd != 0) {
...
#endif				/* defined MASTER */
/**
 * @fn void phyMIB_readfd_handler(int fd, void *dummy)
 ...
 */
void
phyMIB_readfd_handler(int fd, void *dummy)
{
