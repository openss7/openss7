/*****************************************************************************
 ...
 @(#) $RCSfile: phyMIB.c,v $ $Name:  $($Revision: 0.9.2.14 $) $Date: 2009-01-14 14:31:21 $
...
#ident "@(#) $RCSfile: phyMIB.c,v $ $Name:  $($Revision: 0.9.2.14 $) $Date: 2009-01-14 14:31:21 $"

static char const ident[] = "$RCSfile: phyMIB.c,v $ $Name:  $($Revision: 0.9.2.14 $) $Date: 2009-01-14 14:31:21 $";
...
var_physicalEntityTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_physicalEntityTable_row(StorageTmp, 0);
	*write_method = NULL;
	*var_len = 0;
	rval = NULL;
	/* This is where we do the value assignments for the mib results. */
...
var_physicalSAPTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_physicalSAPTable_row(StorageTmp, 0);
	*write_method = NULL;
	*var_len = 0;
	rval = NULL;
	/* This is where we do the value assignments for the mib results. */
...
var_dataCircuitTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_dataCircuitTable_row(StorageTmp, 0);
	*write_method = NULL;
	*var_len = 0;
	rval = NULL;
	/* This is where we do the value assignments for the mib results. */
...
var_physicalConnectionTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_physicalConnectionTable_row(StorageTmp, 0);
	*write_method = NULL;
	*var_len = 0;
	rval = NULL;
	/* This is where we do the value assignments for the mib results. */
...
write_physicalSAPRowStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case ACTION:
		...
		case RS_ACTIVE:
			...
			if (old_value != RS_ACTIVE) {
				...
				if (!physicalSAPTable_consistent(StorageTmp)) {
	...
	case COMMIT:
		...
		case RS_CREATEANDGO:
			...
			if (physicalSAPTable_consistent(StorageNew)) {
...
write_dataCircuitRowStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case ACTION:
		...
		case RS_ACTIVE:
			...
			if (old_value != RS_ACTIVE) {
				/* check that activation is possible */
				if (!dataCircuitTable_consistent(StorageTmp)) {
	...
	case COMMIT:
		...
		case RS_CREATEANDGO:
			/* row creation, set final state */
			/* check if row is ready, otherwise leave at RS_NOTREADY */
			if (dataCircuitTable_consistent(StorageNew)) {
				/* XXX: commit creation to underlying device */
				/* XXX: activate with underlying device */
...
write_physicalConnectionRowStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case ACTION:
		...
		case RS_ACTIVE:
			...
			if (old_value != RS_ACTIVE) {
				/* check that activation is possible */
				if (!physicalConnectionTable_consistent(StorageTmp)) {
	...
	case COMMIT:
		...
		case RS_CREATEANDGO:
			/* row creation, set final state */
			/* check if row is ready, otherwise leave at RS_NOTREADY */
			if (physicalConnectionTable_consistent(StorageNew)) {
				/* XXX: commit creation to underlying device */
				/* XXX: activate with underlying device */
