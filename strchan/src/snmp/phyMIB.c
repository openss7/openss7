/*****************************************************************************
 ...
 @(#) $RCSfile: phyMIB.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2008/01/03 12:46:00 $
...
#ident "@(#) $RCSfile: phyMIB.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2008/01/03 12:46:00 $"

static char const ident[] = "$RCSfile: phyMIB.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2008/01/03 12:46:00 $";
...
oid phyMIB_variables_oid[] = { 1, 3, 6, 1, 4, 1, 29591, 1, 1, 100 };

oid physicalSAPTable_variables_oid[] = { 1, 3, 6, 1, 4, 1, 29591, 1, 1, 100, 1, 1, 2, 1, 1 };
oid dataCircuitTable_variables_oid[] = { 1, 3, 6, 1, 4, 1, 29591, 1, 1, 100, 1, 1, 3, 1, 1 };
oid physicalConnectionTable_variables_oid[] = { 1, 3, 6, 1, 4, 1, 29591, 1, 1, 100, 1, 1, 4, 1, 1 };
...
#define   DATACIRCUITPHYSICALINTERFACESTANDARD  25
	{DATACIRCUITPHYSICALINTERFACESTANDARD, ASN_OCTET_STR, RONLY, var_dataCircuitTable, 6,
	 {1, 1, 3, 1, 1, 9}},
...
{
	struct phyMIB_data *StorageTmp = phyMIBStorage;
