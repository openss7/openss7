/*****************************************************************************
 ...
 @(#) $RCSfile: phyMIB.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2009-01-02 15:04:18 $
...
#ident "@(#) $RCSfile: phyMIB.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2009-01-02 15:04:18 $"

static char const ident[] = "$RCSfile: phyMIB.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2009-01-02 15:04:18 $";
...
phyMIB_create(void)
{
	...
	DBUGMSGTL(("phyMIB", "creating scalars...  "));
	if (StorageNew != NULL) {
