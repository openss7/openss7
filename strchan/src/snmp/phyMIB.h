/*****************************************************************************
 ...
 @(#) $Id: phyMIB.h,v 0.9.2.10 2009-01-04 13:16:12 brian Exp $
...
#ident "@(#) $RCSfile: phyMIB.h,v $ $Name:  $($Revision: 0.9.2.10 $) Copyright (c) 2008-2009 Monavacom Limited."
...
#if 0
extern oid phyBasicCompliance_oid[11];
extern oid physicalGroup_oid[11];
extern oid dataCircuitGroup_oid[11];
extern oid physicalConnectionGroup_oid[11];
#endif
