/*****************************************************************************
 ...
 $Log: zaptel.h,v $
 Revision 0.9.2.4  2008-04-28 23:39:55  brian
...
struct zt_span {
	...
	/* Req: Set the requested chunk size.  This is the unit in which you must report results
	   for conferencing, etc */
...
#define	ZT_RADSTAT_RXCT	4	/* currently receiving continuous tone with current settings */
...
#define	ZT_RADPAR_EXTRXTONE 6	/* 0 means use internal decoder, 1 means UIOA logic true is CT
				   decode, 2 means UIOA logic false is CT decode */
...
#define	ZT_RADPAR_RXTONE	9	/* CTCSS tone, (1-32) or DCS tone (1-777), or 0 meaning no
					   tone, set index also (1-15) */
#define	ZT_RADPAR_RXTONECLASS 10	/* Tone class (0-65535), set index also (1-15) */
#define	ZT_RADPAR_TXTONE 11	/* CTCSS tone (1-32) or DCS tone (1-777) or 0 to indicate no tone,
				   to transmit for this tone index (0-32, 0 disables transmit
				   CTCSS), set index also (0-15) */
#define	ZT_RADPAR_DEBOUNCETIME 12	/* receive indication debounce time, milliseconds (1-999) */
#define	ZT_RADPAR_BURSTTIME 13	/* end of transmit with no CT tone in milliseconds (0-999) */

#define	ZT_RADPAR_UIODATA 14	/* read/write UIOA and UIOB data. Bit 0 is UIOA, bit 1 is UIOB */
#define	ZT_RADPAR_UIOMODE 15	/* 0 means UIOA and UIOB are both outputs, 1 means UIOA is input,
				   UIOB is output, 2 means UIOB is input and UIOA is output, 3
				   means both UIOA and UIOB are inputs. Note mode for UIOA is
