...
dnl =========================================================================
dnl
dnl @(#) $Id: acinclude.m4,v 0.9 2004/04/03 12:44:16 brian Exp $
dnl
dnl =========================================================================
dnl
...
dnl =========================================================================
dnl
dnl Last Modified $Date: 2004/04/03 12:44:16 $ by $Author: brian $
dnl 
dnl =========================================================================
...
[
    ...
    USER_CFLAGS="${CFLAGS}"
    _INET_SETUP
    INET_INCLUDES="-I- -imacros ./config.h -I./src/include -I${srcdir}/src/include${streams_cv_includes:+ -I}${streams_cv_includes} ${xti_cv_includes:+ -I}${xti_cv_includes}"
