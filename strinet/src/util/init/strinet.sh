#!/bin/sh
#
# @(#) $RCSfile: strinet.sh,v $ $Name:  $($Revision: 0.9.2.16 $) $Date: 2007/08/14 04:28:49 $
...
# -----------------------------------------------------------------------------
#
# Last Modified $Date: 2007/08/14 04:28:49 $ by $Author: brian $
#
# -----------------------------------------------------------------------------
#
# $Log: strinet.sh,v $
# Revision 0.9.2.16  2007/08/14 04:28:49  brian
# - GPLv3 header update
#
# =============================================================================
