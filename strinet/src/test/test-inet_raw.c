/*****************************************************************************
 ...
 @(#) $RCSfile: test-inet_raw.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2005/05/14 08:28:53 $
...
#ident "@(#) $RCSfile: test-inet_raw.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2005/05/14 08:28:53 $"

static char const ident[] = "$RCSfile: test-inet_raw.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2005/05/14 08:28:53 $";
