/*****************************************************************************
 ...
 @(#) $RCSfile: test-inet_raw.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2005/04/04 16:43:17 $
...
#ident "@(#) $RCSfile: test-inet_raw.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2005/04/04 16:43:17 $"

static char const ident[] = "$RCSfile: test-inet_raw.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2005/04/04 16:43:17 $";
