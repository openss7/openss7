/*****************************************************************************
 ...
 @(#) $RCSfile: test-inet_udp.c,v $ $Name:  $($Revision: 0.9 $) $Date: 2004/04/03 12:44:18 $
 ...
 Revision 0.9  2004/04/03 12:44:18  brian
...
#ident "@(#) $RCSfile: test-inet_udp.c,v $ $Name:  $($Revision: 0.9 $) $Date: 2004/04/03 12:44:18 $"
...
#endif
	, { sizeof(struct t_opthdr) + sizeof(t_scalar_t), T_INET_UDP, T_UDP_CHECKSUM, T_SUCCESS} , T_NO
#if 0
