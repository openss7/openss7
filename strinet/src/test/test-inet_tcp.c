/*****************************************************************************
 ...
 @(#) $RCSfile: test-inet_tcp.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/04/04 16:43:17 $
...
#ident "@(#) $RCSfile: test-inet_tcp.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/04/04 16:43:17 $"

static char const ident[] = "$RCSfile: test-inet_tcp.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/04/04 16:43:17 $";
