/*****************************************************************************
 ...
 @(#) $RCSfile: cdiapi.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:21:58 $
...
static char const ident[] = "$RCSfile: cdiapi.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:21:58 $";
