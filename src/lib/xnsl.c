/*****************************************************************************
 ...
 @(#) $RCSfile: xnsl.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:22:00 $
...
static char const ident[] = "$RCSfile: xnsl.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:22:00 $";
 ...
 * This development manual was written for the OpenSS7 NSL Library version \$Name:  $(\$Revision: 1.1.2.2 $).
