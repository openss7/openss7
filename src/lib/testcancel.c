/*****************************************************************************
 ...
 @(#) $RCSfile: testcancel.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:37:47 $
...
#ident "@(#) $RCSfile: testcancel.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:37:47 $"

static char const ident[] = "$RCSfile: testcancel.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:37:47 $";
