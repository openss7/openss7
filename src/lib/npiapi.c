/*****************************************************************************
 ...
 @(#) $RCSfile: npiapi.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:37:46 $
...
#ident "@(#) $RCSfile: npiapi.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:37:46 $"

static char const ident[] = "$RCSfile: npiapi.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:37:46 $";
