...
/*
 @(#) $RCSfile: NotifyResponse.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:08 $ <p>
  ...
  +--java.util.EventObject
        ...
        +--jain.protocol.ip.mgcp.JainMgcpEvent
              ...
              +--jain.protocol.ip.mgcp.JainMgcpResponseEvent
                    |
                    +--jain.protocol.ip.mgcp.message.NotifyResponse
   ...
   Constructor Summary
   NotifyResponse(java.lang.Object source, ReturnCode returnCode)
             Constructs a new NotifyResponse Event object, setting the
   return code to be used and a reference to the Command Event object (or
   a clone thereof) that elicited this response.
...
public NotifyResponse(java.lang.Object source,
                      ReturnCode returnCode)
               throws java.lang.IllegalArgumentException

          Constructs a new NotifyResponse Event object, setting the
          return code to be used and a reference to the Command Event
          object (or a clone thereof) that elicited this response.
