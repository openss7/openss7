...
/*
 @(#) $RCSfile: ModifyConnectionResponse.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:20 $ <p>
...
java.lang.Object
  ...
  +--java.util.EventObject
   ...
   See Also: 
          ModifyConnection, Serialized Form
     _________________________________________________________________
   ...
   Constructor Summary
   ModifyConnectionResponse(java.lang.Object source,
   ...
   Method Summary
    ...
    void
   setLocalConnectionDescriptor(ConnectionDescriptor localConnectionDescr
   iptor)
...
public ConnectionDescriptor getLocalConnectionDescriptor()
        ...
        Returns:
                The session description that contains information about
                the addresses and RTP ports used for the connection.
     _________________________________________________________________

  setLocalConnectionDescriptor

public void setLocalConnectionDescriptor(ConnectionDescriptor localConnectionDe
scriptor)

          Sets the Local Connection Descriptor string.

        Parameters:
                localConnectionDescriptor - Optional parameter. A session
                description that contains information about the addresses
                and RTP ports used for the connection. Must be set to
                null, if not used.
     _________________________________________________________________
