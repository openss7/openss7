...
/*
 @(#) $RCSfile: BearerInformation.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:21 $ <p>
...
java.lang.Object
  ...
  +--jain.protocol.ip.mgcp.message.parms.BearerInformation
   ...
   Defines the encoding method to be used for encoding the data received
   from the line side.
   ...
   static BearerInformation EncMethod_A_Law
             Encapsulates the A-law encoding method in a
   BearerInformation object.
   static BearerInformation EncMethod_mu_Law
             Encapsulates the mu-law encoding method in a
   BearerInformation object.
   ...
   Method Summary
    ...
    java.lang.String toString()
             Returns the encoding method as a java.lang.String ("A" or "mu").
...
public static final BearerInformation EncMethod_A_Law
          ...
          Encapsulates the A-law encoding method in a BearerInformation
          object.
     _________________________________________________________________
...
public static final BearerInformation EncMethod_mu_Law
          ...
          Encapsulates the mu-law encoding method in a BearerInformation
          object.
...
public int getEncodingMethod()
        ...
        Returns:
                An integer value that indicates the encoding method to be
                used.
     _________________________________________________________________
