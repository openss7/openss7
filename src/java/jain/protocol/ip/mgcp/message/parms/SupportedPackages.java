...
/*
 @(#) $RCSfile: SupportedPackages.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:22 $ <p>
...
java.lang.Object
  ...
  +--jain.protocol.ip.mgcp.message.parms.CapabilityValue
   ...
   This class represents an endpoint capability expressed as a list of
   supported MGCP event/signal packages.
   ...
   Method Summary
    PackageName[] getSupportedPackageNames()
             Returns the list of supported package names that is
   encapsulated by this CapabilityValue object.
    java.lang.String toString()
             Returns a java.lang.String of the form "v:<supportedPackageNames>"
   where <supportedPackageNames> is a comma-separated list of supported
   package names.
...
public java.lang.String toString()
          ...
          Returns a java.lang.String of the form "v:<supportedPackageNames>" where
          <supportedPackageNames> is a comma-separated list of supported
          package names.
