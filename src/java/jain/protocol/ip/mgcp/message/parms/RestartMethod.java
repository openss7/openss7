...
/*
 @(#) $RCSfile: RestartMethod.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:09 $ <p>
...
java.lang.Object
  ...
  +--jain.protocol.ip.mgcp.message.parms.RestartMethod
   ...
   Defines the Restart Method values for use in the RestartInProgress
   command.
   ...
   Method Summary
    int getRestartMethod()
             Get the integer constant that corresponds to this Restart
   Method.
    java.lang.String toString()
             Get the java.lang.String that corresponds to the name of the Restart
   Method.
...
public int getRestartMethod()
        ...
        Returns:
                One of the predefined constants that represent a Restart
                Method.
     _________________________________________________________________
