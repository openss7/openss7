...
/*
 @(#) $RCSfile: ExtendedConnectionParm.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:08 $ <p>
...
java.lang.Object
  ...
  +--jain.protocol.ip.mgcp.message.parms.ConnectionParm
   ...
   Class that defines an extended connection parameter. A connection
   parameter describes the status of a connection. Returned by Gateway
   ...
   static int EXTENSION
             Signifies that this ConnectionParm object represents an
   extension parameter.
   ...
   int connectionParmValue)
             Constructs a new ConnectionParm object that is an extension
   parameter.



   Method Summary
    java.lang.String getConnectionParmExtensionName()
...
public ExtendedConnectionParm(java.lang.String connectionParmExtensionName,
        ...
        Parameters:
                connectionParmExtensionName - A two-character java.lang.String that
                is the name of this connection parameter extension.
        ...
        Throws:
                ...
                connection paramter name is not a java.lang.String of length
                exactly two or if the connection parameter value is
...
public java.lang.String getConnectionParmExtensionName()
        ...
        Returns:
                The name of the extension parameter, or null, if this is
                not an extension parameter.
     _________________________________________________________________
