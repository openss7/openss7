...
/*
 @(#) $RCSfile: WildcardNotPermittedException.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:09 $ <p>
        ...
        +--java.lang.Exception
              ...
              +--jain.protocol.ip.JainIPException
                    ...
                    +--jain.protocol.ip.mgcp.JainIPMgcpException
                          |
                          +--jain.protocol.ip.mgcp.message.parms.WildcardNotPer
mittedException
   ...
   The Wildcard Not Permitted Exception is thrown when the Requested
   Information parameter is specified in the AuditEndpoint command event
   constructor, but the Endpoint Identifier parameter in that constructor
   has been specified using the wildcard convention.
   ...
   WildcardNotPermittedException()
             Default constructor.
   WildcardNotPermittedException(java.lang.String msg)
