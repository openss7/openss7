...
/*
 @(#) $RCSfile: ConnectionDescriptor.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:21 $ <p>
...
java.lang.Object
  ...
  +--jain.protocol.ip.mgcp.message.parms.ConnectionDescriptor
   ...
   A connection description, in the form of a Session Description
   Protocol (SDP) string.
   ...
   ConnectionDescriptor(java.lang.String connectionDescriptor)
             Constructs a new Connection Descriptor, setting the
   description string.
...
public ConnectionDescriptor(java.lang.String connectionDescriptor)
          ...
          Constructs a new Connection Descriptor, setting the description
          string.

        Parameters:
                connectionDescriptor - The string to be used as the
