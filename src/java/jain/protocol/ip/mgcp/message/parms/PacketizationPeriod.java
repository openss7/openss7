...
/*
 @(#) $RCSfile: PacketizationPeriod.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:22 $ <p>
...
java.lang.Object
  ...
  +--jain.protocol.ip.mgcp.message.parms.LocalOptionValue
   ...
   PacketizationPeriod(int value)
             Constructs a new packetization period in which the upper and
   lower bounds are the same value.
   PacketizationPeriod(int lower, int upper)
             Constructs a new packetization period in which the upper and
   lower bounds are distinct values.
   ...
   getLocalOptionValueType, getResourceReservation,
...
public int getPacketizationPeriodLowerBound()
        ...
        Overrides:
                getPacketizationPeriodLowerBound in class
                LocalOptionValue
...
public int getPacketizationPeriodUpperBound()
        ...
        Overrides:
                getPacketizationPeriodUpperBound in class
                LocalOptionValue
...
public java.lang.String toString()
          ...
          Returns a java.lang.String of the form "p:<lowerBound>[-<upperBound>]".
