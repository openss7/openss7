...
/*
 @(#) $RCSfile: ConflictingParameterException.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:08 $ <p>
        ...
        +--java.lang.Exception
              ...
              +--jain.protocol.ip.JainIPException
                    ...
                    +--jain.protocol.ip.mgcp.JainIPMgcpException
                          |
                          +--jain.protocol.ip.mgcp.message.parms.ConflictingPar
ameterException
   ...
   The Conflicting Parameter Exception is thrown when an attempt is made
   to set a parameter, which, if set, would conflict with another
   parameter that has already been set.
   ...
   ConflictingParameterException()
             Default constructor.
   ConflictingParameterException(java.lang.String msg)
