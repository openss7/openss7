...
/*
 @(#) $RCSfile: ConnectionParm.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:21 $ <p>
...
java.lang.Object
  ...
  +--jain.protocol.ip.mgcp.message.parms.ConnectionParm
   ...
   Abstract class that defines a connection parameter (e.g., number of
   packets sent). A connection parameter describes the status of a
   connection. Returned by Gateway when a connection is deleted.
...
public int getConnectionParmType()
        ...
        Returns:
                The integer value that represents which type of
                connection parameter this is.
     _________________________________________________________________
