...
/*
 @(#) $RCSfile: RequestIdentifier.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:22 $ <p>
...
java.lang.Object
  ...
  +--jain.protocol.ip.mgcp.message.parms.RequestIdentifier
   ...
   Constructor Summary
   RequestIdentifier(java.lang.String requestIdentifier)
             Constructs a new Request Identifier, setting the string for
   the identifier.
...
public RequestIdentifier(java.lang.String requestIdentifier)
                  throws java.lang.IllegalArgumentException

          Constructs a new Request Identifier, setting the string for the
          identifier.

        Parameters:
                requestIdentifier - The Request Identifier string.

        Throws:
                java.lang.IllegalArgumentException - Thrown if the
                request identifier string does not contain between 1 and
