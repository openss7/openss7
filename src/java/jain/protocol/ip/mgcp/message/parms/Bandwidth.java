...
/*
 @(#) $RCSfile: Bandwidth.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:08 $ <p>
...
java.lang.Object
  ...
  +--jain.protocol.ip.mgcp.message.parms.LocalOptionValue
   ...
   Constructor Summary
   Bandwidth(int value)
             Constructs a new bandwidth range in which the upper and
   lower bounds are the same value.
   Bandwidth(int lower, int upper)
             Constructs a new bandwidth range in which the upper and
   ...
   Method Summary
    ...
    java.lang.String toString()
             Returns the bandwidth range as a java.lang.String of the form
   "b:<lower bound>[-<upper bound>]" where the upper bound is omitted if
...
public Bandwidth(int value)
          ...
          Constructs a new bandwidth range in which the upper and lower
...
public int getBandwidthLowerBound()
        ...
        Overrides:
                getBandwidthLowerBound in class LocalOptionValue
...
public int getBandwidthUpperBound()
        ...
        Overrides:
                getBandwidthUpperBound in class LocalOptionValue
...
public java.lang.String toString()
          ...
          Returns the bandwidth range as a java.lang.String of the form "b:<lower
          bound>[-<upper bound>]" where the upper bound is omitted if the
