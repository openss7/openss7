...
/*
 @(#) $RCSfile: SilenceSuppression.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:09 $ <p>
  ...
  +--jain.protocol.ip.mgcp.message.parms.LocalOptionValue
   ...
   Method Summary
    ...
    java.lang.String toString()
             Returns "s:on" or "s:off" depending on the state of the
   boolean value for silence suppression.
...
public java.lang.String toString()
          ...
          Returns "s:on" or "s:off" depending on the state of the boolean
          value for silence suppression.
