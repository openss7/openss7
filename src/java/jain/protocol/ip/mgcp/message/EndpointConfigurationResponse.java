...
/*
 @(#) $RCSfile: EndpointConfigurationResponse.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:20 $ <p>
  ...
  +--java.util.EventObject
        ...
        +--jain.protocol.ip.mgcp.JainMgcpEvent
              ...
              +--jain.protocol.ip.mgcp.JainMgcpResponseEvent
                    |
                    +--jain.protocol.ip.mgcp.message.EndpointConfigurationRespo
nse
   ...
   The acknowledgment to an MGCP EndpointConfiguration command, expressed
   as an event object.
   ...
   Constructor Summary
   EndpointConfigurationResponse(java.lang.Object source,
...
public EndpointConfigurationResponse(java.lang.Object source,
        ...
        Throws:
                java.lang.IllegalArgumentException - Thrown if return
