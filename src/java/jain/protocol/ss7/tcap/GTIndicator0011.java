/*
 @(#) $RCSfile: GTIndicator0011.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:29 $ <p>
...
/**
  ...
  * to store, create and retrieve GlobalTitle-0011 entries. It is
  ...
  * the addition of the GTIndicator0011 class.
  */
public final class GTIndicator0011 extends GlobalTitle {
    ...
    /** @deprecated
      * Constructs a new Global Title Indicator-0011 with the relevent
    ...
    /** @deprecated
      ...
      * Thrown if this mandatory parameter has not been set since JAIN
      * TCAP v1.1.  */
