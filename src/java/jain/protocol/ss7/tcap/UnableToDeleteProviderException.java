/*
 @(#) $RCSfile: UnableToDeleteProviderException.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:29 $ <p>
...
/**
  ...
  * JainTcapStack is invoked to delete a JainTcapProvider but the
  * deletion is not allowed. This may be because the JainTcapProvider
  * has already been deleted, or because the JainTcapProvider is in use.
  * @version 1.2.2
  * @author Monavacon Limited
  * @deprecated As of JAIN TCAP v1.1. This class is no longer needed as
  * a result of the addition of the DeleteProviderException class.
  */
public class UnableToDeleteProviderException extends TcapException {
    /** @deprecated
      * Constructs a new UnableToDeleteProviderException with the
