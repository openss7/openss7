...
/**
  ...
  * <code>JainTcapProviders</code> and the implicit attaching/detaching
  * of those <code>JainTcapProviders</code> to this JainTcapStack
  * implementation. <p>
  *
...
public interface JainTcapStack {
    ...
    /**
      ...
      * JainTcapStackImpl. This method replaces the
      ...
      * set the JainTcapStack reference in the newly created
    ...
    */
    ...
    /**
      ...
      * Providers of this JainTcapStackImpl will be proprietary objects
      * belonging to the same stack vendor.
      *
      * @return
      * A JainTcapProvider Array containing all of the Peer JAIN TCAP
