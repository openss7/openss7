/*
 @(#) $RCSfile: TcapException.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:29 $ <p>
...
/**
  ...
  * a result of JAIN Exception Strategy.
  */
public class TcapException extends SS7Exception {
    /** @deprecated
      * Constructs a new TcapException with the specified detail
      * message.
      * @param msg
