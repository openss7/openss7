/*
 @(#) $RCSfile: TimerResetReqEvent.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:30 $ <p>
...
/**
  * An event representing a TCAP Timer Reset request component
...
public final class TimerResetReqEvent extends ComponentReqEvent {
    /** Constructs a new Timer Reset request Event, with only the Event
      * Source and the JAIN TCAP Mandatory parameters being supplied to
      * the constructor.
      * @param source
      * The Event Source supplied to the method.
      * @param dialogueId
      * The Dialogue Identifier supplied to the method.
      * @param invokeId
      * The Invoke Identifier supplied to the method.  */
    public TimerResetReqEvent(java.lang.Object source, int dialogueId,
            int invokeId) {
        super(source);
