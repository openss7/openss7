/*
 @(#) $RCSfile: ErrorReqEvent.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:30 $ <p>
...
public final class ErrorReqEvent extends ComponentReqEvent {
    /** Constructs a new Error request Event, with only the Event Source
    ...
    public ErrorReqEvent(java.lang.Object source, int dialogueId,
            int errorType, byte[] errorCode) {
        super(source);
    ...
    /** @deprecated
      * As of JAIN TCAP v1.1. No replacement - no function for
      * parameter.
      */
    ...
    /** Gets the Parameters' parameter of the ERROR request Component.
      ...
      * @return
      * The Parameters of the Error Request Component.
