/*
 @(#) $RCSfile: RejectIndEvent.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:30 $ <p>
...
public final class RejectIndEvent extends ComponentIndEvent {
    /** Constructs a new Reject indication Event, with only the Event
      ...
      * @param problemType
      * The Problem Type supplied to the constructor.
      * @param problem
      * The Problem supplied to the constructor.
      * @param lastComponent
      * The Last Component flag supplied to the constructor.  */
    public RejectIndEvent(java.lang.Object source, int dialogueId,
            int problemType, int problem, boolean lastComponent) {
        super(source);
    ...
    /** Sets the problem type of this Reject request Component.
      * @param problemType
      * The new ProblemType value, one of the following: <ul>
    ...
    /** Gets the Dialogue Id parameter of this Reject Indication, which
    ...
    /** Gets the Invoke Id parameter of this Reject indication. Invoke
      * Id identifies the operation invocation and its result. The
      * mapping rules for the Invoke Identifier in an REJECT Component
    ...
    /** Gets the Parameters' parameter of the Reject indication
    ...
    /** Returns the problem details of this Reject indication Component.
      * @return
      * The problem detail. One of the following problem codes, grouped
      * by Problem type: <ul>
      * <li>PROBLEM_TYPE_GENERAL <ol>
      *     <li>PROBLEM_CODE_BADLY_STRUCTURED_COMPONENT
      *     <li>PROBLEM_CODE_MISTYPED_COMPONENT
    ...
    public int getProblem()
        ...
        if (m_problemPresent)
            return m_problem;
        throw new MandatoryParameterNotSetException("Problem: not set.");
    }
    /** @deprecated
      * As of JAIN TCAP v1.1. No replacement - no function for parameter.  */
    ...
    /** Whether the Problem Type is present.
      * @serial m_problemTypePresent
      * - a default serializable field.  */
    private boolean m_problemTypePresent = false;
    /** Whether the Problem is present.
      * @serial m_problemPresent
      * - a default serializable field.  */
    private boolean m_problemPresent = false;
    /** The Reject Type of the Reject Indication Component, which is
      * defaulted to REJECT_TYPE_LOCAL.
      * @serial m_rejectType
      * - a default serializable field.  */
    private int m_rejectType = 1;
    /** Whether the Reject Type is present.
      * @serial rejectTypePresent
      * - a default serializable field.  */
