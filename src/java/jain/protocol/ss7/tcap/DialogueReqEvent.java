/*
 @(#) $RCSfile: DialogueReqEvent.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:29 $ <p>
...
/**
  * A DialogueReqEvent is the superclass of all Dialogue Request
  * primitives, which represent TCAP Dialogue Requests sent from a
  ...
  * interface, therefore all Dialogue Request primitives that extend
...
public abstract class DialogueReqEvent extends java.util.EventObject implements java.io.Serializable, java.lang.Cloneable {
    ...
    /** Sets the source of this event. This method may be used to
      * overirde the setting of the event source through the
    ...
    /** Sets the Dialogue Id parameter, of this Dialogue Request Event,
      * which is a reference identifier that is used to uniquely
      ...
      * <em>Note to developers:-</em> If this is the first BEGIN
      * transaction message of a new dialogue a call should be made to
      * the getNewDialogueID method of the JainTcapProvider in order to
      * get returned a free Dialogue Id from the underlying stack
      * implementation.
      * @param dialogueId
    ...
    /** Sets the Dialogue Portion of this Dialogue handling request
    ...
    /** Sets the Quality of Service of this Dialogue Request Event, the
      * Quality of Service parameter is initialized to zero, therefore
      * by default can be interpreted as "Not Used".
      * @param qualityOfService
      * The new QualityOfService value.  */
    ...
    public int getDialogueId()
        ...
        if (m_dialogueIdPresent)
            return m_dialogueId;
        throw new MandatoryParameterNotSetException("Dialog Id: not set.");
    }
    ...
    /** Gets the Dialogue Portion of this Dialogue handling request
      * primitive. The Dialogue Portion provides a mechanism to
      * determine the interpretation of TCAP message information,
      * security and confidentiality at a remote TCAP. A Dialogue
    ...
    /** Gets the Quality of Service parameter of this Dialogue Requeat
      * event. Quality of Service is an SCCP parameter that is required
    ...
    /** This abstract method defines the 'getPrimitiveType' method that
      ...
      * type of that subclassed Dialogue Request primitive.
      * @return
    ...
    /** The Quality of Service parameter for Dialogue Request Events.
      ...
      * - a default serializable field.
      * We code this parameter as: 0 - Not used 1 - Sequence guaranteed
      * 2 - Return message on error: 3 - Both 'Sequence guaranteed' and
      * 'Return message on error' Therefore a value of 3(byte equivalent
      * is used) = Both 'Sequence guaranteed' and 'Return message on
      * error' for a connectionless SCCP network service.  */
    ...
    /** The Dialogue Portion of this Dialogue handling request
      * primitive.
      * @serial m_dialoguePortion
      * - a default serializable field.  */
    protected DialoguePortion m_dialoguePortion = null;
    /** Whether Dialogue Portion is present.
