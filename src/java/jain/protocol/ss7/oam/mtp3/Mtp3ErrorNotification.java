/*
 @(#) $RCSfile: Mtp3ErrorNotification.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:26 $ <p>
...
/**
  * This Notification may be emitted by any Mtp3 Managed Bean if a user defined error is
  * encountered. <p>
  *
  * This Mtp3ErrorNotification should be sent to all applications that have registered
  ...
  * @version 1.2.2
  */
public class Mtp3ErrorNotification extends OamErrorNotification {
    /**
      * Routing error.
      * <br> Emitted By: OwnSignallingPointMBean
      * <br> Notification Type: "jain.protocol.ss7.oam.mtp3.error.routing_error".
      */
    public static final int MTP3_ERROR_ROUTING_ERROR = 1;
    /**
      * Illegal timer expiry in the MTP3 software. This may happen if a timer expires in a
      * state where this timer was not supposed to be active.
      * <br> Emitted By: Mtp3TimerProfileMBean
      * <br> Notification Type: "jain.protocol.ss7.oam.mtp3.error.illegal_timer_expiry".
      */
    public static final int MTP3_ERROR_ILLEGAL_TIMER_EXPIRY = 2;
    /**
      ...
      */
    public Mtp3ErrorNotification(OamManagedObjectMBean source, long sequenceNumber, int errorType)
