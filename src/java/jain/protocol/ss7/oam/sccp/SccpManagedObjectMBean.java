/*
 @(#) $RCSfile: SccpManagedObjectMBean.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:27 $ <p>
...
/**
  * This interface is used by an MBean to emit three differect types of Sccp
  * Notifications. These Sccp Notifications are: SccpAlarmNotifications,
  * SccpErrorNotifications and SccpStatisticNotifications. <p>
  *
  ...
  * hand-back object. The Filter specifies which types of Sccp Notification the Listener
  ...
  *
  * This interface is used as a logical grouping for all MBeans in the Sccp layer. All
  ...
  * @version 1.2.2
  */
public abstract interface SccpManagedObjectMBean extends OamManagedObjectMBean {
}
