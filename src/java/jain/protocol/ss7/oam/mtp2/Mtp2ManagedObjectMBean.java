/*
 @(#) $RCSfile: Mtp2ManagedObjectMBean.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:25 $ <p>
...
/**
  * This interface is used by an MBean to emit three differect types of Mtp2
  * Notifications. These Mtp2 Notifications are: Mtp2AlarmNotifications,
  * Mtp2ErrorNotifications and Mtp2StatisticNotifications. <p>
  *
  ...
  * hand-back object. The Filter specifies which types of Mtp2 Notification the Listener
  ...
  *
  * This interface is used as a logical grouping for all MBeans in the MTP2 layer. All
  ...
  * @version 1.2.2
  */
public abstract interface Mtp2ManagedObjectMBean extends OamManagedObjectMBean {
}
