/*
 @(#) $RCSfile: TcapAlarmNotification.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:28 $ <p>
...
/**
  * A TcapAlarmNotification is a Notification emitted by a Tcap Managed Bean (MBean) to
  ...
  *
  * This TcapAlarmNotification should be sent to all applications that have registered
  ...
  * @version 1.2.2
  */
public class TcapAlarmNotification extends OamAlarmNotification {
    /**
      * Alarm Type Constant: No resources remaining. This alarm is generated if the
      * maximum resource for the TCAP stack configuration is reached and no new resource
      * can be allocated. <p>
      * <br> Emitted By: TcapNodeMBean
      * <br> Notification Type: "jain.protocol.ss7.oam.tcap.alarm.ssn_unavailable_maintenance".
      */
    public static final int TCAP_ALARM_RESOURCE_LIMIT_REACHED = 1;
    /**
      * Constructs a new TcapAlarmNotification.
      *
      * @param source
      * The Managed Bean that emitted this Notification.
      *
      ...
      */
    public TcapAlarmNotification(OamManagedObjectMBean source, long sequenceNumber, int priority, int alarmType) throws IllegalArgumentException { }
