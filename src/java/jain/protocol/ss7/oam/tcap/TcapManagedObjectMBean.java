/*
 @(#) $RCSfile: TcapManagedObjectMBean.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:28 $ <p>
...
/**
  * This interface is used by an MBean to emit three differect types of Tcap
  * Notifications. These types of Tcap Notifications are: TcapAlarmNotifications,
  * TcapErrorNotifications and TcapStatisticNotifications. <p>
  *
  ...
  * hand-back object. The Filter specifies which types of Tcap Notification the Listener
  ...
  *
  * This interface is used as a logical grouping for all MBeans in the Tcap layer. All
  ...
  * <center> Inheritance hierarchy for JAIN OAM Notification </center><br> <p>
  ...
  * @version 1.2.2
  */
public abstract interface TcapManagedObjectMBean extends OamManagedObjectMBean {
}
