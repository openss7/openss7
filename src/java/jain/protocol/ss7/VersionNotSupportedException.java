/*
 @(#) $RCSfile: VersionNotSupportedException.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:24 $ <p>
...
/**
  * This Exception is thrown to indicate that there is no support for
