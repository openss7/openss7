/*
 @(#) $RCSfile: IdNotAvailableException.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:23 $ <p>
...
/**
  * This Exception is thrown to indicate that there are no more free
  * Dialogue Ids or InvokeId
  * @serial
  *
