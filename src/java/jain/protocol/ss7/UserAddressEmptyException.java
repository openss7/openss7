/*
 @(#) $RCSfile: UserAddressEmptyException.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:24 $ <p>
...
/**
  * This JAIN UserAddressEmptyException is a run time exception thrown
...
public class UserAddressEmptyException extends SS7Exception {
    /**
      * Constructs a new UserAddressEmptyException with the specified
      * detail message.
      * @param msg
      * The detail message.
      */
