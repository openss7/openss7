/*
 @(#) $RCSfile: UserAddressLimitException.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:24 $ <p>
...
/**
  * This Exception is thrown when an attempt is made to add an User
  * Address to a JainTcapListener when the Limit of User Addresses
...
public class UserAddressLimitException extends SS7Exception {
    /**
      * Constructs a new UserAddressLimitException with the specified
      * detail message.
      * @param msg
      * The detail message.
      */
