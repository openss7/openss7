/*
 @(#) $RCSfile: ScreeningTable.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:36:35 $ <p>
...
/**
  ...
  * @version 1.2.2
  */
public class ScreeningTable implements ScreeningTableMBean {
    ...
    public java.lang.String getObjectType() {
        return new java.lang.String("OBJECT_TYPE_SCREENING_TABLE");
    }
    /* ScreeningTableMBean interface */
    public native void setScreeningType(Integer screeningType)
        throws IllegalArgumentException;
    public native Integer getScreeningType();
    public native ObjectName[] getValidList(ObjectName destSignallingPoint);
    public native void setValidList(ObjectName destSignallingPoint, ObjectName[] authorisedList)
