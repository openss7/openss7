/*
 @(#) $RCSfile: Mtp2Sap.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:36:34 $ <p>
...
/**
  ...
  * @version 1.2.2
  */
public class Mtp2Sap implements Mtp2SapMBean {
    public Mtp2Sap()
    ...
    public java.lang.String getObjectType() {
        return new java.lang.String("OBJECT_TYPE_MTP2_SAP");
    }
    /* Mtp2SapMBean interface */
    public native ObjectName getMtp2TimerProfile();
    public native void setMtp2TimerProfile(ObjectName timerProfile);
    public native void setPortType(Integer portType)
        throws IllegalArgumentException;
    public native Integer getPortType();
