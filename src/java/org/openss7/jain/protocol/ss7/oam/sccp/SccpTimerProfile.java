/*
 @(#) $RCSfile: SccpTimerProfile.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:36:36 $ <p>
...
/**
  ...
  * @version 1.2.2
  */
public class SccpTimerProfile implements SccpTimerProfileMBean {
    public SccpTimerProfile()
    ...
    public java.lang.String getObjectType() {
        return new java.lang.String("OBJECT_TYPE_SCCP_TIMER_PROFILE");
    }
    /* OamTimerProfileMBean interface */
    public native void initialiseTimers();
    /* SccpTimerProfileMBean interface */
    public native ObjectName getSccpTimerConnect();
    public native ObjectName getSccpTimerGuard();
    public native ObjectName getSccpTimerIAR();
    public native ObjectName getSccpTimerIAS();
    public native ObjectName getSccpTimerInt();
    public native ObjectName getSccpTimerReassembly();
    public native ObjectName getSccpTimerRelease();
    public native ObjectName getSccpTimerRepeatRelease();
    public native ObjectName getSccpTimerReset();
    public native ObjectName getSccpTimerCoordChg();
    public native ObjectName getSccpTimerIgnoreSST();
    public native ObjectName getSccpTimerRtgStatInfo();
