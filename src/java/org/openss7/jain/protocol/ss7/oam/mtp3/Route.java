/*
 @(#) $RCSfile: Route.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:36:35 $ <p>
...
/**
  ...
  * @version 1.2.2
  */
public class Route implements RouteMBean {
    public Route()
    ...
    public java.lang.String getObjectType() {
        return new java.lang.String("OBJECT_TYPE_ROUTE");
    }
    /* RouteMBean interface */
    public native ObjectName getDestSignallingPoint();
    public native void setDestSignallingPoint(ObjectName destinationSignallingPoint);
    public native ObjectName getFirstLinkSet();
    public native Boolean isSignallingPointAccessible();
    public native void setRoutingAllowed(Boolean allowed);
    public native Boolean isRoutingAllowed();
    public native Integer getAvailability();
    public native Integer getPriority();
    public native void setPriority(Integer priority)
        throws IllegalArgumentException;
    public native ObjectName[] getLinkSets();
    public native ObjectName getLinkSet(Integer index);
    public native void setLinkSet(Integer index, ObjectName linkset)
        throws TooManyInstancesException;
    public native void setLinkSets(ObjectName[] linksets)
        throws TooManyInstancesException;
    public native void clearLinkSetList();
