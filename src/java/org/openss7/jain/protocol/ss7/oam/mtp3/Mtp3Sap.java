/*
 @(#) $RCSfile: Mtp3Sap.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:36:35 $ <p>
...
/**
  ...
  * @version 1.2.2
  */
public class Mtp3Sap implements Mtp3SapMBean {
    public Mtp3Sap()
    ...
    public java.lang.String getObjectType() {
        return new java.lang.String("OBJECT_TYPE_MTP3_SAP");
    }
    /* Mtp3SapMBean interface */
    public native void setSignallingPoint(ObjectName signallingPoint)
        throws IllegalArgumentException;
    public native ObjectName getSignallingPoint();
    public native ObjectName[] getMtp3SapUsers();
    public native ObjectName getMtp3SapUser(Integer index);
    public native void setServiceIndicator(Integer serviceIndicator)
        throws IllegalArgumentException;
    public native Integer getServiceIndicator();
    public native Integer getSapStatus();
