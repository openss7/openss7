/*
 @(#) $RCSfile: ConcernedArea.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:36:35 $ <p>
...
/**
  ...
  * @version 1.2.2
  */
public class ConcernedArea implements ConcernedAreaMBean {
    public ConcernedArea()
    ...
    public java.lang.String getObjectType() {
        return new java.lang.String("OBJECT_TYPE_CONCERNED_AREA");
    }
    /* ConcernedAreaMBean interface */
    public native void setRemoteSubsystem(Integer index, ObjectName remoteSccp)
        throws TooManyInstancesException;
    public native ObjectName getRemoteSubsystem(Integer index);
    public native void setRemoteSubsystems(ObjectName[] remoteSccps)
        throws TooManyInstancesException;
    public native ObjectName[] getRemoteSubsystems();
