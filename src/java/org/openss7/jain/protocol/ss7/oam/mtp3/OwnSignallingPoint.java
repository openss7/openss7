/*
 @(#) $RCSfile: OwnSignallingPoint.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:36:35 $ <p>
...
/**
  ...
  * @version 1.2.2
  */
public class OwnSignallingPoint implements OwnSignallingPointMBean {
    public OwnSignallingPoint()
    ...
    public java.lang.String getObjectType() {
        return new java.lang.String("OBJECT_TYPE_OWN_SIGNALLING_POINT");
    }
    /* SignallingPointMBean interface */
    public native void setSignallingPointCode(Long pointCode)
        throws IllegalArgumentException;
    public native Long getSignallingPointCode();
    public native void setNetworkIndicator(Integer networkInd)
        throws IllegalArgumentException;
    public native Integer getNetworkIndicator();
    public native void setType(Integer type)
        throws IllegalArgumentException;
    public native Integer getType();
    public native ObjectName[] getMtp3Saps();
    public native ObjectName getMtp3Sap(Integer index);
    /* OwnSignallingPointMBean interface */
    public native void setBackup(ObjectName backup);
    public native ObjectName getBackup();
    public native void setRouteSet(Integer index, ObjectName routeSet)
        throws TooManyInstancesException;
    public native void setRouteSets(ObjectName[] routeSets)
        throws TooManyInstancesException;
    ...
    public native void setScreeningTables(ObjectName[] screeningTables)
        throws TooManyInstancesException, IllegalOperationException;
    public native void setScreeningTable(Integer index, ObjectName screeningTable)
        throws TooManyInstancesException, IllegalOperationException;
    public native ObjectName getMtp3TimerProfile();
    public native void setMtp3TimerProfile(ObjectName timerProfile);
