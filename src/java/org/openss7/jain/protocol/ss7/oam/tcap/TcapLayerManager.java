/*
 @(#) $RCSfile: TcapLayerManager.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:36:36 $ <p>
 ...
 Last Modified $Date: 2009-06-21 11:36:36 $ by $Author: brian $
 */

package org.openss7.jain.protocol.ss7.oam.tcap;

import javax.management.*;

import jain.protocol.ss7.oam.tcap.*;
...
/**
  ...
  * @version 1.2.2
  */
public class TcapLayerManager implements TcapLayerManagerMBean {
    public TcapLayerManager()
    ...
    public native ObjectName getActiveTcapNode(Integer index);
    public native void setActiveTcapNodes(ObjectName[] tcapLayers)
        throws TooManyInstancesException;
    public native ObjectName[] getActiveTcapNodes();
    public native ObjectName createTcapNode(ObjectName sp, ObjectName[] subsystems)
        throws TooManyInstancesException;
    public native void deleteTcapNode(ObjectName tcap);
