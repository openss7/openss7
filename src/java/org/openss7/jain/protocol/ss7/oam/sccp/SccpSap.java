/*
 @(#) $RCSfile: SccpSap.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:36:36 $ <p>
...
/**
  ...
  * @version 1.2.2
  */
public class SccpSap implements SccpSapMBean {
    public SccpSap()
    ...
    public java.lang.String getObjectType() {
        return new java.lang.String("OBJECT_TYPE_SCCP_SAP");
    }
    /* SccpSapMBean interface */
    public native void setSubsystemNumber(Integer ssn);
    public native Integer getSubsystemNumber();
    public native void setMtp3Sap(ObjectName mtp3Sap);
    public native ObjectName getMtp3Sap();
    public native void setConcernedArea(ObjectName concernedArea);
    public native ObjectName getConcernedArea();
    public native Integer getSapAvailabilityStatus();
    public native Integer getSubsystemStatus();
