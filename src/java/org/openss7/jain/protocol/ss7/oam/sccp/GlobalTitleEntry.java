/*
 @(#) $RCSfile: GlobalTitleEntry.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:36:35 $ <p>
...
/**
  ...
  * @version 1.2.2
  */
public class GlobalTitleEntry implements GlobalTitleEntryMBean {
    public GlobalTitleEntry()
    ...
    public java.lang.String getObjectType() {
        return new java.lang.String("OBJECT_TYPE_GLOBAL_TITLE_ENTRY");
    }
    /* GlobalTitleEntryMBean interface */
    public native Integer getGTIndicator();
    public native void setGTIndicator(Integer indicator)
        throws IllegalArgumentException;
    public native void setAddressInformation(Byte[] addressInformation)
        throws IllegalArgumentException;
    public native Byte[] getAddressInformation();
    public native void setSccpEntitySet(ObjectName sccpEntitySet);
    public native ObjectName getSccpEntitySet();
    public native void setNatureOfAddrInd(Integer natureOfAddrInd)
        throws IllegalArgumentException;
    public native Integer getNatureOfAddrInd();
    public native void setNumberingPlan(Integer numberingPlan)
        throws IllegalArgumentException;
    public native Integer getNumberingPlan();
    public native Byte getTranslationType();
    public native void setTranslationType(Byte translationType);
    public native void setEncodingScheme(Integer encodingScheme)
        throws IllegalArgumentException;
    public native Integer getEncodingScheme();
