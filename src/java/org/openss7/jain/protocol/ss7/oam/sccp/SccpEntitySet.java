/*
 @(#) $RCSfile: SccpEntitySet.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:36:35 $ <p>
...
/**
  ...
  * @version 1.2.2
  */
public class SccpEntitySet implements SccpEntitySetMBean {
    ...
    public java.lang.String getObjectType() {
        return new java.lang.String("OBJECT_TYPE_SCCP_ENTITY_SET");
    }
    /* SccpEntitySetMBean interface */
    public native Integer getSharingMode();
    public native void setSharingMode(Integer sharingMode)
        throws IllegalArgumentException;
    public native void setDestinationSubsystems(ObjectName[] destinationSubsystems)
        throws TooManyInstancesException;
    public native ObjectName[] getDestinationSubsystems();
    public native void setDestinationSubsystem(Integer index, ObjectName destinationSubsystem)
        throws TooManyInstancesException;
    public native ObjectName getDestinationSubsystem(Integer index);
