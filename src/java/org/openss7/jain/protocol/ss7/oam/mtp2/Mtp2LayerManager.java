/*
 @(#) $RCSfile: Mtp2LayerManager.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:36:34 $ <p>
...
package org.openss7.jain.protocol.ss7.oam.mtp2;
...
/**
  ...
  * @version 1.2.2
  */
public class Mtp2LayerManager implements Mtp2LayerManagerMBean {
    public Mtp2LayerManager()
        throws MalformedObjectNameException {
        m_objectName = new ObjectName("org.openss7.jain.protocol.ss7.oam.mtp2:type=" + getObjectType() + ",id=" + getObjectId());
    }
    ...
    public java.lang.String getObjectType() {
        return new java.lang.String("OBJECT_TYPE_MTP2_LAYER_MANAGER");
    }
    ...
    /* Mtp2LayerManagerMBean interface extensions */
    public native ObjectName createMtp2TimerProfile()
        throws TooManyInstancesException;
    public native ObjectName createMtp2Sap(Integer portType)
        throws TooManyInstancesException, IllegalArgumentException;
    public native void deleteMtp2TimerProfile(ObjectName timerProfile);
    public native void deleteMtp2Sap(ObjectName sap);
    public native ObjectName getActiveMtp2Sap(Integer index);
    public native void setActiveMtp2Sap(Integer index, ObjectName mtp2Sap)
        throws TooManyInstancesException;
    public native ObjectName[] getActiveMtp2Saps();
    public native void setActiveMtp2Saps(ObjectName[] mtp2Saps)
        throws TooManyInstancesException;
    public native ObjectName[] getMtp2Saps();
    public native ObjectName getMtp2Sap(Integer index);
    public native ObjectName[] getMtp2TimerProfiles();
    public native ObjectName getMtp2TimerProfile(Integer index);
