/*
 @(#) $RCSfile: RouteSet.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:36:35 $ <p>
...
/**
  ...
  * @version 1.2.2
  */
public class RouteSet implements RouteSetMBean {
    public RouteSet()
    ...
    public native Boolean isLoadSharing();
    ...
    public native Integer getCongestionLevel();
    public native ObjectName[] getRoutes();
    public native void setRoutes(ObjectName[] routes)
