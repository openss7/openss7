/*
 @(#) $RCSfile: Mtp2TimerProfile.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:36:34 $ <p>
...
/**
  ...
  * @version 1.2.2
  */
public class Mtp2TimerProfile implements Mtp2TimerProfileMBean {
    public Mtp2TimerProfile()
    ...
    public java.lang.String getObjectType() {
        return new java.lang.String("OBJECT_TYPE_MTP2_TIMER_PROFILE");
    }
    /* OamTimerProfileMBean interface */
    public native void initialiseTimers();
    /* Mtp2TimerProfileMBean interface */
    public native ObjectName getMtp2TimerT1();
    public native ObjectName getMtp2TimerT2();
    public native ObjectName getMtp2TimerT3();
    public native ObjectName getMtp2TimerT4E();
    public native ObjectName getMtp2TimerT4N();
    public native ObjectName getMtp2TimerT5();
    public native ObjectName getMtp2TimerT6();
    public native ObjectName getMtp2TimerT7();
