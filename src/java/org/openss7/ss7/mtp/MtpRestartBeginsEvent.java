/*
 @(#) $RCSfile: MtpRestartBeginsEvent.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:36:46 $ <p>
...
/**
  ...
  * @version 1.2.2
  */
public class MtpRestartBeginsEvent extends MtpRestartEvent {
    public MtpRestartBeginsEvent(java.lang.Object source,
            javax.jain.ss7.SignalingPointCode affectedPointCode) {
        super(source, MtpPrimitiveType.RESTART_BEGINS, affectedPointCode);
    }
}
