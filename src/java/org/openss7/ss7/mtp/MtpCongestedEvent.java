/*
 @(#) $RCSfile: MtpCongestedEvent.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:36:45 $ <p>
...
/**
  * This class models the MTP-STATUS indication primitive of the MTP,
  * when used to indicate the congesetion of a remote signalling point
  * code or cluster.  This is also equivalent to the SCON message in
  * M3UA (RFC 4666).
  *
  ...
  * signalling point associate with the JainMtpStack. </ul>
  *
