/*
 @(#) $RCSfile: MtpRoute.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:36:46 $ <p>
...
public class MtpRoute extends MtpParameter {
    private javax.jain.ss7.SignalingPointCode signalingPointCode = null;
    private MtpRouteType routeType = null;
    public MtpRoute(javax.jain.ss7.SignalingPointCode signalingPointCode,
            MtpRouteType routeType) {
    ...
    public MtpRouteType getRouteType() {
        return routeType;
    }
}
