/*
 @(#) $RCSfile: MtpRouteType.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:36:46 $ <p>
...
public class MtpRouteType extends MtpParameter {
    public final static int M_ROUTE_MEMBER = 0;
    public final static int M_ROUTE_CLUSTER = 1;
    public final static int M_ROUTE_NETWORK = 2;
    public final static int M_ROUTE_WILDCARD = 3;
    private int routeType;
    private boolean local = false;
    protected MtpRouteType(int routeType, boolean local) {
