/*
 @(#) $RCSfile: PeerUnavailableException.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:51 $ <p>
...
/**
    The PeerUnavailableException indicates that a vendor's implementation of a JAIN SIP interface
...
public class PeerUnavailableException extends SipException {
    ...
    /**
        Constructs a new PeerUnavailableException with the specified error message and specialized
        cause that triggered this error condition.
        @param message The detail of the error message.
        @param cause The specialized cause that triggered this exception.
      */
    public PeerUnavailableException(java.lang.String message, java.lang.Throwable cause) {
        super(message, cause);
    }
}
