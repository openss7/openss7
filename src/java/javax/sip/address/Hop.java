/*
 @(#) $RCSfile: Hop.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:52 $ <p>
...
/**
    The Hop interface defines a location a request can transit on the way to its destination, i.e. a
    route. It defines the host, port and transport of the location. This interface is used to
    identify locations in the Router interface.
    @version 1.2.2
