/*
 @(#) $RCSfile: ObjectInUseException.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:51 $ <p>
...
/**
    This exception is thrown by a method that is unable to delete a specified Object because the
...
public class ObjectInUseException extends SipException {
    ...
    /**
        Constructs a new ObjectInUseException with the specified error message and specialized cause
        that triggered this error condition.
        @param message The detail of the error message.
        @param cause The specialized cause that triggered this exception.
      */
    public ObjectInUseException(java.lang.String message, java.lang.Throwable cause) {
        super(message, cause);
    }
}
