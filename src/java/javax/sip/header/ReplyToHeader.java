/*
 @(#) $RCSfile: ReplyToHeader.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:54 $ <p>
...
/**
    ...
    request or populated in such a way that does not reveal any private information. <p> For
    Example: <br> <code> Reply-To: Bob sip:bob@biloxi.com </code>
    @see HeaderAddress
    @see Parameters
    @version 1.2.2
...
public interface ReplyToHeader extends HeaderAddress, Parameters, Header {
    /**
      ...
      */
    static final java.lang.String NAME = "Reply-To";
}
