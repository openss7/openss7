/*
 @(#) $RCSfile: ExtensionHeader.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:53 $ <p>
...
/**
    ...
    headers are defined in the current version of this specification). Headers that are not part of
    the current version of this specification MUST implement ExtensionHeader.
    @version 1.2.2
...
public interface ExtensionHeader extends Header {
    /**
        ...
        @exception java.text.ParseException Thrown when an error was found while parsing the value
        parameter.
      */
