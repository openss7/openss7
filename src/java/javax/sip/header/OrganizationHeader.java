/*
 @(#) $RCSfile: OrganizationHeader.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:53 $ <p>
...
/**
    The OrganizationHeader conveys the name of the organization to which the entity issuing the
    Request or Response belongs. It may be used by client software to filter calls.
    @version 1.2.2
...
public interface OrganizationHeader extends Header {
    /**
      ...
      */
    static final java.lang.String NAME = "Organization";
    /**
        Sets the organization value of the OrganizationHeader to the organization parameter
        supplied.
