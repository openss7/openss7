/*
 @(#) $RCSfile: SubjectHeader.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:54 $ <p>
...
/**
    ...
    to use the same subject indication as the invitation. <p> For Example: <br> <code> Subject:
    Where is the Moscone? </code>
    @version 1.2.2
...
public interface SubjectHeader extends Header {
    /**
      ...
      */
    static final java.lang.String NAME = "Subject";
    /**
