/*
 @(#) $RCSfile: ContentLanguageHeader.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:53 $ <p>
...
/**
    The Content-Language header field is used to indicate the language of the message body. <p> For
    Example:<br><code>Content-Language: fr</code>
...
public interface ContentLanguageHeader extends Header {
    /**
      ...
      */
    static final java.lang.String NAME = "Content-Language";
    /**
