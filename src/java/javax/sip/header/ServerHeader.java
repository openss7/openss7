/*
 @(#) $RCSfile: ServerHeader.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:54 $ <p>
...
/**
    ...
    request. Revealing the specific software version of the server might allow the server to become
    more vulnerable to attacks against software that is known to contain security holes.
    Implementers SHOULD make the Server header field a configurable option. If the Response is being
    forwarded through a proxy, the proxy application must not modify the ServerHeaders. Instead, it
    should include a ViaHeader. <p> For Example: <br> <code> Server: HomeServer v2 </code>
    @see ViaHeader
    @see UserAgentHeader
    @version 1.2.2
...
public interface ServerHeader extends Header {
    /**
      ...
      */
    static final java.lang.String NAME = "Server";
    /**
        Returns a ListIterator over the List of product values.
        @return A ListIterator over the List of strings identifying the software of this
        ServerHeader.
      */
