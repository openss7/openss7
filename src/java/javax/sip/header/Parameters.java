/*
 @(#) $RCSfile: Parameters.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:28:37 $ <p>
...
/**
    This interface defines methods for accessing generic parameters for Headers that contain generic
    parameter values.
    @version 1.2.2
...
public interface Parameters {
    ...
    /**
        Returns an Iterator over the names (Strings) of all parameters present in this
        ParametersHeader.
