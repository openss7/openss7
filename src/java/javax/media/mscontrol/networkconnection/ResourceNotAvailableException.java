/*
 @(#) $RCSfile: ResourceNotAvailableException.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:27 $ <p>
...
ectionException
                   extended by  javax.media.mscontrol.networkconnection.Resourc
eNotAvailableException
...
public class ResourceNotAvailableException
   ...
   extends NetworkConnectionException

   This exception is thrown when the media server has not enough
   resources available. (e.g., no more network port available).
   ...
   ResourceNotAvailableException(java.lang.Throwable cause)
...
public ResourceNotAvailableException(java.lang.Throwable cause)
     _________________________________________________________________
