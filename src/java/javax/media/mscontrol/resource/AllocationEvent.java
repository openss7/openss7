/*
 @(#) $RCSfile: AllocationEvent.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:28 $ <p>
...
Interface AllocationEvent
   ...
   All Superinterfaces:
          MediaEvent<MediaObject>, StatusEvent
     _________________________________________________________________
...
public interface AllocationEvent
   ...
   Field Summary
   static Symbol ev_AllocationConfirmed
             This Symbol is returned by getEventID() to signal the
   completion of a ResourceContainer.confirm().
  ...
  ev_AllocationConfirmed

static final Symbol ev_AllocationConfirmed
