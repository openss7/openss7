/*
 @(#) $RCSfile: ConfigSymbol.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:28 $ <p>
...
Interface ConfigSymbol<C extends MediaConfig>

   All Superinterfaces:
          Symbol
     _________________________________________________________________

public interface ConfigSymbol<C extends MediaConfig>
   ...
   Methods inherited from interface javax.media.mscontrol.resource.Symbol
