/*
 @(#) $RCSfile: UserFunctionConstants.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:12 $ <p>
...
javax.media.mscontrol.resource.common
Interface UserFunctionConstants
     _________________________________________________________________

public interface UserFunctionConstants

   A UserFunction is a wrapper on a customer-provided resource.

   Requires that a ResourceContainer is created with a MediaConfig
   including a UserFunction.
     _________________________________________________________________

   Field Summary
   static Symbol a_FunctionName
...
static final Symbol a_FunctionName

          Attribute indicating what function is actually run by the
          resource.
          This is an attribute, and cannot be changed. It must be
          specified in the MediaConfig.
     _________________________________________________________________
...
*/
package javax.jain.media.mscontrol.resource.common;
