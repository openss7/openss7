/*
 @(#) $RCSfile: VolumeConstants.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:12 $ <p>
...
Interface VolumeConstants
     _________________________________________________________________

public interface VolumeConstants

   Provides Symbols to control the Volume, in a ResourceContainer.
     _________________________________________________________________
