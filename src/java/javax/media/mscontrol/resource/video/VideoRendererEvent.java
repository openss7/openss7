/*
 @(#) $RCSfile: VideoRendererEvent.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:32 $ <p>
...
Interface VideoRendererEvent

   All Superinterfaces:
          MediaEvent<VideoRenderer>, ResourceEvent<VideoRenderer>
     _________________________________________________________________

public interface VideoRendererEvent

   extends ResourceEvent<VideoRenderer>

   The class of events returned by a VideoRenderer.
     _________________________________________________________________
