/*
 @(#) $RCSfile: MixerConfig.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:11 $ <p>
...
public interface MixerConfig

   extends MediaConfig

   This class describes the media-processing resources included in the
   mixer
     _________________________________________________________________
