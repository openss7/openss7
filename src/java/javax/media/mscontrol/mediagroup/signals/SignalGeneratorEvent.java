/*
 @(#) $RCSfile: SignalGeneratorEvent.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:25 $ <p>
...
Interface SignalGeneratorEvent
   ...
   All Superinterfaces:
          MediaEvent<SignalGenerator>, ResourceEvent<SignalGenerator>,
          SignalConstants, SignalGeneratorConstants
     _________________________________________________________________

public interface SignalGeneratorEvent

   extends ResourceEvent<SignalGenerator>, SignalGeneratorConstants

   Defines the methods used in SignalGenerator Events.

   There are no methods specific to SignalGeneratorEvent.
     _________________________________________________________________
   ...
   javax.media.mscontrol.mediagroup.signals.SignalGeneratorConstants
   ev_EmitSignals, p_Amplitude, p_DtmfGeneratorMode, p_InterSigGap,
   p_Length
