/*
 * NotDelegatedException.java Version-1.4, 2002/11/22 09:26:10 -0800 (Fri)
...
/**
 * Thrown if releaseInDelgation and the MediaService is not delegated.
 *
 * @author  Jeff Peck
 * @since   JTAPI-1.3
 */
public 
class NotDelegatedException extends MediaException {
    /**
     * Constructs a <code>NotDelegatedException</code> 
     * with no specified detail message. 
     */
    public NotDelegatedException() {super();}
