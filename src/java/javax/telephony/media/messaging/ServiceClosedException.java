/*
 * ServiceClosedException.java Version-1.4, 2002/11/22 09:26:10 -0800 (Fri)
...
/** A ServiceException indicating this service is closed.
 *
 * @author  Jeff Peck
 * @since   JTAPI-1.4
 */
public class ServiceClosedException extends ServiceException {
    /**
     * Constructs a <code>ServiceClosedException</code> 
     * with no specified detail message. 
     */
    public ServiceClosedException() { super(); }
     ...
     *
     * Wraps the given Event in a ServiceClosedException.
