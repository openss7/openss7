...
/**
 * The <CODE>AgentTermLoggedOffEv</CODE> interface indicates that an Agent has
 * moved into the <CODE>Agent.LOG_OFF</CODE> state. This interface extends the
 ...
 */
public interface AgentTermLoggedOffEv extends AgentTermEv {
