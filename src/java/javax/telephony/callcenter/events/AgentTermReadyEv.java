...
/**
 * The <CODE>AgentTermReadyEv</CODE> interface indicates that an Agent has
 * moved into the <CODE>Agent.READY</CODE> state. This interface extends the
 ...
 */
public interface AgentTermReadyEv extends AgentTermEv {
