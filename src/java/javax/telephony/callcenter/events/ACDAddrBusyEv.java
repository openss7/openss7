...
/**
 * The <CODE>ACDAddrBusyEv</CODE> interface indicates that an Agent has moved
 * into the <CODE>Agent.BUSY</CODE> state. This interface extends the
 ...
 */
public interface ACDAddrBusyEv extends ACDAddrEv {
