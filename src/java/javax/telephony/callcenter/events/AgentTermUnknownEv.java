...
/**
 * The <CODE>AgentTermUnknownEv</CODE> interface indicates that an Agent has
 * moved into the <CODE>Agent.UNKNOWN</CODE> state. This interface extends the
 ...
 */
public interface AgentTermUnknownEv extends AgentTermEv {
