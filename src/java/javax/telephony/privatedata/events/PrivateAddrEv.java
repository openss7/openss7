/*
#pragma ident "@(#)PrivateAddrEv.java	1.3      96/11/03     SMI"
...
/**
 * The <CODE>PrivateAddrEv</CODE> interface sends platform-specific event
 * information to an <CODE>AddressObserver</CODE>. This interface extends the
 * core <CODE>AddrEv</CODE> interface. This interface could be a stand-alone
 * event for private data that is not associated with any other event. This
 * interface could also be used to extend any other event for private data.
 * <p>
