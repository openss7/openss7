/*
 @(#) $RCSfile: ProviderUnavailableException.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:33 $ <p>
...
/** This exception indicates that the JccProvider is currently not
  ...
  * obtained via the getReason() method on this interface.
  * @since 1.0b
  * @version 1.2.2
  * @author Monavacon Limited
  */
public class ProviderUnavailableException extends java.lang.RuntimeException {
    ...
    /** Returns the cause for this exception. This methods was
      * originally called getCause(). However, this signature conflicted
      * with J2SDKv1.4.0 Beta 3.
