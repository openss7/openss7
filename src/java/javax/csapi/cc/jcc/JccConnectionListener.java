/*
 @(#) $RCSfile: JccConnectionListener.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:33 $ <p>
...
/** This interface is an extension of the JccCallListener interface and
  * reports state changes both of the JccCall and its JccConnections.
  * @since 1.0
  * @version 1.2.2
...
public interface JccConnectionListener extends JccCallListener {
    ...
    /** Indicates that the JccConnection has just been placed in the
      * JccConnection.ADDRESS_ANALYZE state
      * @param connectionevent
      * JccConnectionEvent.  */
    ...
    /** Indicates that the JccConnection has just experienced a mid call
      * event. To learn more about the specifics of the mid call event,
      * JccConnection.getMidCallData() can be queried.
      * @param connectionevent
      * JccConnectionEvent.
      * @since 1.0b */
