/*
 @(#) $RCSfile: ResourceUnavailableException.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:33 $ <p>
...
/** This exception indicates that a resource inside the system is not
  * available to complete an operation. The type embodied in this
  * exception clarifies what is not available and is obtained via the
  * getType() method in this class.
  * @since 1.0b
  * @version 1.2.2
  * @author Monavacon Limited
  */
public class ResourceUnavailableException extends java.lang.Exception {
    ...
    /** The internal resources to handle another method have been
      * exceeded.  */
    public static final int OUTSTANDING_METHOD_EXCEEDED = 4;
    /** An internal resource, unspecified by the implementation, has
      * been exceeded.  */
    public static final int UNSPECIFIED_LIMIT_EXCEEDED = 5;
    /** No dialtone detected.  */
    public static final int NO_DIALTONE = 6;
    /** A user has not responded in the time allowed by an
      * implementation.  */
