/*
 @(#) $RCSfile: PrivilegeViolationException.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:33 $ <p>
...
/** This exception indicates that an action pertaining to a certain
  * object failed because the application did not have the proper
  * security permissions to execute that command.
  *
  * This class stores the type of privilege not available which is
  * obtained via the getType() method in this class.
  * @since 1.0b
  * @version 1.2.2
  * @author Monavacon Limited
  */
public class PrivilegeViolationException extends java.lang.Exception {
