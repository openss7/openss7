...
/*
 @(#) $RCSfile: VersionNotSupportedException.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:14 $ <p>
  ...
  +--java.lang.Throwable
      ...
      +--java.lang.Exception
          ...
          +javax.megaco.MegacoException
              |
              +--javax.megaco.VersionNotSupportedException
     _________________________________________________________________

   public class VersionNotSupportedException
   extends MegacoException

   This Exception is thrown when version set for the stack on its
   creation is such that it cannot be created.
     _________________________________________________________________
   ...
   VersionNotSupportedException(java.lang.String msg)
             Constructs a new VersionNotSupportedException with the
