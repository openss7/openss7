...
/*
 @(#) $RCSfile: DeleteAssocResp.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:15 $ <p>
...
java.lang.Object
  ...
  +--java.util.EventObject
        ...
        +--javax.megaco.association.AssociationEvent
                |
                +--javax.megaco.association.DeleteAssocResp

   All Implemented Interfaces:
          java.io.Serializable
     _________________________________________________________________

   public class DeleteAssocResp
   ...
   delete association request received from the application.
   ...
   Constructor Summary
   DeleteAssocResp (java.lang.Object source, int  assocHandle)

              Constructs a Delete Association Response Event object. This
   ...
   Association Request sent to stack.. The possible values that this can
   take is defined in ReturnStatus.
   ...
   further qualifies the error due to which the delete association event
...
public DeleteAssocResp(java.lang.Object source,
                     int assocHandle)
     Constructs a Delete Association Response Event object.
...
public final int getAssocOperIdentifier()
          ...
          This method returns that the event object as delete association
        ...
        Returns:
                ...
                object as the type of delete association response event.
                This is defined as M_DELETE_ASSOC_RESP in AssocEventType.
     _________________________________________________________________
...
public final int getEventStatus()
          ...
          This method returns whether the delete association event was
          successful or not.
        ...
        Returns:
                ...
                ReturnStatus. If the returnStatus is not set, then this
                method would return value 0.
     _________________________________________________________________
...
public final void setEventStatus(ReturnStatus returnStatus)
        throws javax.megaco.InvalidArgumentException
          ...
          delete association event was successful or not.


        Parameters:
                returnStatus - The return status of the processing of the
                delete association event. The static object corresponding
...
public final int getErrorCode()
        ...
        Returns:
                ...
                specifying why the execution of the delete association
