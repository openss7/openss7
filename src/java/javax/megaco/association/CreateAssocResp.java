...
/*
 @(#) $RCSfile: CreateAssocResp.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:15 $ <p>
...
java.lang.Object
  ...
  +--java.util.EventObject
        ...
        +--javax.megaco.association.AssociationEvent
                 |
                 +--javax.megaco.association.CreateAssocResp

   All Implemented Interfaces:
          java.io.Serializable
     _________________________________________________________________

   public class CreateAssocResp
   extends AssociationEvent

   The class extends JAIN MEGACO Association Events. This class is used
   by the stack when it needs to send back response for the create
   association request received from the application.
   ...
   Constructor Summary
   CreateAssocResp (java.lang.Object source, int assocHandle)

              Constructs a Create Association Response Event object. This
   ...
   ReturnStatus, that identifies whether the create association event
   could be handled successfuly or not.
...
public CreateAssocResp(java.lang.Object source, int assocHandle)

          Constructs a Create Association Response Event object.
...
public final int getAssocOperIdentifier()
        ...
        Returns:
                ...
                This is defined as M_CREATE_ASSOC_RESP in AssocEventType.
     _________________________________________________________________
...
public final int getEventStatus()
        ...
        Returns:
                ...
                delete association event issued earlier could be
...
public final void setEventStatus(ReturnStatus returnStatus)
        throws javax.megaco.InvalidArgumentException
          ...
          create association request was success or not.


        Parameters:
                returnStatus - The return status of the processing of the
                create association event. The static object corresponding
...
public final int getErrorCode()
        ...
        Returns:
                ...
                specifying why the execution of the create association
...
public final void setErrorCode(ErrorCode ecode)
        ...
        Parameters:
                The error code corresponding to why the create
                association event could not be executed successfuly.
