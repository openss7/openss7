...
/*
 @(#) $RCSfile: RootMaxTermsPerCtxtPrpt.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:41 $ <p>
...
java.lang.Object
    ...
    +--javax.megaco.pkg.PkgItem
        ...
        +--javax.megaco.pkg.PkgPrptyItem
               |
               +--javax.megaco.pkg.BaseRootPkg.RootMaxTermsPerCtxtPrpt

   All Implemented Interfaces:
          None
     _________________________________________________________________

   public class RootMaxTermsPerCtxtPrpt
   extends PkgPrptyItem

   The MEGACO MaxTermsPerCtxt property class extends the PkgPrptyItem
   class. This is a final class. This  class defines MaxTermsPerCtxt
   property of MEGACO Root package. The methods shall define that this
   property item belongs to the Root package.
     _________________________________________________________________

   Constructor Summary
   RootMaxTermsPerCtxtPrpt()
   ...
   Field Summary
    public static final int  ROOT_MAX_TERMS_PER_CTXT_PRPT
               Identifies MaxTermsPerCtxt property of the MEGACO Base
   Root Package.
...
public RootMaxTermsPerCtxtPrpt()
          ...
          the MEGACO Package for property MaxTermsPerCtxt and Package as
          Base Root.
...
public int getPropertyId()
          ...
          this class returns the id of the Maximum Termination per
          Context property of ROOT Package.

        Returns:
                It shall return ROOT_MAX_TERMS_PER_CTXT_PRPT..
     _________________________________________________________________
...
public int getItemId()
          ...
          returns the id of the Maximum Terminations per Context property
          of ROOT Package.
...
public static int getItemsPkgId()
          ...
          Since the Maximum Termination per Context property is defined
          in the Base ROOT Package of MEGACO protocol, this method
          returns the value BASE_ROOT_PACKAGE constant. This constant is
...
public java.lang.String toString()
  ...
  ROOT_MAX_TERMS_PER_CTXT_PRPT

public static final int ROOT_MAX_TERMS_PER_CTXT_PRPT

          Identifies MaxTermsPerCtxt property of the MEGACO Base Root
