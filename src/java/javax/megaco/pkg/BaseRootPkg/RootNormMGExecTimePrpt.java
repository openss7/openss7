...
/*
 @(#) $RCSfile: RootNormMGExecTimePrpt.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:41 $ <p>
...
java.lang.Object
    ...
    +--javax.megaco.pkg.PkgItem
        ...
        +--javax.megaco.pkg.PkgPrptyItem
               |
               +--javax.megaco.pkg.BaseRootPkg.RootNormMGExecTimePrpt

   All Implemented Interfaces:
          None
     _________________________________________________________________

   public class RootNormMGExecTimePrpt
   extends PkgPrptyItem

   The MEGACO NormMGExecTime property class extends the PkgPrptyItem
   class. This is a final class. This  class defines NormMGExecTime
   property of MEGACO Root package. The methods shall define that this
   property item belongs to the Root package.
     _________________________________________________________________

   Constructor Summary
   RootNormMGExecTimePrpt()
   ...
   Field Summary
    public static final int  ROOT_NORM_MG_EXEC_TIME_PRPT
               Identifies NormMGExecTime property of the MEGACO Base Root
   Package.
...
public RootNormMGExecTimePrpt()
          ...
          the MEGACO Package for property NormMGExecTime and Package as
          Base Root.
...
public int getPropertyId()
          ...
          this class returns the id of the Normal MG Execution Time
          property of ROOT Package.

        Returns:
                It shall return ROOT_NORM_MG_EXEC_TIME_PRPT.
     _________________________________________________________________
...
public int getItemId()
          ...
          returns the id of the Normal MG Execution Time property of ROOT
          Package.
...
public static int getItemsPkgId()
          ...
          Since the Normal MG Execution Time property is defined in the
