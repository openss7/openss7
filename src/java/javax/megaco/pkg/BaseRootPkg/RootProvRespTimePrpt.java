...
/*
 @(#) $RCSfile: RootProvRespTimePrpt.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:41 $ <p>
...
java.lang.Object
    ...
    +--javax.megaco.pkg.PkgItem
        ...
        +--javax.megaco.pkg.PkgPrptyItem
               |
               +--javax.megaco.pkg.BaseRootPkg.RootProvRespTimePrpt

   All Implemented Interfaces:
          None
     _________________________________________________________________

   public class RootProvRespTimePrpt
   extends PkgPrptyItem

   The MEGACO ProvisionalResponseTimer property class extends the
   PkgPrptyItem class. This is a final class. This  class defines
   ProvisionalResponseTimer property of MEGACO Root package. The methods
   shall define that this property item belongs to the Root package.
   ...
   Field Summary
    public static final int  ROOT_PROV_RESP_TIME_PRPT
               Identifies Provisional response timer property of the
   MEGACO Base Root Package.
...
public RootProvRespTimePrpt()
          ...
          the MEGACO Package for property ProvisionalResponseTimer and
          Package as Base Root.
...
public int getPropertyId()
          ...
          this class returns the id of the Provisional Response Time
          property of ROOT Package.

        Returns:
                It shall return ROOT_PROV_RESP_TIME_PRPT.
     _________________________________________________________________
...
public int getItemId()
          ...
          returns the id of the Provisional Response Time property of
          ROOT Package.
...
public static int getItemsPkgId()
          ...
          Since the Provisional Response Time property is defined in the
...
public java.lang.String toString()
  ...
  ROOT_PROV_RESP_TIME_PRPT

public static final int ROOT_PROV_RESP_TIME_PRPT

          Identifies Provisional response timer property of the MEGACO
          Base Root Package. Its value shall be set equal to 0x0005.
     _________________________________________________________________
     _________________________________________________________________
