...
/*
 @(#) $RCSfile: PkgSignalItem.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:39 $ <p>
...
java.lang.Object
  ...
  +--javax.megaco.pkg.PkgItem
   ...
   Direct Known Subclasses:
          AnalogLineSPkg , ContCtSignal , ContRspSignal ,
          CPToneGenBtSignal , CPToneGenCrSignal , CPToneGenCtSignal ,
          CPToneGenCwtSignal , CPToneGenDtSignal , CPToneGenPtSignal ,
          CPToneGenRtSignal , CPToneGenSitSignal , CPToneGenWtSignal ,
          DTMFGenD0Signal , DTMFGenD1Signal , DTMFGenD2Signal ,
          DTMFGenD3Signal , DTMFGenD4Signal , DTMFGenD5Signal ,
          DTMFGenD6Signal , DTMFGenD7Signal , DTMFGenD8Signal ,
          DTMFGenD9Signal , DTMFGenDASignal , DTMFGenDBSignal ,
          DTMFGenDCSignal , DTMFGenDDSignal , DTMFGenDHashSignal ,
          DTMFGenDStarSignal , ToneGenPlayToneSignal
     _________________________________________________________________

   public abstract class PkgSignalItem
   extends PkgItem

   The MEGACO signal item class is an abstract class defined as the base
   class for all the signal items in the MEGACO Package. This class shall
   be used for setting the signals, list of parameters names and their
   ...
   Constructor Summary
   PkgSignalItem()
              Constructs a MEGACO Signal item from an abstract class.

   Method Summary
    abstract int  getSignalId()
              The method can be used to get the signal identifier.
...
public PkgSignalItem()
          ...
          Constructs a Jain MEGACO Package Signal Item Object. This is an
...
public abstract int getSignalId()
          ...
          The method can be used to get the signal identifier. This
          method gives the signal id of the package. This is an abstract
          method and is defined by the methods of the derived class which
          shall return an hard coded value for the signal id.

        Returns:
                signalId - The integer corresponding to the signal id.
     _________________________________________________________________
...
public final int getItemType()
        ...
        Returns:
                ...
                corresponding to the signal. This shall return
                M_ITEM_SIGNAL.
     _________________________________________________________________
...
public MegacoPkg getItemsPkgId()
        ...
        Returns:
                packageId - The package id to which the signal is
                associated.
     _________________________________________________________________
...
public void setAssociatedPkgId(MegacoPkg packageId)
      throws javax.megaco.InvalidArgumentException
        ...
        Throws:
                InvalidArgumentException If the method is called to
                modify the associated package after the parameter has
                been set.
     _________________________________________________________________
...
public final PkgItemParam[] getMegacoPkgItemParam()
        ...
        Returns:
                ...
                parameter is not set then this returns a NULL value.
     _________________________________________________________________
...
onException
          ...
          method sets the attached parameters for the signal. This method
