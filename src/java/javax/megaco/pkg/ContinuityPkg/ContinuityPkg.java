...
/*
 @(#) src/java/javax/megaco/pkg/ContinuityPkg/ContinuityPkg.java <p>
...
java.lang.Object
        ...
        +--javax.megaco.pkg.MegacoPkg
                |
                +--javax.megaco.pkg.ContinuityPkg.ContinuityPkg
   ...
   corresponding to the Continuity Package. This class also overrides the
   ...
   Constructor Summary
   ContinuityPkg()
              Constructs a MEGACO Continuity Package.
...
public ContinuityPkg()
          ...
          Constructs a derived class of Continuity Package that extends
          the Package
...
public final int  getPkgId()
          ...
          which the object is created. For Continuity Package constant
          value CONTINUITY_PACKAGE shall be returned.

        Returns:
                Constant value CONTINUITY_PACKAGE indicating Continuity
                Package.
     _________________________________________________________________
