...
/*
 @(#) $RCSfile: AnalogLineSParamMaxdur.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:40 $ <p>
...
javax.megaco.pkg
Class AnalogLineSParamMaxdur

java.lang.Object
  |
  +--javax.megaco.pkg.PkgItemParam
         |
         +--javax.megaco.pkg.AnalogLineSPkg.AnalogLineSParamMaxdur

   All Implemented Interfaces:
          None
     _________________________________________________________________

   public class AnalogLineSParamMaxdur
   extends java.lang.Object

   The MEGACO parameter class for the Maximum Duration Parameter is
   ...
   class that specifies the parameter as Maximum Duration.

   Field Summary
    public static final int  ANALOG_LINE_PARAM_MAXDUR
               Identifies Maximum Duration parameter of the MEGACO Analog
...
public AnalogLineSParamMaxdur()
          ...
          package that specifies the parameter as Maximum Duration.
...
public int getParamId()
          ...
          method in this class returns Id of Maximum Duration parameter.


        Returns:
                paramId - Returns param id ANALOG_LINE_PARAM_MAXDUR.
     _________________________________________________________________
...
public int[] getParamsItemIds()
        ...
        Returns:
                The integer value corresponding to Flash Hook. Thus this
                shall return ANALOG_LINE_FLASH_EVENT.
     _________________________________________________________________
