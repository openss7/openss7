...
/*
 @(#) $RCSfile: AnalogLineSParamFreq.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:20 $ <p>
...
javax.megaco.pkg
Class AnalogLineSParamFreq

java.lang.Object
  |
  +--javax.megaco.pkg.PkgItemParam
         |
         +--javax.megaco.pkg.AnalogLineSPkg.AnalogLineSParamFreq

   All Implemented Interfaces:
          None
     _________________________________________________________________

   public class AnalogLineSParamFreq
   extends java.lang.Object

   The MEGACO parameter class for the Frequency Parameter is associated
   with Ring signal of Analog Line Supervision Package. This class
   ...
   class that specifies the parameter as Frequency.

   Field Summary
    public static final int  ANALOG_LINE_PARAM_FREQ
               Identifies Frequency parameter of the MEGACO Analog Line
   Supervision Package.
...
public AnalogLineSParamFreq()
          ...
          package that specifies the parameter as Frequency.
...
public int getParamId()
          ...
          method in this class returns Id of Frequency parameter.


        Returns:
                paramId - Returns param id is ANALOG_LINE_PARAM_FREQ.
     _________________________________________________________________
...
public int[] getParamsItemIds()
        ...
        Returns:
                The integer value corresponding to Ring. Thus this shall
                return ANALOG_LINE_RING_SIGNAL.
     _________________________________________________________________
...
public java.lang.String toString()
  ...
  ANALOG_LINE_PARAM_FREQ

public static final int ANALOG_LINE_PARAM_FREQ

   Identifies Frequency parameter of the MEGACO Analog Line Supervision
