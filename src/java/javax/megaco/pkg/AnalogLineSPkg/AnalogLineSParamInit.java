...
/*
 @(#) $RCSfile: AnalogLineSParamInit.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:20 $ <p>
...
javax.megaco.pkg
Class AnalogLineSParamInit

java.lang.Object
  |
  +--javax.megaco.pkg.PkgItemParam
         |
         +--javax.megaco.pkg.AnalogLineSPkg.AnalogLineSParamInit

   All Implemented Interfaces:
          None
     _________________________________________________________________

   public class AnalogLineSParamInit
   extends java.lang.Object

   The MEGACO parameter class for the Init Parameter is associated with
   On Hook and Off Hook event of Analog Line Supervision Package. This
   ...
   class that specifies the parameter as Initial State.

   Field Summary
    public static final int  ANALOG_LINE_PARAM_INIT
               Identifies Initial State parameter of the MEGACO Analog
...
public AnalogLineSParamInit()
          ...
          package that specifies the parameter as Initial State.
...
public int getParamId()
          ...
          method in this class returns Id of Initial State parameter.


        Returns:
                paramId - Returns param id ANALOG_LINE_PARAM_INIT.
     _________________________________________________________________
...
public int[] getParamsItemIds()
        ...
        Returns:
                The integer values corresponding to On Hook event and Off
                Hook event. Thus this shall return a vector containing
                the elements
                          ANALOG_LINE_ONHOOK_EVENT and
...
public java.lang.String toString()
  ...
  ANALOG_LINE_PARAM_INIT

public static final int ANALOG_LINE_PARAM_INIT

   Identifies Init parameter of the MEGACO Analog Line Supervision
