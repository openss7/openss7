...
/*
 @(#) $RCSfile: AnalogLineSParamMindur.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:40 $ <p>
 ...
 Last Modified $Date: 2009-06-21 11:35:40 $ by $Author: brian $
 */
...
javax.megaco.pkg
Class AnalogLineSParamMindur

java.lang.Object
  |
  +--javax.megaco.pkg.PkgItemParam
         |
         +--javax.megaco.pkg.AnalogLineSPkg.AnalogLineSParamMindur

   All Implemented Interfaces:
          None
     _________________________________________________________________

   public class AnalogLineSParamMindur
   extends java.lang.Object

   The MEGACO parameter class for the Minimum Duration Parameter is
   associated with Flash Hook event of Analog Line Supervision Package.
   This class defines all the static information for this parameter.
     _________________________________________________________________

   Constructor Summary
   AnalogLineSParamMindur()
              Constructs a Analog Line Supervision package parameter
   class that specifies the parameter as Minimum Duration.

   Field Summary
    public static final int  ANALOG_LINE_PARAM_MINDUR
               Identifies Minimum Duration State parameter of the MEGACO
...
public AnalogLineSParamMindur()
          ...
          Constructs a parameter class for Analog Line Supervision
          package that specifies the parameter as Minimum Duration.
...
public int getParamId()
          ...
          method in this class returns Id of Minimum Duration parameter.


        Returns:
                paramId - Returns param id ANALOG_LINE_PARAM_MINDUR.
     _________________________________________________________________
...
public int getParamValueType()
        ...
        Returns:
                It returns M_ITEM_PARAM_VALUE_INTEGER indicating that the
...
public int[] getParamsDescriptorIds()
        ...
        Returns:
                ...
                shall thus return a value M_EVENT_DESC as a part of
                integer vector.
     _________________________________________________________________
...
public int[] getParamsItemIds()
        ...
        Returns:
                The integer value corresponding to Minimum Duration. Thus
                this shall return ANALOG_LINE_FLASH_EVENT.
     _________________________________________________________________
...
public int getParamsPkgId()
        ...
        Returns:
                This shall return ANALOG_LINE_PACKAGE as the integer
...
public java.lang.String toString()
  ...
  ANALOG_LINE_PARAM_MINDUR

public static final int ANALOG_LINE_PARAM_MINDUR

           Identifies Minimum Duration parameter of the MEGACO Analog
          Line Supervision Package. Its value shall be set equal to
          0x0004.
