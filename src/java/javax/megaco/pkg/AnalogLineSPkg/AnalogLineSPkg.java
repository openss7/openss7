...
/*
 @(#) $RCSfile: AnalogLineSPkg.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:40 $ <p>
...
java.lang.Object
   ...
   overrides the getExtendedPkgIds to define that there are no packages
   that this package extends.
     _________________________________________________________________

   Constructor Summary
   AnalogLineSPkg()
              Constructs a MEGACO Analog Line Supervision Package.
...
public AnalogLineSPkg()
          ...
          Constructs a derived class of Analog Line Supervision Package
          that extends the Package
...
public final int  getPkgId()
          ...
          constant value ANALOG_LINE_PACKAGE shall be returned.

        Returns:
                Constant value ANALOG_LINE_PACKAGE indicating Analog Line
                Supervision Package.
     _________________________________________________________________
