...
/*
 @(#) $RCSfile: PkgPrptyItem.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:19 $ <p>
...
java.lang.Object
  ...
  +--javax.megaco.pkg.PkgItem
   ...
   Direct Known Subclasses:
          RootMaxNrOfCtxtPrpt , RootMaxTermsPerCtxtPrpt ,
          RootNormMGCExecTimePrpt , RootNormMGExecTimePrpt ,
          RootProvRespTimePrpt , NetworkJitPrpt , TDMCktEcPrpt ,
          TDMCktGainPrpt
     _________________________________________________________________

   public abstract class PkgPrptyItem
   extends PkgItem

   The MEGACO property item class is an abstract class defined as the
   base class for all the property items in the MEGACO Package. This
   class shall be used for setting the property and their values. This
   ...
   Constructor Summary
   PkgPrptyItem()
              The MEGACO Property item class is an abstract class defined
   as the base class for all the Property items in the MEGACO Package.
   This class shall be used for setting the Property and their values.
   This extends the PkgItem class. This is an abstract class and hence
   cannot be created as a separate object.

   Method Summary
    abstract int  getPropertyId()
              The method can be used to get the property identifier.
    abstract int  getItemValueType()
              This method specifies the type of the parameter value, i.e.
   whether string or integer or boolean or double value. The value types
   are defined in ParamValueType.
   ...
   javax.megaco.ParameterNotSetException
              ...
              This method gets the valid value which is of integer. This
   ...
   sublist of values or range of value. If the relation specifies set or
   range or sublist, it automatically assumes the relation to be
   "MEGACO_EQUAL". The value types are defined in ParamRelation The
   ...
   If the parameter value is of type boolean, only one value can be set.
   final  void  setItemValue(double[] value)
           throws javax.megaco.InvalidArgumentException

              This method sets the list of values where each element is
   of double type. This shall change to INT64 bit value in the next
   release of RFC3015.
...
public PkgPrptyItem()
          ...
          Constructs a Jain MEGACO Pacakge Property Item Object. This is
...
public abstract int getPropertyId()
          ...
          The method can be used to get the property identifier. This
          method gives the property id of the package. This is an
          abstract method and is defined by the methods of the derived
          class which shall return an hard coded value for the property
          id.

        Returns:
                propertyId - The integer corresponding to the property
                id.
     _________________________________________________________________
...
public final int getItemType()
        ...
        Returns:
                ...
                corresponding to the property. This shall return
                M_ITEM_PROPERTY.
     _________________________________________________________________
...
public abstract int getItemValueType()
          ...
          in the MEGACO packages. These could be one of string or integer
          or boolean or double value.
...
o.ParameterNotSetException
          ...
          integer. This is to be called only if the getItemValueType
        ...
        Throws:
                javax.megaco.MethodInvocationException - It shall also
                throw an exception if the value type is not integer.
                javax.megaco.ParameterNotSetException - Thrown if this
                parameter has not been set.
     _________________________________________________________________
...
public  final void setItemValue(int[] value)
          ...
          This method sets the list of values where each element is of
          integer. This is to be called only if the getItemValueType
          returns M_ITEM_PARAM_VALUE_INTEGER. If values is of integer,
          value should be one defined in the corresponding parameter's
