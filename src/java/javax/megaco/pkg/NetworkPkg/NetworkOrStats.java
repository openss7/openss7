...
/*
 @(#) $RCSfile: NetworkOrStats.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:24 $ <p>
...
java.lang.Object
    ...
    +--javax.megaco.pkg.PkgItem
        ...
        +--javax.megaco.pkg.PkgStatsItem
               |
               +--javax.megaco.pkg.NetworkPkg.NetworkOrStats

   All Implemented Interfaces:
          None
     _________________________________________________________________

   public class NetworkOrStats
   extends PkgStatsItem

   The MEGACO Octet received statistics class extends the PkgStatsItem
   class. This is a final class. This  class defines Octet received
   statistics of MEGACO Network package. The methods shall define that
   this statistics item belongs to the Network package.
     _________________________________________________________________
   ...
   Field Summary
    public static final int NETWORK_OR_STATS
               Identifies Octets received statistics of the MEGACO
   Network Package.
...
public NetworkOrStats()
          ...
          the MEGACO Package for statistics Octet received and Package as
          Network.
...
public int getStatisticsId()
          ...
          this class returns the id of the Octets Received statistics of
          Network Package.

        Returns:
                It shall return NETWORK_OR_STATS.
     _________________________________________________________________
...
public int getItemId()
          ...
          returns the id of the Octets Received statistics of Network
          Package.
...
public static int getItemsPkgId()
          ...
          Since the Octet Received statistics is defined in the Network
...
public static final int NETWORK_OR_STATS
          ...
          Identifies Octets received statistics of the MEGACO Network
