...
/*
 @(#) $RCSfile: NetworkPkg.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:25 $ <p>
...
java.lang.Object
        ...
        +--javax.megaco.pkg.MegacoPkg
                |
                +--javax.megaco.pkg.ToneGenPkg.NetworkPkg
   ...
   public class NetworkPkg
   extends MegacoPkg

   The MEGACO Network Package inherits all methods of the Package, but
   overrides the getPkgId and getPkgName to define packageid
   corresponding to the Network Package. This class also overrides the
   ...
   Constructor Summary
   NetworkPkg()
              Constructs a MEGACO Network Package.
...
public NetworkPkg()
          ...
          Constructs a derived class of Network Package that extends the
          Package
...
public final int  getPkgId()
          ...
          which the object is created. For Network Package constant value
          NETWORK_PACKAGE shall be returned.

        Returns:
                Constant value NETWORK_PACKAGE indicating Network
                Package.
     _________________________________________________________________
