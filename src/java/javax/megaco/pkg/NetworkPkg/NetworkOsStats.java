...
/*
 @(#) $RCSfile: NetworkOsStats.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:24 $ <p>
...
java.lang.Object
    ...
    +--javax.megaco.pkg.PkgItem
        ...
        +--javax.megaco.pkg.PkgStatsItem
               |
               +--javax.megaco.pkg.NetworkPkg.NetworkOsStats

   All Implemented Interfaces:
          None
     _________________________________________________________________

   public class NetworkOsStats
   extends PkgStatsItem

   The MEGACO Octet sent statistics class extends the PkgStatsItem class.
   This is a final class. This  class defines Octet sent statistics of
   ...
   Field Summary
    public static final int NETWORK_OS_STATS
               Identifies Octets sent statistics of the MEGACO Network
   Package.
...
public NetworkOsStats()
          ...
          the MEGACO Package for statistics Octet sent and Package as
          Network.
...
public int getStatisticsId()
          ...
          this class returns the id of the Octet Sent statistics of
          Network Package.

        Returns:
                It shall return NETWORK_OS_STATS.
     _________________________________________________________________
...
public int getItemId()
          ...
          returns the id of the Octet Sent statistics of Network Package.
...
public static int getItemsPkgId()
          ...
          Since the Octet Sent statistics is defined in the Network
