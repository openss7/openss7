...
/*
 @(#) $RCSfile: NetworkParamCs.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:46 $ <p>
...
javax.megaco.pkg
Class NetworkParamCs

java.lang.Object
  |
  +--javax.megaco.pkg.PkgItemParam
         |
         +--javax.megaco.pkg.NetworkPkg.NetworkParamCs

   All Implemented Interfaces:
          None
     _________________________________________________________________

   public class NetworkParamCs
   extends java.lang.Object

   The MEGACO parameter class for the Cause Parameter is associated with
   Network Failure event of Network Package. This class defines all the
   ...
   the parameter as Cause.

   Field Summary
    public static final int  NETWORK_PARAM_CS
               Identifies Cause parameter of the MEGACO Network Package.
...
public int getParamId()
          ...
          method in this class returns Id of Cause parameter.


        Returns:
                paramId - Returns param id NETWORK_PARAM_CS.
     _________________________________________________________________
...
public int[] getParamsItemIds()
        ...
        Returns:
                ...
                this shall return NETWORK_NETFAIL_EVENT.
     _________________________________________________________________
...
public static final int NETWORK_PARAM_CS
          ...
          Identifies Cause parameter of the MEGACO Network Package. Its
