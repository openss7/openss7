...
/*
 @(#) $RCSfile: GenParamFailureCause.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:24 $ <p>
...
javax.megaco.pkg
Class GenParamFailureCause

java.lang.Object
  |
  +--javax.megaco.pkg.PkgItemParam
         |
         +--javax.megaco.pkg.GenericPkg.GenParamFailureCause

   All Implemented Interfaces:
          None
     _________________________________________________________________

   public class GenParamFailureCause
   extends java.lang.Object

   The MEGACO parameter class for the Failure Cause Parameter is
   associated with Cause event of Generic Package. This class defines all
   the static information for this parameter.
     _________________________________________________________________

   Constructor Summary
   GenParamFailureCause()
              Constructs a Generic package parameter class that specifies
   the parameter as Signal Identity.

   Field Summary
    public static final int  GEN_PARAM_FAILURE_CAUSE
               Identifies Failure Cause parameter of the MEGACO Generic
   Package.
...
public GenParamFailureCause()
          ...
          Constructs a parameter class for Generic package that specifies
          the parameter as Failure Cause.
...
public int getParamId()
          ...
          method in this class returns Id of Failure Cause parameter.


        Returns:
                paramId - Returns param id  GEN_PARAM_FAILURE_CAUSE.
     _________________________________________________________________
...
public int[] getParamsItemIds()
        ...
        Returns:
                The integer value corresponding to Cause Event. Thus this
                shall return GEN_CAUSE_EVENT.
     _________________________________________________________________
...
public int getParamsPkgId()
        ...
        Returns:
                This shall return GENERIC_PACKAGE as the integer value.
