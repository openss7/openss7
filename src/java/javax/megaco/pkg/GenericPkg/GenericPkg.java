...
/*
 @(#) $RCSfile: GenericPkg.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:46 $ <p>
...
java.lang.Object
        ...
        +--javax.megaco.pkg.MegacoPkg
                |
                +--javax.megaco.pkg.GenericPkg.GenericPkg
   ...
   public class GenericPkg
   extends MegacoPkg

   The MEGACO Generic package inherits all methods of the Package, but
   overrides the getPkgId and getPkgName to define packageid
   corresponding to the Generic Package. This class also overrides the
...
public GenericPkg()
          ...
          Constructs a derived class of Generic Package that extends the
          Package
...
public final int getPkgId()
          ...
          which the object is created. For Generic Package constant value
          GENERIC_PACKAGE shall be returned.

        Returns:
                Constant value GENERIC_PACKAGE indicating Generic
                Package.
     _________________________________________________________________
