...
/*
 @(#) $RCSfile: CPToneGenBtSignal.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:43 $ <p>
...
java.lang.Object
    ...
    +--javax.megaco.pkg.PkgItem
        ...
        +--javax.megaco.pkg.PkgSignalItem
               |
               +--javax.megaco.pkg.CPToneGenPkg.CPToneGenBtSignal

   All Implemented Interfaces:
          None
     _________________________________________________________________

   public class CPToneGenBtSignal
   extends PkgSignalItem

   The MEGACO Busy Tone signal class extends the PkgSignalItem class.
   This is a final class. This  class defines Busy Tone signal of MEGACO
   ...
   Constructor Summary
   CPToneGenBtSignal()
              Constructs a MEGACO Signal Item with signal id as Busy
   Tone.
   ...
   Field Summary
    public static final int CP_TONE_GEN_BT_SIGNAL
               Identifies Busy Tone signal of the MEGACO Call Progress
...
public CPToneGenBtSignal()
          ...
          MEGACO Package for signal Busy Tone and Package as Call
...
public int getSignalId()
          ...
          returns the id of the Busy Tone signal of Call Progress Tone
          Generator Package.

        Returns:
                It shall return CP_TONE_GEN_BT_SIGNAL.
     _________________________________________________________________
...
public MegacoPkg getItemsPkgId()
          ...
          the Busy Tone signal is defined in the Call Progress Tone
...
public java.lang.String toString()
  ...
  CP_TONE_GEN_BT_SIGNAL

public static final int CP_TONE_GEN_BT_SIGNAL

          Identifies Call waiting tone signal of the MEGACO Call Progress
          Tone Generator Package. Its value shall be set equal to 0x0032.
     _________________________________________________________________
     _________________________________________________________________
