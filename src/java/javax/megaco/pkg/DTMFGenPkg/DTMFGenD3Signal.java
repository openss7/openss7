...
/*
 @(#) $RCSfile: DTMFGenD3Signal.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:23 $ <p>
...
java.lang.Object
    ...
    +--javax.megaco.pkg.PkgItem
        ...
        +--javax.megaco.pkg.PkgSignalItem
               |
               +--javax.megaco.pkg.DTMFGenPkg.DTMFGenD3Signal

   All Implemented Interfaces:
          None
     _________________________________________________________________

   public class DTMFGenD3Signal
   extends PkgSignalItem

   The MEGACO DTMF character 3 signal class extends the PkgSignalItem
   class. This is a final class. This  class defines DTMF character 3
   ...
   Field Summary
    public static final int DTMF_GEN_D3_SIGNAL
               Identifies signal id DTMF character 3 of the MEGACO DTMF
   Generator Package.
...
public DTMFGenD3Signal()
          ...
          MEGACO Package for Signal DTMF character 3 and Package as DTMF
          Generator.
...
public int getSignalId()
          ...
          returns the id of the DTMF character 3 signal of DTMF Generator
          Package.

        Returns:
                It shall return DTMF_GEN_D3_SIGNAL.
     _________________________________________________________________
...
public static int getItemsPkgId()
          ...
          Since the DTMF character 3 signal is defined in the DTMF
...
public static final int DTMF_GEN_D3_SIGNAL
          ...
          Identifies signal id DTMF character 3 of the MEGACO DTMF
          Generator Package. Its value shall be set equal to 0x0013.
     _________________________________________________________________
     _________________________________________________________________
