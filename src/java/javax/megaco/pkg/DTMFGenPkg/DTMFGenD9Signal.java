...
/*
 @(#) $RCSfile: DTMFGenD9Signal.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:45 $ <p>
...
java.lang.Object
    ...
    +--javax.megaco.pkg.PkgItem
        ...
        +--javax.megaco.pkg.PkgSignalItem
               |
               +--javax.megaco.pkg.DTMFGenPkg.DTMFGenD9Signal

   All Implemented Interfaces:
          None
     _________________________________________________________________

   public class DTMFGenD9Signal
   extends PkgSignalItem

   The MEGACO DTMF character 9 signal class extends the PkgSignalItem
   class. This is a final class. This  class defines DTMF character 9
   ...
   Field Summary
    public static final int DTMF_GEN_D9_SIGNAL
               Identifies signal id DTMF character 9 of the MEGACO DTMF
   Generator Package.
...
public DTMFGenD9Signal()
          ...
          MEGACO Package for Signal DTMF character 9 and Package as DTMF
          Generator.
...
public int getSignalId()
          ...
          returns the id of the DTMF character 9 signal of DTMF Generator
          Package.

        Returns:
                It shall return DTMF_GEN_D9_SIGNAL.
     _________________________________________________________________
...
public MegacoPkg getItemsPkgId()
          ...
          Since the DTMF character 9 signal is defined in the DTMF
...
public static final int DTMF_GEN_D9_SIGNAL
          ...
          Identifies signal id DTMF character 9 of the MEGACO DTMF
          Generator Package. Its value shall be set equal to 0x0019.
     _________________________________________________________________
     _________________________________________________________________
