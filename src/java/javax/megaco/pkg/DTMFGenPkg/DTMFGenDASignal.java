...
/*
 @(#) $RCSfile: DTMFGenDASignal.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:23 $ <p>
...
java.lang.Object
    ...
    +--javax.megaco.pkg.PkgItem
        ...
        +--javax.megaco.pkg.PkgSignalItem
               |
               +--javax.megaco.pkg.DTMFGenPkg.DTMFGenDASignal

   All Implemented Interfaces:
          None
     _________________________________________________________________

   public class DTMFGenDASignal
   extends PkgSignalItem

   The MEGACO DTMF character A signal class extends the PkgSignalItem
   class. This is a final class. This  class defines DTMF character A
   ...
   Field Summary
    public static final int DTMF_GEN_DA_SIGNAL
               Identifies signal id DTMF character A of the MEGACO DTMF
   Generator Package.
...
public DTMFGenDASignal()
          ...
          MEGACO Package for Signal DTMF character A and Package as DTMF
          Generator.
...
public int getSignalId()
          ...
          returns the id of the DTMF character A signal of DTMF Generator
          Package.

        Returns:
                It shall return DTMF_GEN_DA_SIGNAL.
     _________________________________________________________________
...
public MegacoPkg getItemsPkgId()
          ...
          Since the DTMF character A signal is defined in the DTMF
...
public static final int DTMF_GEN_DA_SIGNAL
          ...
          Identifies signal id DTMF character A of the MEGACO DTMF
          Generator Package. Its value shall be set equal to 0x001a.
     _________________________________________________________________
     _________________________________________________________________
