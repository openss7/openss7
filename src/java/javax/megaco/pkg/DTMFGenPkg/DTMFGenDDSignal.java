...
/*
 @(#) $RCSfile: DTMFGenDDSignal.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:23 $ <p>
...
java.lang.Object
    ...
    +--javax.megaco.pkg.PkgItem
        ...
        +--javax.megaco.pkg.PkgSignalItem
               |
               +--javax.megaco.pkg.DTMFGenPkg.DTMFGenDDSignal

   All Implemented Interfaces:
          None
     _________________________________________________________________

   public class DTMFGenDDSignal
   extends PkgSignalItem

   The MEGACO DTMF character D signal class extends the PkgSignalItem
   class. This is a final class. This  class defines DTMF character D
   ...
   Field Summary
    public static final int DTMF_GEN_DD_SIGNAL
               Identifies signal id DTMF character D of the MEGACO DTMF
   Generator Package.
...
public DTMFGenDDSignal()
          ...
          MEGACO Package for Signal DTMF character D and Package as DTMF
          Generator.
...
public int getSignalId()
          ...
          returns the id of the DTMF character D signal of DTMF Generator
          Package.

        Returns:
                It shall return DTMF_GEN_DD_SIGNAL.
     _________________________________________________________________
...
public MegacoPkg getItemsPkgId()
          ...
          Since the DTMF character D signal is defined in the DTMF
...
public static final int DTMF_GEN_DD_SIGNAL
          ...
          Identifies signal id DTMF character D of the MEGACO DTMF
          Generator Package. Its value shall be set equal to 0x001d.
     _________________________________________________________________
     _________________________________________________________________
