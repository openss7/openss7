...
/*
 @(#) $RCSfile: DTMFGenDBSignal.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:23 $ <p>
...
java.lang.Object
    ...
    +--javax.megaco.pkg.PkgItem
        ...
        +--javax.megaco.pkg.PkgSignalItem
               |
               +--javax.megaco.pkg.DTMFGenPkg.DTMFGenDBSignal

   All Implemented Interfaces:
          None
     _________________________________________________________________

   public class DTMFGenDBSignal
   extends PkgSignalItem

   The MEGACO DTMF character B signal class extends the PkgSignalItem
   class. This is a final class. This  class defines DTMF character B
   ...
   Field Summary
    public static final int DTMF_GEN_DB_SIGNAL
               Identifies signal id DTMF character B of the MEGACO DTMF
   Generator Package.
...
public DTMFGenDBSignal()
          ...
          MEGACO Package for Signal DTMF character B and Package as DTMF
          Generator.
...
public int getSignalId()
          ...
          returns the id of the DTMF character B signal of DTMF Generator
          Package.

        Returns:
                It shall return DTMF_GEN_DB_SIGNAL.
     _________________________________________________________________
...
public static int getItemsPkgId()
          ...
          Since the DTMF character B signal is defined in the DTMF
...
public static final int DTMF_GEN_DB_SIGNAL
          ...
          Identifies signal id DTMF character B of the MEGACO DTMF
          Generator Package. Its value shall be set equal to 0x001b.
     _________________________________________________________________
     _________________________________________________________________
