...
/*
 @(#) $RCSfile: DTMFDetParamMeth.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:22 $ <p>
...
javax.megaco.pkg
Class DTMFDetParamMeth

java.lang.Object
  |
  +--javax.megaco.pkg.PkgItemParam
         |
         +--javax.megaco.pkg.DTMFDetPkg.DTMFDetParamMeth

   All Implemented Interfaces:
          None
     _________________________________________________________________

   public class DTMFDetParamMeth
   extends java.lang.Object

   The MEGACO parameter class for the Termination Method Parameter is
   associated with Signal Completion event of DTMF Detect Package. This
   class defines all the static information for this parameter.
     _________________________________________________________________

   Constructor Summary
   DTMFDetParamMeth()
              Constructs a DTMF Detection package parameter class that
   specifies the parameter as Termination Method.

   Field Summary
    public static final int  DTMF_DET_PARAM_METH
               Identifies Termination method parameter of the MEGACO DTMF
   Detection Package.
...
public int getParamId()
          ...
          method in this class returns Id of Termination Method
          parameter.


        Returns:
                paramId - Returns param id DTMF_DET_PARAM_METH.
     _________________________________________________________________
