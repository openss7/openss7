...
/*
 @(#) $RCSfile: RTPParamRtppltype.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:25 $ <p>
...
javax.megaco.pkg
Class RTPParamRtppltype

java.lang.Object
  |
  +--javax.megaco.pkg.PkgItemParam
         |
         +--javax.megaco.pkg.RTPPkg.RTPParamRtppltype

   All Implemented Interfaces:
          None
     _________________________________________________________________

   public class RTPParamRtppltype
   extends java.lang.Object

   The MEGACO parameter class for the Payload Type Parameter is
   associated with Payload Transition event of RTP Package. This class
   defines all the static information for this parameter.
     _________________________________________________________________

   Constructor Summary
   RTPParamRtppltype()
              Constructs a RTP package parameter class that specifies the
   parameter as Payload Type.

   Field Summary
    public static final int  RTP_PARAM_PL_TYPE
               Identifies Payload Type parameter of the MEGACO RTP
   Package.
...
public RTPParamRtppltype()
          ...
          Constructs a parameter class for RTP package that specifies the
          parameter as Payload Type.
...
public int getParamId()
          ...
          method in this class returns Id of Payload Type parameter.


        Returns:
                paramId - Returns param id as RTP_PARAM_PL_TYPE.
     _________________________________________________________________
...
public int[] getParamsDescriptorIds()
        ...
        Returns:
                This parameter can be present in Observed Event
...
public int[] getParamsItemIds()
        ...
        Returns:
                The integer value corresponding to Payload Transition
                event. Thus this shall return RTP_PLTRANS_EVENT.
     _________________________________________________________________
...
public int getParamsPkgId()
        ...
        Returns:
                This shall return RTP_PACKAGE as the integer value. The
...
public static final int RTP_PARAM_PL_TYPE
          ...
          Identifies Payload Type parameter of the MEGACO RTP Package.
          Its value shall be set equal to 0x01.
     _________________________________________________________________
     _________________________________________________________________
