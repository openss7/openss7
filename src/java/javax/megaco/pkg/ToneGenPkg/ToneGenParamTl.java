...
/*
 @(#) $RCSfile: ToneGenParamTl.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:48 $ <p>
...
javax.megaco.pkg
Class ToneGenParamTl

java.lang.Object
  |
  +--javax.megaco.pkg.PkgItemParam
         |
         +--javax.megaco.pkg.ToneGenPkg.ToneGenParamTl

   All Implemented Interfaces:
          None
     _________________________________________________________________

   public class ToneGenParamTl
   extends java.lang.Object

   The MEGACO parameter class for the Tonelist Parameter is associated
   with Play Tone signal of Tone Generator Package. This class defines
   ...
   Field Summary
    public static final int  TONE_GEN_PARAM_TL
               Identifies Tone List parameter of the MEGACO Tone
   Generator Package.
...
public ToneGenParamTl()
          ...
          Constructs a parameter class for Tone Generator package that
          specifies the parameter as tone list.
...
public int getParamId()
          ...
          method in this class returns Id of Tone List parameter.


        Returns:
                paramId - Returns param id as TONE_GEN_PARAM_TL.
     _________________________________________________________________
...
public int[] getParamsDescriptorIds()
        ...
        Returns:
                This parameter can be present in Signal descriptor. It
                shall thus return a value M_SIGNAL_DESC as a part of
                integer vector.
     _________________________________________________________________
...
public int[] getParamsItemIds()
        ...
        Returns:
                The integer value corresponding to Play Tone. Thus this
                shall return TONE_GEN_PLAY_TONE_SIGNAL.
     _________________________________________________________________
...
public int getParamsPkgId()
        ...
        Returns:
                This shall return TONE_GEN_PACKAGE as the integer value.
...
public static final int TONE_GEN_PARAM_TL
          ...
          Identifies Tone List parameter of the MEGACO Tone Generator
