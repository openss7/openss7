...
/*
 @(#) $RCSfile: ToneGenParamInd.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:26 $ <p>
...
javax.megaco.pkg
Class ToneGenParamInd

java.lang.Object
  |
  +--javax.megaco.pkg.PkgItemParam
         |
         +--javax.megaco.pkg.ToneGenPkg.ToneGenParamInd

   All Implemented Interfaces:
          None
     _________________________________________________________________

   public class ToneGenParamInd
   ...
   Field Summary
    public static final int  TONE_GEN_PARAM_IND
               Identifies Inter Signal Duration parameter of the MEGACO
...
public int getParamId()
          ...
          method in this class returns Id of Inter Signal Duration
          parameter.


        Returns:
                paramId - Returns param id as TONE_GEN_PARAM_IND.
     _________________________________________________________________
...
public static final int TONE_GEN_PARAM_IND
          ...
          Identifies Inter Signal Duration parameter of the MEGACO Tone
          Generator Package. Its value shall be set equal to 0x0002.
     _________________________________________________________________
     _________________________________________________________________
