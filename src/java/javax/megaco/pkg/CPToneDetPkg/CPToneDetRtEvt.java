...
/*
 @(#) $RCSfile: CPToneDetRtEvt.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:42 $ <p>
...
java.lang.Object
    ...
    +--javax.megaco.pkg.PkgItem
        ...
        +--javax.megaco.pkg.PkgEventItem
               |
               +--javax.megaco.pkg.CPToneDetPkg.CPToneDetRtEvt

   All Implemented Interfaces:
          None
     _________________________________________________________________

   public class CPToneDetRtEvt
   extends PkgEventItem

   The MEGACO Ringing Tone event class extends the PkgEventItem class.
   This is a final class. This  class defines Ringing Tone event of
   ...
   Constructor Summary
   CPToneDetRtEvt()
              Constructs a MEGACO event item with event id as Ringing
   Tone.
   ...
   Field Summary
    public static final int CP_TONE_DET_RT_EVENT
               Identifies Ringing tone event of the MEGACO Call Progress
   Tone Detect Package.
...
public CPToneDetRtEvt()
          ...
          MEGACO Package for event Ringing Tone and Package as Call
...
public int getEventId()
          ...
          returns the id of the Ringing Tone event of Call Progress Tone
          Detect Package.

        Returns:
                It shall return CP_TONE_DET_RT_EVENT.
     _________________________________________________________________
...
public MegacoPkg getItemsPkgId()
          ...
          Since the Ringing Tone event is defined in the Call Progress
...
public java.lang.String toString()
  ...
  CP_TONE_DET_RT_EVENT

public static final int CP_TONE_DET_RT_EVENT

          Identifies Ringing tone event of the MEGACO Call Progress Tone
          Detect Package. Its value shall be set equal to 0x0031.
     _________________________________________________________________
     _________________________________________________________________
