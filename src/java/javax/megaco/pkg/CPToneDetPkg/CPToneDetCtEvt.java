...
/*
 @(#) $RCSfile: CPToneDetCtEvt.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:41 $ <p>
...
java.lang.Object
    ...
    +--javax.megaco.pkg.PkgItem
        ...
        +--javax.megaco.pkg.PkgEventItem
               |
               +--javax.megaco.pkg.CPToneDetPkg.CPToneDetCtEvt

   All Implemented Interfaces:
          None
     _________________________________________________________________

   public class CPToneDetCtEvt
   extends PkgEventItem

   The MEGACO Congestion Tone event class extends the PkgEventItem class.
   This is a final class. This  class defines Congestion Tone event of
   ...
   Constructor Summary
   CPToneDetCtEvt()
              Constructs a MEGACO event item with event id as Congestion
   Tone.
   ...
   Field Summary
    public static final int CP_TONE_DET_CT_EVENT
               Identifies Congestion Tone event of the MEGACO Call
...
public CPToneDetCtEvt()
          ...
          MEGACO Package for event Congestion Tone and Package as Call
...
public int getEventId()
          ...
          returns the id of the Congestion Tone event of Call Progress
          Tone Detect Package.

        Returns:
                It shall return CP_TONE_DET_CT_EVENT.
     _________________________________________________________________
...
public MegacoPkg getItemsPkgId()
          ...
          Since the Congestion Tone event is defined in the Call Progress
...
public java.lang.String toString()
  ...
  CP_TONE_DET_CT_EVENT

public static final int CP_TONE_DET_CT_EVENT

          Identifies Congestion Tone event of the MEGACO Call Progress
          Tone Detect Package. Its value shall be set equal to 0x0033.
     _________________________________________________________________
     _________________________________________________________________
