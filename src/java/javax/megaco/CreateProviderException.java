...
/*
 @(#) $RCSfile: CreateProviderException.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:13 $ <p>
  ...
  +--java.lang.Throwable
      ...
      +--java.lang.Exception
          ...
          +javax.megaco.MegacoException
              |
              +--javax.megaco.CreateProviderException
...
public CreateProviderException()
          ...
          Creates createProviderException which does not take any input
          string.
     _________________________________________________________________
