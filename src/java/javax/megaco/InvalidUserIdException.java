...
/*
 @(#) $RCSfile: InvalidUserIdException.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:14 $ <p>
...
java.lang.Object
  ...
  +--java.lang.Throwable
   ...
   This Exception is thrown when a User Id is sent which cannot be sent
   thus in that situation.
     _________________________________________________________________

   Constructor Summary
   InvalidUserIdException()
             Constructs a new InvalidUserIdException
   InvalidUserIdException(java.lang.String msg)
             Constructs a new InvalidUserIdException with the specified
   detail message.
...
public InvalidUserIdException(java.lang.String msg)
