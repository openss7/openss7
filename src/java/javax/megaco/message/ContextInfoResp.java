...
/*
 @(#) $RCSfile: ContextInfoResp.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:16 $ <p>
...
java.lang.Object
  ...
  +--java.util.EventObject
        ...
        +--javax.megaco.CommandEvent
                    |
                    +--javax.megaco.message.ContextInfoResp

   All Implemented Interfaces:
          java.io.Serializable
     _________________________________________________________________

   public class ContextInfoResp
   extends CommandEvent

   The class extends JAIN MEGACO Command Events. This class is used to
   represent megaco context information response event. It is used when
   the application needs to respond to a command or an action request
   received with context properties only. Through this the application
   would be able to respond with context properties only. This event
   would be received by the application when the application is only
   expecting a context property in the response with no accompanying
   commands.
     _________________________________________________________________
   ...
   Constructor Summary
   ContextInfoResp(java.lang.Object source, int assocHandle,
                         int txnHandle,
                         int actionHandle,
                         boolean isLastActionInTxn)

       throws javax.megaco.InvalidArgumentException

              Constructs an Action Response Event object.

   Method Summary

   Methods inherited from class javax.megaco.CommandEvent
   getAssocHandle, getTxnHandle, getActionHandle, getCommandIdentifier,
   isLastActionInTxn, setLastActionInTxn, setContextId, getContextid
  ...
  ContextInfoResp
   ...
   public ContextInfoResp(java.lang.Object source, int assocHandle,int
   txnHandle,
                        int actionHandle,
                        boolean isLastActionInTxn)
   ...
   isLastActionInTxn - This parameter specifies whether the action is
   last action in the transaction.
...
public final int getCommandIdentifier()
                      ...
                      This method cannot be overridden by the derived
                      class. This method returns that the command
                      identifier is of type action response Event. This
                      method overrides the corresponding method of the
                      base class CommandEvent.

        Returns:
                Returns an integer value that identifies this event
                object as a action response event i.e. M_ACTION_RESP.
     _________________________________________________________________
     _________________________________________________________________
