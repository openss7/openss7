...
/*
 @(#) $RCSfile: EventBufParam.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:37 $ <p>
...
java.lang.Object
  |
  +--javax.megaco.message.descriptor.EventBufParam
   ...
   public class EventBufParam
   extends java.lang.Object

   The EventBufParam object is a class that shall be used to set the
   stream id, event id, package id and parameter name and value for an
   event id. The class optionally provides interface to specify the
   package name, item name and the associated parameters in the string
   format. This is an independent class derived from java.util.Object and
   shall not have any derived classes.
     _________________________________________________________________

   Constructor Summary
   EventBufParam( PkgEventItem eventItem)
           throws javax.megaco.InvalidArgumentException

              Constructs an object of type event buffer parameter which
   shall be used within the event buffer descriptor.
   EventBufParam( PkgItemStr eventItemStr)
           throws javax.megaco.InvalidArgumentException

              Constructs an object of type event buffer parameter which
   shall be used within the event buffer descriptor. The eventItemStr
   passed in this constructor specifies the package parameters in the
   string format. implementations may use this method for the classes
   which are not defined in the javax.megaco.pkg package.

   Method Summary
    PkgEventItem getMegacoPkgEvtItem()
              The method is used to get the pkgdName and eventOther in
   the event buffer descriptor.
   ...
   part of the event buffer descriptor. This automatically sets the
   Stream Id present flag.
     boolean  isStreamIdPresent()
              The method can be used to check whether stream id is
   present as a part of the event buffer descriptor.
...
public EventBufParam(PkgEventItem eventItem)
                     throws javax.megaco.InvalidArgumentException

          Constructs Event buffer parameter object with the PkgEventItem
          object. This is to be set within an event buffer descriptor.
...
public EventBufParam(PkgItemStr eventItemStr)
                     throws javax.megaco.InvalidArgumentException

          Constructs Event buffer parameter object with the PkgItemStr
...
public PkgEventItem getMegacoPkgEvtItem()
          ...
          buffer descriptor. This method gives the package information,
...
public PkgItemStr getMegacoPkgItemStr()
          ...
          The method can be used to get the pkdgName as set in the event
          buffer descriptor. This method gives the package information,
          the attached event information and the parameter name and
          value. As comapres to the  getMegacoPkgEvtItem() method, this
...
public int getStreamId()
          ...
          The method can be used to get stream id in the event buffer
          descriptor.

        Returns:
                streamId - The integer value of the stream id shall be
                returned. This shall be returned only if the streamId is
                present in the event parameter of the event buffer
                descriptor.
...
public void setStreamId(int streamId)
          ...
          The method can be used to set stream id in the event buffer
