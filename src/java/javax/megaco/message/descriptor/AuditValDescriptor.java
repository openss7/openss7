...
/*
 @(#) $RCSfile: AuditValDescriptor.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:37 $ <p>
...
Class AuditValDescriptor

java.lang.Object
    |
    +--javax.megaco.message.Descriptor
            |
            +--javax.megaco.message.descriptor.AuditValDescriptor

   All Implemented Interfaces:
          java.io.Serializable
     _________________________________________________________________

   public class AuditValDescriptor
   extends Descriptor

   The class extends JAIN MEGACO Descriptor. This class describes the
   audit value request descriptor. It specifies the tokens for which
   ...
   Constructor Summary
   AuditValDescriptor()
              Constructs an Audit Value Descriptor object. This extends
   the Descriptor class. It defines the Audit item of the Megaco for
   Audit Capability.
...
public AuditValDescriptor()
          ...
          Constructs a Audit Value request Descriptor. It specifies the
...
public final int getDescriptorId()
          ...
          value request descriptor. This method overrides the
          corresponding method of the base class Descriptor.


        Returns:
                Returns an integer value that identifies this object of
                the type of audit value request descriptor. It returns
                the value M_AUDIT_VAL_DESC of a audit value descriptor.
     _________________________________________________________________
