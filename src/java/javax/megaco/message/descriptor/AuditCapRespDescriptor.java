...
/*
 @(#) $RCSfile: AuditCapRespDescriptor.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-02-07 07:27:17 $ <p>
...
Class AuditCapRespDescriptor

java.lang.Object
    |
    +--javax.megaco.message.Descriptor
            |
            +--javax.megaco.message.descriptor.AuditCapRespDescriptor

   All Implemented Interfaces:
          java.io.Serializable
     _________________________________________________________________

   public class AuditCapRespDescriptor
   extends Descriptor

   The class extends JAIN MEGACO Descriptor. This class describes the
   audit capability response descriptor. It specifies the tokens and
   descriptors for audit capability response.
   ...
   Constructor Summary
   AuditCapRespDescriptor()
              Constructs an Audit Capability Response Descriptor object.
   This extends the Descriptor class. It defines the Audit Return
   Parameter of the Megaco Protocol for Audit Capability Response.

   Method Summary
    Descriptor[] getDescriptor()
              Gets the Descriptors information for all the descriptor for
   which it has been audited. Only valid descriptors are
    ...
    4. Events Descriptor
    5. Signal Descriptor
    6. Observed Events Descriptor
    7. Event Buffer Descriptor
    8. Statistics Descriptor
    9. Error Descriptor

    void setDescriptor (Descriptor[] descriptorInfo)
             Sets the vector of Descriptors Information for which it has
...
public AuditCapRespDescriptor()
          ...
          Constructs a Audit Capability response Descriptor. It specifies
...
public final int getDescriptorId()
          ...
          capability response descriptor. This method overrides the
          corresponding method of the base class Descriptor.


        Returns:
                Returns an integer value that identifies this object of
                the type of audit capability response descriptor. It
                returns that it is audit capability response Descriptor
                i.e., M_AUDIT_CAP_REPLY_DESC.
     _________________________________________________________________
...
public Descriptor[] getDescriptor()
  ...
  setDescriptor
   ...
   Throws:
       InvalidArgumentException if the descriptor passed to this method
       is invalid.
     _________________________________________________________________
