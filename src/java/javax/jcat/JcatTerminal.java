/*
 @(#) $RCSfile: JcatTerminal.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:28:36 $ <p>
...
public interface JcatTerminal {
    ...
    /**
      ...
      * JcatTerminal.
      */
    public java.util.Set<JcatAddress> getAddresses();
    /**
    ...
    /**
      ...
      * this JcatTerminal.
      */
    public java.util.Set<JcatTerminal> getTerminalConnections();
    /**
      */
