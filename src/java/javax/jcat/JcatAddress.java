/*
 @(#) $RCSfile: JcatAddress.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:09 $ <p>
...
public interface JcatAddress extends JccAddress {
    ...
    /**
      ...
      * object.
      */
    public java.util.Set<JcatTerminal> getTerminals();
    /**
    ...
    /**
      ...
      */
    public java.util.Set<JcatConnection> getConnections();
    /**
