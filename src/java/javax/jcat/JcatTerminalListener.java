/*
 @(#) $RCSfile: JcatTerminalListener.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:10 $ <p>
...
/**
  * A JcatTerminalListener interface is used to report the association/disassociation of a
  * JcatAddress with a JcatTerminal.
  *
  * @since 1.0
  * @see JcatTerminal
...
public interface JcatTerminalListener {
    /**
      ...
      *
      * @param termconnectionevent  event resulting from association of an address.
      * @since 1.0
      */
