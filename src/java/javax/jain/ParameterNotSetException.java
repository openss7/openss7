...
package javax.jain;
  ...
  /**
  * This Exception is thrown when an attempt is made to access a parameter of
  * a JAIN Object when the value of the primitive has not been set.
  *
...
public class ParameterNotSetException extends JainException {
    ...
    */
    public ParameterNotSetException(String error) {
        super(error);
    }

    /**
    * Constructs a new <code>ParameterNotSetException</code> with the specified
    ...
    */
    public ParameterNotSetException(String error, Exception excp) {
        super(error, excp);
    }
}
