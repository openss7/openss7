...
/**
 * This exception is thrown if the add JAIN Listener method of any JAIN Provider
 * is invoked and the specified JAIN Listener to be registered is currently
...
public class ListenerAlreadyRegisteredException extends JainException {
    ...
    */
    public ListenerAlreadyRegisteredException(String error) {
        super(error);
    }

    /**
    * Constructs a new <code>ListenerAlreadyRegisteredException</code> with the specified
    ...
    */
    public ListenerAlreadyRegisteredException(String error, Exception excp) {
        super(error, excp);
    }
}
