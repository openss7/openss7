...
public class JainException extends java.lang.Exception {
    /**
      ...
      * triggered this custome exception.
      */
    ...
    /**
      ...
      */
    public JainException(java.lang.String error) {
        super(error);
    }
    /**
      * Constructs a new JainException with the specified error message and
      * specialized exception that triggered this error condition.
      * @param error The detail of the message.
      * @param excp The specialized exception that triggered this exception.
      */
    public JainException(java.lang.String error, java.lang.Exception excp) {
        super(error);
