/*
 @(#) $RCSfile: SS7ParameterNotSetException.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:38 $ <p>
...
public class SS7ParameterNotSetException extends SS7Exception {
    ...
    /**
      * Constructs a new SS7ParameterNotSetException.
      */
    public SS7ParameterNotSetException() {
        super();
    }
}
