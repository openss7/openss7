/*
 @(#) $RCSfile: MsPosReportRespEvent.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:40 $ <p>
...
/**
  * This primitive (event) is used by the MAP API User to respond to the
  * reception of a positon information "push".
  *
  ...
  * <li>result, conditional parameter, present in case of failure.</ul>
  *
  * @author Monavacon Limited
  * @version 1.2.2
  */
public final class MsPosReportRespEvent extends PositionEvent {
    /**
      * The constructor.
      *
      * @param source
      ...
      */
    public MsPosReportRespEvent(java.lang.Object source)
        throws SS7InvalidParamException {
        super(source,MS_POS_REPORT_RESP_ID);
    }
    /** Empty constructor; needed for serializable objects and beans.  */
    public MsPosReportRespEvent()
        throws SS7InvalidParamException {
        super(null,MS_POS_REPORT_RESP_ID);
    }
    /**
