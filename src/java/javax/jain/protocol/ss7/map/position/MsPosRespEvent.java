/*
 @(#) $RCSfile: MsPosRespEvent.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:41 $ <p>
...
/**
  * This primitive (event) is used by the MAP API User to deliver
  * position information to a "position client". <p>
  *
  ...
  *
  * <li>position, conditional parameter, present if position information
  * is available.
  *
  * <li>result, conditional parameter, present if position request
  * failed. </ul>
  *
  * @author Monavacon Limited
  * @version 1.2.2
  */
public final class MsPosRespEvent extends PositionEvent {
    /**
      * The constructor.
      * @param source
      ...
      */
    public MsPosRespEvent(java.lang.Object source)
        throws SS7InvalidParamException {
        super(source,MS_POS_RESP_ID);
    }
    /**
      * Empty constructor; needed for serializable objects and beans.
      */
    public MsPosRespEvent()
        throws SS7InvalidParamException {
        super(null,MS_POS_RESP_ID);
    }
    /**
      * Set the Position.
      * @param position
    ...
    protected boolean m_positionIsSet = false;
