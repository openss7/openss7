/*
 @(#) $RCSfile: PositionTargetId.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:41 $ <p>
 ...
 Last Modified $Date: 2009-06-21 11:34:41 $ by $Author: brian $
 */
...
/**
  * This parameter contains different identifiers of a Mobile Station
  * for which position information is requested. <p>
  *
  ...
  * <li>msIsdn, conditional parameter
  * <li>imsi, conditional parameter </ul>
  *
  * Conditions for inclusion of parameter components: When the protocol
  * is the Location Service (LCS) of ETSI MAP either msIsdn or imsi must
  * be present, and both may be present.
  *
...
public class PositionTargetId extends MapParameter {
    ...
    /**
      * Set the MSISDN ("telephone number") identifying the Mobile
    ...
    /**
      * Get the MSISDN ("telephone number") identifying the Mobile
      * Station to be positioned.
    ...
    /**
      * Check if the MSISDN parameter is present.
      * @return
      * True or false.
      */
    ...
    /**
      * Set the International Mobile Subscriber Identity (IMSI)
      * identifying the subscriber to be positioned.
      * @param imsi
      * An IMSI.
      * @exception SS7InvalidParamException
      * Thrown if parameter(s) are invalid / out of range.
    ...
    /**
      * Check if the IMSI parameter is present.
      * @return
      * True or false.
      */
