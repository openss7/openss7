/*
 @(#) src/java/javax/jain/protocol/ss7/map/transaction/etsipar/message/DeliverReportMessage.java <p>
...
/**
  * This class represents an ETSI SMS Deliver Report Message.
  * It contains information to be used by the API implementation to
  * build the SMS-DELVIER-REPORT PDU defined in the standard GSM 03.40.
  * <p>
  *
  ...
  *     <li>Presence: conditional (present if error, otherwise not).
  *     </ul>
  *
  ...
  * @version 1.2.2
  */
public class DeliverReportMessage extends EtsiMessage {
    /**
      * The constructor.
      *
      ...
      */
    public DeliverReportMessage()
        throws SS7InvalidParamException {
        super(MESSAGE_DELIVER_REPORT);
    }
    /**
    ...
    /**
      ...
      * any) that is used for the message. Possible values:
    ...
    public void setDcs(int dcs)
        ...
        switch (dcs) {
            case DCS_7_BIT_DEFAULT_ALPHABET:
                ...
                break;
            default:
                throw new SS7InvalidParamException("Data Coding Scheme " + dcs + " out of range.");
        }
    }
    /**
