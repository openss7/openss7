/*
 @(#) $RCSfile: MoMessageRespEvent.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:43 $ <p>
...
/**
  * This primitive (event) is used by the MAP API User to return the
  * result to the Mobile Station when receiving a submitted message. <p>
  *
  ...
  * @version 1.2.2
  */
public final class MoMessageRespEvent extends TransactionEvent {
    /**
      * The constructor.
      * @param source
      ...
      */
    public MoMessageRespEvent(java.lang.Object source)
        throws SS7InvalidParamException {
        super(source, MO_MESSAGE_RESP_ID);
    }
    /** Empty constructor; needed for serializable objects and beans.  */
    public MoMessageRespEvent()
        throws SS7InvalidParamException {
        super(null, MO_MESSAGE_RESP_ID);
    }
    /**
      * Set the response message to be sent to the MS.
      * @param message
      * The result message.
      * @exception SS7InvalidParamException
      * Thrown if parameter(s) are invalid / out of range.
    ...
    /**
      * Get the response message to be sent to the MS.
