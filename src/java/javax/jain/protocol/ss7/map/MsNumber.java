/*
 @(#) $RCSfile: MsNumber.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:38 $ <p>
...
public interface MsNumber {
    ...
    public static final int MS_NUMBER_MIN = 2;

    /**
      * Get the MS Number type.
      * @return MS Number type: the type is either MSIDN or MIN.
      */
