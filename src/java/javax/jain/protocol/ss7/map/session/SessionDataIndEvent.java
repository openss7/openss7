/*
 @(#) $RCSfile: SessionDataIndEvent.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:42 $ <p>
...
/**
  * This primitive (event) is used by the MAP API Provider to deliver
  * data to the MAP API User coming from the Mobile Station. <p>
  *
  ...
  *
  * <li>serviceData, conditional parameter, present if the MS user keyed
  * in any data
  *
  ...
  * @version 1.2.2
  */
public final class SessionDataIndEvent extends SessionEvent {
    /**
      * The constructor.
      * @param source
      ...
      */
    public SessionDataIndEvent(java.lang.Object source)
        throws SS7InvalidParamException {
        super(source, SESSION_DATA_IND_ID);
    }
    /** Empty constructor; needed for serializable objects and beans.  */
    public SessionDataIndEvent()
        throws SS7InvalidParamException {
        super(null, SESSION_DATA_IND_ID);
    }
    /**
      * Set the data that is received on the session.
      * @param serviceData
      * The data received.
      * @exception SS7InvalidParamException
      * Thrown if parameter(s) are invalid / out of range.
    ...
    /**
      * Get the data that is received on the session. It shall be
    ...
    /**
      * Set the result parameter. This parameter is present if the
      * operation failed.
      * @param result
      * Result information.
      * @exception SS7InvalidParamException
    ...
    /**
      * Get the result parameter. It shall be checked if this parameter
      * is present before getting it.
      * @return
      * Result information.
      */
