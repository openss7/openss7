/*
 @(#) $RCSfile: SS7InvalidParamException.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:37 $ <p>
...
/**
  * This exception is thrown if an invalid parameter is supplied.
  *
...
public class SS7InvalidParamException extends SS7Exception {
    ...
    /**
      * Constructs a new SS7InvalidParamException.
      */
    public SS7InvalidParamException() {
        super();
    }
}
