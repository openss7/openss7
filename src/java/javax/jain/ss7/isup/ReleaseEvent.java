/*
 @(#) $RCSfile: ReleaseEvent.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:05 $ <p>
...
public abstract class ReleaseEvent extends IsupEvent {
    /** Constructs a new ReleaseEvent, with only the JAIN ISUP Mandatory parameters
      ...
      * @param primitive  Primitive value for Release Event is ISUP_PRIMITIVE_RELEASE.
