/*
 @(#) $RCSfile: UserServiceInfoCommon.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:06 $ <p>
...
public abstract class UserServiceInfoCommon implements java.io.Serializable {
    ...
    /** Constructs a UserServiceInfoCommon class from the input parameters specified.
      ...
      * @param in_numOfDataBits  The number of data bits excluding parity, range 0 to 3
