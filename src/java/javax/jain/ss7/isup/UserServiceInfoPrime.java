...
* 
* MODULE NAME  : $RCSfile: UserServiceInfoPrime.java,v $
...
public class UserServiceInfoPrime extends UserServiceInfoCommon{
	...
	public UserServiceInfoPrime(byte in_infoTransferCap,
                            byte in_codingStd,
                            boolean in_ext1,
	...
	public void  putUserServiceInfoPrime(byte[] arr, int index, byte par_len){	
		super.putUserServiceInfoCommon(arr,index,par_len);
	}

	public byte[] flatUserServiceInfoPrime()
	{
