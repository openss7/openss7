/*
 @(#) $RCSfile: UserServiceInfoPrime.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:06 $ <p>
...
/** A class representing the ISUP User Service Information Prime parameter.
  * This class provides methods common to ITU and ANSI variants.  The ITU variant has
  * no additional sub-fields while the ANSI variant class inherits from the core class
  * and adds its own specific sub-fields.
  *
  * @author Monavacon Limited
  * @version 1.2.2
  */
public class UserServiceInfoPrime extends UserServiceInfoCommon {
    /** Constructs a new UserServiceInfoPrime class, parameters with default values.  */
    public UserServiceInfoPrime() {
    }
    /** Constructs a UserServiceInfoCommon class from the input parameters specified.
      ...
      * <li>EI_LAST_OCTET. </ul>
      * @param in_infoTransferRateDestToOrig  The information transfer.
      * @param rate from Destination to Origination, range 0 to 31
      ...
      * <li>UR_56DOT0_KBPS, <li>UR_64DOT0_KBPS (ANSI only), <li>UR_57DOT6_KBPS (ITU only),
      ...
      * @param in_numOfDataBits  The number of data bits excluding parity, range 0 to
      * 3; <ul> <li>NDBEP_NOT_USED, <li>NDBEP_5_BIT, <li>NDBEP_7_BIT and
      * <li>NDBEP_8_BIT. </ul>
      * @param in_numOfStopBits  The number of stop bits, range 0 to 3; <ul>
      ...
      * <li>EI_LAST_OCTET. </ul>
      * @param in_userInfoLayer2  The user information layer 2 protocol, range 0 to
      ...
      * <li>EI_LAST_OCTET. </ul>
      * @param in_userInfoLayer3  The user information layer 3 protocol, range 0 to
      ...
      * <li>EI_LAST_OCTET. </ul>
      * @exceptions ParameterRangeInvalidException  Thrown when value is out of range.
      * */
    public UserServiceInfoPrime(byte in_infoTransferCap, byte in_codingStd,
            boolean in_ext1, byte in_infoTransferRate, byte in_transferMode,
            boolean in_ext2, byte in_establishment, byte in_config, byte in_struct,
            boolean in_ext2a, byte in_infoTransferRateDestToOrig, byte in_symmetry,
            boolean in_ext2b, byte in_userInfoLayer1, byte in_layer1Id,
            boolean in_ext3, byte in_userInfoLayer2, byte in_layer2Id,
            boolean in_ext4, byte in_userInfoLayer3, byte in_layer3Id,
            boolean in_ext5, byte in_rateMultiplier, boolean in_ext21,
            byte in_userRate, boolean in_negotiation, boolean in_syncFlag,
            boolean in_ext3a, boolean in_flowCntrlRx, boolean in_flowCntrlTx,
            boolean in_nicRx, boolean in_nicTx, byte in_intermediateRate,
            boolean in_ext3b1, boolean in_bandNegotiationInd, boolean in_msgOrigInd,
            boolean in_lliNegotiationInd, boolean in_modeInd,
            boolean in_multiFrameInd, boolean in_rateAdaptationInd, boolean in_ext3b2,
            byte in_parity, byte in_numDataBits, byte in_numStopBits,
            boolean in_ext3c, byte in_modemType, boolean in_duplexModeInd,
            boolean in_ext3d)
    ...
    /** The toString method retrieves a string containing the values of the members of
      * the UserServiceInfoPrime class.
      * @return A string representation of the member variables.  */
    public java.lang.String toString() {
        StringBuffer b = new StringBuffer(512);
        b.append(super.toString());
        b.append("\njavax.jain.ss7.isup.UserServiceInfoPrime");
        return b.toString();
    }
}
