/*
 @(#) $RCSfile: UserServiceInfoPrime.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-09-02 08:46:47 $ <p>
...
public class UserServiceInfoPrime extends UserServiceInfoCommon {
    ...
    /** Constructs a UserServiceInfoCommon class from the input parameters specified.
      ...
      * rate from Destination to Origination, range 0 to 31
      ...
      * @param in_numDataBits  The number of data bits excluding parity, range 0 to
