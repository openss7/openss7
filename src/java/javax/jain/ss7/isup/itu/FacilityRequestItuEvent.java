/*
 @(#) $RCSfile: FacilityRequestItuEvent.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:08 $ <p>
...
/** An ISUP EVENT: The FacilityRequestItuEvent class is a sub class of the IsupEvent class
    and is exchanged between an ISUP Provider and an ISUP Listener for sending and
    receiving the ISUP FacilityRequest message.
    Listener would send a FacilityEventRequest object to the provider for sending a FAR
    message to the ISUP stack. ISUP Provider would send a FacilityEventRequest object to
    the listener on the reception of a FAR message from the stack for the user address
...
public class FacilityRequestItuEvent extends IsupEvent {
    /** Constructs a new FacilityRequestItuEvent, with only the JAIN ISUP Mandatory
    ...
    public FacilityRequestItuEvent(java.lang.Object source, SignalingPointCode dpc,
        ...
        setFacilityInd(facilityInd);
    }
    /** Gets the ISUP FACILITY REQUEST primtive value.
      * @return The ISUP FACILITY REQUEST primitive value.
      */
    ...
    public void setFacilityInd(short in_facInd)
        ...
        throw new ParameterRangeInvalidException("FacilityInd valud " + in_facInd + " out of range.");
    }
    ...
    public ConReq getConReq()
        ...
        throw new ParameterNotSetException("ConectionRequest not set.");
    }
    ...
    /** The toString method retrieves a string containing the values of the members of the
      * FacilityRequestItuEvent class.
      * @return A string representation of the member variables.
      */
    public java.lang.String toString() {
        StringBuffer b = new StringBuffer(512);
        b.append(super.toString());
        b.append("\njavax.jain.ss7.isup.itu.FacilityRequestItuEvent");
        b.append("\n\tm_facInd: " + m_facInd);
        b.append("\n\tm_callRef: " + m_callRef);
    ...
    protected ParamCompatibilityInfoItu m_pci;
    protected UserToUserIndicatorsItu m_uui;
}
