/*
 @(#) $RCSfile: InformationItuEvent.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:08 $ <p>
...
/** An ISUP Event: The InformationItuEvent class is a sub class of the JAIN ISUP Core
  * InformationEvent class and is used for handling of parameters for the ITU variant of
  * Information Message.
  *
  * @author Monavacon Limited
  * @version 1.2.2
  */
public class InformationItuEvent extends InformationEvent {
    /** Constructs a new InformationItuEvent, with only the JAIN ISUP Mandatory parameters
      ...
      */
    public InformationItuEvent(java.lang.Object source, SignalingPointCode dpc,
    ...
    /** The toString method retrieves a string containing the values of the members of the
      * InformationItuEvent class.
      * @return A string representation of the member variables.
      */
    public java.lang.String toString() {
        StringBuffer b = new StringBuffer(512);
        b.append(super.toString());
        b.append("\njavax.jain.ss7.isup.itu.InformationItuEvent");
        b.append("\n\tm_nsf: " + m_nsf);
        b.append("\n\tm_pci: " + m_pci);
        return b.toString();
    }
