/*
 @(#) $RCSfile: AlertItuEvent.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:07 $ <p>
...
/** An ISUP Event: The AlertItuEvent class is a sub class of the JAIN ISUP Core AlertEvent
    class and is used for handling of parameters for the ITU variant of Address Complete
    Message.
...
public class AlertItuEvent extends AlertEvent {
    /** Constructs a new AlertItuEvent, with only the JAIN ISUP Mandatory parameters by
        calling the super class constructor.
        @param source  The source of this event.
        @param primitive  Primitive value for StartResetInd is ISUP_PRIMITIVE_ALERT. Refer
    ...
    /** Sets the CallDiversionInfoItu parameter of the message.
        @param cdi  The CallDiversionInfo parameter of the event.
      */
    ...
    public java.lang.String toString() {
        ...
        b.append("\njavax.jain.ss7.isup.itu.AlertItuEvent");
        if (m_adiIsSet)
            b.append("\n\tm_adi: " + m_adi);
        b.append("\n\tm_cdi: " + m_cdi);
        b.append("\n\tm_eci: " + m_eci);
