...
* 
* MODULE NAME  : $RCSfile: CalledPartyNumberItu.java,v $
...
public class CalledPartyNumberItu extends CalledPartyNumber{
		...
		public CalledPartyNumberItu(){
			super();
			m_internalNetworkNumberIndicator = false;
		}
		...
		public byte[] flatCalledPartyNumberItu()
		{
			byte[] rc;
			byte intNetNumInd = 0;
			...
			rc = super.flatCalledPartyNumber();
		...
		public void  putCalledPartyNumberItu(byte[] arr, int index, byte par_len){

			super.putCalledPartyNumber(arr,index,par_len);
			if ((byte)((arr[index+1]>>7)&IsupMacros.L_BIT1_MASK) == 1)
				m_internalNetworkNumberIndicator = true;
		}
		
	/**
    * String representation of class CalledPartyNumberItu
    *
    * @return    String provides description of class CalledPartyNumberItu
    */
