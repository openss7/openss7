...
* 
* MODULE NAME  : $RCSfile: CallProgressItuEvent.java,v $
...
public class CallProgressItuEvent extends CallProgressEvent{
	...
	public CallProgressItuEvent(java.lang.Object source,
	...
	/**
    * String representation of class CallProgressItuEvent
    *
    * @return    String provides description of class CallProgressItuEvent
    */
