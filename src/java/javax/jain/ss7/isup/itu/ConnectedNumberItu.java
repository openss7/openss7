/*
 @(#) $RCSfile: ConnectedNumberItu.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:08 $ <p>
...
/** A class representing a Connected Number parameter.
    This class contains all the subfields for the ITU variant.
...
public class ConnectedNumberItu extends NumberParameter {
    ...
    /** Constructs a new ConnectedNumberItu.
        ...
        indicator. <ul> <li>APRI_ADDRESS_PRESENTATION_ALLOWED,
      ...
      */
    public ConnectedNumberItu(byte natureOfAddressIndicator, byte numberingPlanIndicator,
    ...
    /** Gets the Address Presentation Restricted Ind field of the parameter, range 0 to 3.
    ...
    /** Gets the Screening Ind field of the parameter.
        @return Screening indicator, range 0 to 3, see ConnectedNumberItu().
      */
    ...
    /** The toString method retrieves a string containing the values of the members of the
        ConnectedNumberItu class.
        @return A string representation of the member variables.
      */
    public java.lang.String toString() {
        StringBuffer b = new StringBuffer(512);
        b.append(super.toString());
        b.append("\njavax.jain.ss7.isup.itu.ConnectedNumberItu");
