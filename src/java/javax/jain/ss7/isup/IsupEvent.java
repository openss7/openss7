/*
 @(#) $RCSfile: IsupEvent.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:04 $ <p>
...
/** The IsupEvent class is the superclass of all ISUP primitives that can be exchanged
  ...
  * @version 1.2.2
  */
public abstract class IsupEvent extends JainEvent {
    /** Construct a new IsupEvent. */
    protected IsupEvent() { }
