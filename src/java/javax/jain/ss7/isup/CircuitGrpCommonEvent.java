/*
 @(#) $RCSfile: CircuitGrpCommonEvent.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2011-09-02 08:46:47 $ <p>
...
/** An ISUP EVENT: The CircuitGrpCommonEvent class is a sub class of the IsupEvent
  * class and is the Super class of all the Circuit Group Maintenance message classes.
  * It and is exchanged between an ISUP Provider and an ISUP Listener for sending and
  * receiving circuit group maintenance message.
  *
  * @author Monavacon Limited
  * @version 1.2.2
  */
public abstract class CircuitGrpCommonEvent extends IsupEvent {
    /** Constructs a new CircuitGrpCommonEvent, with the JAIN ISUP Mandatory
    ...
    protected CircuitGrpCommonEvent(java.lang.Object source, SignalingPointCode dpc,
        ...
        this.setRangeAndStatus(in_rangeAndStatus);
    }
    ...
    public void checkMandatoryParameters()
        ...
        if (m_rangeAndStatus == null)
            throw new MandatoryParameterNotSetException("RangeAndStatus is not set.");
    }
    /** Gets the Range and Status fields of circuits parameter of the message.
      * Refer to Range And Status parameter class for more information.
      * @return The Range and Status parameter of the event.
      * @exception MandatoryParameterNotSetException  Thrown when mandatory ISUP
      * parameter is not set.  */
    public RangeAndStatus getRangeAndStatus()
        throws MandatoryParameterNotSetException {
        if (m_rangeAndStatus != null)
            return m_rangeAndStatus;
        throw new MandatoryParameterNotSetException("RangeAndStatus is not set.");
    }
    ...
    /** The toString method retrieves a string containing the values of the members of
      * the CircuitGrpCommonEvent class.
      * @return A string representation of the member variables.  */
    public java.lang.String toString() {
        StringBuffer b = new StringBuffer(512);
        b.append(super.toString());
        b.append("\njavax.jain.ss7.isup.CircuitGrpCommonEvent");
        b.append("\n\tm_rangeAndStatus: " + m_rangeAndStatus);
        return b.toString();
    }
    protected RangeAndStatus m_rangeAndStatus = null;
}
