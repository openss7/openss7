/*
 @(#) $RCSfile: OptionalBwdCallInd.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:05 $ <p>
...
/** A class representing the ISUP Optional Backward Call Indicators parameter.
  ...
  * @version 1.2.2
  */
public abstract class OptionalBwdCallInd implements java.io.Serializable {
