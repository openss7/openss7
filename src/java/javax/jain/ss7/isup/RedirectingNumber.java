...
* 
* MODULE NAME  : $RCSfile: RedirectingNumber.java,v $
...
public class RedirectingNumber extends NumberParameter{
	...
	public void  putRedirectingNumber(byte[] arr, int index, byte par_len){
	...
	public byte[] flatRedirectingNumber()
	{
			byte[] rc;
	...
	/**
    * String representation of class RedirectingNumber
    *
    * @return    String provides description of class RedirectingNumber
    */
