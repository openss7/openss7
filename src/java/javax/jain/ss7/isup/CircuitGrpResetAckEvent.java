/*
 @(#) $RCSfile: CircuitGrpResetAckEvent.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:03 $ <p>
...
/** An ISUP EVENT: The CircuitGrpResetAckEvent class is a sub class of the
  * CircuitGrpCommonEvent class.
  * It is exchanged between an ISUP Provider and an ISUP Listener for sending and
  * receiving circuit group reset acknowledgment message(GRA). This event defines the
  * common parameters to ITU and ANSI. The ANSI class has some additional parameters
  * and inherits from the core class.
  *
  * @author Monavacon Limited
  * @version 1.2.2
  */
public class CircuitGrpResetAckEvent extends CircuitGrpCommonEvent {
    /** Constructs a new CircuitGrpResetAckEvent, with the JAIN ISUP Mandatory
      ...
      * @param in_rangeAndStatus  Gives the range and status of the affected circuits.
    ...
    /** Gets the ISUP CIRCUIT GROUP RESET ACKNOWLEDGMENT primtive value.
      * @return The ISUP CIRCUIT GROUP RESET ACKNOWLEDGMENT primitive value.  */
    ...
    /** The toString method retrieves a string containing the values of the members of
      * the CircuitGrpResetAckEvent class.
      * @return A string representation of the member variables.  */
    public java.lang.String toString() {
        StringBuffer b = new StringBuffer(512);
        b.append(super.toString());
        b.append("\njavax.jain.ss7.isup.CircuitGrpResetAckEvent");
        return b.toString();
    }
}
