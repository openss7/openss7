...
/**
  * An ISUP Event : The CircuitGrpResetAckAnsiEvent class is a sub class of ISUP Core CircuitGrpResetAckEvent class
  * and is to handle the ANSI variant of GRA message.
  */
public class CircuitGrpResetAckAnsiEvent extends CircuitGrpResetAckEvent {
    /**
      * Constructs a new CircuitGrpResetAckAnsiEvent, with only the JAIN ISUP Mandatory parameters being supplied to
      * the constructor, using the super class's constructor.
      ...
      * @param in_rangeAndStatus - Gives the range of the affected circuits. <em>IN THIS EVENT, THE STATUS FIELD IS NOT
      * PRESENT.</em>  Refer to RangeAndStatus class for more details.
    ...
    public CircuitAssignMapAnsi getCircuitAssignMap() throws ParameterNotSetException {
        if (isCircuitAssignMapPresent())
            return m_cam;
        throw ParameterNotSetException("CircuitAssignMap parameter is not set.");
    }
    /**
    ...
    /**
      * The toString method retrieves a string containing the values of the members of the CircuitGrpResetAckAnsiEvent
      * class.
