/*
 @(#) $RCSfile: CircuitGrpResetAckAnsiEvent.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:06 $ <p>
...
/** An ISUP Event: The CircuitGrpResetAckAnsiEvent class is a sub class of ISUP Core
  * CircuitGrpResetAckEvent class and is to handle the ANSI variant of GRA message.
  *
  * @author Monavacon Limited
  * @version 1.2.2
  */
public class CircuitGrpResetAckAnsiEvent extends CircuitGrpResetAckEvent {
    /** Constructs a new CircuitGrpResetAckAnsiEvent, with only the JAIN ISUP Mandatory
      ...
      * @param in_rangeAndStatus - Gives the range of the affected circuits. <em>IN
    ...
    public CircuitAssignMapAnsi getCircuitAssignMap() throws ParameterNotSetException {
        if (isCircuitAssignMapPresent())
            return m_cam;
        throw new ParameterNotSetException("CircuitAssignMap parameter is not set.");
    }
    ...
    /** The toString method retrieves a string containing the values of the members of
      * the CircuitGrpResetAckAnsiEvent class.
