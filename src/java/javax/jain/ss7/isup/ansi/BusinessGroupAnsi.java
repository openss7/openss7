...
/**
  * A class representing the ANSI ISUP Business Group parameter. This methods
  * provide access to the various sub-fields of this parameter.
  */
public class BusinessGroupAnsi extends java.lang.Object implements java.io.Serializable {
    ...
    /**
      ...
      *
      * @param in_partySel  The party selector, range 0 to 15.
      * <ul>
      * <li>PS_NO_INDICATION
      * <li>PS_CALLING_PARTY_NUMBER
      * <li>PS_CALLED_PARTY_NUMBER
      * <li>PS_CONNECTED_PARTY_NUMBER
      * <li>PS_REDIRECTING_NUMBER
      * <li>PS_ORIGINAL_CALLED_NUMBER
      * </ul>
      * @param in_linePrivInd  The line privileges information indicator.
      * <ul>
      * <li>LPII_FIXED_LINE_PRIVILEGES
      * <li>LPII_CUSTOMER_DEFINED_LINE_PRIVILEGES
      * </ul>
      * @param in_bgIdType  The business group identifiertType.
      * <ul>
      * <li>BGIT_MULT_LOCATION_BUSINESS_GROUP_IDENTIFIER
      * <li>BGIT_INTERWORKING_WITH_PRIVATE_NETWORKS_IDENTIFIER
      * </ul>
      * @param in_attendantStatus  The attendant status.
      * <ul>
      * <li>AS_NO_INDICATION
      * <li>AS_ATTENDANT_LINE
      * </ul>
      ...
      * @param in_linePriv  The line privileges, range 0 to 255.
      * <ul>
      * <li>LP_UNRESTRICTED
      * <li>LP_SEMI_RESTRICTED
      * <li>LP_FULLY_RESTRICTED
      * <li>LP_FULLY_RESTRICTED_INTRA_SWITCH
      * <li>LP_DENIED
      * </ul>
    ...
    public BusinessGroupAnsi(byte in_partySel, boolean in_linePrivInd, boolean
        ...
        if (PS_NO_INDICATION > in_partySel || in_partySel > PS_ORIGINAL_CALLED_NUMBER)
            throw ParameterRangeInvalidException("Party Selection " + in_partySel + " is out of bounds.");
        if (LP_UNRESTRICTED > in_linePriv || in_linePriv > LP_DENIED)
            throw ParameterRangeInvalidException("Line Privilege " + in_linePriv + " is out of bounds.");
    ...
    /**
      ...
      * @param aPartySelector The PartySelector value, range 0 to 15, see BusinessGroupAnsi().
    ...
    public void setPartySelector(byte aPartySelector) throws ParameterRangeInvalidException {
        if (PS_NO_INDICATION > aPartySelector || aPartySelector > PS_ORIGINAL_CALLED_NUMBER)
            throw ParameterRangeInvalidException("Party Selection " + aPartySelector + " is out of bounds.");
    ...
    /**
      ...
      * @param aLinePrivilegesInfoIndicator  The Line Privileges Info Indicator value, see BusinessGroupAnsi().
      */
    ...
    /**
      ...
      * @param aBusinessGroupIdentifierType  The BusinessGroupIdentifierType value, see BusinessGroupAnsi().
      */
    public void setBusinessGroupIdType(boolean aBusinessGroupIdentifierType) {
        m_bgId = aBusinessGroupIdentifierType;
    }
    /**
    ...
    /**
      ...
      * @param aBusinessGroupIdentifier  The BusinessGroupIdentifier value, range 0 to 0xffffff.
      * @exception ParameterRangeInvalidException  Thrown when the sub-field is out of the range specified.
      */
    ...
    /**
      ...
      * @param aLinePrivileges  The LinePrivileges value, range 0 to 255, see BusinessGroupAnsi().
      * @exception ParameterRangeInvalidException  Thrown when the sub-field is out of the range specified.
      */
    public void setLinePriv(short aLinePrivileges) throws ParameterRangeInvalidException {
        if (LP_UNRESTRICTED > aLinePrivileges || aLinePrivileges > LP_DENIED)
            throw ParameterRangeInvalidException("Line Privilege " + aLinePrivileges + " is out of bounds.");
    ...
    public java.lang.String toString() {
        ...
        if (m_linePrivInd != null)
            buffer.append("\n\tLine Privileges: " + m_linePrivInd);
        if (m_bgIdType != null)
            buffer.append("\n\tBusiness Group ID Type: " + m_bgIdType);
        if (m_attendantStatus != null)
            buffer.append("\n\tAttendant Status: " + m_attendantStatus);
        if (m_bgId != null)
            buffer.append("\n\tBusiness Group Id: " + m_bgId);
        if (m_subGroupId != null)
            buffer.append("\n\tSubgroup Id: " + m_subGroupId);
        if (m_linePriv != null)
            buffer.append("\n\tLine Privilege: " + m_linePriv);
        return buffer.toString();
    }
    private byte m_partySel = null;
    private boolean m_linePrivInd = null;
    private boolean m_bgIdType = null;
    private boolean m_attendantStatus = null;
    private int m_bgId = null;
    private int m_subGroupId = null;
    private short m_linePriv = null;
}
