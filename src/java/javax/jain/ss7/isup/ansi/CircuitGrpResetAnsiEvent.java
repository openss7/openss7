...
/**
  * An ISUP Event : The CircuitGrpResetAnsiEvent class is a sub class of ISUP Core CircuitGrpResetEvent class and is
  * to handle the ANSI variant of GRS message.
  */
public class CircuitGrpResetAnsiEvent extends CircuitGrpResetEvent {
    /**
      * Constructs a new CircuitGrpResetEvent, with only the JAIN ISUP Mandatory parameters being supplied to the
      * constructor, using the super class's constructor.
      * @param source  The source of this event.
      * @param primitive  Primitive value is ISUP_PRIMITIVE_CIRCUIT_GRP_RESET. Refer to IsupEvent class for more
      * details.
      * @param dpc  The destination point code.
      * @param opc  The origination point code.
      * @param sls  The signaling link selection.
      * @param cic  The CIC on which the call has been established.
      * @param congestionPriority  Priority of the ISUP message which may be used in the optional national congestion
      * control procedures at MTP3. Refer to getCongestionPriority method in IsupEvent class for more details.
      * @param in_rangeAndStatus  Gives the range of the affected circuits. IN THIS EVENT, THE STATUS FIELD IS NOT
      * PRESENT.  Refer to RangeAndStatus class for more details.
    ...
    public CircuitAssignMapAnsi getCircuitAssignMap() throws ParameterNotSetException {
        if (isCircuitAssignMapPresent())
            return m_cam;
        throw ParameterNotSetException("CircuitAssignMapAnsi is not set.");
    }
    /**
    ...
    /**
      * The toString method retrieves a string containing the values of the members of the CircuitGrpResetAnsiEvent
      * class.
