/*
 @(#) $RCSfile: OrigCalledNumber.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:05 $ <p>
...
/** A class representing the ITU and ANSI Original Called Number parameter.
  * This class provides methods to access the sub-fields of this parameter.
  *
...
public class OrigCalledNumber extends NumberParameter {
    ...
    /** Constructs a new OrigCalledNumber taking no parameters.
      * This constructor sets all the sub-field values to their spare value (which is
      * zero).  */
    public OrigCalledNumber() {
    }
    /** Constructs a new original called party Id.
      * @param natureOfAddressIndicator  The nature of address indicator, range 0 to
      * 127, see NumberParameter().
      * @param numberingPlanIndicator  The numbering plan indicator, range 0 to 7,
      * see NumberParameter().
    ...
    /** The toString method retrieves a string containing the values of the members of
      * the OrigCalledNumber class.
      * @return A string representation of the member variables.  */
    public java.lang.String toString() {
        StringBuffer b = new StringBuffer(512);
        b.append("\njavax.jain.ss7.isup.OrigCalledNumber:");
        b.append("\n\tm_addressPresentationRestrictionIndicator: " + m_addressPresentationRestrictionIndicator);
        return b.toString();
    }
    protected byte m_addressPresentationRestrictionIndicator;
}
