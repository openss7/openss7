 ...
 * originates. <P>
 * For example: within the JAIN INAP API, the lower-level package structure and classname of
 * a proprietary implementation of the <I>jain.protocol.ss7.inap.JainInapStack</I>
 * interface <B>must</B> be <I>jain.protocol.ss7.inap.JainInapStackImpl</I>.<P>
 *
 ...
 * e.g. <I>jain.protocol.ss7.inap.JainInapStackImpl</I> is the mandated naming convention
 * for <I>jain.protocol.ss7.inap.JainInapStack</I>.<P>
 * The resulting Peer JAIN SS7 Object would be located at: <I><B>com.sun</B>.jain.protocol.ss7.inap.JainInapStackImpl</I><BR>
 *
 ...
 * different Vendor with a domain name 'foo.com' would have their Peer JainInapStack Object
 * located at <I><B>com.foo</B>.jain.protocol.ss7.inap.JainInapStackImpl</I>.<BR>
...
public class JainSS7Factory {
    ...
    * For example: To create an instance of the <I>jain.protocol.ss7.inap.JainInapStack</I>
    * from the JAIN INAP API, the supplied classname <B>will</B> be
    * <I>jain.protocol.ss7.inap.JainInapStackImpl</I>.<P>
    * <P>
    *
    * Under the JAIN naming convention, the <B>upper-level package structure</B> (pathname)
    * can be used to differentiate between proprietary implementations from different SS7 Vendors.
    ...
    */
    public synchronized Object createSS7Object(String objectClassName) throws javax.jain.PeerUnavailableException {
