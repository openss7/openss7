/*
 @(#) $RCSfile: JainSS7Factory.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:45 $ <p>
...
/**
  ...
  * <p>
  *
  * For example: within the JAIN INAP API, the lower-level package
  * structure and classname of a proprietary implementation of the
  * jain.protocol.ss7.inap.JainInapStack interface must be
  * jain.protocol.ss7.inap.JainInapStackImpl. <p>
  *
  ...
  *
  * e.g. jain.protocol.ss7.inap.JainInapStackImpl is the mandated naming
  * convention for jain.protocol.ss7.inap.JainInapStack. <p>
  *
  * The resulting Peer JAIN SS7 Object would be located at:
  * com.sun.jain.protocol.ss7.inap.JainInapStackImpl Because the space
  ...
  * their Peer JainInapStack Object located at
  * com.foo.jain.protocol.ss7.inap.JainInapStackImpl.  This is a similar
...
public class JainSS7Factory {
    ...
    /**
      ...
      * jain.protocol.ss7.inap.JainInapStack from the JAIN INAP API, the
    ...
    /**
      ...
      * JAIN SS7 Factory.
      */
    public java.util.Vector<java.lang.Object> getJainObjectList() {
        return m_jainObjectList;
    }
    protected static JainSS7Factory m_jainSS7Factory = null;
    protected static java.lang.String m_pathName = "com.sun";
    protected static java.util.Vector<java.lang.Object> m_jainObjectList = new java.util.Vector<java.lang.Object>();
}
