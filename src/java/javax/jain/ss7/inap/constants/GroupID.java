/*
 @(#) $RCSfile: GroupID.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:48 $ <p>
...
/**
  * This class contains the identity of the group
  * (facilityGroupMemberID/trunkGroupID).
  * @version 1.2.2
  * @author Monavacon Limited
  */
public class GroupID {
    /** Internal integer value: FACILITY_GROUP_MEMBER_ID. */
    ...
    public static final GroupID FACILITY_GROUP_MEMBER_ID
        = new GroupID(M_FACILITY_GROUP_MEMBER_ID);
    /** GroupID :TRUNK_GROUP_ID */
    public static final GroupID TRUNK_GROUP_ID
        = new GroupID(M_TRUNK_GROUP_ID);
