/*
 @(#) $RCSfile: FilteringTimeOutChoice.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:48 $ <p>
...
public class FilteringTimeOutChoice {
    /** Internal integer value: duration. */
    public static final int M_DURATION = 0;
    /** Internal integer value: stop time. */
    ...
    public static final FilteringTimeOutChoice DURATION
        = new FilteringTimeOutChoice(M_DURATION );
    /** FilteringTimeOutChoice :STOPTIME */
    public static final FilteringTimeOutChoice STOPTIME
        = new FilteringTimeOutChoice(M_STOPTIME );
    /** Gets the integer value representation of constant class.
      * @return
      * Integer value of constant class.  */
