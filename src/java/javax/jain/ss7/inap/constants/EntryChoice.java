/*
 @(#) $RCSfile: EntryChoice.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:47 $ <p>
...
/**
  * This class indicates the Entry choice.
  * @version 1.2.2
  * @author Monavacon Limited
  */
public class EntryChoice {
    /** Internal integer value: AGREEMENTS.  */
    public static final int M_AGREEMENTS = 0;
    /** Internal integer value: NETWORK_SPECIFIC.  */
    public static final int M_NETWORK_SPECIFIC = 1;
    ...
    private EntryChoice(int entryChoice) {
        this.entryChoice = entryChoice;
    }    
    /** EntryChoice : AGREEMENTS */
    public static final EntryChoice AGREEMENTS
        = new EntryChoice(M_AGREEMENTS);
