/*
 @(#) $RCSfile: CancelChoice.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:47 $ <p>
...
/**
  * This class indicates the operations that need to be cancelled
  * (invokeID / allRequests / Call Segments).
  * @version 1.2.2
  * @author Monavacon Limited
  */
public class CancelChoice {
    /** Internal integer value: invoke ID. */
    public static final int M_INVOKE_ID =0;
    /** Internal integer value: all requests. */
    public static final int M_ALL_REQUESTS =1;
    /** Internal integer value: call segment. */
    ...
    public static final CancelChoice INVOKE_ID
        = new CancelChoice(M_INVOKE_ID);
    /** CancelChoice : ALL_REQUESTS */
    public static final CancelChoice ALL_REQUESTS
        = new CancelChoice(M_ALL_REQUESTS);
    /** CancelChoice : ALL_REQUESTS */
    public static final CancelChoice CALL_SEGMENT
        = new CancelChoice(M_CALL_SEGMENT);
