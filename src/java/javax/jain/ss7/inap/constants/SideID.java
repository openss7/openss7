/*
 @(#) $RCSfile: SideID.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:50 $ <p>
...
/**
  ...
  */
public class SideID {
    /** Internal integer value: send. */
    public static final int M_SEND = 0;
    /** Internal integer value: received. */
    ...
    /** SideID  :SEND */
    public static final SideID SEND
        = new SideID(M_SEND);
    /** SideID  :RECEIVE */
    public static final SideID RECEIVE
        = new SideID(M_RECEIVE);
