/*
 @(#) $RCSfile: ReceivedInformationChoice.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:49 $ <p>
...
public class ReceivedInformationChoice { 
    /** Internal integer value: digits. */
    public static final int M_DIGITS_RESPONSE = 0;
    /** Internal integer value: IA5. */
    ...
    /** Private constructor for the constant class.
      * @param receivedInformationChoice
    ...
    public static final ReceivedInformationChoice DIGITS_RESPONSE
        = new ReceivedInformationChoice(M_DIGITS_RESPONSE);
    /** ReceivedInformationChoice  :IA5_RESPONSE */
    public static final ReceivedInformationChoice IA5_RESPONSE
        = new ReceivedInformationChoice(M_IA5_RESPONSE);
