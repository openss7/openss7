/*
 @(#) $RCSfile: ConnectedPartyChoice.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:47 $ <p>
...
public class ConnectedPartyChoice {
    ...
    public static final ConnectedPartyChoice LEG_ID
        = new ConnectedPartyChoice(M_LEG_ID);
