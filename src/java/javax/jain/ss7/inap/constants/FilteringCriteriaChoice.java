/*
 @(#) $RCSfile: FilteringCriteriaChoice.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:48 $ <p>
...
public class FilteringCriteriaChoice {
    /** Internal integer value: dialed number. */
    public static final int M_DIALLED_NUMBER = 0;
    /** Internal integer value: calling line ID. */
    public static final int M_CALLING_LINE_ID = 1;
    /** Internal integer value: service key. */
    public static final int M_SERVICE_KEY = 2;
    /** Internal integer value: address and service. */
    ...
    public static final FilteringCriteriaChoice DIALLED_NUMBER
        = new FilteringCriteriaChoice(M_DIALLED_NUMBER );
    /** FilteringCriteriaChoice :CALLING_LINE_ID */
    public static final FilteringCriteriaChoice CALLING_LINE_ID
        = new FilteringCriteriaChoice(M_CALLING_LINE_ID);
    /** FilteringCriteriaChoice :SERVICE_KEY */
    public static final FilteringCriteriaChoice SERVICE_KEY
        = new FilteringCriteriaChoice(M_SERVICE_KEY);
    /** FilteringCriteriaChoice :ADDRESS_AND_SERVICE */
    public static final FilteringCriteriaChoice ADDRESS_AND_SERVICE
        = new FilteringCriteriaChoice(M_ADDRESS_AND_SERVICE);
