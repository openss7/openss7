/*
 @(#) $RCSfile: ReportCondition.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:49 $ <p>
...
/**
  * This class specifies the cause of sending the 'StatusReport'
...
public class ReportCondition  {
    ...
    /** Internal integer value: TIMER_EXPIRED.  */
    ...
    public static final ReportCondition STATUS_REPORT
        = new ReportCondition(M_STATUS_REPORT);
    /** ReportCondition :TIMER_EXPIRED */
    public static final ReportCondition TIMER_EXPIRED
        = new ReportCondition(M_TIMER_EXPIRED);
