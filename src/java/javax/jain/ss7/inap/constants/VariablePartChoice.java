/*
 @(#) $RCSfile: VariablePartChoice.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:50 $ <p>
...
public class VariablePartChoice {
    ...
    /** Internal integer value: number.  */
    public static final int M_NUMBER = 1;
    /** Internal integer value: time.  */
    public static final int M_TIME = 2;
    /** Internal integer value: date.  */
    public static final int M_DATE = 3; 
    /** Internal integer value: price.  */
    ...
    public static final VariablePartChoice INTEGER
        = new VariablePartChoice(M_INTEGER);
    /** VariablePartChoice :NUMBER */
    public static final VariablePartChoice NUMBER
        = new VariablePartChoice(M_NUMBER);
    /** VariablePartChoice :TIME */
    public static final VariablePartChoice TIME
        = new VariablePartChoice(M_TIME);
    /** VariablePartChoice :DATE */
    public static final VariablePartChoice DATE
        = new VariablePartChoice(M_DATE);
