/*
 @(#) $RCSfile: InvokeProblem.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:48 $ <p>
...
public class InvokeProblem extends java.util.Hashtable {
    ...
    public InvokeProblem() {
        clear();
        put("DUPLICATE_INVOKE_ID", new java.lang.Integer(0));
        put("UNRECOGNIZED_OPERATION", new java.lang.Integer(1));
        put("MISTYPED_PARAMETER", new java.lang.Integer(2));
        put("RESOURCE_LIMITATION", new java.lang.Integer(3));
        put("INITIATING_RELEASE", new java.lang.Integer(4));
        put("UNRECOGNIZED_LINKED_ID", new java.lang.Integer(5));
        put("LINKED_RESPONSE_UNEXPECTED", new java.lang.Integer(6));
        put("UNEXPECTED_LINKED_OPERATION", new java.lang.Integer(7));
    }
}
