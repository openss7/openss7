/*
 @(#) $RCSfile: ReturnResultProblem.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:28:36 $ <p>
...
public class ReturnResultProblem extends java.util.Hashtable<java.lang.String,java.lang.Integer> {
    ...
    /** Internal integer value: mistyped parameter.  */
    public static final int MISTYPED_PARAMETER = 2;
    /** Constructor for ReturnResultProblem datatype.  */
    public ReturnResultProblem() {
    	clear();
    	put("UNRECOGNIZED_INVOKE_ID", new java.lang.Integer(0));
    	put("RETURN_RESULT_UNEXPECTED", new java.lang.Integer(1));
    	put("MISTYPED_PARAMETER", new java.lang.Integer(2));
    }
}
