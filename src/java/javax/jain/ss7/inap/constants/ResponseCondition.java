/*
 @(#) $RCSfile: ResponseCondition.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:49 $ <p>
...
/**
  * This class is used to identify the reason, why the
  * ServiceFilteringResponse operation is sent. <ul>
  * <li> Intermediate - response indicates that service filtering is active.
  * <li> LastResponse - indicates that the service filtering is stopped.
  * </ul>
  *
  * @version 1.2.2
...
public class ResponseCondition {
    /** Internal integer value: INTERMEDIATE_RESPONSE. */
    public static final int M_INTERMEDIATE_RESPONSE = 0;
    /** Internal integer value: LAST_RESPONSE. */
    ...
    public static final  ResponseCondition INTERMEDIATE_RESPONSE
        = new ResponseCondition(M_INTERMEDIATE_RESPONSE);
