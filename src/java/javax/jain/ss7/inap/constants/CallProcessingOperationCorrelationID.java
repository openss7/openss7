/*
 @(#) $RCSfile: CallProcessingOperationCorrelationID.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:47 $ <p>
...
/**
  * This class Call Processing Operation Correlation ID indicates what
  * message should be used to deliver the specified UNI APDU with
  * component. Default is FACILITY and in this case the APDU is
  * delivered during the BCSM suspended at a DP.
  * @version 1.2.2
  * @author Monavacon Limited
  */
public class CallProcessingOperationCorrelationID {
    /** Internal integer value: alterting. */
    public static final int M_ALERTING = 1;
    /** Internal integer value: setup. */
    public static final int M_SETUP = 5;
    /** Internal integer value: connect. */
    public static final int M_CONNECT = 7;
    /** Internal integer value: disconnect. */
    public static final int M_DISCONNECT = 69;
    /** Internal integer value: release. */
    public static final int M_RELEASE = 77;
    /** Internal integer value: release complete. */
    public static final int M_RELEASE_COMPLETE = 90;
    /** Internal integer value: facility. */
    ...
    /** Private constructor for the constant class.
      * @param callProcessingOperationCorrelationID
    ...
    public static final CallProcessingOperationCorrelationID ALERTING
        = new CallProcessingOperationCorrelationID(M_ALERTING);
    /** callProcessingOperationCorrelationID:SETUP */
    public static final CallProcessingOperationCorrelationID SETUP
        = new CallProcessingOperationCorrelationID(M_SETUP);
    /** callProcessingOperationCorrelationID:CONNECT */
    public static final CallProcessingOperationCorrelationID CONNECT
        = new CallProcessingOperationCorrelationID(M_CONNECT);
    /** callProcessingOperationCorrelationID:DISCONNECT */
    public static final CallProcessingOperationCorrelationID DISCONNECT
        = new CallProcessingOperationCorrelationID(M_DISCONNECT);
    /** callProcessingOperationCorrelationID:RELEASE */
    public static final CallProcessingOperationCorrelationID RELEASE
        = new CallProcessingOperationCorrelationID(M_RELEASE);
    /** callProcessingOperationCorrelationID:RELEASE_COMPLETE */
    public static final CallProcessingOperationCorrelationID RELEASE_COMPLETE
        = new CallProcessingOperationCorrelationID(M_RELEASE_COMPLETE);
