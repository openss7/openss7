/*
 @(#) $RCSfile: MidCallReportType.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:49 $ <p>
...
/**
  * The class MidCallReportType indicates whether to report the event
  * when the SSF is in either the "monitoring state" only or in any
  * state.
  * @version 1.2.2
  * @author Monavacon Limited
  */
public class MidCallReportType {
    /** Internal integer value: IN_MONITORING_STATE.  */
    public static final int M_IN_MONITORING_STATE = 0;
    /** Internal integer value: IN_ANY_STATE.  */
    ...
    public static final MidCallReportType IN_MONITORING_STATE
        = new MidCallReportType(M_IN_MONITORING_STATE);
