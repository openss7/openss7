/*
 @(#) $RCSfile: ToneIDChoice.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:50 $ <p>
...
public class ToneIDChoice {
    ...
    /** ToneIDChoice  :LOCAL */
    public static final ToneIDChoice LOCAL
        = new ToneIDChoice(M_LOCAL);
    /** ToneIDChoice  :GLOBAL */
    public static final ToneIDChoice GLOBAL
        = new ToneIDChoice(M_GLOBAL);
