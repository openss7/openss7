/*
 @(#) $RCSfile: GapTreatmentChoice.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:48 $ <p>
...
public class GapTreatmentChoice {
    /** Internal integer value: INFORMATION_TO_SEND.  */
    ...
    public static final GapTreatmentChoice INFORMATION_TO_SEND
        = new GapTreatmentChoice(M_INFORMATION_TO_SEND);
    /** GapTreatmentChoice  :RELEASE_CAUSE */
    public static final GapTreatmentChoice RELEASE_CAUSE
        = new GapTreatmentChoice(M_RELEASE_CAUSE);
