/*
 @(#) $RCSfile: ControlType.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:47 $ <p>
...
/**
  * This class ControlType indicates the reason for activating call
  * gapping.
  * @version 1.2.2
  * @author Monavacon Limited
  */
public class ControlType {
    /** Internal integer value: SCP_OVERLOADED.  */
    public static final int M_SCP_OVERLOADED = 0;
    /** Internal integer value: MANUALLY_INITIATED.  */
    public static final int M_MANUALLY_INITIATED = 1;
    /** Internal integer value: DESTINATION_OVERLOAD.  */
    ...
    public static final ControlType SCP_OVERLOADED
        = new ControlType(M_SCP_OVERLOADED);
    /** ControlType :MANUALLY_INITIATED */
    public static final ControlType MANUALLY_INITIATED
        = new ControlType(M_MANUALLY_INITIATED);
