/*
 @(#) $RCSfile: ComponentType.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:47 $ <p>
...
/**
  * This class Component Type indicates the type of event that is
  * reported to the SSF.
  *
  * @version 1.2.2
...
public class ComponentType {
    ...
    /** Internal integer value: INVOKE.  */
    public static final int M_INVOKE = 1;
    /** Internal integer value: R_RESULT.  */
    public static final int M_R_RESULT = 2;
    /** Internal integer value: R_ERROR.  */
    public static final int M_R_ERROR = 3;
    /** Internal integer value: R_REJECT.  */
    public static final int M_R_REJECT = 4;
    /** Internal integer value: R_RESULT_NOT_LAST.  */
    ...
    public static final ComponentType ANY
        = new ComponentType(M_ANY);
    /** ComponentType : INVOKE */
    public static final ComponentType INVOKE
        = new ComponentType(M_INVOKE);
    /** ComponentType : R_RESULT */
    public static final ComponentType R_RESULT
        = new ComponentType(M_R_RESULT);
    /** ComponentType : R_ERROR */
    public static final ComponentType R_ERROR
        = new ComponentType(M_R_ERROR);
    /** ComponentType : R_REJECT */
    public static final ComponentType R_REJECT
        = new ComponentType(M_R_REJECT);
