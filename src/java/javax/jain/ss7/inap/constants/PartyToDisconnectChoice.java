/*
 @(#) $RCSfile: PartyToDisconnectChoice.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:49 $ <p>
...
public class PartyToDisconnectChoice {
    ...
    public static final PartyToDisconnectChoice LEG_ID
        = new PartyToDisconnectChoice(M_LEG_ID);
