/*
 @(#) $RCSfile: CollectedInfoChoice.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:47 $ <p>
...
public class CollectedInfoChoice {
    /** Internal integer value: collected digtis. */
    public static final int M_COLLECTED_DIGITS = 0;
    /** Internal integer value: IA5 information. */
    ...
    public static final CollectedInfoChoice COLLECTED_DIGITS
        = new CollectedInfoChoice(M_COLLECTED_DIGITS);
    /** CollectedInfoChoice : IA5INFORMATION */
    public static final CollectedInfoChoice IA5INFORMATION
        = new CollectedInfoChoice(M_IA5INFORMATION);
