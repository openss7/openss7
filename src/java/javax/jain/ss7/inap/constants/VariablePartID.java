/*
 @(#) $RCSfile: VariablePartID.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:50 $ <p>
...
public class VariablePartID {
    ...
    /** Private constructor for the constant class.
      * @param variablePartID
      * Integer value of constant class.  */
    private VariablePartID(int variablePartID) {
        this.variablePartID = variablePartID;
    }
    /** VariablePartID  :DATE */
    public static final VariablePartID DATE
        = new VariablePartID(M_DATE);
    /** VariablePartID  :TIME */
    public static final VariablePartID TIME
        = new VariablePartID(M_TIME);
    /** VariablePartID  :PRICE */
    public static final VariablePartID PRICE
        = new VariablePartID(M_PRICE);
