/*
 @(#) $RCSfile: TargetLineIdentifierChoice.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:50 $ <p>
...
public class TargetLineIdentifierChoice {
    /** Internal integer value: individual. */
    ...
    /** Private constructor for TargetLineIdentifierChoice constant
      * objects.
      * @param targetLineIdentifierChoice
      * The integer value of the constant class.
      */
    private TargetLineIdentifierChoice(int targetLineIdentifierChoice) {
        this.targetLineIdentifierChoice = targetLineIdentifierChoice;
    }
    /** TargetLineIdentifierChoice :INDIVIDUAL */
    public static final TargetLineIdentifierChoice INDIVIDUAL
        = new TargetLineIdentifierChoice(M_INDIVIDUAL);
