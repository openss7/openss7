/*
 @(#) $RCSfile: ForwardingCondition.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:48 $ <p>
...
/**
  * The class for Forwarding Condition indicates the condition that must
  * be met to complete the Connect operation.
  * @version 1.2.2
  * @author Monavacon Limited
  */
public class ForwardingCondition {
    /** Internal integer value: busy.  */
    public static final int M_BUSY = 0;
    /** Internal integer value: no answer.  */
    public static final int M_NO_ANSWER = 1;
    /** Internal integer value: any.  */
    ...
    public static final ForwardingCondition BUSY
        = new ForwardingCondition(M_BUSY);
    /** ForwardingCondition :N0_ANSWER */
    public static final ForwardingCondition NO_ANSWER
        = new ForwardingCondition(M_NO_ANSWER);
