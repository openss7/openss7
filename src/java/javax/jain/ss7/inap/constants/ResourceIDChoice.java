/*
 @(#) $RCSfile: ResourceIDChoice.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:49 $ <p>
...
public class ResourceIDChoice {
    /** Internal integer value: line ID. */
    public static final int M_LINE_ID = 0;
    /** Internal integer value: facility group ID. */
    public static final int M_FACILITY_GROUP_ID = 1;
    /** Internal integer value: facility group member ID. */
    public static final int M_FACILITY_GROUP_MEMBER_ID = 2;
    /** Internal integer value: trunk group ID. */
    ...
    public static final ResourceIDChoice LINE_ID
        = new ResourceIDChoice(M_LINE_ID);
    /** ResourceIDChoice  :FACILITY_GROUP_ID */
    public static final ResourceIDChoice FACILITY_GROUP_ID
        = new ResourceIDChoice(M_FACILITY_GROUP_ID);
    /** ResourceIDChoice  :FACILITY_GROUP_MEMBER_ID */
    public static final ResourceIDChoice FACILITY_GROUP_MEMBER_ID
        = new ResourceIDChoice(M_FACILITY_GROUP_MEMBER_ID);
    /** ResourceIDChoice  :TRUNK_GROUP_ID */
    public static final ResourceIDChoice TRUNK_GROUP_ID
        = new ResourceIDChoice(M_TRUNK_GROUP_ID);
