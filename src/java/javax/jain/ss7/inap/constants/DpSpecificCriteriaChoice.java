/*
 @(#) $RCSfile: DpSpecificCriteriaChoice.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:47 $ <p>
...
public class DpSpecificCriteriaChoice{
    /** Internal integer value: number of digits. */
    public static final int M_NUMBER_OF_DIGITS = 0;
    /** Internal integer value: application timer. */
    public static final int M_APPLICATION_TIMER = 1;
    /** Internal integer value: mid-call control information. */
    ...
    /** Private constructor for the constant class.
      * @param dpSpecificCriteriaChoice
    ...
    public static final DpSpecificCriteriaChoice NUMBER_OF_DIGITS
        = new DpSpecificCriteriaChoice(M_NUMBER_OF_DIGITS);
    /** DpSpecificCriteriaChoice : APPLICATION_TIMER */
    public static final DpSpecificCriteriaChoice APPLICATION_TIMER
        = new DpSpecificCriteriaChoice(M_APPLICATION_TIMER);
    /** DpSpecificCriteriaChoice : MID_CALL_CONTROL_INFO */
    public static final DpSpecificCriteriaChoice MID_CALL_CONTROL_INFO
        = new DpSpecificCriteriaChoice(M_MID_CALL_CONTROL_INFO );
