/*
 @(#) $RCSfile: MessageIDChoice.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:49 $ <p>
...
public class MessageIDChoice {
    /** Internal integer value: ELEMENTARY_MESSAGE_ID.  */
    public static final int M_ELEMENTARY_MESSAGE_ID = 0;
    /** Internal integer value: TEXT.  */
    public static final int M_TEXT = 1;
    /** Internal integer value: ELEMENTARY_MESSAGE_IDS.  */
    public static final int M_ELEMENTARY_MESSAGE_IDS = 29;
    /** Internal integer value: VARIABLE_MESSAGE.  */
    ...
    public static final MessageIDChoice ELEMENTARY_MESSAGE_ID
        = new MessageIDChoice(M_ELEMENTARY_MESSAGE_ID);
    /** MessageIDChoice :ATTRIBUTES */
    public static final MessageIDChoice TEXT
        = new MessageIDChoice(M_TEXT);
    /** MessageIDChoice :ELEMENTARY_MESSAGE_IDS */
    public static final MessageIDChoice ELEMENTARY_MESSAGE_IDS
        = new MessageIDChoice(M_ELEMENTARY_MESSAGE_IDS);
