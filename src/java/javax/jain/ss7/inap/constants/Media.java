/*
 @(#) $RCSfile: Media.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:49 $ <p>
...
/**
  ...
  */
public class Media {
    /** Internal integer value: voice mail. */
    public static final int M_VOICE_MAIL = 0;
    /** Internal integer value: fax group 3. */
    public static final int M_FAX_GROUP_3 = 1;
    /** Internal integer value: fax group 4. */
    ...
    /** Media : VOICE_MAIL */
    public static final Media VOICE_MAIL
        = new Media(M_VOICE_MAIL);
    /** Media : FAX_GROUP_3 */
    public static final Media FAX_GROUP_3
        = new Media(M_FAX_GROUP_3);
    /** Media : FAX_GROUP_4 */
