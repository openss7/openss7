/*
 @(#) $RCSfile: MessageType.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:49 $ <p>
...
public class MessageType {
    /** Internal integer value: request. */
    public static final int M_REQUEST = 0;
    /** Internal integer value: notification. */
    ...
    public static final MessageType REQUEST
        = new MessageType(M_REQUEST);
    /** MessageType :NOTIFICATION */
    public static final MessageType NOTIFICATION
        = new MessageType(M_NOTIFICATION);
