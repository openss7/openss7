/*
 @(#) $RCSfile: CGEncountered.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:47 $ <p>
...
/**
  * This class indicates the type of automatic call gapping encountered,
  * if any.
  * @version 1.2.2
  * @author Monavacon Limited
  */
public class CGEncountered {
    /** Internal integer value: NO_CG_ENCOUNTERED.  */
    public static final int M_NO_CG_ENCOUNTERED = 0;
    /** Internal integer value: MANUAL_CG_ENCOUNTERED.  */
    public static final int M_MANUAL_CG_ENCOUNTERED = 1;
    /** Internal integer value: SCP_OVERLOAD.  */
    public static final int M_SCP_OVERLOAD = 2;
    /** Private internal integer value for constant class. */
    ...
    public static final CGEncountered NO_CG_ENCOUNTERED
        = new CGEncountered(M_NO_CG_ENCOUNTERED);
    /** CGEncountered :MANUAL_CG_ENCOUNTERED */
    public static final CGEncountered MANUAL_CG_ENCOUNTERED
        = new CGEncountered(M_MANUAL_CG_ENCOUNTERED);
    /** CGEncountered :SCP_OVERLOAD */
    public static final CGEncountered SCP_OVERLOAD
        = new CGEncountered(M_SCP_OVERLOAD);
