/*
 @(#) $RCSfile: GeneralProblem.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:48 $ <p>
...
public class GeneralProblem {
    /** Internal integer value: unrecognized component. */
    public static final int M_UNRECOGNIZED_COMPONENT = 0;
    /** Internal integer value: mistyped component. */
    public static final int M_MISTYPED_COMPONENT = 1;
    /** Internal integer value: badly structured component. */
    ...
    public static final GeneralProblem UNRECOGNIZED_COMPONENT
        = new GeneralProblem(M_UNRECOGNIZED_COMPONENT);
    /** GeneralProblem :MISTYPED_COMPONENT */
    public static final GeneralProblem MISTYPED_COMPONENT
        = new GeneralProblem(M_MISTYPED_COMPONENT);
    /** GeneralProblem : BADLY_STRUCTURED_COMPONENT */
    public static final GeneralProblem BADLY_STRUCTURED_COMPONENT
        = new GeneralProblem( M_BADLY_STRUCTURED_COMPONENT);
