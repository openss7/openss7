/*
 @(#) $RCSfile: ActionPerformed.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:46 $ <p>
 ...
 Last Modified $Date: 2009-06-21 11:34:46 $ by $Author: brian $
 */
...
public class ActionPerformed {
    /** Internal integer value: ACTIVATED */
    public static final int M_ACTIVATED = 1;       
    /** Internal integer value: DEACTIVATED */
    public static final int M_DEACTIVATED = 2;
    /** Internal integer value: ALREADY_ACTIVE */
    public static final int M_ALREADY_ACTIVE = 3;
    /** Internal integer value: ALREADY_INACTIVE */
    public static final int M_ALREADY_INACTIVE = 4;
    /** Internal integer value: IS_ACTIVE */
    public static final int M_IS_ACTIVE = 5;
    /** Internal integer value: IS_INACTIVE */
    ...
    public static final ActionPerformed ACTIVATED
        = new ActionPerformed(M_ACTIVATED);
    /** ActionPerformed : DEACTIVATED */
    public static final ActionPerformed DEACTIVATED
        = new ActionPerformed(M_DEACTIVATED);
    /** ActionPerformed : ALREADY_ACTIVE */
    public static final ActionPerformed ALREADY_ACTIVE
        = new ActionPerformed(M_ALREADY_ACTIVE);
    /** ActionPerformed :ALREADY_INACTIVE */
    public static final ActionPerformed ALREADY_INACTIVE
        = new ActionPerformed(M_ALREADY_INACTIVE);
    /** ActionPerformed : IS_ACTIVE */
    public static final ActionPerformed IS_ACTIVE
        = new ActionPerformed(M_IS_ACTIVE);
