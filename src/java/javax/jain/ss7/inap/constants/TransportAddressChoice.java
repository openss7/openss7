/*
 @(#) $RCSfile: TransportAddressChoice.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:50 $ <p>
...
public class TransportAddressChoice {
    /** Internal integer value: IP address. */
    public static final int M_IP_ADDRESS = 0;
    /** Internal integer value: SCCP user address. */
    ...
    public static final TransportAddressChoice IP_ADDRESS
        = new TransportAddressChoice(M_IP_ADDRESS);
    /** TransportAddressChoice :SCCP_USER_ADDRESS */
    public static final TransportAddressChoice SCCP_USER_ADDRESS
        = new TransportAddressChoice(M_SCCP_USER_ADDRESS);
