/*
 @(#) $RCSfile: NumberMatchChoice.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:49 $ <p>
...
public class NumberMatchChoice {
    /** Internal integer value: initial match. */
    public static final int M_INITIAL_MATCH = 0;
    /** Internal integer value: total match. */
    ...
    public static final NumberMatchChoice INITIAL_MATCH
        = new NumberMatchChoice(M_INITIAL_MATCH );
    /** NumberMatchChoice :TOTAL_MATCH */
    public static final NumberMatchChoice TOTAL_MATCH
        = new NumberMatchChoice(M_TOTAL_MATCH );
