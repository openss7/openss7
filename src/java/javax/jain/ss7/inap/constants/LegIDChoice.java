/*
 @(#) $RCSfile: LegIDChoice.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:48 $ <p>
...
public class LegIDChoice {
    /** Internal integer value: SENDING_SIDE_ID. */
    public static final int M_SENDING_SIDE_ID = 0;
    /** Internal integer value: RECEIVING_SIDE_ID. */
    ...
    public static final LegIDChoice SENDING_SIDE_ID
        = new LegIDChoice(M_SENDING_SIDE_ID);
    /** LegIDChoice  :RECEIVING_SIDE_ID */
    public static final LegIDChoice  RECEIVING_SIDE_ID
        = new LegIDChoice(M_RECEIVING_SIDE_ID);
