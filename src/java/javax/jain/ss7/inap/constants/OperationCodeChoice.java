/*
 @(#) $RCSfile: OperationCodeChoice.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:49 $ <p>
...
public class OperationCodeChoice {
    /** Internal integer value: global. */
    public static final int M_GLOBAL_CODE = 0;
    /** Internal integer value: local. */
    ...
    public static final OperationCodeChoice GLOBAL_CODE
        = new OperationCodeChoice(M_GLOBAL_CODE);
    /** OperationCodeChoide :LOCAL */
    public static final OperationCodeChoice LOCAL
        = new OperationCodeChoice(M_LOCAL);
