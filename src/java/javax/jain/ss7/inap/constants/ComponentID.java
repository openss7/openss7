/*
 @(#) $RCSfile: ComponentID.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:47 $ <p>
...
/**
  * This class indicates the identity of the component
  * (componentInfo/relayedComponent).
  * @version 1.2.2
  * @author Monavacon Limited.
  */
public class ComponentID {
    /** Internal integer value: COMPONENT_INFO.  */
    public static final int M_COMPONENT_INFO = 0;
    /** Internal integer value: RELAYED_COMPONENT.  */
    ...
    public static final ComponentID COMPONENT_INFO
        = new ComponentID(M_COMPONENT_INFO);
