/*
 @(#) $RCSfile: BeginIndEvent.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:28:36 $ <p>
...
/**
  ...
  * indicate: <ul>
  *
  * <li>Operations in a TCAP TC_Begin Ind. </ul>
  *
...
public final class BeginIndEvent extends DialogueIndEvent {
    ...
    public BeginIndEvent(java.lang.Object source,
        ...
        super(source, originationAddress, callID, applicationContext,
                inapMessages, DialoguePrimitiveType.BEGIN);
    }
}
