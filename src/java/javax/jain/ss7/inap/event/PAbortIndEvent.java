...
<UL>
<LI> Operations in a TCAP TC_P_ABORT Ind
</UL> */
public final class PAbortIndEvent extends DialogueIndEvent
{

  private PAbortReason pAbortReason;
   

/**
Constructs a new PabortIndEvent .
*/
  public PAbortIndEvent(java.lang.Object source,TransportAddress originationAddress, int callID, byte[] applicationContext,PAbortReason pAbortReason) 
  {
  		super(source);
