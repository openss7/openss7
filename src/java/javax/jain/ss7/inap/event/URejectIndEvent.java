 ...
 *  File Name     : URejectIndEvent.java
...
/**
 This Class contains information related to the Reject Component being received
 */	
 
public class URejectIndEvent extends ComponentIndEvent
...
*/
	...
	public URejectIndEvent(Object source, int invokeID , RejectType rejecttype , int rejectcode) throws IllegalArgumentException
	{
		super(source);
		componentIndPrimitiveType=ComponentIndPrimitiveType.U_REJECT;
