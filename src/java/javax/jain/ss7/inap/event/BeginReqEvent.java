...
/** 
 This class represents the BeginReqEvent class. 
 This event will be passed from the Listener to the Provider to indicate:
<UL>
<LI> Operations in a TCAP TC_Begin Req
</UL> */
...
/**
Constructs a new BeginreqEvent .
*/
  public BeginReqEvent(java.lang.Object source,TransportAddress destinationAddress, int callID, byte[] applicationContext,Vector inapMessages)
  {
  		super(source);
