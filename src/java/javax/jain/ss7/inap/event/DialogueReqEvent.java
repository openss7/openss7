/*
 @(#) $RCSfile: DialogueReqEvent.java,v $ $Name:  $($Revision: 1.1.2.3 $) $Date: 2011-01-12 03:23:45 $ <p>
...
/**
  * This Class is the Super class of all Dialogue Request Events
  * Classes.
  *
  * @version 1.2.2
  * @author Monavacon Limited
  */
public class DialogueReqEvent extends DialogueEvent {
    /** Constructs a new DialogueReqEvent.  */
    public DialogueReqEvent(java.lang.Object source) {
        super(source);
    }
    /** Constructs a new DialogueReqEvent with primitive type.  */
    protected DialogueReqEvent(java.lang.Object source, DialoguePrimitiveType dialoguePrimitiveType) {
        super(source, dialoguePrimitiveType);
    }
    /** Protected constructor with all fields. */
    protected DialogueReqEvent(java.lang.Object source,
            TransportAddress destinationAddress,
            int callID, byte[] applicationContext,
            DialoguePrimitiveType dialoguePrimitiveType) {
        super(source, destinationAddress, callID, applicationContext, dialoguePrimitiveType);
    }
    ...
    protected DialogueReqEvent(java.lang.Object source,
            ...
            DialoguePrimitiveType dialoguePrimitiveType) {
        super(source, destinationAddress, callID, applicationContext, inapMessages, dialoguePrimitiveType);
    }
    ...
    public void setDestinationAddress(TransportAddress destinationAddress) {
        super.setTransportAddress(destinationAddress);
    }
}
