...
<UL>
<LI> Operations in a TCAP TC_U_ABORT Ind
</UL> */
...
*/
  public UAbortIndEvent(java.lang.Object source,TransportAddress originationAddress, int callID, byte[] applicationContext,UAbortReason abortReason) throws IllegalArgumentException
  {
  		super(source);
