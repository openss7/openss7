...
<UL>
<LI> Operations , Return Results , Return Errors , Rejects , Cancel in a TCAP TC_CONTINUE Ind
</UL> */
...
*/
  public ContinueIndEvent(java.lang.Object source,TransportAddress originationAddress, int callID, byte[] applicationContext,Vector inapMessages)
  {
  		super(source);
		dialoguePrimitiveType= DialoguePrimitiveType.CONTINUE;
