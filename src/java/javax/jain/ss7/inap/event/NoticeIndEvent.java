...
<UL>
<LI> Operations in a TCAP TC_NOTICE Ind
</UL> */
...
*/
  public NoticeIndEvent(java.lang.Object source,TransportAddress originationAddress, int callID, byte[] applicationContext,ReportCause reportCause) throws IllegalArgumentException

  {
  		super(source);
		dialoguePrimitiveType= DialoguePrimitiveType.NOTICE;
