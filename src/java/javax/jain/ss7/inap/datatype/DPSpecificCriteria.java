/*
 @(#) $RCSfile: DPSpecificCriteria.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:53 $ <p>
...
public class DPSpecificCriteria implements java.io.Serializable {
    ...
    public DPSpecificCriteria(int criteriaValue,DpSpecificCriteriaChoice dPSpecificCriteriaChoice ) throws IllegalArgumentException {
        ...
        else if (dPSpecificCriteriaChoice == DpSpecificCriteriaChoice.APPLICATION_TIMER)
    ...
    public int getNumberOfDigits()
        ...
        throw new ParameterNotSetException("Number of Digits: not set.");
    }
    /** Sets Number of Digits.  */
    public void setNumberOfDigits(int numberOfDigits)
        throws IllegalArgumentException {
        if(1 <= numberOfDigits && numberOfDigits <= 255) {
            this.numberOfDigits = numberOfDigits;
            dPSpecificCriteriaChoice = DpSpecificCriteriaChoice.NUMBER_OF_DIGITS; 
            return;
        }
        throw new IllegalArgumentException("Number of Digits: " + numberOfDigits + ", out of range.");
    }
    ...
    public int getApplicationTimer()
        ...
        throw new ParameterNotSetException("Application Timer: not set.");
    }
    /** Sets Application Timer.  */
    public void setApplicationTimer(int applicationTimer)
        throws IllegalArgumentException {
        if (0 <= applicationTimer && applicationTimer <= 2047) { 
            this.applicationTimer = applicationTimer;
            dPSpecificCriteriaChoice = DpSpecificCriteriaChoice.APPLICATION_TIMER;
            return;
        }
        throw new IllegalArgumentException("Application Timer: " + applicationTimer + ", out of range.");
    }
    ...
    public MidCallControlInfo getMidCallControlInfo()
        ...
        throw new ParameterNotSetException("Mid-Call Control Info: not set.");
    }
