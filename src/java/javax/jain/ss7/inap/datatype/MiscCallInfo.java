/*
 @(#) $RCSfile: MiscCallInfo.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:54 $ <p>
...
public class MiscCallInfo implements java.io.Serializable {
    ...
    /** Gets Message Type.  This parameter gets the category of
      * instruction issued to the SCF <ul>
      * <li>REQUEST
      * <li>NOTIFICATION </ul> */
    ...
    /** Gets Detection Point Assignment.  Request for instructions has
      * been issued to the SCF.This gets the category for the trigger
      * (line, group, office). <ul>
      * <li>INDIVIDUAL_LINE
      * <li>GROUP_BASED
      * <li>OFFICE_BASED </ul> */
    public DPAssignment getDpAssignment()
        throws ParameterNotSetException {
        if (isDpAssignment)
            return dPAssignment;
        throw new ParameterNotSetException("DP Assignment: not set.");
    }
    /** Sets Detection Point Assignment.  */
    public void setDpAssignment (DPAssignment dpAssignment) {
        this.dPAssignment = dPAssignment;
        this.isDpAssignment = true;
    }
