/*
 @(#) $RCSfile: MidCallInfoType.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:54 $ <p>
...
public class MidCallInfoType implements java.io.Serializable {
    ...
    public DigitsGenericDigits getINServiceControlCodeHigh()
        throws ParameterNotSetException {
        if (isINServiceControlCodeHigh)
            return iNServiceControlCodeHigh;
        throw new ParameterNotSetException("IN Service Control Code High: not set.");
    }
    ...
    public void setINServiceControlCodeHigh(DigitsGenericDigits iNServiceControlCodeHigh) {
        ...
        this.isINServiceControlCodeHigh = true;
    }
