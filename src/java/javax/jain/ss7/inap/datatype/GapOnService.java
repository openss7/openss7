/*
 @(#) $RCSfile: GapOnService.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:53 $ <p>
...
public class GapOnService implements java.io.Serializable {
    ...
    public GapOnService(int serviceKey)
    ...
    /** Gets Dp Criteria.  */
    public int  getDpCriteria()
        throws ParameterNotSetException {
        if (isDpCriteria)
            return dpCriteria;
        throw new ParameterNotSetException("DP Criteria: not set.");
    }
    /** Sets Dp Criteria.  */
    public void setDpCriteria(int dpCriteria) {
        this.dpCriteria = dpCriteria;
        this.isDpCriteria = true; 
    }
