/*
 @(#) $RCSfile: HighLayerCompatibility.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:54 $ <p>
 ...
 Last Modified $Date: 2009-06-21 11:34:54 $ by $Author: brian $
 */
...
/** This Class defines the High layer Compatibitilty Format (encoded as
  * in Q.931).
  * @version 1.2.2
...
public class HighLayerCompatibility implements java.io.Serializable {
    ...
    public HighLayerCompatibility(int codingStandard,
            int interpretation, int presentationMethodOfProtocolProfile,
            java.lang.String highLayerCharacteristicsIdentification) {
    ...
    public java.lang.String getExtendedHighLayerCharacteristicsIdentification() throws ParameterNotSetException {
        if(isExtendedHighLayerCharacteristicsIdentification)
            return extendedHighLayerCharacteristicsIdentification;
        throw new ParameterNotSetException("Extended High Layer Characteristics Id: not set.");
    }
    ...
    /** Indicates if the Extended High Layer Characteristics Identification
    ...
    private java.lang.String highLayerCharacteristicsIdentification;
    private java.lang.String extendedHighLayerCharacteristicsIdentification;
