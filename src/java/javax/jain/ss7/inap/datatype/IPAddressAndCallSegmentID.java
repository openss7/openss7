/*
 @(#) $RCSfile: IPAddressAndCallSegmentID.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:54 $ <p>
...
public class IPAddressAndCallSegmentID implements java.io.Serializable {
    /** Constructor For IPAddressAndCallSegmentID.  */
    public IPAddressAndCallSegmentID(CalledPartyNumber iPRoutingAddress, int callSegmentID) {
        setIPRoutingAddress(iPRoutingAddress);
        setCallSegment(callSegmentID);
    }
