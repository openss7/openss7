/*
 @(#) $RCSfile: RedirectingPartyID.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:55 $ <p>
...
/** This Class defines the RedirectingPartyID datatype (encoded as
  * Redirecting Number in Q.763).
  * @version 1.2.2
  * @author Monavacon Limited
  */
public class RedirectingPartyID implements java.io.Serializable {
    /** Constructor For RedirectingPartyID.  */
    public RedirectingPartyID(int natureOfAddressIndicator,
            int numberingPlanIndicator,
            int addressPresentationRestrictedIndicator,
            java.lang.String addressSignal) {
