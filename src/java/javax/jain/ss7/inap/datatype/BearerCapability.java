/*
 @(#) $RCSfile: BearerCapability.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:51 $ <p>
...
/** This Class defines the BearerCapability Datatype.
  ...
  */
public class BearerCapability implements java.io.Serializable {
    ...
    public BearerCap getBearerCap()
        ...
        if (bearerCapabilityChoice == BearerCapabilityChoice.BEARER_CAP)
            return bearerCap;
        throw new ParameterNotSetException("Bearer Capbility: not set.");
    }
    /** Sets Bearer Cap.  */
    public void setBearerCap(BearerCap bearercap) {
        this.bearerCap = bearercap;
        this.bearerCapabilityChoice = BearerCapabilityChoice.BEARER_CAP;
    }
    /** Gets Transmission Medium Requirement.  */
    public byte getTmr()
        throws ParameterNotSetException {
         if (bearerCapabilityChoice == BearerCapabilityChoice.TMR)
             return tmr;
         throw new ParameterNotSetException("Transmission Medium Requirement: not set.");
    }
    /** Sets Transmission Medium Requirement.  */
    public void setTmr(byte tmr) {
        this.tmr = tmr;
        this.bearerCapabilityChoice = BearerCapabilityChoice.TMR;
    }
