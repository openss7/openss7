/*
 @(#) $RCSfile: CollectedInfo.java,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2009-07-13 07:13:29 $ <p>
...
/** This class defines the CollectedInfo Datatype.
  ...
  */
public class CollectedInfo implements java.io.Serializable {
    ...
    public CollectedDigits getCollectedDigits() throws ParameterNotSetException {
        if (collectedInfoChoice ==CollectedInfoChoice.COLLECTED_DIGITS)
            return collectedDigits;
        throw new ParameterNotSetException("Collected Digits: not set.");
    }
    /** Sets Collected Digits.  */
    public void setCollectedDigits(CollectedDigits collectedDigits) {
        this.collectedDigits = collectedDigits;
        this.collectedInfoChoice = CollectedInfoChoice.COLLECTED_DIGITS;  
    }
    /** Gets IA5Information .  */
    public boolean getIA5Information()
        throws ParameterNotSetException {
        if (collectedInfoChoice == CollectedInfoChoice.IA5INFORMATION)
            return isIA5Information;
        throw new ParameterNotSetException("IA5 Information: not set.");
    }
    /** Sets IA5Information .  */
    public void setIA5Information(boolean iA5Information) {
        this.isIA5Information = iA5Information;
        this.collectedInfoChoice = CollectedInfoChoice.IA5INFORMATION;
    }
