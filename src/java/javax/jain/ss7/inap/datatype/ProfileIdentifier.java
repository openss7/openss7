/*
 @(#) $RCSfile: ProfileIdentifier.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:55 $ <p>
...
/** This class defines the ProfileIdentifier Datatype.
  ...
  */
public class ProfileIdentifier implements java.io.Serializable {
    ...
    public CalledPartyNumber getAccess()
        ...
        if (profileIdentifierChoice == ProfileIdentifierChoice.ACCESS)
            return access;
        throw new ParameterNotSetException("Access: not set.");
    }
    /** Sets Access.  */
    public void setAccess(CalledPartyNumber access) {
        this.access = access;
        this.profileIdentifierChoice = ProfileIdentifierChoice.ACCESS;
    }
    /** Gets Group.  */
    public FacilityGroup getGroup()
        throws ParameterNotSetException {
        if (profileIdentifierChoice == ProfileIdentifierChoice.GROUP)
            return group;
        throw new ParameterNotSetException("Group: not set.");
    }
    /** Sets Group.  */
    public void setGroup(FacilityGroup group) {
        this.group = group;
        this.profileIdentifierChoice = ProfileIdentifierChoice.GROUP;
    }
