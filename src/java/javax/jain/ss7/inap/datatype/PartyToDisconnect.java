/*
 @(#) $RCSfile: PartyToDisconnect.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:54 $ <p>
...
public class PartyToDisconnect implements java.io.Serializable {
    ...
    public LegID getLegID()
        ...
        if (partyToDisconnectChoice == PartyToDisconnectChoice.LEG_ID)
            return legID;
    ...
    public void setLegID(LegID legID) {
        this.legID = legID;
        this.partyToDisconnectChoice = PartyToDisconnectChoice.LEG_ID;
    }
    /** Gets the Call Segment ID.  */
    public int getCallSegmentID()
        throws ParameterNotSetException {
        if (partyToDisconnectChoice == PartyToDisconnectChoice.CALL_SEGMENT_ID)
    ...
    public void setCallSegmentID(int callSegmentID) {
        ...
        this.partyToDisconnectChoice = PartyToDisconnectChoice.CALL_SEGMENT_ID;
    }
    private LegID legID;
