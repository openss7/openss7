/*
 @(#) $RCSfile: MidCallSpecificInfo.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:54 $ <p>
...
/** This class defines the MidCallSpecificInfo DataType.
  ...
  */
public class MidCallSpecificInfo implements java.io.Serializable {
    /** Gets Connect Time.  */
    ...
    /** Gets Mid Call Info.  */
    public DigitsGenericDigits getOMidCallInfo()
        throws ParameterNotSetException {
        if (isOMidCallInfo)
            return oMidCallInfo;
        throw new ParameterNotSetException("OBSCM Mid-Call Info: not set.");
    }
    /** Sets Mid Call Info.  */
    public void setOMidCallInfo(DigitsGenericDigits oMidCallInfo) {
        this.oMidCallInfo = oMidCallInfo;
        this.isOMidCallInfo = true;
    }
