/*
 @(#) $RCSfile: RedirectionInformation.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:55 $ <p>
...
/** This Class defines the RedirectionInformation datatype (encoded as
  * in Q.763).
  * @version 1.2.2
...
public class RedirectionInformation implements java.io.Serializable {
    ...
    public RedirectionInformation(int redirectingIndicator,
            int originalRedirectionReason, int redirectionCounter,
