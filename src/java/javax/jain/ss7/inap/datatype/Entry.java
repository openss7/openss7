/*
 @(#) $RCSfile: Entry.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:53 $ <p>
...
public class Entry implements java.io.Serializable {
    ...
    public int[] getAgreements()
        ...
        if (entryChoice.getEntryChoice() == EntryChoice.AGREEMENTS.getEntryChoice())
            return agreements;
        throw new ParameterNotSetException("Agreements: not set.");
    }
    ...
    public int getNetworkSpecific()
        throws ParameterNotSetException {
        if (entryChoice.getEntryChoice() == EntryChoice.NETWORK_SPECIFIC.getEntryChoice())
            return networkSpecific ;
        throw new ParameterNotSetException("Network Specific Parameter: not set.");
    }
