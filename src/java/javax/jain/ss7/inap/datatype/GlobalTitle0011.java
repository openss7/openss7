/*
 @(#) $RCSfile: GlobalTitle0011.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:54 $ <p>
...
/** This Class defines the Global Title 0011 datatype (encoded as in
  * Q.713).
  * @version 1.2.2
...
public class GlobalTitle0011 extends GlobalTitle implements java.io.Serializable {
    ...
    public GlobalTitle0011(int translationType, int numberingPlan,
            int encodingScheme, int globalTitleIndicator,
