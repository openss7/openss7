/*
 @(#) $RCSfile: CSFailure.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:51 $ <p>
...
/** This class defines the CSFailure Datatype.
  * @version 1.2.2
  * @author Monavacon Limited
  */
public class CSFailure implements java.io.Serializable {
    /** Constructor For CSFailure.  */
    public CSFailure(int callSegmentID) {
    ...
    public java.lang.String getReason()
        ...
        if (isReason)
            return reason;
        throw new ParameterNotSetException("Reason: not set.");
    }
    /** Sets Reason.  */
