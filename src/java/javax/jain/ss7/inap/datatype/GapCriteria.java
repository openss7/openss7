/*
 @(#) $RCSfile: GapCriteria.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:53 $ <p>
...
public class GapCriteria implements java.io.Serializable {
    ...
    public DigitsGenericNumber getCalledAddressValue()
        ...
        if (gapCriteriaChoice == GapCriteriaChoice.CALLED_ADDRESS_VALUE)
            return calledAddressValue;
        throw new ParameterNotSetException("Called Address: not set.");
    }
    ...
    public GapOnService getGapOnService()
        throws ParameterNotSetException {
        if (gapCriteriaChoice == GapCriteriaChoice.GAP_ON_SERVICE)
            return gapOnService;
        throw new ParameterNotSetException("Gap On Service: not set.");
    }
    /** Sets Gap On Service.  */
    ...
    public int getGapAllInTraffic()
        throws ParameterNotSetException {
        if (gapCriteriaChoice == GapCriteriaChoice.GAP_ALL_IN_TRAFFIC)
            return gapAllInTraffic;
        throw new ParameterNotSetException("Gap All In Traffic: not set.");
    }
    ...
    public CalledAddressAndService getCalledAddressAndService()
        throws ParameterNotSetException {
        if (gapCriteriaChoice == GapCriteriaChoice.CALLED_ADDRESS_AND_SERVICE)
    ...
    public void setCalledAddressAndService(CalledAddressAndService calledAddressAndService) {
        ...
        this.gapCriteriaChoice = GapCriteriaChoice.CALLED_ADDRESS_AND_SERVICE;
    }
    /** Gets Calling Address and Service Value.  */
    public CallingAddressAndService getCallingAddressAndService()
        throws ParameterNotSetException {
        if (gapCriteriaChoice == GapCriteriaChoice.CALLING_ADDRESS_AND_SERVICE)
            return callingAddressAndService;
        throw new ParameterNotSetException("Calling Address and Service: not set.");
    }
    ...
    public void setCallingAddressAndService(CallingAddressAndService callingAddressAndService) {
        ...
        this.gapCriteriaChoice = GapCriteriaChoice.CALLING_ADDRESS_AND_SERVICE;
    }
