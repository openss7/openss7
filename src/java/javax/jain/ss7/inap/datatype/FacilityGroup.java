/*
 @(#) $RCSfile: FacilityGroup.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:53 $ <p>
...
public class FacilityGroup implements java.io.Serializable {
    ...
    public FacilityGroup(FacilityGroupID groupID, FacilityGroupID facilityGroupID) {
        if (groupID == FacilityGroupID.PRIVATE_FACILITY)
            setPrivateFacilityID(facilityGroupID.getFacilityGroupID());
        else if (groupID == FacilityGroupID.TRUNK_GROUP)
    ...
    public FacilityGroup(FacilityGroupID groupID, java.lang.String facilityGroupID) {
        if (groupID == FacilityGroupID.HUNT_GROUP)
            setHuntGroup(facilityGroupID);
        else if (groupID == FacilityGroupID.ROUTE_INDEX)
    ...
    public int getTrunkGroupID() throws ParameterNotSetException {
        if (facilityGroupChoice == FacilityGroupChoice.TRUNK_GROUP_ID)
            return trunkGroupID;
    ...
    public void  setTrunkGroupID (int trunkGroupID) {
        ...
        this.facilityGroupChoice =FacilityGroupChoice.TRUNK_GROUP_ID;
    }
    /** Gets Private Facility ID.  */
    public int getPrivateFacilityID()
        throws ParameterNotSetException {
        if (facilityGroupChoice ==FacilityGroupChoice.PRIVATE_FACILITY_ID)
            return privateFacilityID;
        throw new ParameterNotSetException("Private Facility Id: not set.");
    }
    /** Sets Private Facility ID.  */
    public void  setPrivateFacilityID (int privateFacilityID) {
        this.privateFacilityID = privateFacilityID;
        this.facilityGroupChoice = FacilityGroupChoice.PRIVATE_FACILITY_ID;
    }
    /** Gets Hunt Group.  */
    public java.lang.String getHuntGroup()
        throws ParameterNotSetException {
        if (facilityGroupChoice == FacilityGroupChoice.HUNT_GROUP)
            return huntGroup;
        throw new ParameterNotSetException("Hunt Group: not set.");
    }
    /** Sets Hunt Group.  */
    ...
    /** Gets Route Index.  */
    public java.lang.String getRouteIndex()
        throws ParameterNotSetException {
        if (facilityGroupChoice == FacilityGroupChoice.ROUTE_INDEX)
            return routeIndex;
    ...
    private java.lang.String huntGroup;
    private java.lang.String routeIndex;
