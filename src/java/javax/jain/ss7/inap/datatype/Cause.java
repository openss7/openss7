/*
 @(#) $RCSfile: Cause.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:52 $ <p>
...
public class Cause implements java.io.Serializable {
    ...
    /** Sets Cause Value.  */
    public void setCauseValue(java.lang.String causeValue) {
    ...
    public java.lang.String getDiagnostics() throws ParameterNotSetException {
        if (isDiagnostics)
            return diagnostics;
        throw new ParameterNotSetException("Diagnostics: not set.");
    }
    /** Sets Dignostics.  */
