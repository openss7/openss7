/*
 @(#) $RCSfile: BothGapTreatmentParameters.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:51 $ <p>
...
public class BothGapTreatmentParameters implements java.io.Serializable {
    ...
    public BothGapTreatmentParameters(InformationToSend informationToSend, Cause releaseCause) {
