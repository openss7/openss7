/*
 @(#) $RCSfile: ForwardServiceInteractionInd.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:53 $ <p>
 ...
 Last Modified $Date: 2009-06-21 11:34:53 $ by $Author: brian $
 */
...
public class ForwardServiceInteractionInd implements java.io.Serializable {
    ...
    public java.lang.String getConferenceTreatmentIndicator() throws ParameterNotSetException {
        if (isConferenceTreatmentIndicator)
            return conferenceTreatmentIndicator;
        throw new ParameterNotSetException("Conference Treatment Indicator: not set.");
    }
    ...
    public void setConferenceTreatmentIndicator(java.lang.String conferenceTreatmentIndicator) {
        ...
        this.isConferenceTreatmentIndicator = true;
    }
    /** Indicates if the Conference Treatment Indicator optional
    ...
    public java.lang.String getCallDiversionTreatmentIndicator()
        throws ParameterNotSetException {
        if (isCallDiversionTreatmentIndicator)
            return callDiversionTreatmentIndicator;
        throw new ParameterNotSetException("Call Diversion Treatment Indicator: not set.");
    }
    ...
    public void setCallDiversionTreatmentIndicator(java.lang.String callDiversionTreatmentIndicator) {
        ...
        this.isCallDiversionTreatmentIndicator = true;
    }
    /** Indicates if the Call Diversion Treatment Indicator optional
      * parameter is present.
      * @return
      * True when present, false otherwise.  */
    ...
    public java.lang.String getCallOfferingTreatmentIndicator()
        throws ParameterNotSetException {
        if (isCallOfferingTreatmentIndicator)
            return callOfferingTreatmentIndicator;
        throw new ParameterNotSetException("Call Offering Treatment Indicator: not set.");
    }
    ...
    public void setCallOfferingTreatmentIndicator(java.lang.String callOfferingTreatmentIndicator) {
        ...
        this.isCallOfferingTreatmentIndicator = true;
    }
    /** Indicates if the Call Offering Treatment Indicator optional
      * parameter is present.
      * @return
      * True when present, false otherwise.  */
    ...
    private java.lang.String callDiversionTreatmentIndicator;
    private boolean isCallDiversionTreatmentIndicator = false ;
    private java.lang.String callOfferingTreatmentIndicator;
