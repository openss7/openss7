/*
 @(#) $RCSfile: InformationToSend.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:54 $ <p>
...
public class InformationToSend implements java.io.Serializable {
    ...
    public InbandInfo getInbandInfo()
        ...
        if (informationToSendChoice == InformationToSendChoice.INBAND_INFO)
            return inbandInfo;
    ...
    public Tone getTone()
        throws ParameterNotSetException {
        if (informationToSendChoice == InformationToSendChoice.TONE)
            return tone;
        throw new ParameterNotSetException();
    }
    /** Sets Tone Details.  */
    ...
    public java.lang.String getDisplayInformation()
        throws ParameterNotSetException {
        if (informationToSendChoice == InformationToSendChoice.DISPLAY_INFORMATION)
