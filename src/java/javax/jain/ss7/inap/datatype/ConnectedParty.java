/*
 @(#) $RCSfile: ConnectedParty.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:52 $ <p>
...
public class ConnectedParty implements java.io.Serializable {
    ...
    public LegID getLegID() throws ParameterNotSetException {
        if (connectedPartyChoice == ConnectedPartyChoice.LEG_ID)
            return legID;
    ...
    public void setLegID(LegID legID) {
        this.legID = legID;
        this.connectedPartyChoice = ConnectedPartyChoice.LEG_ID;
    }
    /** Gets Call Segment ID.  */
    public int getCallSegmentID()
        throws ParameterNotSetException {
        if (connectedPartyChoice == ConnectedPartyChoice.CALL_SEGMENT_ID)
    ...
    public void setCallSegmentID(int callSegmentID) {
        ...
        this.connectedPartyChoice = ConnectedPartyChoice.CALL_SEGMENT_ID;
    }
    private LegID legID;
