/*
 @(#) $RCSfile: TransportAddress.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:55 $ <p>
...
public class TransportAddress implements java.io.Serializable {
    ...
    /** Constructor For TransportAddress.  */
    public TransportAddress(java.net.InetAddress ipAddress) {
    ...
    public SccpUserAddress getSccpUserAddress()
        ...
        if (transportAddressChoice == TransportAddressChoice.SCCP_USER_ADDRESS)
            return sccpUserAddress;
        throw new ParameterNotSetException("SCCP User Address: not set.");
    }
    ...
    public java.net.InetAddress getIPAddress()
        throws ParameterNotSetException {
        if (transportAddressChoice == TransportAddressChoice.IP_ADDRESS)
            return ipAddress;
        throw new ParameterNotSetException("IP Address: not set.");
    }
    /** Sets IP Address.  */
