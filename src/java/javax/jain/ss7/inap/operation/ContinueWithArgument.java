/*
 @(#) $RCSfile: ContinueWithArgument.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:59 $ <p>
...
public class ContinueWithArgument extends Operation implements java.io.Serializable
{
    ...
    public java.lang.String getGenericName() throws ParameterNotSetException {
        if (isGenericName)
            return genericName;
        throw new ParameterNotSetException("Generic Name: not set.");
    }
    /** Sets Generic Name.  */
    public void setGenericName(java.lang.String genericName) {
        this.genericName = genericName;
        this.isGenericName = true;
    }
