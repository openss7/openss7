/*
 @(#) $RCSfile: OAnswer.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:00 $ <p>
...
public class OAnswer extends Operation implements java.io.Serializable {
    ...
    public CallingPartySubaddress getCallingPartySubaddress() throws ParameterNotSetException {
        ...
        throw new ParameterNotSetException("Calling Party Subadddress: not set.");
    }
    ...
    public RedirectingPartyID getRedirectingPartyID() throws ParameterNotSetException {
        ...
        throw new ParameterNotSetException("Redirection Party Id: not set.");
    }
