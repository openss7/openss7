/*
 @(#) $RCSfile: MoveCallSegments.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:59 $ <p>
...
/** This class represents the MoveCallSegments Operation.
  ...
  */
public class MoveCallSegments extends Operation implements java.io.Serializable {
    /** Constructor For MoveCallSegments.  */
    public MoveCallSegments(int targetCallSegmentAssociation, CallSegment callSegments[], Leg legs[]) {
