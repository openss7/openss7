/*
 @(#) $RCSfile: Connect.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:58 $ <p>
...
public class Connect   extends Operation implements java.io.Serializable {
    ...
    public int getCutAndPaste() throws ParameterNotSetException {
        if (isCutAndPaste)
            return cutAndPaste;
        throw new ParameterNotSetException("Cut and Paste: not set.");
    }
    /** Sets Cut And Paste parameter.  */
    public void setCutAndPaste(int cutAndPaste) throws IllegalArgumentException {
        if (0 <= cutAndPaste && cutAndPaste <= 22) {
            this.cutAndPaste = cutAndPaste;
            this.isCutAndPaste = true;
            return;
        }
        throw new IllegalArgumentException("Cut and Paste: " + cutAndPaste + ", out of range.");
    }
    ...
    /** Gets Forwarding Condition.  This parameter gets the condition that
      * has been met to complete the Connect. <ul>
      * <li>BUSY
      * <li>NO_ANSWER
      * <li>ANY </ul> */
    public ForwardingCondition getForwardingCondition() throws ParameterNotSetException {
        if (isForwardingCondition)
            return forwardingCondition;
        throw new ParameterNotSetException("Forwarding Condition: not set.");
    }
    ...
    public void setForwardingCondition(ForwardingCondition forwardingCondition) {
        ...
        this.isForwardingCondition = true;
    }
    ...
    public java.lang.String getISDNAccessRelatedInformation() throws ParameterNotSetException {
        ...
        throw new ParameterNotSetException("ISDN Access Related Info: not set.");
    }
    ...
    public java.lang.String getServiceInteractionIndicators() throws ParameterNotSetException {
        ...
        throw new ParameterNotSetException("Service Interactoin Indicators: not set.");
    }
    ...
    public void setCallingPartyCategory(java.lang.String callingPartyCategory) {
        ...
        this.isCallingPartyCategory = true;
    }
    ...
    public RedirectionInformation getRedirectionInformation() throws ParameterNotSetException {
        ...
        throw new ParameterNotSetException("Redirection Info: not set.");
    }
    ...
    public java.lang.String getDisplayInformation() throws ParameterNotSetException {
        ...
        throw new ParameterNotSetException("Display Info: not set.");
    }
    ...
    public LegID getLegToBeCreated() throws ParameterNotSetException {
        ...
        throw new ParameterNotSetException("Let to be Created: not set.");
    }
