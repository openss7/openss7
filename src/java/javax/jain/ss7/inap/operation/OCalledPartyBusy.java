/*
 @(#) $RCSfile: OCalledPartyBusy.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:00 $ <p>
...
/** This class represents the OCalledPartyBusy Operation.
  * @version 1.2.2
  * @author Monavacon Limited
  */
public class OCalledPartyBusy extends Operation implements java.io.Serializable {
    /** Constructor For OCalledPartyBusy.  */
    public OCalledPartyBusy(DPSpecificCommonParameters dPSpecificCommonParameters) {
        operationCode = OperationCode. O_CALLED_PARTY_BUSY;
    ...
    /** Indicates if the Gets Calling Facility Group  optional parameter is present.
      * @return True when present, false otherwise.  */
