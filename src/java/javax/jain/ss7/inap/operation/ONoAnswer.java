...
public class ONoAnswer  extends Operation   implements Serializable
{
...
/**
Constructor For ONoAnswer
*/
	public ONoAnswer(DPSpecificCommonParameters dPSpecificCommonParameters)
	{
		operationCode = OperationCode.O_NO_ANSWER;
