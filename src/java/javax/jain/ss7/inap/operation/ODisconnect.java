/*
 @(#) $RCSfile: ODisconnect.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:00 $ <p>
...
public class ODisconnect extends Operation implements java.io.Serializable {
    ...
    public void setCallingFacilityGroupMember(int callingFacilityGroupMember) throws IllegalArgumentException {
        if (0 <= callingFacilityGroupMember && callingFacilityGroupMember <= 2147483647) {
            this.callingFacilityGroupMember = callingFacilityGroupMember;
            this.isCallingFacilityGroupMember = true;
            return;
        }
        throw new IllegalArgumentException("Calling Facility Group Member: " + callingFacilityGroupMember + ", out of range.");
    }
    ...
    public void setConnectTime(int connectTime) throws IllegalArgumentException {
        if (0 <= connectTime && connectTime <= 2147483647) {
            this.connectTime = connectTime;
            this.isConnectTime = true;
            return;
        }
        throw new IllegalArgumentException("Connect Time: " + connectTime + ", out of range.");
    }
    ...
    public int getComponentCorrelationID() throws ParameterNotSetException {
        ...
        throw new ParameterNotSetException("Component Correpation Id: not set.");
    }
    ...
    public void setComponentCorrelationID(int componentCorrelationID) throws IllegalArgumentException {
        if (0 <= componentCorrelationID && componentCorrelationID <= 2147483647) {
            this.componentCorrelationID = componentCorrelationID;
            this.isComponentCorrelationID = true;
            return;
        }
        throw new IllegalArgumentException("Component Correlation Id: " + componentCorrelationID + ", out of range.");
    }
