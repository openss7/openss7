/*
 @(#) $RCSfile: CallInformationReport.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:58 $ <p>
...
/** This class represents the CallInformationReport Operation.
  * @version 1.2.2
  * @author Monavacon Limited
  */
public class CallInformationReport   extends Operation  implements java.io.Serializable
{
    /** Constructors For CallInformationReport.  */
    public CallInformationReport(RequestedInformationList requestedInformationList) {
        operationCode = OperationCode.CALL_INFORMATION_REPORT;
        setRequestedInformationList(requestedInformationList);
    }
    /** Gets Operation Code.  */
    public OperationCode getOperationCode() {
        return operationCode;
    }
    /** Gets Requested Information List.  */
    public RequestedInformationList getRequestedInformationList() {
        return requestedInformationList;
    }
    /** Sets Requested Information List.  */
    public void setRequestedInformationList(RequestedInformationList requestedInformationList) {
    ...
    /** Gets Last Event Indicator.  */
    public boolean getLastEventIndicator() {
        return lastEventIndicator;
    }
    /** Sets Last Event Indicator.  */
    public void setLastEventIndicator(boolean lastEventIndicator) {
        this.lastEventIndicator = lastEventIndicator;
    }
