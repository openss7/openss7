/*
 @(#) $RCSfile: TerminationAttemptAuthorized.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:02 $ <p>
 ...
 Last Modified $Date: 2009-06-21 11:35:02 $ by $Author: brian $
 */
...
/** This class represents the TerminationAttemptAuthorized Operation.
  * @version 1.2.2
  * @author Monavacon Limited
  */
public class TerminationAttemptAuthorized extends Operation implements java.io.Serializable {
    /** Constructor For TerminationAttemptAuthorized.  */
    public TerminationAttemptAuthorized(DPSpecificCommonParameters dPSpecificCommonParameters) {
        operationCode = OperationCode.TERM_ATTEMPT_AUTHORIZED;
    ...
    public OriginalCalledPartyID getOriginalCalledPartyID() throws ParameterNotSetException {
        ...
        throw new ParameterNotSetException("Called Party Id: not set.");
    }
