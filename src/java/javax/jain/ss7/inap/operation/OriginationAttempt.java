/*
 @(#) $RCSfile: OriginationAttempt.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:00 $ <p>
...
public class OriginationAttempt extends Operation implements java.io.Serializable {
    ...
    public OriginationAttempt(DPSpecificCommonParameters dPSpecificCommonParameters) {
        operationCode = OperationCode.ORIGINATION_ATTEMPT;
