/*
 @(#) $RCSfile: EventNotificationCharging.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:59 $ <p>
...
public class EventNotificationCharging extends Operation implements java.io.Serializable {
    ...
    public java.lang.String getEventSpecificInformationCharging() throws ParameterNotSetException {
        if (isEventSpecificInformationCharging)
            return eventSpecificInformationCharging;
        throw new ParameterNotSetException("Event Specific Information Charging: not set.");
    }
    ...
    public void setEventSpecificInformationCharging(java.lang.String eventSpecificInformationCharging) {
        ...
        this.isEventSpecificInformationCharging = true;
    }
    ...
    /** Gets Monitor Mode.  This parameter gets the information of an event
      * being relayed and/or processed by the SSP. In the context of
      * charging events, the following explanantions hold good. <ul>
      * <li>INTERRUPTED - Means that the SSF has notified the SCF of the
      * charging event; does not process the event but discards it.
      * <li>NOTIFY_AND_CONTINUE - Means that the SSF has notified the SCF of
      * the charging event and continues processing the event without
      * waiting for SCF instructions.
      * <li>TRANSPARENT - Means that the SSF does not notify the SCF of the
      * event. Monitoring the charging of a previously requested charging
      * event is ended. <ul> */
    public int getMonitorMode() throws ParameterNotSetException {
        if (isMonitorMode)
            return monitorMode;
        throw new ParameterNotSetException("Monitor Mode: not set.");
    }
    /** Sets Monitor Mode.  */
