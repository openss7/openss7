/*
 @(#) $RCSfile: ResetTimer.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:01 $ <p>
...
public class ResetTimer extends Operation implements java.io.Serializable {
    ...
    public void setTimerValue(int timerValue) throws IllegalArgumentException {
        if (0 <= timerValue && timerValue <= 2147483647) {
            this.timerValue = timerValue;
            return;
        }
        throw new IllegalArgumentException("Timer Value: " + timerValue + ", out of range.");
    }
