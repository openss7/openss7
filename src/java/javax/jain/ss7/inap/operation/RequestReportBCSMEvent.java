/*
 @(#) $RCSfile: RequestReportBCSMEvent.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:00 $ <p>
...
/** This class represents the RequestReportBCSMEvent Operation.
  * @version 1.2.2
  * @author Monavacon Limited
  */
public class RequestReportBCSMEvent extends Operation implements java.io.Serializable {
    /** Constructor For RequestReportBCSMEvent.  */
    public RequestReportBCSMEvent(BCSMEvent bCSMEvents[]) {
        operationCode = OperationCode.REQUEST_REPORT_BCSM_EVENT;
        setBCSMEvents(bCSMEvents);
    }
    /** Gets Operation Code.  */
    ...
    /** Gets BCSM Events.  */
    public BCSMEvent[] getBCSMEvents() {
        return bCSMEvents;
    }
    /** Gets a Particular BCSM Event.  */
    public BCSMEvent getBCSMEvent(int index) {
        return bCSMEvents[index];
    }
    /** Sets BCSM Events.  */
    public void setBCSMEvents(BCSMEvent bCSMEvents[]) {
        this.bCSMEvents = bCSMEvents;
    }
    /** Sets a particular BCSM Event.  */
    public void setBCSMEvent(int index, BCSMEvent bCSMEvent) {
        bCSMEvents[index] = bCSMEvent;
    }
    ...
    private BCSMEvent bCSMEvents[];
    private DigitsGenericDigits bCSMEventCorrelationID;
    private boolean isBcsmEventCorrelationID = false;
