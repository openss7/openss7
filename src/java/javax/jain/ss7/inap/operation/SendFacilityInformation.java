/*
 @(#) $RCSfile: SendFacilityInformation.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:01 $ <p>
...
public class SendFacilityInformation  extends Operation   implements java.io.Serializable
{
    ...
    /** Gets Call Processing Operation Correlation ID.  Returns one of the
      * following messages: <ul>
      * <li>ALERTING
      * <li>SETUP
      * <li>CONNECT
      * <li>DISCONNECT
