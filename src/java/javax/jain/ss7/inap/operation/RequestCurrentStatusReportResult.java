/*
 @(#) $RCSfile: RequestCurrentStatusReportResult.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:35:00 $ <p>
...
/** This class represents the RequestCurrentStatusReportResult Operation Result.
  * @version 1.2.2
  * @author Monavacon Limited
  */
public class RequestCurrentStatusReportResult extends Operation implements java.io.Serializable {
    /** Constructor For RequestCurrentStatusReportResult.  */
    public RequestCurrentStatusReportResult(ResourceStatus resourceStatus) {
        operationCode = OperationCode.REQUEST_CURRENT_STATUS_REPORT;
