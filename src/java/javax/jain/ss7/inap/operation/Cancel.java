/*
 @(#) $RCSfile: Cancel.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:58 $ <p>
...
public class Cancel extends Operation implements java.io.Serializable {
    ...
    public Cancel(int invokeID, CancelID cancelID) {
        ...
        if (cancelID == CancelID.INVOKE_ID)
            setInvokeID(invokeID);
        else if (cancelID == CancelID.ALL_REQUESTS)
    ...
    public void setInvokeID(int invokeID) {
        ...
        this.cancelChoice = CancelChoice.INVOKE_ID;
    }
    ...
    public void setAllRequests(int allRequests) {
        ...
        this.cancelChoice = CancelChoice.ALL_REQUESTS;
    }
    ...
    public void setCallSegmentToCancel(CallSegmentToCancel callSegmentToCancel) {
        ...
        this.cancelChoice = CancelChoice.CALL_SEGMENT;
    }
    /** Gets Cancel Choice.  */
