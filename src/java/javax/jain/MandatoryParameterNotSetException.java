/*
 @(#) $RCSfile: MandatoryParameterNotSetException.java,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:34:34 $ <p>
...
/**
  * This Exception is thrown by any JAIN Provider if all of the
  * mandatory parameters required by an implementation of any JAIN
  * Provider to send an Event have not been set.
  * @serial
  *
...
public class MandatoryParameterNotSetException extends ParameterNotSetException {
    ...
    /** Constructs a new MandatoryParameterNotSetException with the
    ...
    /** Constructs a new MandatoryParameterNotSetException with the
      * specified error message and specialized exception that triggered
