/*****************************************************************************
 ...
 @(#) $RCSfile: ixemap.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:22:37 $
...
static char const ident[] = "$RCSfile: ixemap.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:22:37 $";
