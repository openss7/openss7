/*****************************************************************************
 ...
 @(#) $RCSfile: dlrcv.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:47:54 $
...
#ident "@(#) $RCSfile: dlrcv.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:47:54 $"

static char const ident[] = "$RCSfile: dlrcv.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:47:54 $";
