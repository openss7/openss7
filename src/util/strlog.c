/*****************************************************************************
 ...
 @(#) $RCSfile: strlog.c,v $ $Name:  $($Revision: 1.1.2.3 $) $Date: 2011-01-18 16:59:52 $
...
static char const ident[] = "$RCSfile: strlog.c,v $ $Name:  $($Revision: 1.1.2.3 $) $Date: 2011-01-18 16:59:52 $";
