/*****************************************************************************
 ...
 @(#) $RCSfile: strconf.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:22:38 $
...
static char const ident[] = "$RCSfile: strconf.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:22:38 $";
