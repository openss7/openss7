...
static char const ident[] = "src/util/ss7pcapd.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
output_header(void)
{
	...
	fprint_time(stdout);
	fprintf(stdout,
		" # SS7CAPD src/util/ss7pcapd.c (" PACKAGE_ENVR " " PACKAGE_DATE ") Output File Header\n");
	uname(&uts);
	fprint_time(stdout);
