/*****************************************************************************
 ...
 @(#) $RCSfile: x400config.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:47:56 $
...
#ident "@(#) $RCSfile: x400config.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:47:56 $"

static char const ident[] = "$RCSfile: x400config.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:47:56 $";
