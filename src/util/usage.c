/*****************************************************************************
 ...
 @(#) $RCSfile: usage.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:47:55 $
...
#ident "@(#) $RCSfile: usage.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:47:55 $"

static char const ident[] = "$RCSfile: usage.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:47:55 $";
