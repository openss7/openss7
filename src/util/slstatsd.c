/*****************************************************************************
 ...
 @(#) $RCSfile: slstatsd.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:47:55 $
...
#ident "@(#) $RCSfile: slstatsd.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:47:55 $"

static char const ident[] = "$RCSfile: slstatsd.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:47:55 $";
...
slstats_header(void)
{
	...
	ftimestamp();
	fprint_time(stdout);
	fprintf(stdout, " # SLSTATSD $Id: slstatsd.c,v 1.1.2.1 2009-06-21 11:47:55 brian Exp $ Output Header\n");
	uname(&uts);
	fprint_time(stdout);
