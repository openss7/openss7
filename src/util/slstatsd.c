/*****************************************************************************
 ...
 @(#) $RCSfile: slstatsd.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:22:38 $
...
static char const ident[] = "$RCSfile: slstatsd.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:22:38 $";
...
slstats_header(void)
{
	...
	ftimestamp();
	fprint_time(stdout);
	fprintf(stdout, " # SLSTATSD $Id: slstatsd.c,v 1.1.2.2 2010-11-28 14:22:38 brian Exp $ Output Header\n");
	uname(&uts);
	fprint_time(stdout);
