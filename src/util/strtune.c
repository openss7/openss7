/*****************************************************************************
 ...
 @(#) $RCSfile: strtune.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:22:39 $
...
static char const ident[] = "$RCSfile: strtune.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:22:39 $";
