#!/bin/sh
#
# @(#) $RCSfile: strtty.sh,v $ $Name:  $($Revision: 0.9.2.11 $) $Date: 2008-10-21 22:42:20 $
...
# -----------------------------------------------------------------------------
#
# Last Modified $Date: 2008-10-21 22:42:20 $ by $Author: brian $
#
# -----------------------------------------------------------------------------
#
# $Log: strtty.sh,v $
...
#
# Revision 0.9.2.10  2008-04-28 17:46:05  brian
# - updates for release
#
# Revision 0.9.2.9  2007/08/14 03:04:40  brian
# - GPLv3 header update
#
