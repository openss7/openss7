#!/bin/sh
#
# @(#) $RCSfile: openss7.sh,v $ $Name:  $($Revision: 1.1.2.5 $) $Date: 2011-05-15 12:01:21 $
...
#   openss7 this is some short list of modules.  These modules must be loaded
#   before sysctl parameters can be configured.  On some systems it is possible
#   to identify this module as a system preloaded module, but on others the
#   module is only loaded when the initscript is run.
#
start_preload () {
