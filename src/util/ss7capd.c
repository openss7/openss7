...
static char const ident[] = "src/util/ss7capd.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
char lnkname[64] = "";
char cfgfile[127] = "";
char outpdir[127] = "/var/log/ss7capd";
char devname[127] = "/dev/streams/clone/x400p-sl";
