/*****************************************************************************
 ...
 @(#) $RCSfile: test-loop.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:44:17 $
...
#ident "@(#) $RCSfile: test-loop.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:44:17 $"

static char const ident[] = "$RCSfile: test-loop.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:44:17 $";
