/*****************************************************************************
 ...
 @(#) $RCSfile: test-loop.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:22:28 $
...
static char const ident[] = "$RCSfile: test-loop.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:22:28 $";
