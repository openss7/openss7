/*****************************************************************************
 ...
 @(#) $RCSfile: test-x400p-sdt2.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:44:21 $
...
#ident "@(#) $RCSfile: test-x400p-sdt2.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:44:21 $"

static char const ident[] = "$RCSfile: test-x400p-sdt2.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:44:21 $";
...
do_tests(void)
{
	...
	if ((pfd[0] = open("/dev/streams/clone/x400p-sl", O_NONBLOCK | O_RDWR)) < 0) {
		perror("open");
		exit(2);
	}
	printf("Opening other stream\n");
	if ((pfd[1] = open("/dev/streams/clone/x400p-sl", O_NONBLOCK | O_RDWR)) < 0) {
		perror("open");
		exit(2);
	}
