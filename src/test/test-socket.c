/*****************************************************************************
 ...
 @(#) $RCSfile: test-socket.c,v $ $Name:  $($Revision: 1.1.2.3 $) $Date: 2011-05-31 09:46:17 $
...
static char const ident[] = "$RCSfile: test-socket.c,v $ $Name:  $($Revision: 1.1.2.3 $) $Date: 2011-05-31 09:46:17 $";
