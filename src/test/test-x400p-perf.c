/*****************************************************************************
 ...
 @(#) $RCSfile: test-x400p-perf.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:44:21 $
...
#ident "@(#) $RCSfile: test-x400p-perf.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:44:21 $"

static char const ident[] = "$RCSfile: test-x400p-perf.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:44:21 $";
