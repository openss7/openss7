/*****************************************************************************
 ...
 @(#) $RCSfile: test-x400p-hsl.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:44:21 $
 ...
 $Log: test-x400p-hsl.c,v $
 Revision 1.1.2.1  2009-06-21 11:44:21  brian
 - added files to new distro

 *****************************************************************************/

#ident "@(#) $RCSfile: test-x400p-hsl.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:44:21 $"

static char const ident[] = "$RCSfile: test-x400p-hsl.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:44:21 $";
...
sdt_write(int fd)
{
	...
	const size_t len = 80;
	const uint8_t buf[] = {
		0xff, 0x0f, 0xff, 0x0f, 0x4a, 0x00, 0x01, 0x02,
...
do_tests(void)
{
	...
	printf("Allowing spans to stabilize for 10 seconds\n");
	fflush(stdout);
	sleep(10);
	...
	for (span = 0; span < 4; span++) {
		printf(".");
		fflush(stdout);
		sdt_daedt_start(pfd[span]);
		sdt_daedr_start(pfd[span]);
	}
	printf("Done.\n");
	fflush(stdout);
