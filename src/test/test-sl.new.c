/*****************************************************************************
 ...
 @(#) $RCSfile: test-sl.new.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:44:20 $
...
#ident "@(#) $RCSfile: test-sl.new.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:44:20 $"

static char const ident[] = "$RCSfile: test-sl.new.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:44:20 $";
