/*****************************************************************************
 ...
 @(#) $RCSfile: test-mux.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:22:29 $
...
static char const ident[] = "$RCSfile: test-mux.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:22:29 $";
