...
static char const ident[] = "src/modules/sl.new.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define SL_REVISION	"OpenSS7 src/modules/sl.new.c (" PACKAGE_ENVR ") " PACKAGE_DATE
