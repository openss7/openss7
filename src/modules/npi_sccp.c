/*****************************************************************************
 ...
 @(#) $RCSfile: npi_sccp.c,v $ $Name:  $($Revision: 1.1.2.3 $) $Date: 2011-09-02 08:46:54 $
...
static char const ident[] = "$RCSfile: npi_sccp.c,v $ $Name:  $($Revision: 1.1.2.3 $) $Date: 2011-09-02 08:46:54 $";
