...
static char const ident[] = "src/modules/npi_sccp.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define NPI_SCCP_COPYRIGHT	"Copyright (c) 2008-2019  Monavacon Limited.  All Rights Reserved."
