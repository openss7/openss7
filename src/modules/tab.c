/*****************************************************************************
 ...
 @(#) $RCSfile: tab.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:40:36 $
...
#ident "@(#) $RCSfile: tab.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:40:36 $"

static char const ident[] = "$RCSfile: tab.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:40:36 $";
