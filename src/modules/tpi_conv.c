...
static char const ident[] = "src/modules/tpi_conv.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define TPI_CONV_COPYRIGHT	"Copyright (c) 2008-2019  Monavacon Limited.  All Rights Reserved."
