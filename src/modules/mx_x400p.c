...
static char const ident[] = "src/modules/mx_x400p.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define MX_SDL_REVISION	"OpenSS7 src/modules/mx_x400p.c (" PACKAGE_ENVR ") " PACKAGE_DATE
