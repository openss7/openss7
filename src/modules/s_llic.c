/*****************************************************************************
 ...
 @(#) $RCSfile: s_llic.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:40:33 $
...
#ident "@(#) $RCSfile: s_llic.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:40:33 $"

static char const ident[] = "$RCSfile: s_llic.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:40:33 $";
...
#define S_LLIC_COPYRIGHT	"Copyright (c) 2008-2009  Monavacon Limited.  All Rights Reserved."
#define S_LLIC_REVISION		"OpenSS7 $RCSfile: s_llic.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:40:33 $"
