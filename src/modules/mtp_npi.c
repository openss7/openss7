...
static char const ident[] = "src/modules/mtp_npi.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define MTP_NPI_REVISION	"OpenSS7 File: " __FILE__ "  Version: " PACKAGE_ENVR "  Date: " PACKAGE_DATE
