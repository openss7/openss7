...
static char const ident[] = "src/modules/pipemod.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define PIPEMOD_COPYRIGHT	"Copyright (c) 2008-2019  Monavacon Limited.  All Rights Reserved."
