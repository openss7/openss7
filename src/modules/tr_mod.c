...
static char const ident[] = "src/modules/tr_mod.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define TR_REVISION	"OpenSS7 File: " __FILE__ "  Version: " PACKAGE_ENVR "  Date: " PACKAGE_DATE
