...
static char const ident[] = "src/modules/slpmod.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define SL_REVISION	"OpenSS7 src/modules/slpmod.c (" PACKAGE_ENVR ") " PACKAGE_DATE
