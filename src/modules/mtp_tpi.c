...
static char const ident[] = "src/modules/mtp_tpi.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define MTP_TPI_COPYRIGHT	"Copyright (c) 2008-2019  Monavacon Limited.  All Rights Reserved."
