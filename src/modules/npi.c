...
static char const ident[] = "src/modules/npi.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define NPI_REVISION	"OpenSS7 src/modules/npi.c (" PACKAGE_ENVR ") " PACKAGE_DATE
