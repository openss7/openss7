...
static char const ident[] = "src/modules/s_nlic.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define S_NLIC_COPYRIGHT	"Copyright (c) 2008-2015  Monavacon Limited.  All Rights Reserved."
#define S_NLIC_REVISION		"OpenSS7 File: " __FILE__ "  Version: " PACKAGE_ENVR "  Date: " PACKAGE_DATE
