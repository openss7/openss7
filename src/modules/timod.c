/*****************************************************************************
 ...
 @(#) $RCSfile: timod.c,v $ $Name:  $($Revision: 1.1.2.3 $) $Date: 2010-11-28 14:22:08 $
...
static char const ident[] = "$RCSfile: timod.c,v $ $Name:  $($Revision: 1.1.2.3 $) $Date: 2010-11-28 14:22:08 $";
...
#define TIMOD_COPYRIGHT	"Copyright (c) 2008-2010  Monavacon Limited.  All Rights Reserved."
#define TIMOD_REVISION	"OpenSS7 $RCSfile: timod.c,v $ $Name:  $($Revision: 1.1.2.3 $) $Date: 2010-11-28 14:22:08 $"
...
#endif				/* CONFIG_STREAMS_TIMOD_MODULE */
...
#ifndef CONFIG_STREAMS_TIMOD_MODULE
static
#endif
...
#ifdef MODULE
#ifdef MODULE_ALIAS
MODULE_ALIAS("streams-modid-" __stringify(CONFIG_STREAMS_TIMOD_MODID));
MODULE_ALIAS("streams-module-timod");
#endif				/* MODULE_ALIAS */
#endif				/* MODULE */
...
#define MOD_ID		CONFIG_STREAMS_TIMOD_MODID
...
STATIC struct timod_trans timod_trans_map[] = {
	{.cmd = _O_TI_GETINFO,}
	, {.cmd = _O_TI_OPTMGMT,}
	, {.cmd = _O_TI_BIND,}
	, {.cmd = _O_TI_UNBIND,}
...
#else				/* CONFIG_STREAMS_TIMOD_MODULE */
