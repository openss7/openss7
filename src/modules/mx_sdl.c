...
static char const ident[] = "src/modules/mx_sdl.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define MX_SDL_REVISION	"OpenSS7 src/modules/mx_sdl.c (" PACKAGE_ENVR ") " PACKAGE_DATE
