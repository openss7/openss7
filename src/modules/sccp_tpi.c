...
static char const ident[] = "src/modules/sccp_tpi.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define SCCP_TPI_REVISION	"OpenSS7 src/modules/sccp_tpi.c (" PACKAGE_ENVR ") " PACKAGE_DATE
