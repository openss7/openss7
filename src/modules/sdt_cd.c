...
static char const ident[] = "src/modules/sdt_cd.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define SDT_REVISION	"OpenSS7 src/modules/sdt_cd.c (" PACKAGE_ENVR ") " PACKAGE_DATE
