...
static char const ident[] = "src/modules/aal2.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define AAL2_REVISION	"OpenSS7 File: " __FILE__ "  Version: " PACKAGE_ENVR "  Date: " PACKAGE_DATE
