...
static char const ident[] = "src/modules/pckt.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define PCKT_COPYRIGHT	"Copyright (c) 2008-2019  Monavacon Limited.  All Rights Reserved."
