/*****************************************************************************
 ...
 @(#) $RCSfile: cmot.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:22:01 $
...
static char const ident[] = "$RCSfile: cmot.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:22:01 $";
