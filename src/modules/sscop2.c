...
static char const ident[] = "src/modules/sscop2.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define SSCOP_REVISION	"OpenSS7 src/modules/sscop2.c (" PACKAGE_ENVR ") " PACKAGE_DATE
