...
static char const ident[] = "src/modules/m2pa_sl.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define M2PA_SL_REVISION	"OpenSS7 File: " __FILE__ "  Version: " PACKAGE_ENVR "  Date: " PACKAGE_DATE
