...
static char const ident[] = "src/modules/zaptel.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define ZAP_MX_REVISION	"OpenSS7 src/modules/zaptel.c (" PACKAGE_ENVR ") " PACKAGE_DATE
