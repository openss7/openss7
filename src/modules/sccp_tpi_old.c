/*****************************************************************************
 ...
 @(#) File: src/modules/sccp_tpi_old.c
...
static char const ident[] = "src/modules/sccp_tpi_old.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define SCCP_TPI_REVISION	"OpenSS7 src/modules/sccp_tpi_old.c (" PACKAGE_ENVR ") " PACKAGE_DATE
