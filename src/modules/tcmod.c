...
static char const ident[] = "src/modules/tcmod.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define TCMOD_COPYRIGHT	"Copyright (c) 2008-2020  Monavacon Limited.  All Rights Reserved."
