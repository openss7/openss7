/*****************************************************************************
 ...
 @(#) $RCSfile: sl_tpi.c,v $ $Name:  $($Revision: 1.1.2.4 $) $Date: 2011-09-02 08:46:55 $
...
static char const ident[] = "$RCSfile: sl_tpi.c,v $ $Name:  $($Revision: 1.1.2.4 $) $Date: 2011-09-02 08:46:55 $";
