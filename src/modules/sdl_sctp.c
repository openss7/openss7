/*****************************************************************************
 ...
 @(#) $RCSfile: sdl_sctp.c,v $ $Name:  $($Revision: 1.1.2.3 $) $Date: 2011-09-02 08:46:55 $
...
static char const ident[] = "$RCSfile: sdl_sctp.c,v $ $Name:  $($Revision: 1.1.2.3 $) $Date: 2011-09-02 08:46:55 $";
