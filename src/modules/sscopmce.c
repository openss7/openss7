...
static char const ident[] = "src/modules/sscopmce.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define SSCOPMCE_COPYRIGHT	"Copyright (c) 2008-2019  Monavacon Limited.  All Rights Reserved."
