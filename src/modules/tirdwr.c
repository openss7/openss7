...
static char const ident[] = "src/modules/tirdwr.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define TIRDWR_COPYRIGHT	"Copyright (c) 2008-2019  Monavacon Limited.  All Rights Reserved."
