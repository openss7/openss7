/*****************************************************************************
 ...
 @(#) $RCSfile: dl_sl.c,v $ $Name:  $($Revision: 1.1.2.3 $) $Date: 2011-09-02 08:46:52 $
...
static char const ident[] = "$RCSfile: dl_sl.c,v $ $Name:  $($Revision: 1.1.2.3 $) $Date: 2011-09-02 08:46:52 $";
