/*****************************************************************************
 ...
 @(#) $RCSfile: sdl.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:40:34 $
...
#ident "@(#) $RCSfile: sdl.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:40:34 $"

static char const ident[] = "$RCSfile: sdl.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:40:34 $";
...
#define SDL_REVISION	"OpenSS7 $RCSfile: sdl.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:40:34 $"
...
STATIC streamscall int sdl_open(queue_t *, dev_t *, int, int, cred_t *);
STATIC streamscall int sdl_close(queue_t *, int, cred_t *);
