...
static char const ident[] = "src/modules/sdl_cd.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define SDL_REVISION	"OpenSS7 src/modules/sdl_cd.c (" PACKAGE_ENVR ") " PACKAGE_DATE
