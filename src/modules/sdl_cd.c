/*****************************************************************************
 ...
 @(#) $RCSfile: sdl_cd.c,v $ $Name:  $($Revision: 1.1.2.3 $) $Date: 2011-09-02 08:46:55 $
...
static char const ident[] = "$RCSfile: sdl_cd.c,v $ $Name:  $($Revision: 1.1.2.3 $) $Date: 2011-09-02 08:46:55 $";
...
#define SDL_DESCRIP	"Part of the OpenSS7 SS7 Stack for Linux Fast-STREAMS"
#define SDL_REVISION	"OpenSS7 $RCSfile: sdl_cd.c,v $ $Name:  $($Revision: 1.1.2.3 $) $Date: 2011-09-02 08:46:55 $"
