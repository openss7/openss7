...
static char const ident[] __attribute__((unused)) = "src/snmp/cdr2MIB.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
callDetailLogRecordR2Table_create(void)
{
	...
	if (StorageNew != NULL) {
		...
		StorageNew->logRecordIdLen = 0;
		StorageNew->logRecordId[StorageNew->logRecordIdLen] = 0;
		StorageNew->sequenceId = (struct counter64) { 0, 0 };
		StorageNew->zoneId = (struct counter64) { 0, 0 };
		StorageNew->recSeqId = (struct counter64) { 0, 0 };
		StorageNew->fileSeqId = (struct counter64) { 0, 0 };
