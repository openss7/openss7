/*****************************************************************************
 ...
 @(#) $RCSfile: cdr2MIB.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:42:31 $
 ...
 Last Modified $Date: 2009-06-21 11:42:31 $ by $Author: brian $
 ...
 Revision 0.9.2.12  2009-02-18 20:18:44  brian
 - updated agents
...
#ident "@(#) $RCSfile: cdr2MIB.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:42:31 $"

static char const ident[] = "$RCSfile: cdr2MIB.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:42:31 $";
...
#define   CREATIONTRIGGERLIST   2
	{(u_char) CREATIONTRIGGERLIST, ASN_OCTET_STR, RWRITE, var_simpleUsageMeteringControlTable, 5, {1, 3, 1, 1, 1}},
...
#define   CONFIGURATIONMASK     5
	{(u_char) CONFIGURATIONMASK, ASN_OCTET_STR, RWRITE, var_configurableSimpleUsageMeteringControlTable, 5, {1, 4, 1, 1, 2}},
...
#define   CDRPURPOSE            49
	{(u_char) CDRPURPOSE, ASN_OCTET_STR, RONLY, var_callDetailLogRecordTable, 5, {1, 7, 1, 1, 35}},
...
#define   ACCESSDELIVERY        59
	{(u_char) ACCESSDELIVERY, ASN_OCTET_STR, RONLY, var_callDetailLogRecordTable, 5, {1, 7, 1, 1, 45}},
...
#define   CONFIGURATIONR2MASK   81
	{(u_char) CONFIGURATIONR2MASK, ASN_OCTET_STR, RWRITE, var_configurableSimpleUsageMeteringControlR2Table, 5, {1, 8, 1, 1, 1}},
...
parse_simpleUsageMeteringControlTable(const char *token, char *line)
{
	...
	line = read_config_read_data(ASN_OCTET_STR, line, &StorageTmp->creationTriggerList, &StorageTmp->creationTriggerListLen);
...
parse_configurableSimpleUsageMeteringControlTable(const char *token, char *line)
{
	...
	line = read_config_read_data(ASN_OCTET_STR, line, &StorageTmp->configurationMask, &StorageTmp->configurationMaskLen);
...
store_configurableSimpleUsageMeteringControlTable(int majorID, int minorID, void *serverarg, void *clientarg)
{
	...
	for (hcindex = configurableSimpleUsageMeteringControlTableStorage; hcindex != NULL; hcindex = hcindex->next) {
		...
		/* XXX: comment entire section if row not persistent */
		{
			...
			cptr = read_config_store_data(ASN_OCTET_STR, cptr, &StorageTmp->configurationMask, &StorageTmp->configurationMaskLen);
...
parse_callDetailLogRecordTable(const char *token, char *line)
{
	...
	line = read_config_read_data(ASN_OCTET_STR, line, &StorageTmp->cDRPurpose, &StorageTmp->cDRPurposeLen);
	...
	line = read_config_read_data(ASN_OCTET_STR, line, &StorageTmp->accessDelivery, &StorageTmp->accessDeliveryLen);
...
store_callDetailLogRecordTable(int majorID, int minorID, void *serverarg, void *clientarg)
{
	...
	for (hcindex = callDetailLogRecordTableStorage; hcindex != NULL; hcindex = hcindex->next) {
		...
		/* XXX: comment entire section if row not persistent */
		{
			...
			cptr = read_config_store_data(ASN_OCTET_STR, cptr, &StorageTmp->cDRPurpose, &StorageTmp->cDRPurposeLen);
			...
			cptr = read_config_store_data(ASN_OCTET_STR, cptr, &StorageTmp->accessDelivery, &StorageTmp->accessDeliveryLen);
...
parse_configurableSimpleUsageMeteringControlR2Table(const char *token, char *line)
{
	...
	line = read_config_read_data(ASN_OCTET_STR, line, &StorageTmp->configurationR2Mask, &StorageTmp->configurationR2MaskLen);
...
write_creationTriggerList(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE1:
		...
		if ((var_val_type != ASN_BIT_STR && var_val_type != ASN_OCTET_STR)) {
			snmp_log(MY_FACILITY(LOG_NOTICE), "write to creationTriggerList not ASN_OCTET_STR\n");
...
write_configurationMask(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE1:
		...
		if ((var_val_type != ASN_BIT_STR && var_val_type != ASN_OCTET_STR)) {
			snmp_log(MY_FACILITY(LOG_NOTICE), "write to configurationMask not ASN_OCTET_STR\n");
			return SNMP_ERR_WRONGTYPE;
		}
		if (var_val_type == ASN_BIT_STR) {
...
write_configurationR2Mask(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE1:
		...
		if ((var_val_type != ASN_BIT_STR && var_val_type != ASN_OCTET_STR)) {
			snmp_log(MY_FACILITY(LOG_NOTICE), "write to configurationR2Mask not ASN_OCTET_STR\n");
			return SNMP_ERR_WRONGTYPE;
		}
		if (var_val_type == ASN_BIT_STR) {
