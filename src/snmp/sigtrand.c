/*****************************************************************************
 ...
 @(#) $RCSfile: sigtrand.c,v $ $Name: OpenSS7-0_9_2 $($Revision: 0.9.2.1 $) $Date: 2009-01-19 13:33:36 $
 ...
 Last Modified $Date: 2009-01-19 13:33:36 $ by $Author: brian $
...
#ident "@(#) $RCSfile: sigtrand.c,v $ $Name: OpenSS7-0_9_2 $($Revision: 0.9.2.1 $) $Date: 2009-01-19 13:33:36 $"

static char const ident[] = "$RCSfile: sigtrand.c,v $ $Name: OpenSS7-0_9_2 $($Revision: 0.9.2.1 $) $Date: 2009-01-19 13:33:36 $";
...
const char sa_program[] = "sigtrand";
...
char sa_logfile[256] = "/var/log/sigtrand.log";	/* log file name */
char sa_pidfile[256] = "/var/run/sigtrand.pid";	/* pid file name */
char sa_sysctlf[256] = "/etc/sigtrand.conf";	/* sysctl file name */
...
Options:\n\
    ...
    -l, --log-file [LOGFILE]\n\
        log to log file name LOGFILE.  [default: /var/log/sigtrand.log]\n\
    -L, --log-stderr\n\
    ...
    -n, --nodaemon\n\
        run in the foreground.\n\
    -n, --name NAME\n\
        use NAME for configuration file base.  [default: sigtrand]\n\
    -p, --port PORTNUM\n\
        listen on port number PORTNUM.  [default: 161]\n\
    -p, --pidfile PIDFILE\n\
        write daemon pid to PIDFILE.  [default: /var/run/sigtrand.pid]\n\
    -P, --pidfile PIDFILE\n\
        write daemon pid to PIDFILE.  [default: /var/run/sigtrand.pid]\n\
    -q, --quiet\n\
...
sa_init_logging(int argc, char *argv[])
{
	...
	if (sa_logsyslog) {
		...
		snmp_enable_syslog_ident("sigtrand", LOG_DAEMON);
		...
		closelog();
#if defined LOG_PERROR
		openlog("sigtrand", LOG_PID | LOG_CONS | LOG_NDELAY | (sa_logstderr ? LOG_PERROR : 0), MY_FACILITY(0));
#else				/* defined LOG_PERROR */
		openlog("sigtrand", LOG_PID | LOG_CONS | LOG_NDELAY, MY_FACILITY(0));
#endif				/* defined LOG_PERROR */
	}
	if (sa_logcallog) {
		snmp_enable_calllog();
