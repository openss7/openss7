/*****************************************************************************
 ...
 @(#) $Id: mxMIB.h,v 0.9.2.15 2009-02-18 20:18:59 brian Exp $
...
#ident "@(#) $RCSfile: mxMIB.h,v $ $Name:  $($Revision: 0.9.2.15 $) Copyright (c) 2008-2009 Monavacon Limited."
...
struct mxDrivTable_data {
	...
	ulong mxDrivMajor;		/* ReadOnly */
	uint8_t *mxDrivDescription;	/* ReadOnly */
	size_t mxDrivDescriptionLen;
	uint8_t *mxDrivRevision;	/* ReadOnly */
	size_t mxDrivRevisionLen;
	uint8_t *mxDrivCopyright;	/* ReadOnly */
	size_t mxDrivCopyrightLen;
	uint8_t *mxDrivSupportedDevice;	/* ReadOnly */
	size_t mxDrivSupportedDeviceLen;
	uint8_t *mxDrivContact;		/* ReadOnly */
	size_t mxDrivContactLen;
	long mxDrivLicense;		/* ReadOnly */
	uint8_t *mxDrivDate;		/* ReadOnly */
	size_t mxDrivDateLen;
...
struct mxSpanTable_data {
	...
	long mxSpanStandbyStatus;	/* ReadOnly */
...
extern struct header_complex_index *mxDrivTableStorage;
...
extern oid mxCardTypePLX9030_oid[13];
extern oid mxCardTypePLXDevelopmentBoard_oid[13];
extern oid mxCardTypeX400P_oid[13];
extern oid mxCardTypeE400P_oid[14];
extern oid mxCardTypeT400P_oid[14];
extern oid mxCardTypeX400P_SS7_oid[13];
extern oid mxCardTypeE400P_SS7_oid[14];
extern oid mxCardTypeT400P_SS7_oid[14];
...
extern oid mxChipTypeDS2154_oid[13];
extern oid mxChipTypeDS21354_oid[13];
...
extern oid mxPciGroup_oid[12];
extern oid mxCardGroup_oid[12];
extern oid mxSpanGroup_oid[12];
extern oid mxChanGroup_oid[12];
extern oid mxXconGroup_oid[12];
extern oid mxBertGroup_oid[12];
extern oid mxScalarGroup_oid[12];
extern oid mxNearEndCurrentGroup_oid[12];
extern oid mxNearEndIntervalGroup_oid[12];
extern oid mxNearEndTotalGroup_oid[12];
...
FindVarMethod var_mxDrivTable;
struct mxDrivTable_data *mxDrivTable_create(void);
struct mxDrivTable_data *mxDrivTable_duplicate(struct mxDrivTable_data *);
int mxDrivTable_destroy(struct mxDrivTable_data **);
int mxDrivTable_add(struct mxDrivTable_data *);
int mxDrivTable_del(struct mxDrivTable_data *);
void parse_mxDrivTable(const char *, char *);
SNMPCallback store_mxDrivTable;
void refresh_mxDrivTable(int);
...
WriteMethod write_mxDrivRowStatus;
...
WriteMethod write_mxCardStatus;
