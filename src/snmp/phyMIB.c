...
static char const ident[] __attribute__((unused)) = "src/snmp/phyMIB.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
dataCircuitTable_create(void)
{
	...
	if (StorageNew != NULL) {
		...
		StorageNew->dataCircuitBitErrorsReceived = (struct counter64) { 0, 0 };
		StorageNew->dataCircuitBitErrorsTransmitted = (struct counter64) { 0, 0 };
