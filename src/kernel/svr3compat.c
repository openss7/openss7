...
static char const ident[] = "src/kernel/svr3compat.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define SVR3COMP_REVISION	"OpenSS7 File: " __FILE__ "  Version: " PACKAGE_ENVR "  Date: " PACKAGE_DATE
