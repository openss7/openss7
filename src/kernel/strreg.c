/*****************************************************************************
 ...
 @(#) $RCSfile: strreg.c,v $ $Name:  $($Revision: 1.1.2.5 $) $Date: 2011-09-20 09:51:39 $
...
static char const ident[] = "$RCSfile: strreg.c,v $ $Name:  $($Revision: 1.1.2.5 $) $Date: 2011-09-20 09:51:39 $";
