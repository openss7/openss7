...
static char const ident[] = "src/kernel/suncompat.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define SUNCOMP_COPYRIGHT	"Copyright (c) 2008-2019  Monavacon Limited.  All Rights Reserved."
