/*****************************************************************************
 ...
 @(#) $RCSfile: wrapper.c,v $ $Name:  $($Revision: 1.1.2.5 $) $Date: 2011-03-17 07:01:29 $
...
#define WRAPPER_REVISION	"LfS $RCSfile: wrapper.c,v $ $Name:  $($Revision: 1.1.2.5 $) $Date: 2011-03-17 07:01:29 $"
...
__asm__(".equiv session_of_pgrp," __stringify(HAVE_SESSION_OF_PGRP_ADDR));
__asm__(".type session_of_pgrp,@function");
...
__asm__(".equiv is_ignored," __stringify(HAVE_IS_IGNORED_ADDR));
__asm__(".type is_ignored,@function");
...
__asm__(".equiv is_orphaned_pgrp," __stringify(HAVE_IS_ORPHANED_PGRP_ADDR));
__asm__(".type is_orphaned_pgrp,@function");
...
__asm__(".equiv is_current_pgrp_orphaned," __stringify(HAVE_IS_CURRENT_PGRP_ORPHANED_ADDR));
__asm__(".type is_current_pgrp_orphaned,@function");
...
__asm__(".equiv tasklist_lock," __stringify(HAVE_TASKLIST_LOCK_ADDR));
__asm__(".type tasklist_lock,@object");
...
__asm__(".equiv kill_pid_info," __stringify(HAVE_KILL_PID_INFO_ADDR));
__asm__(".type kill_pid_info,@function");
...
__asm__(".equiv kill_proc_info," __stringify(HAVE_KILL_PROC_INFO_ADDR));
__asm__(".type kill_proc_info,@function");
...
__asm__(".equiv kill_sl_func," __stringify(HAVE_KILL_SL_ADDR));
__asm__(".type kill_sl_func,@function");
...
__asm__(".equiv send_group_sig_info," __stringify(HAVE_SEND_GROUP_SIG_INFO_ADDR));
__asm__(".type send_group_sig_info,@function");
...
__asm__(".equiv group_send_sig_info," __stringify(HAVE_GROUP_SEND_SIG_INFO_ADDR));
__asm__(".type group_send_sig_info,@function");
...
__asm__(".equiv __wake_up_sync," __stringify(HAVE___WAKE_UP_SYNC_ADDR));
__asm__(".type __wake_up_sync,@function");
...
__asm__(".equiv modules," __stringify(HAVE_MODULES_ADDR));
__asm__(".type modules,@object");
...
__asm__(".equiv module_text_address," __stringify(HAVE_MODULE_TEXT_ADDRESS_ADDR));
__asm__(".type module_text_address,@function");
...
__asm__(".equiv __module_address," __stringify(HAVE___MODULE_ADDRESS_ADDR));
__asm__(".type __module_address,@function");
__asm__(".global __module_address");
EXPORT_SYMBOL_GPL(__module_address);
#endif                          /* HAVE___MODULE_ADDRESS_ADDR */

#ifdef HAVE_FILE_MOVE_ADDR
__asm__(".equiv file_move," __stringify(HAVE_FILE_MOVE_ADDR));
__asm__(".type file_move,@function");
...
__asm__(".equiv file_kill," __stringify(HAVE_FILE_KILL_ADDR));
__asm__(".type file_kill,@function");
__asm__(".global file_kill");
EXPORT_SYMBOL_GPL(file_kill);
#endif				/* HAVE_FILE_KILL_ADDR */

#ifdef HAVE_PUT_FILP_ADDR
__asm__(".equiv put_filp," __stringify(HAVE_PUT_FILP_ADDR));
__asm__(".type put_filp,@function");
...
__asm__(".equiv kthread_should_stop," __stringify(HAVE_KTHREAD_SHOULD_STOP_ADDR));
__asm__(".type kthread_should_stop,@function");
...
/* SLES 2.6.5 takes the prize for kernel developer stupidity! */
__asm__(".equiv kthread_create," __stringify(HAVE_KTHREAD_CREATE_ADDR));
__asm__(".type kthread_create,@function");
...
/* SLES 2.6.5 takes the prize for kernel developer stupidity! */
__asm__(".equiv kthread_bind," __stringify(HAVE_KTHREAD_BIND_ADDR));
__asm__(".type kthread_bind,@function");
...
/* SLES 2.6.5 takes the prize for kernel developer stupidity! */
__asm__(".equiv kthread_stop," __stringify(HAVE_KTHREAD_STOP_ADDR));
__asm__(".type kthread_stop,@function");
...
__asm__(".equiv inet_proto_lock," __stringify(HAVE_INET_PROTO_LOCK_ADDR));
__asm__(".type inet_proto_lock,@object");
...
__asm__(".equiv inet_protos," __stringify(HAVE_INET_PROTOS_ADDR));
__asm__(".type inet_protos,@object");
...
__asm__(".equiv skbuff_head_cache," __stringify(HAVE_SKBUFF_HEAD_CACHE_ADDR));
__asm__(".type skbuff_head_cache,@object");
...
__asm__(".equiv icmp_err_convert," __stringify(HAVE_ICMP_ERR_CONVERT_ADDR));
__asm__(".type icmp_err_convert,@object");
...
__asm__(".equiv icmp_statistics," __stringify(HAVE_ICMP_STATISTICS_ADDR));
__asm__(".type icmp_statistics,@object");
...
__asm__(".equiv ip_route_output_flow," __stringify(HAVE_IP_ROUTE_OUTPUT_FLOW_ADDR));
__asm__(".type ip_route_output_flow,@function");
...
__asm__(".equiv ip_rt_min_pmtu," __stringify(HAVE_IP_RT_MIN_PMTU_ADDR));
__asm__(".type ip_rt_min_pmtu,@object");
...
__asm__(".equiv ip_rt_mtu_expires," __stringify(HAVE_IP_RT_MTU_EXPIRES_ADDR));
__asm__(".type ip_rt_mtu_expires,@object");
...
__asm__(".equiv ip_rt_update_pmtu," __stringify(HAVE_IP_RT_UPDATE_PMTU_ADDR));
__asm__(".type ip_rt_update_pmtu,@function");
...
__asm__(".equiv sysctl_ip_dynaddr," __stringify(HAVE_SYSCTL_IP_DYNADDR_ADDR));
__asm__(".type sysctl_ip_dynaddr,@object");
...
__asm__(".equiv sysctl_ip_nonlocal_bind," __stringify(HAVE_SYSCTL_IP_NONLOCAL_BIND_ADDR));
__asm__(".type sysctl_ip_nonlocal_bind,@object");
...
__asm__(".equiv sysctl_ip_default_ttl," __stringify(HAVE_SYSCTL_IP_DEFAULT_TTL_ADDR));
__asm__(".type sysctl_ip_default_ttl,@object");
...
__asm__(".equiv __ip_route_output_key," __stringify(HAVE___IP_ROUTE_OUTPUT_KEY_ADDR));
__asm__(".type __ip_route_output_key,@function");
...
__asm__(".equiv __xfrm_policy_check," __stringify(HAVE___XFRM_POLICY_CHECK_ADDR));
__asm__(".type __xfrm_policy_check,@function");
...
#endif
__asm__(".equiv xfrm_policy_delete," __stringify(HAVE_XFRM_POLICY_DELETE_ADDR));
__asm__(".type xfrm_policy_delete,@function");
...
__asm__(".equiv snmp_get_info," __stringify(HAVE_SNMP_GET_INFO_ADDR));
__asm__(".type snmp_get_info,@function");
__asm__(".global snmp_get_info");
EXPORT_SYMBOL_GPL(snmp_get_info);
#endif				/* HAVE_SNMP_GET_INFO_ADDR */

#ifdef HAVE_IP_FRAG_NQUEUES_ADDR
__asm__(".equiv ip_frag_nqueues," __stringify(HAVE_IP_FRAG_NQUEUES_ADDR));
__asm__(".type ip_frag_nqueues,@object");
...
__asm__(".equiv ip_frag_mem," __stringify(HAVE_IP_FRAG_MEM_ADDR));
__asm__(".type ip_frag_mem,@object");
...
__asm__(".equiv sysctl_rmem_default," __stringify(HAVE_SYSCTL_RMEM_DEFAULT_ADDR));
__asm__(".type sysctl_rmem_default,@object");
...
__asm__(".equiv sysctl_wmem_default," __stringify(HAVE_SYSCTL_WMEM_DEFAULT_ADDR));
__asm__(".type sysctl_wmem_default,@object");
...
__asm__(".equiv sysctl_rmem_max," __stringify(HAVE_SYSCTL_RMEM_MAX_ADDR));
__asm__(".type sysctl_rmem_max,@object");
...
__asm__(".equiv sysctl_wmem_max," __stringify(HAVE_SYSCTL_WMEM_MAX_ADDR));
__asm__(".type sysctl_wmem_max,@object");
...
__asm__(".equiv tcp_openreq_cachep," __stringify(HAVE_TCP_OPENREQ_CACHEP_ADDR));
__asm__(".type tcp_openreq_cachep,@object");
...
__asm__(".equiv tcp_set_keepalive," __stringify(HAVE_TCP_SET_KEEPALIVE_ADDR));
__asm__(".type tcp_set_keepalive,@function");
...
__asm__(".equiv tcp_sync_mss," __stringify(HAVE_TCP_SYNC_MSS_ADDR));
__asm__(".type tcp_sync_mss,@function");
...
__asm__(".equiv tcp_write_xmit," __stringify(HAVE_TCP_WRITE_XMIT_ADDR));
__asm__(".type tcp_write_xmit,@function");
...
__asm__(".equiv tcp_cwnd_application_limited," __stringify(HAVE_TCP_CWND_APPLICATION_LIMITED_ADDR));
__asm__(".type tcp_cwnd_application_limited,@function");
...
__asm__(".equiv sysctl_tcp_fin_timeout," __stringify(HAVE_SYSCTL_TCP_FIN_TIMEOUT_ADDR));
__asm__(".type sysctl_tcp_fin_timeout,@object");
...
#endif
__asm__(".equiv tcp_current_mss," __stringify(HAVE_TCP_CURRENT_MSS_ADDR));
__asm__(".type tcp_current_mss,@function");
...
#endif
__asm__(".equiv tcp_set_skb_tso_segs," __stringify(HAVE_TCP_SET_SKB_TSO_SEGS_ADDR));
__asm__(".type tcp_set_skb_tso_segs,@function");
...
__asm__(".equiv tcp_set_skb_tso_factor," __stringify(HAVE_TCP_SET_SKB_TSO_FACTOR_ADDR));
__asm__(".type tcp_set_skb_tso_factor,@function");
...
__asm__(".equiv sock_alloc," __stringify(HAVE_SOCK_ALLOC_ADDR));
__asm__(".type sock_alloc,@function");
...
__asm__(".equiv sysctl_local_port_range," __stringify(HAVE_SYSCTL_LOCAL_PORT_RANGE_ADDR));
__asm__(".type sysctl_local_port_range,@object");
...
__asm__(".equiv tcp_memory_allocated," __stringify(HAVE_TCP_MEMORY_ALLOCATED_ADDR));
__asm__(".type tcp_memory_allocated,@object");
...
__asm__(".equiv tcp_sockets_allocated," __stringify(HAVE_TCP_SOCKETS_ALLOCATED_ADDR));
__asm__(".type tcp_sockets_allocated,@object");
...
__asm__(".equiv tcp_orphan_count," __stringify(HAVE_TCP_ORPHAN_COUNT_ADDR));
__asm__(".type tcp_orphan_count,@object");
...
__asm__(".equiv tcp_tw_count," __stringify(HAVE_TCP_TW_COUNT_ADDR));
__asm__(".type tcp_tw_count,@object");
...
__asm__(".equiv ip_cmsg_recv," __stringify(HAVE_IP_CMSG_RECV_ADDR));
__asm__(".type ip_cmsg_recv,@function");
...
__asm__(".equiv ip_cmsg_send," __stringify(HAVE_IP_CMSG_SEND_ADDR));
__asm__(".type ip_cmsg_send,@function");
...
__asm__(".equiv inet_bind," __stringify(HAVE_INET_BIND_ADDR));
__asm__(".type inet_bind,@function");
...
__asm__(".equiv inet_ioctl," __stringify(HAVE_INET_IOCTL_ADDR));
__asm__(".type inet_ioctl,@function");
...
__asm__(".equiv inet_getname," __stringify(HAVE_INET_GETNAME_ADDR));
__asm__(".type inet_getname,@function");
...
__asm__(".equiv inet_multi_getname," __stringify(HAVE_INET_MULTI_GETNAME_ADDR));
__asm__(".type inet_multi_getname,@function");
...
__asm__(".equiv socket_get_info," __stringify(HAVE_SOCKET_GET_INFO_ADDR));
__asm__(".type socket_get_info,@function");
...
__asm__(".equiv afinet_get_info," __stringify(HAVE_AFINET_GET_INFO_ADDR));
__asm__(".type afinet_get_info,@function");
...
__asm__(".equiv tcp_prot," __stringify(HAVE_TCP_PROT_ADDR));
__asm__(".type tcp_prot,@object");
...
__asm__(".equiv udp_prot," __stringify(HAVE_UDP_PROT_ADDR));
__asm__(".type udp_prot,@object");
...
__asm__(".equiv raw_prot," __stringify(HAVE_RAW_PROT_ADDR));
__asm__(".type raw_prot,@object");
...
__asm__(".equiv secure_tcp_sequence_number," __stringify(HAVE_SECURE_TCP_SEQUENCE_NUMBER_ADDR));
__asm__(".type secure_tcp_sequence_number,@function");
...
__asm__(".equiv ioctl32_hash_table," __stringify(HAVE_IOCTL32_HASH_TABLE_ADDR));
__asm__(".type ioctl32_hash_table,@object");
...
__asm__(".equiv ioctl32_sem," __stringify(HAVE_IOCTL32_SEM_ADDR));
__asm__(".type ioctl32_sem,@object");
__asm__(".global ioctl32_sem");
EXPORT_SYMBOL_GPL(ioctl32_sem);
#endif				/* HAVE_IOCTL32_SEM_ADDR */

#ifdef HAVE_MOUNT_SEM_ADDR
__asm__(".equiv mount_sem," __stringify(HAVE_MOUNT_SEM_ADDR));
__asm__(".type mount_sem,@object");
...
__asm__(".equiv namespace_sem," __stringify(HAVE_NAMESPACE_SEM_ADDR));
__asm__(".type namespace_sem,@object");
...
__asm__(".equiv clone_mnt," __stringify(HAVE_CLONE_MNT_ADDR));
__asm__(".type clone_mnt,@function");
...
__asm__(".equiv check_mnt," __stringify(HAVE_CHECK_MNT_ADDR));
__asm__(".type check_mnt,@function");
...
#endif
__asm__(".equiv graft_tree," __stringify(HAVE_GRAFT_TREE_ADDR));
__asm__(".type graft_tree,@function");
...
__asm__(".equiv do_umount," __stringify(HAVE_DO_UMOUNT_ADDR));
__asm__(".type do_umount,@function");
...
__asm__(".equiv _def_fifo_ops," __stringify(HAVE__DEF_FIFO_OPS_ADDR));
__asm__(".type _def_fifo_ops,@object");
...
__asm__(".equiv __tcp_push_pending_frames," __stringify(HAVE___TCP_PUSH_PENDING_FRAMES_ADDR));
__asm__(".type __tcp_push_pending_frames,@function");
