...
static char const ident[] = "src/kernel/osfcompat.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define OSFCOMP_COPYRIGHT	"Copyright (c) 2008-2019  Monavacon Limited.  All Rights Reserved."
