/*****************************************************************************
 ...
 @(#) $RCSfile: streams.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:21:56 $
...
static char const ident[] = "$RCSfile: streams.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:21:56 $";
