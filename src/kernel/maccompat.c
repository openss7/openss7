...
static char const ident[] = "src/kernel/maccompat.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define MACCOMP_COPYRIGHT	"Copyright (c) 2008-2019  Monavacon Limited.  All Rights Reserved."
