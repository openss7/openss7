...
static char const ident[] = "src/drivers/hdlc.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define HDLC_REVISION	"OpenSS7 src/drivers/hdlc.c (" PACKAGE_ENVR ") " PACKAGE_DATE
