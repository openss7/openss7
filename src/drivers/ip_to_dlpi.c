/*****************************************************************************
 ...
 @(#) $RCSfile: ip_to_dlpi.c,v $ $Name:  $($Revision: 1.1.2.5 $) $Date: 2011-09-02 08:46:33 $
...
static char const ident[] = "$RCSfile: ip_to_dlpi.c,v $ $Name:  $($Revision: 1.1.2.5 $) $Date: 2011-09-02 08:46:33 $";
