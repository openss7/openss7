/*****************************************************************************
 ...
 @(#) $RCSfile: m3ua_mtpu.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:21:34 $
...
static char const ident[] = "$RCSfile: m3ua_mtpu.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:21:34 $";
