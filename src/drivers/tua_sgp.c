/*****************************************************************************
 ...
 @(#) $RCSfile: tua_sgp.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:57 $
...
#ident "@(#) $RCSfile: tua_sgp.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:57 $"

static char const ident[] = "$RCSfile: tua_sgp.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:57 $";
 ...
 */
static int
tua_recv_reg_req(sgp_t * sgp, mblk_t *msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 */
static int
tua_recv_reg_rsp(sgp_t * sgp, mblk_t *msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 */
static int
tua_recv_dereg_req(sgp_t * sgp, mblk_t *msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 */
static int
tua_recv_dereg_rsp(sgp_t * sgp, mblk_t *msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 */
static int
tua_recv_uni(sgp_t * sgp, mblk_t *msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 */
static int
tua_recv_beg(sgp_t * sgp, mblk_t *msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 */
static int
tua_recv_con(sgp_t * sgp, mblk_t *msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 */
static int
tua_recv_end(sgp_t * sgp, mblk_t *msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 */
static int
tua_recv_u_abt(sgp_t * sgp, mblk_t *msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 */
static int
tua_recv_p_abt(sgp_t * sgp, mblk_t *msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 */
static int
tua_recv_not(sgp_t * sgp, mblk_t *msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 */
static int
tua_recv_ivk(sgp_t * sgp, mblk_t *msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 */
static int
tua_recv_res(sgp_t * sgp, mblk_t *msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 */
static int
tua_recv_u_err(sgp_t * sgp, mblk_t *msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 */
static int
tua_recv_rej(sgp_t * sgp, mblk_t *msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
...
int
tua_recv_msg(sgp_t * sgp, mblk_t *msg)
{
