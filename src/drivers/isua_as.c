/*****************************************************************************
 ...
 @(#) $RCSfile: isua_as.c,v $ $Name:  $($Revision: 1.1.2.5 $) $Date: 2011-09-20 09:51:35 $
...
static char const ident[] = "$RCSfile: isua_as.c,v $ $Name:  $($Revision: 1.1.2.5 $) $Date: 2011-09-20 09:51:35 $";
