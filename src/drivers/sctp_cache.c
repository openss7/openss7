/*****************************************************************************
 ...
 @(#) $RCSfile: sctp_cache.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:52 $
...
#ident "@(#) $RCSfile: sctp_cache.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:52 $"

static char const ident[] = "$RCSfile: sctp_cache.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:52 $";
