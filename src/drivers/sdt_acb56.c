...
static char const ident[] = "src/drivers/sdt_acb56.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define ACB56_REVISION	"OpenSS7 src/drivers/sdt_acb56.c (" PACKAGE_ENVR ") " PACKAGE_DATE
...
#define ACB56_BANNER	ACB56_DESCRIP	"\n" \
			...
			ACB56_DEVICES	"\n" \
			ACB56_CONTACT	"\n"
#define ACB56_SPLASH	ACB56_DEVICE	" - " \
			ACB56_REVISION	"\n"
