/*****************************************************************************
 ...
 @(#) File: src/drivers/sl_x400p.curr.c
...
static char const ident[] = "src/drivers/sl_x400p.curr.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define SL_X400P_REVISION	"OpenSS7 src/drivers/sl_x400p.curr.c (" PACKAGE_ENVR ") " PACKAGE_DATE
