...
static char const ident[] = "src/drivers/cd-llc.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define LLC_REVISION	"OpenSS7 src/drivers/cd-llc.c (" PACKAGE_ENVR ") " PACKAGE_DATE
