/*****************************************************************************
 ...
 @(#) $RCSfile: m3ua_asp.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:48 $
...
#ident "@(#) $RCSfile: m3ua_asp.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:48 $"

static char const ident[] = "$RCSfile: m3ua_asp.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:48 $";
 ...
 */
static int
m3ua_recv_data(asp_t * asp, mblk_t *msg)
{
 ...
 */
static int
m3ua_distribute(asp_t * asp, mblk_t *mp, parm_t * rc)
{
	int i;
	mblk_t *dp, *ep;
...
static int
m3ua_snmm_parm_check(asp_t * asp, mblk_t *msg, m3ua_parms_t * parms)
{
	mblk_t *ep;
...
static int
m3ua_not_sg(asp_t * asp, mblk_t *msg)
{
	mblk_t *ep;
 ...
 */
static int
m3ua_recv_duna(asp_t * asp, mblk_t *msg)
{
	int err;
	mblk_t *mp;
	m3ua_parms_t parms;
 ...
 */
static int
m3ua_recv_dava(asp_t * asp, mblk_t *msg)
{
	(void) q;
	(void) msg;
	/* 
 ...
 */
static int
m3ua_recv_daud(asp_t * asp, mblk_t *msg)
{
	mblk_t *ep;
 ...
 */
static int
m3ua_recv_scon(asp_t * asp, mblk_t *msg)
{
	mblk_t *ep;
	size_t mlen = msgdsize(msg);
 ...
 */
static int
m3ua_recv_dupu(asp_t * asp, mblk_t *msg)
{
	mblk_t *ep;
	size_t mlen = msgdsize(msg);
 ...
 */
static int
m3ua_recv_drst(asp_t * asp, mblk_t *msg)
{
	mblk_t *ep;
	size_t mlen = msgdsize(msg);
 ...
 */
static int
m3ua_recv_reg_rsp(asp_t * asp, mblk_t *msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 */
static int
m3ua_recv_dereg_rsp(asp_t * asp, mblk_t *msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
...
int
m3ua_asp_recv_msg(asp_t * asp, mblk_t *mp)
{
