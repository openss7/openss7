/*****************************************************************************
 ...
 @(#) $RCSfile: isdn.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:46 $
...
#ident "@(#) $RCSfile: isdn.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:46 $"

static char const ident[] = "$RCSfile: isdn.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:46 $";
...
#define ISDN_REVISION	"LfS $RCSfile: isdn.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:46 $"
 ...
 *  =========================================================================
 */
STATIC kmem_cachep_t isdn_cc_cachep = NULL;
STATIC kmem_cachep_t isdn_cr_cachep = NULL;
STATIC kmem_cachep_t isdn_ch_cachep = NULL;
STATIC kmem_cachep_t isdn_tg_cachep = NULL;
STATIC kmem_cachep_t isdn_fg_cachep = NULL;
STATIC kmem_cachep_t isdn_eg_cachep = NULL;
STATIC kmem_cachep_t isdn_xg_cachep = NULL;
STATIC kmem_cachep_t isdn_dc_cachep = NULL;
STATIC kmem_cachep_t isdn_dl_cachep = NULL;
...
isdn_alloc_ch(ulong id, struct fg *fg, struct tg *tg, ulong ts)
{
	...
	if ((ch = kmem_cache_alloc(isdn_ch_cachep, GFP_ATOMIC))) {
		bzero(ch, sizeof(*ch));
		ch_get(ch);	/* first get */
