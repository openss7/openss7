...
static char const ident[] = "src/drivers/sscop_n.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define SSCOP_NPI_REVISION	"OpenSS7 src/drivers/sscop_n.c (" PACKAGE_ENVR ") " PACKAGE_DATE
