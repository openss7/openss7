...
static char const ident[] = "src/drivers/tl.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define TI_COPYRIGHT	"Copyright (c) 2008-2020  Monavacon Limited.  All Rights Reserved."
