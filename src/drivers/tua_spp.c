/*****************************************************************************
 ...
 @(#) $RCSfile: tua_spp.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:21:41 $
...
static char const ident[] = "$RCSfile: tua_spp.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:21:41 $";
