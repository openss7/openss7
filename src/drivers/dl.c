...
static char const ident[] = "src/drivers/dl.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define DL_REVISION	"OpenSS7 src/drivers/dl.c (" PACKAGE_ENVR ") " PACKAGE_DATE
