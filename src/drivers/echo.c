...
static char const ident[] = "src/drivers/echo.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define ECHO_COPYRIGHT	"Copyright (c) 2008-2019  Monavacon Limited.  All Rights Reserved."
