...
#define SDLM_REVISION	"OpenSS7 src/drivers/sdlm.c (" PACKAGE_ENVR ") " PACKAGE_DATE
#define SDLM_COPYRIGHT	"Copyright (c) 2008-2019  Monavacon Limited.  All Rights Reserved."
