...
static char const ident[] = "src/drivers/m3ua_as.old.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define M3UA_REVISION	"OpenSS7 src/drivers/m3ua_as.old.c (" PACKAGE_ENVR ") " PACKAGE_DATE
...
#define M3UA_BANNER	M3UA_DESCRIP	"\n" \
			...
			M3UA_DEVICES	"\n" \
			M3UA_CONTACT	"\n"
#define M3UA_SPLASH	M3UA_DEVICE	" - " \
			M3UA_REVISION	"\n"
