...
static char const ident[] = "src/drivers/sfx.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define SFX_COPYRIGHT	"Copyright (c) 2008-2019  Monavacon Limited.  All Rights Reserved."
