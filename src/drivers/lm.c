/*****************************************************************************
 ...
 @(#) $RCSfile: lm.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:47 $
...
#ident "@(#) $RCSfile: lm.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:47 $"

static char const ident[] = "$RCSfile: lm.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:47 $";
