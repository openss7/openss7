...
static char const ident[] = "src/drivers/fifo.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define FIFO_COPYRIGHT	"Copyright (c) 2008-2019  Monavacon Limited.  All Rights Reserved."
