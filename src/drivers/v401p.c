...
static char const ident[] = "src/drivers/v401p.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define MX_V400P_COPYRIGHT	"Copyright (c) 2008-2020  Monavacon Limited.  All Rights Reserved."
