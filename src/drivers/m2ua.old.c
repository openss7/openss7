...
static char const ident[] = "src/drivers/m2ua.old.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define M2UA_REVISION	"OpenSS7 src/drivers/m2ua.old.c (" PACKAGE_ENVR ") " PACKAGE_DATE
