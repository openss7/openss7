/*****************************************************************************
 ...
 @(#) $RCSfile: tali.c,v $ $Name:  $($Revision: 1.1.2.3 $) $Date: 2011-09-02 08:46:37 $
...
static char const ident[] = "$RCSfile: tali.c,v $ $Name:  $($Revision: 1.1.2.3 $) $Date: 2011-09-02 08:46:37 $";
