...
static char const ident[] = "src/drivers/socksys.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define SOCKSYS_COPYRIGHT	"Copyright (c) 2008-2020  Monavacon Limited.  All Rights Reserved."
