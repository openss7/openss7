/*****************************************************************************
 ...
 @(#) $RCSfile: sscop_recv.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:54 $
...
#ident "@(#) $RCSfile: sscop_recv.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:54 $"

static char const ident[] = "$RCSfile: sscop_recv.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:54 $";
