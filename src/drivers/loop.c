...
static char const ident[] = "src/drivers/loop.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define LOOP_COPYRIGHT	"Copyright (c) 2008-2020  Monavacon Limited.  All Rights Reserved."
