...
static char const ident[] = "src/drivers/sdt_x400p.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define SDT_X400P_COPYRIGHT	"Copyright (c) 2008-2020  Monavacon Limited.  All Rights Reserved."
