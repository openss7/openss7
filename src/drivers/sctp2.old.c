/*****************************************************************************
 ...
 @(#) $RCSfile: sctp2.old.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:51 $
...
#ident "@(#) $RCSfile: sctp2.old.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:51 $"

static char const ident[] = "$RCSfile: sctp2.old.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:51 $";
...
#define SCTP_REVISION	"OpenSS7 $RCSfile: sctp2.old.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:51 $"
 ...
 */
typedef typeof(ip_tos2prio[0]) ip_tos2prio_t;
ip_tos2prio_t ip_tos2prio[16] = { 0, 1, 0, 0, 2, 2, 2, 2, 6, 6, 6, 6, 4, 4, 4, 4 };
