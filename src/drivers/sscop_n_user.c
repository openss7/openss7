/*****************************************************************************
 ...
 @(#) $RCSfile: sscop_n_user.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:54 $
 ...
 $Log: sscop_n_user.c,v $
 Revision 1.1.2.1  2009-06-21 11:20:54  brian
 - added files to new distro

 *****************************************************************************/

#ident "@(#) $RCSfile: sscop_n_user.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:54 $"

static char const ident[] = "$RCSfile: sscop_n_user.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:54 $";
