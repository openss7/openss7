/*****************************************************************************
 ...
 @(#) $RCSfile: sscop_n2.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:21:37 $
...
static char const ident[] = "$RCSfile: sscop_n2.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:21:37 $";
