/*****************************************************************************
 ...
 @(#) $RCSfile: sscop_t_user.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:32:25 $
...
static char const ident[] = "$RCSfile: sscop_t_user.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:32:25 $";
