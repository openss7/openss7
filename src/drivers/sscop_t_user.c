/*****************************************************************************
 ...
 @(#) $RCSfile: sscop_t_user.c,v $ $Name:  $($Revision: 1.1.2.3 $) $Date: 2011-04-05 16:35:13 $
...
static char const ident[] = "$RCSfile: sscop_t_user.c,v $ $Name:  $($Revision: 1.1.2.3 $) $Date: 2011-04-05 16:35:13 $";
