/*****************************************************************************
 ...
 @(#) $RCSfile: tali_sccp.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:55 $
...
#ident "@(#) $RCSfile: tali_sccp.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:55 $"

static char const ident[] = "$RCSfile: tali_sccp.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2009-06-21 11:20:55 $";
