...
static char const ident[] = "src/drivers/dl2.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define ND_COPYRIGHT	"Copyright (c) 2008-2020  Monavacon Limited.  All Rights Reserved."
