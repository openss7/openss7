...
static char const ident[] = "src/drivers/mx.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define MX_REVISION	"OpenSS7 src/drivers/mx.c (" PACKAGE_ENVR ") " PACKAGE_DATE
