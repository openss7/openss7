...
static char const ident[] = "src/drivers/h225.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define ISDN_REVISION	"OpenSS7 File: " __FILE__ "  Version: " PACKAGE_ENVR "  Date: " PACKAGE_DATE
