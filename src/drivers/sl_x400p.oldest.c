...
static char const ident[] = "src/drivers/sl_x400p.oldest.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define SL_X400P_REVISION	"OpenSS7 src/drivers/sl_x400p.oldest.c (" PACKAGE_ENVR ") " PACKAGE_DATE
