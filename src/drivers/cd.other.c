...
static char const ident[] = "src/drivers/cd.other.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define HDLC_REVISION	"OpenSS7 src/drivers/cd.other.c (" PACKAGE_ENVR ") " PACKAGE_DATE
