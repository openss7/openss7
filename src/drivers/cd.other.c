/*****************************************************************************
 ...
 @(#) $RCSfile: cd.other.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:21:31 $
...
static char const ident[] = "$RCSfile: cd.other.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:21:31 $";
...
#define HDLC_REVISION	"OpenSS7 $RCSfile: cd.other.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:21:31 $"
