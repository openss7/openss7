/*****************************************************************************
 ...
 @(#) $RCSfile: tcap.c,v $ $Name:  $($Revision: 1.1.2.6 $) $Date: 2011-09-20 09:51:37 $
...
static char const ident[] = "$RCSfile: tcap.c,v $ $Name:  $($Revision: 1.1.2.6 $) $Date: 2011-09-20 09:51:37 $";
