/*****************************************************************************
 ...
 @(#) $RCSfile: nuls.c,v $ $Name:  $($Revision: 1.1.2.6 $) $Date: 2011-09-20 09:51:36 $
...
static char const ident[] = "$RCSfile: nuls.c,v $ $Name:  $($Revision: 1.1.2.6 $) $Date: 2011-09-20 09:51:36 $";
