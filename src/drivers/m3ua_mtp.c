/*****************************************************************************
 ...
 @(#) $RCSfile: m3ua_mtp.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:21:33 $
...
static char const ident[] = "$RCSfile: m3ua_mtp.c,v $ $Name:  $($Revision: 1.1.2.2 $) $Date: 2010-11-28 14:21:33 $";
