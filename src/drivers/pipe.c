...
static char const ident[] = "src/drivers/pipe.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define PIPE_COPYRIGHT	"Copyright (c) 2008-2019  Monavacon Limited.  All Rights Reserved."
