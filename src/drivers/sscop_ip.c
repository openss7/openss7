...
static char const ident[] = "src/drivers/sscop_ip.c (" PACKAGE_ENVR ") " PACKAGE_DATE;
...
#define SSCOP_REVISION	"OpenSS7 src/drivers/sscop_ip.c (" PACKAGE_ENVR ") " PACKAGE_DATE
