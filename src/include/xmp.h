/*****************************************************************************
 ...
 @(#) $Id: xmp.h,v 1.1.2.1 2009-06-21 11:23:46 brian Exp $
...
#ident "@(#) $RCSfile: xmp.h,v $ $Name:  $($Revision: 1.1.2.1 $) Copyright (c) 2008-2009 Monavacon Limited."
 ...
 *
 * In the header file, OM class constants are prefixed with the OMP_O prefix to denote that they are
