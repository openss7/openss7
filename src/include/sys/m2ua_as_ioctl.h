/*****************************************************************************
 ...
 @(#) $Id: m2ua_as_ioctl.h,v 1.1.2.1 2009-06-21 11:25:36 brian Exp $
...
#ident "@(#) $RCSfile: m2ua_as_ioctl.h,v $ $Name:  $($Revision: 1.1.2.1 $) Copyright (c) 2008-2009 Monavacon Limited."
