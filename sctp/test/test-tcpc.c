/*****************************************************************************
 ...
 @(#) $RCSfile: test-tcpc.c,v $ $Name:  $($Revision: 0.9.2.10 $) $Date: 2007/08/14 09:42:43 $
...
#ident "@(#) $RCSfile: test-tcpc.c,v $ $Name:  $($Revision: 0.9.2.10 $) $Date: 2007/08/14 09:42:43 $"

static char const ident[] = "$RCSfile: test-tcpc.c,v $ $Name:  $($Revision: 0.9.2.10 $) $Date: 2007/08/14 09:42:43 $";
