/*****************************************************************************
 ...
 @(#) $Id: etsi10.c,v 0.9.2.2 2001/04/27 14:10:16 brian Exp $
 ...
 Last Modified $Date: 2001/04/27 14:10:16 $ by $Author: brian $

 -----------------------------------------------------------------------------

 $Log: etsi10.c,v $
 Revision 0.9.2.2  2001/04/27 14:10:16  brian
 Initial revision

 Revision 0.1  2001/04/27 14:10:16  brian
 Initial revision

 *****************************************************************************/

static char const ident[] = "$Name:  $($Revision: 0.9.2.2 $) $Date: 2001/04/27 14:10:16 $";
...
#define TEST_PORT 10000
	addr[0].sin_port = htons(2964);
	addr[1].sin_port = htons(2964);
