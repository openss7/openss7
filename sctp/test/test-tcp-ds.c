/*****************************************************************************
 ...
 @(#) $RCSfile: test-tcp-ds.c,v $ $Name:  $($Revision: 0.9.2.10 $) $Date: 2008-10-31 12:47:13 $
 ...
 $Log: test-tcp-ds.c,v $
 Revision 0.9.2.10  2008-10-31 12:47:13  brian
 - missing definition

 Revision 0.9.2.9  2008-04-29 08:49:54  brian
 - updated headers for Affero release

 Revision 0.9.2.8  2007/08/14 09:42:43  brian
 - GPLv3 header update
...
#ident "@(#) $RCSfile: test-tcp-ds.c,v $ $Name:  $($Revision: 0.9.2.10 $) $Date: 2008-10-31 12:47:13 $"

static char const ident[] = "$RCSfile: test-tcp-ds.c,v $ $Name:  $($Revision: 0.9.2.10 $) $Date: 2008-10-31 12:47:13 $";
...
", NAME, PACKAGE, VERSION, "$Revision: 0.9.2.10 $ $Date: 2008-10-31 12:47:13 $");
}
