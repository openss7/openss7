/*****************************************************************************
 ...
 @(#) $RCSfile: test-tcp-ds.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2002/05/23 15:24:58 $
...
#ident "@(#) $RCSfile: test-tcp-ds.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2002/05/23 15:24:58 $"

static char const ident[] = "$RCSfile: test-tcp-ds.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2002/05/23 15:24:58 $";
