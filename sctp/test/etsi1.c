/*****************************************************************************
 ...
 @(#) $Id: etsi1.c,v 0.9.2.2 2001/04/25 10:52:05 brian Exp $
 ...
 Last Modified $Date: 2001/04/25 10:52:05 $ by $Author: brian $

 -----------------------------------------------------------------------------

 $Log: etsi1.c,v $
 Revision 0.9.2.2  2001/04/25 10:52:05  brian
 Initial revision

 Revision 0.1  2001/04/25 10:52:05  brian
 Initial revision

 *****************************************************************************/

static char const ident[] = "$Name:  $($Revision: 0.9.2.2 $) $Date: 2001/04/25 10:52:05 $";
...
main() {
	...
	inet_aton("192.168.12.1",	    &addr[0].sin_addr);
	inet_aton("192.169.12.1",	    &addr[1].sin_addr);
...
#define TEST_PORT 10000
	addr[0].sin_port = htons(3000);
	addr[1].sin_port = htons(3000);
...
//		goto dead;
	...
	if ( test_multi_bind(0,4,1) )
		goto dead;
	if ( test_connect(0,0,1) )
		goto dead;
