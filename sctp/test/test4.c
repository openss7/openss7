/*****************************************************************************
 ...
 @(#) $Id: test4.c,v 0.9.2.2 2001/04/16 04:55:04 brian Exp $
 ...
 Last Modified $Date: 2001/04/16 04:55:04 $ by $Author: brian $

 -----------------------------------------------------------------------------

 $Log: test4.c,v $
 Revision 0.9.2.2  2001/04/16 04:55:04  brian
 Initial revision

 Revision 0.1  2001/04/16 04:55:04  brian
 Initial revision

 *****************************************************************************/

static char const ident[] = "$Name:  $($Revision: 0.9.2.2 $) $Date: 2001/04/16 04:55:04 $";
...
void test_multi_bind(int n, int a, int m)
{
	int i;
...
//	printf("Testing single bind:\n");
	test_multi_bind(6,5,2);
	test_multi_bind(5,3,2);
	test_multi_bind(4,1,2);
	test_multi_bind(3,4,2);
	test_multi_bind(2,2,2);
	test_multi_bind(1,0,2);
	test_multi_bind(0,0,2);
