/*****************************************************************************
 ...
 @(#) $Id: etsi3.c,v 0.9.2.2 2001/04/27 13:22:45 brian Exp $
 ...
 Last Modified $Date: 2001/04/27 13:22:45 $ by $Author: brian $

 -----------------------------------------------------------------------------

 $Log: etsi3.c,v $
 Revision 0.9.2.2  2001/04/27 13:22:45  brian
 Initial revision

 Revision 0.1  2001/04/27 13:22:45  brian
 Initial revision

 *****************************************************************************/

static char const ident[] = "$Name:  $($Revision: 0.9.2.2 $) $Date: 2001/04/27 13:22:45 $";
...
main() {
	...
	inet_aton("192.168.18.1",	    &addr[0].sin_addr);
	inet_aton("192.169.18.1",	    &addr[1].sin_addr);
