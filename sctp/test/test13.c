/*****************************************************************************
 ...
 @(#) $Id: test13.c,v 0.9.2.3 2002/05/14 09:38:55 brian Exp $
 ...
 Revision 0.1.1.1  2001/04/25 06:22:41  brian
...
//      if ( send(s[n], "This is a test!", 16, MSG_OOB|MSG_NOSIGNAL) < 0 )
	if ((len = send(s[n], "This is a test!", 16, MSG_NOSIGNAL)) < 0)
		return show_error(__FUNCTION__);
...
#define TEST_PORT 10000
	...
	fprintf(stderr, "Reading data in 10 seconds...\n");
	sleep(10);
	...
	fprintf(stderr, "Closing in 10 seconds...\n");
	sleep(10);
