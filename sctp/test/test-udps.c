/*****************************************************************************
 ...
 @(#) $RCSfile: test-udps.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2002/05/22 14:34:53 $
...
#ident "@(#) $RCSfile: test-udps.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2002/05/22 14:34:53 $"
...
int main(int argc, char **argv)
{
	...
	while (1) {
		...
		c = getopt_long(argc, argv, "l:r:t:hp:", long_options,
				&option_index);
		if (c == -1)
			break;
		switch (c) {
