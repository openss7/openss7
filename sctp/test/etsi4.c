/*****************************************************************************
 ...
 @(#) $Id: etsi4.c,v 0.9.2.2 2001/04/25 14:12:19 brian Exp $
 ...
 Last Modified $Date: 2001/04/25 14:12:19 $ by $Author: brian $

 -----------------------------------------------------------------------------

 $Log: etsi4.c,v $
 Revision 0.9.2.2  2001/04/25 14:12:19  brian
 Initial revision

 Revision 0.1  2001/04/25 14:12:19  brian
 Initial revision

 *****************************************************************************/

static char const ident[] = "$Name:  $($Revision: 0.9.2.2 $) $Date: 2001/04/25 14:12:19 $";
...
#define TEST_PORT 10000
	addr[0].sin_port = htons(0);
	addr[1].sin_port = htons(0);
