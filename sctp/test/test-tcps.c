/*****************************************************************************
 ...
 @(#) $RCSfile: test-tcps.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2005/05/14 08:29:35 $
...
#ident "@(#) $RCSfile: test-tcps.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2005/05/14 08:29:35 $"

static char const ident[] = "$RCSfile: test-tcps.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2005/05/14 08:29:35 $";
