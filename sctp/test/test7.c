/*****************************************************************************
 ...
 @(#) $Id: test7.c,v 0.9.2.2 2001/04/18 00:24:24 brian Exp $
 ...
 Last Modified $Date: 2001/04/18 00:24:24 $ by $Author: brian $

 -----------------------------------------------------------------------------

 $Log: test7.c,v $
 Revision 0.9.2.2  2001/04/18 00:24:24  brian
 Initial revision

 Revision 0.1  2001/04/18 00:24:24  brian
 Initial revision

 *****************************************************************************/

static char const ident[] = "$Name:  $($Revision: 0.9.2.2 $) $Date: 2001/04/18 00:24:24 $";
...
main() {
	...
	inet_aton("192.168.0.5",    &addr[3].sin_addr);
