/*****************************************************************************
 ...
 @(#) $RCSfile: test-sctp-ss.c,v $ $Name:  $($Revision: 0.9.2.12 $) $Date: 2008-10-31 12:47:12 $
 ...
 Revision 0.9.2.9  2007/03/12 09:33:20  brian
 ...
 Revision 1.7  2005/05/14 08:29:35  brian
 - copyright header correction

 *****************************************************************************/

#ident "@(#) $RCSfile: test-sctp-ss.c,v $ $Name:  $($Revision: 0.9.2.12 $) $Date: 2008-10-31 12:47:12 $"

static char const ident[] = "$RCSfile: test-sctp-ss.c,v $ $Name:  $($Revision: 0.9.2.12 $) $Date: 2008-10-31 12:47:12 $";
...
//      unsigned char my_msg[] = "This is a good short test message that has some 64 bytes in it.";
	...
	if ((lfd = socket(PF_INET, SOCK_STREAM, IPPROTO_SCTP)) < 0) {
		perror("socket");
		goto dead1;
	}
