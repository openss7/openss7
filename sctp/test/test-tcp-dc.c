/*****************************************************************************
 ...
 @(#) $RCSfile: test-tcp-dc.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2007/08/14 09:42:43 $
...
#ident "@(#) $RCSfile: test-tcp-dc.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2007/08/14 09:42:43 $"

static char const ident[] = "$RCSfile: test-tcp-dc.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2007/08/14 09:42:43 $";
