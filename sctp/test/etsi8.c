/*****************************************************************************
 ...
 @(#) $Id: etsi8.c,v 0.9.2.2 2001/04/27 13:01:15 brian Exp $
 ...
 Last Modified $Date: 2001/04/27 13:01:15 $ by $Author: brian $

 -----------------------------------------------------------------------------

 $Log: etsi8.c,v $
 Revision 0.9.2.2  2001/04/27 13:01:15  brian
 Initial revision

 Revision 0.1  2001/04/27 13:01:15  brian
 Initial revision

 *****************************************************************************/

static char const ident[] = "$Name:  $($Revision: 0.9.2.2 $) $Date: 2001/04/27 13:01:15 $";
...
main() {
	...
	inet_aton("192.168.2.2",	    &addr[0].sin_addr);
	inet_aton("192.169.2.2",	    &addr[1].sin_addr);
...
#define TEST_PORT 10000
	addr[0].sin_port = htons(7);
	addr[1].sin_port = htons(7);
