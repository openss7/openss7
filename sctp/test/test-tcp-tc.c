/*****************************************************************************
 ...
 @(#) $RCSfile: test-tcp-tc.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2002/05/23 15:24:58 $
...
#ident "@(#) $RCSfile: test-tcp-tc.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2002/05/23 15:24:58 $"
...
void usage(void)
{
	fprintf(stderr, "Usage:  test-tcpc [options]\n");
	...
	fprintf(stderr,
		"      rem_host specifies the remote (sendto) address for the TCP\n");
