/*****************************************************************************
 ...
 @(#) $RCSfile: test-tcp-tc.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2008-10-31 12:47:13 $
 ...
 $Log: test-tcp-tc.c,v $
 Revision 0.9.2.9  2008-10-31 12:47:13  brian
 - missing definition

 Revision 0.9.2.8  2008-04-29 08:49:54  brian
 - updated headers for Affero release

 Revision 0.9.2.7  2007/08/14 09:42:43  brian
 - GPLv3 header update

 Revision 0.9.2.6  2007/03/12 09:33:21  brian
 - boosted default test port numbers from 10000 to 18000

 Revision 0.9.2.5  2005/07/18 11:56:35  brian
 - standard indentation

 Revision 0.9.2.4  2005/05/14 08:29:35  brian
 - copyright header correction

 Revision 1.4  2005/05/14 08:29:35  brian
 - copyright header correction

 *****************************************************************************/

#ident "@(#) $RCSfile: test-tcp-tc.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2008-10-31 12:47:13 $"

static char const ident[] = "$RCSfile: test-tcp-tc.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2008-10-31 12:47:13 $";
...
", NAME, PACKAGE, VERSION, "$Revision: 0.9.2.9 $ $Date: 2008-10-31 12:47:13 $");
}
