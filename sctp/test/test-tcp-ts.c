/*****************************************************************************
 ...
 @(#) $RCSfile: test-tcp-ts.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2008-04-29 08:49:54 $
...
#ident "@(#) $RCSfile: test-tcp-ts.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2008-04-29 08:49:54 $"

static char const ident[] = "$RCSfile: test-tcp-ts.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2008-04-29 08:49:54 $";
