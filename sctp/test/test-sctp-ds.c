/*****************************************************************************
 ...
 @(#) $RCSfile: test-sctp-ds.c,v $ $Name:  $($Revision: 0.9.2.13 $) $Date: 2008-10-31 12:47:12 $
 ...
 $Log: test-sctp-ds.c,v $
 Revision 0.9.2.13  2008-10-31 12:47:12  brian
 - missing definition

 Revision 0.9.2.12  2008-04-29 08:49:53  brian
 - updated headers for Affero release

 Revision 0.9.2.11  2007/08/14 09:42:43  brian
 - GPLv3 header update

 Revision 0.9.2.10  2007/03/12 09:33:20  brian
 - boosted default test port numbers from 10000 to 18000

 Revision 0.9.2.9  2005/07/18 11:56:33  brian
 - standard indentation

 Revision 0.9.2.8  2005/05/14 08:29:34  brian
 - copyright header correction

 Revision 1.8  2005/05/14 08:29:34  brian
 - copyright header correction

 *****************************************************************************/

#ident "@(#) $RCSfile: test-sctp-ds.c,v $ $Name:  $($Revision: 0.9.2.13 $) $Date: 2008-10-31 12:47:12 $"

static char const ident[] = "$RCSfile: test-sctp-ds.c,v $ $Name:  $($Revision: 0.9.2.13 $) $Date: 2008-10-31 12:47:12 $";
...
", NAME, PACKAGE, VERSION, "$Revision: 0.9.2.13 $ $Date: 2008-10-31 12:47:12 $");
}
