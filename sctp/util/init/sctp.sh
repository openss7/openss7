#!/bin/sh
#
# @(#) $RCSfile: sctp.sh,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2007/08/14 09:42:47 $
...
# -----------------------------------------------------------------------------
#
# Last Modified $Date: 2007/08/14 09:42:47 $ by $Author: brian $
#
# -----------------------------------------------------------------------------
#
# $Log: sctp.sh,v $
# Revision 0.9.2.7  2007/08/14 09:42:47  brian
# - GPLv3 header update
#
# =============================================================================
