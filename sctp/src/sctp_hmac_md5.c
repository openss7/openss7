/*****************************************************************************
 ...
 @(#) $RCSfile: sctp_hmac_md5.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2005/03/14 09:36:52 $
...
#ident "@(#) $RCSfile: sctp_hmac_md5.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2005/03/14 09:36:52 $"

static char const ident[] = "$RCSfile: sctp_hmac_md5.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2005/03/14 09:36:52 $";
