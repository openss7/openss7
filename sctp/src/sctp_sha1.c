/*****************************************************************************
 ...
 @(#) $RCSfile: sctp_sha1.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2005/01/11 08:28:55 $
...
#ident "@(#) $RCSfile: sctp_sha1.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2005/01/11 08:28:55 $"

static char const ident[] = "$RCSfile: sctp_sha1.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2005/01/11 08:28:55 $";
