/*****************************************************************************
 ...
 @(#) $RCSfile: sctp_sha1.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2005/01/01 11:17:54 $
...
#ident "@(#) $RCSfile: sctp_sha1.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2005/01/01 11:17:54 $"

static char const ident[] = "$RCSfile: sctp_sha1.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2005/01/01 11:17:54 $";
