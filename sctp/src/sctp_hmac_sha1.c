/*****************************************************************************
 ...
 @(#) $RCSfile: sctp_hmac_sha1.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2005/03/09 08:03:19 $
...
#ident "@(#) $RCSfile: sctp_hmac_sha1.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2005/03/09 08:03:19 $"

static char const ident[] = "$RCSfile: sctp_hmac_sha1.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2005/03/09 08:03:19 $";
