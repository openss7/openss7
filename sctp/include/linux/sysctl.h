...
enum
{
	...
	NET_SCTP_RTO_INITIAL=91,
	NET_SCTP_RTO_MIN=92,
	NET_SCTP_RTO_MAX=93,
	NET_SCTP_HEARTBEAT_ITVL=94,
	NET_SCTP_INIT_RETRIES=95,
	NET_SCTP_VALID_COOKIE_LIFE=96,
	NET_SCTP_MAX_SACK_DELAY=97,
	NET_SCTP_PATH_MAX_RETRANS=98,
	NET_SCTP_ASSOC_MAX_RETRANS=99,
	NET_SCTP_MAC_TYPE=100,
	NET_SCTP_CSUM_TYPE=101,
	NET_SCTP_COOKIE_INC=102,
	NET_SCTP_THROTTLE_ITVL=103,
	NET_SCTP_MEM=104,
	NET_SCTP_WMEM=105,
	NET_SCTP_RMEM=106,
	NET_SCTP_MAX_ISTREAMS=107,
	NET_SCTP_REQ_OSTREAMS=108,
	NET_SCTP_ECN=109,
	NET_SCTP_ADAPTATION_LAYER_INFO=110,
	NET_SCTP_PARTIAL_RELIABILITY=111,
	NET_SCTP_MAX_BURST=112,
};
