...
#define SCTP_SKB_SH_SRCE(__skb)	((__skb)->h.sh->srce)
#define SCTP_SKB_SH_DEST(__skb)	((__skb)->h.sh->dest)
#define SCTP_SKB_SH_VTAG(__skb)	((__skb)->h.sh->v_tag)
#define SCTP_SKB_SH_CSUM(__skb)	((__skb)->h.sh->check)
