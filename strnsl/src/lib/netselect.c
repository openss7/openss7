/*****************************************************************************
 ...
 @(#) $RCSfile: netselect.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2007/08/14 04:56:59 $
 ...
 $Log: netselect.c,v $
 Revision 0.9.2.4  2007/08/14 04:56:59  brian
 - GPLv3 header update
...
#ident "@(#) $RCSfile: netselect.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2007/08/14 04:56:59 $"
