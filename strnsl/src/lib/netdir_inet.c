/*****************************************************************************
 ...
 @(#) $RCSfile: netdir_inet.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/09/25 12:30:57 $
...
#ident "@(#) $RCSfile: netdir_inet.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/09/25 12:30:57 $"

static char const ident[] = "$RCSfile: netdir_inet.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/09/25 12:30:57 $";
