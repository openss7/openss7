...
# =============================================================================
# 
# @(#) $RCSfile: modsyms.sh,v $ $Name: OpenSS7-0_9_2 $($Revision: 0.9.2.10 $) $Date: 2008-04-28 09:23:11 $
#
# -----------------------------------------------------------------------------
#
...
version="3.0.0"
ident='$RCSfile: modsyms.sh,v $ $Name: OpenSS7-0_9_2 $($Revision: 0.9.2.10 $) $Date: 2008-04-28 09:23:11 $'
