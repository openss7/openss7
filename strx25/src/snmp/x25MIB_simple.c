...
init_x25MIB_simple(void)
{
	...
	REGISTER_MIB("x25MIB_simple", x25MIB_simple_variables, variable7,
		     x25MIB_simple_variables_oid);
 ...
 */
unsigned char *
var_x25MIB_simple(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len,
...
int
write_x25PLEAdministrativeState(int action, unsigned char *var_val, unsigned char var_val_type,
...
int
write_x25PLEFacilityNonNegotiable(int action, unsigned char *var_val, unsigned char var_val_type,
				  size_t var_val_len, unsigned char *statP, oid * name,
				  size_t name_len)
{
	static u_char string[SPRINT_MAX_LEN];
...
int
write_x25PLEFacilityAvailability(int action, unsigned char *var_val, unsigned char var_val_type,
				 size_t var_val_len, unsigned char *statP, oid * name,
				 size_t name_len)
{
	static u_char string[SPRINT_MAX_LEN];
...
int
write_x25PLEFacilityNegotiation(int action, unsigned char *var_val, unsigned char var_val_type,
				size_t var_val_len, unsigned char *statP, oid * name,
				size_t name_len)
{
	static u_char string[SPRINT_MAX_LEN];
...
int
write_x25PLEPacketSequenceNumbering(int action, unsigned char *var_val, unsigned char var_val_type,
				    size_t var_val_len, unsigned char *statP, oid * name,
				    size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDefaultPacketSizeIncoming(int action, unsigned char *var_val,
...
int
write_x25PLEDefaultPacketSizeOutgoing(int action, unsigned char *var_val,
				      unsigned char var_val_type, size_t var_val_len,
				      unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDefaultWindowSizeIncoming(int action, unsigned char *var_val,
				      unsigned char var_val_type, size_t var_val_len,
				      unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDefaultWindowSizeOutgoing(int action, unsigned char *var_val,
				      unsigned char var_val_type, size_t var_val_len,
				      unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDefaultThroughputClassIncoming(int action, unsigned char *var_val,
					   unsigned char var_val_type, size_t var_val_len,
					   unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDefaultThroughputClassOutgoing(int action, unsigned char *var_val,
					   unsigned char var_val_type, size_t var_val_len,
					   unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLESNServiceProvider(int action, unsigned char *var_val, unsigned char var_val_type,
			      size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static oid *objid;
	int size;
...
int
write_x25PLESNSAP(int action, unsigned char *var_val, unsigned char var_val_type,
		  size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static oid *objid;
	int size;
...
int
write_x25PLELogicalChannelAssignmentHIC(int action, unsigned char *var_val,
					unsigned char var_val_type, size_t var_val_len,
					unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLELogicalChannelAssignmentLIC(int action, unsigned char *var_val,
					unsigned char var_val_type, size_t var_val_len,
					unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLELogicalChannelAssignmentHTC(int action, unsigned char *var_val,
					unsigned char var_val_type, size_t var_val_len,
					unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLELogicalChannelAssignmentLTC(int action, unsigned char *var_val,
					unsigned char var_val_type, size_t var_val_len,
					unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLELogicalChannelAssignmentHOC(int action, unsigned char *var_val,
					unsigned char var_val_type, size_t var_val_len,
					unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLELogicalChannelAssignmentLOC(int action, unsigned char *var_val,
					unsigned char var_val_type, size_t var_val_len,
					unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEIVMODefaultPacketSizeIncoming(int action, unsigned char *var_val,
					  unsigned char var_val_type, size_t var_val_len,
					  unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEIVMODefaultPacketSizeOutgoing(int action, unsigned char *var_val,
					  unsigned char var_val_type, size_t var_val_len,
					  unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEIVMODefaultThroughputClassIncoming(int action, unsigned char *var_val,
					       unsigned char var_val_type, size_t var_val_len,
					       unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEIVMODefaultThroughputClassOutgoing(int action, unsigned char *var_val,
					       unsigned char var_val_type, size_t var_val_len,
					       unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEIVMODefaultWindowSizeIncoming(int action, unsigned char *var_val,
					  unsigned char var_val_type, size_t var_val_len,
					  unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEIVMODefaultWindowSizeOutgoing(int action, unsigned char *var_val,
					  unsigned char var_val_type, size_t var_val_len,
					  unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEIVMOFlowControlParameterNegotiation(int action, unsigned char *var_val,
						unsigned char var_val_type, size_t var_val_len,
						unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEIVMOLocalDTEAddress(int action, unsigned char *var_val, unsigned char var_val_type,
				size_t var_val_len, unsigned char *statP, oid * name,
				size_t name_len)
{
	static u_char string[SPRINT_MAX_LEN];
...
int
write_x25PLEIVMOLogicalChannelAssignmentHPC(int action, unsigned char *var_val,
					    unsigned char var_val_type, size_t var_val_len,
					    unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEIVMOLogicalChannelAssignmentLPC(int action, unsigned char *var_val,
					    unsigned char var_val_type, size_t var_val_len,
					    unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEIVMOLogicalChannelAssignmentHIC(int action, unsigned char *var_val,
					    unsigned char var_val_type, size_t var_val_len,
					    unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEIVMOLogicalChannelAssignmentLIC(int action, unsigned char *var_val,
					    unsigned char var_val_type, size_t var_val_len,
					    unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEIVMOLogicalChannelAssignmentHTC(int action, unsigned char *var_val,
					    unsigned char var_val_type, size_t var_val_len,
					    unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEIVMOLogicalChannelAssignmentLTC(int action, unsigned char *var_val,
					    unsigned char var_val_type, size_t var_val_len,
					    unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEIVMOLogicalChannelAssignmentHOC(int action, unsigned char *var_val,
					    unsigned char var_val_type, size_t var_val_len,
					    unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEIVMOLogicalChannelAssignmentLOC(int action, unsigned char *var_val,
					    unsigned char var_val_type, size_t var_val_len,
					    unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEIVMOSNServiceProvider(int action, unsigned char *var_val, unsigned char var_val_type,
				  size_t var_val_len, unsigned char *statP, oid * name,
				  size_t name_len)
{
	static oid *objid;
...
int
write_x25PLEIVMOThroughputClassNegotiation(int action, unsigned char *var_val,
					   unsigned char var_val_type, size_t var_val_len,
					   unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDTEPacketSequencing(int action, unsigned char *var_val, unsigned char var_val_type,
				size_t var_val_len, unsigned char *statP, oid * name,
				size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDTEMaxActiveCircuits(int action, unsigned char *var_val, unsigned char var_val_type,
				 size_t var_val_len, unsigned char *statP, oid * name,
				 size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDTECallDeflectionSubscription(int action, unsigned char *var_val,
					  unsigned char var_val_type, size_t var_val_len,
					  unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDTERestartTime(int action, unsigned char *var_val, unsigned char var_val_type,
			   size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PLEDTERestartCount(int action, unsigned char *var_val, unsigned char var_val_type,
			    size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PLEDTEMinimumRecallTimer(int action, unsigned char *var_val, unsigned char var_val_type,
				  size_t var_val_len, unsigned char *statP, oid * name,
				  size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDTERegistrationTime(int action, unsigned char *var_val, unsigned char var_val_type,
				size_t var_val_len, unsigned char *statP, oid * name,
				size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDTERegistrationCount(int action, unsigned char *var_val, unsigned char var_val_type,
				 size_t var_val_len, unsigned char *statP, oid * name,
				 size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDTERegistrationPermitted(int action, unsigned char *var_val, unsigned char var_val_type,
				     size_t var_val_len, unsigned char *statP, oid * name,
				     size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDTEProfile(int action, unsigned char *var_val, unsigned char var_val_type,
		       size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static oid *objid;
	int size;
...
int
write_x25PLEDTERowStatus(int action, unsigned char *var_val, unsigned char var_val_type,
			 size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PLEDCEPacketSequencing(int action, unsigned char *var_val, unsigned char var_val_type,
				size_t var_val_len, unsigned char *statP, oid * name,
				size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDCECallDeflectionSubscription(int action, unsigned char *var_val,
					  unsigned char var_val_type, size_t var_val_len,
					  unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDCECUG(int action, unsigned char *var_val, unsigned char var_val_type,
		   size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PLEDCEFastSelectAcceptance(int action, unsigned char *var_val, unsigned char var_val_type,
				    size_t var_val_len, unsigned char *statP, oid * name,
				    size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDCEIncomingCallsBarred(int action, unsigned char *var_val, unsigned char var_val_type,
				   size_t var_val_len, unsigned char *statP, oid * name,
				   size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDCEOneWayLogicalChannelOutgoing(int action, unsigned char *var_val,
					    unsigned char var_val_type, size_t var_val_len,
					    unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDCEOutgoingCallsBarred(int action, unsigned char *var_val, unsigned char var_val_type,
				   size_t var_val_len, unsigned char *statP, oid * name,
				   size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDCEBilateralCUG(int action, unsigned char *var_val, unsigned char var_val_type,
			    size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PLEDCEBilateralCUGWithOutgoingAccess(int action, unsigned char *var_val,
					      unsigned char var_val_type, size_t var_val_len,
					      unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDCECallRedirection(int action, unsigned char *var_val, unsigned char var_val_type,
			       size_t var_val_len, unsigned char *statP, oid * name,
			       size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDCEChargingInformation(int action, unsigned char *var_val, unsigned char var_val_type,
				   size_t var_val_len, unsigned char *statP, oid * name,
				   size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDCECUGWithIncomingAccess(int action, unsigned char *var_val, unsigned char var_val_type,
				     size_t var_val_len, unsigned char *statP, oid * name,
				     size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDCECUGWithOutgoingAccess(int action, unsigned char *var_val, unsigned char var_val_type,
				     size_t var_val_len, unsigned char *statP, oid * name,
				     size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDCEDBitModification(int action, unsigned char *var_val, unsigned char var_val_type,
				size_t var_val_len, unsigned char *statP, oid * name,
				size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDCEDefaultThroughputClassSubscription(int action, unsigned char *var_val,
						  unsigned char var_val_type, size_t var_val_len,
						  unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDCEDefaultThroughputClassSupported(int action, unsigned char *var_val,
					       unsigned char var_val_type, size_t var_val_len,
					       unsigned char *statP, oid * name, size_t name_len)
{
	static u_char string[SPRINT_MAX_LEN];
...
int
write_x25PLEDCEDefaultThroughputClassIncoming(int action, unsigned char *var_val,
					      unsigned char var_val_type, size_t var_val_len,
					      unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDCEDefaultThroughputClassOutgoing(int action, unsigned char *var_val,
					      unsigned char var_val_type, size_t var_val_len,
					      unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDCEHuntGroup(int action, unsigned char *var_val, unsigned char var_val_type,
			 size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PLEDCEIncomingCallBarredWithinCUG(int action, unsigned char *var_val,
					   unsigned char var_val_type, size_t var_val_len,
					   unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDCELocalChargingPrevention(int action, unsigned char *var_val,
				       unsigned char var_val_type, size_t var_val_len,
				       unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDCENonStandardDefaultPacketSizeSubscription(int action, unsigned char *var_val,
...
int
write_x25PLEDCENonStandardDefaultPacketSizeMaximum(int action, unsigned char *var_val,
						   unsigned char var_val_type, size_t var_val_len,
...
int
write_x25PLEDCENonStandardDefaultPacketSizeIncoming(int action, unsigned char *var_val,
						    unsigned char var_val_type, size_t var_val_len,
						    unsigned char *statP, oid * name,
						    size_t name_len)
{
...
int
write_x25PLEDCENonStandardDefaultPacketSizeOutgoing(int action, unsigned char *var_val,
						    unsigned char var_val_type, size_t var_val_len,
						    unsigned char *statP, oid * name,
						    size_t name_len)
{
...
int
write_x25PLEDCENonStandardDefaultWindowSizeSubscription(int action, unsigned char *var_val,
							unsigned char var_val_type,
							size_t var_val_len, unsigned char *statP,
							oid * name, size_t name_len)
{
...
int
write_x25PLEDCENonStandardDefaultWindowSizeMaximum(int action, unsigned char *var_val,
						   unsigned char var_val_type, size_t var_val_len,
						   unsigned char *statP, oid * name,
						   size_t name_len)
{
...
int
write_x25PLEDCENonStandardDefaultWindowSizeIncoming(int action, unsigned char *var_val,
						    unsigned char var_val_type, size_t var_val_len,
						    unsigned char *statP, oid * name,
						    size_t name_len)
{
...
int
write_x25PLEDCENonStandardDefaultWindowSizeOutgoing(int action, unsigned char *var_val,
						    unsigned char var_val_type, size_t var_val_len,
						    unsigned char *statP, oid * name,
						    size_t name_len)
{
...
int
write_x25PLEDCENUIOverride(int action, unsigned char *var_val, unsigned char var_val_type,
			   size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PLEDCENUISubscription(int action, unsigned char *var_val, unsigned char var_val_type,
			       size_t var_val_len, unsigned char *statP, oid * name,
			       size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDCEOneWayLogicalChannelIncoming(int action, unsigned char *var_val,
					    unsigned char var_val_type, size_t var_val_len,
					    unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDCEOnlineFacilityRegistration(int action, unsigned char *var_val,
					  unsigned char var_val_type, size_t var_val_len,
					  unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDCEOutgoingCallBarredWithinCUG(int action, unsigned char *var_val,
					   unsigned char var_val_type, size_t var_val_len,
					   unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDCEPacketRetransmission(int action, unsigned char *var_val, unsigned char var_val_type,
				    size_t var_val_len, unsigned char *statP, oid * name,
				    size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDCEReverseChargingAcceptance(int action, unsigned char *var_val,
					 unsigned char var_val_type, size_t var_val_len,
					 unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDCEROASubscription(int action, unsigned char *var_val, unsigned char var_val_type,
			       size_t var_val_len, unsigned char *statP, oid * name,
			       size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDCERestartIndication(int action, unsigned char *var_val, unsigned char var_val_type,
				 size_t var_val_len, unsigned char *statP, oid * name,
				 size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDCERestartCount(int action, unsigned char *var_val, unsigned char var_val_type,
			    size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PLEDCEIncomingCall(int action, unsigned char *var_val, unsigned char var_val_type,
			    size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PLEDCECallCount(int action, unsigned char *var_val, unsigned char var_val_type,
			 size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PLEDCEResetIndication(int action, unsigned char *var_val, unsigned char var_val_type,
			       size_t var_val_len, unsigned char *statP, oid * name,
			       size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDCEResetCount(int action, unsigned char *var_val, unsigned char var_val_type,
			  size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PLEDCEClearIndication(int action, unsigned char *var_val, unsigned char var_val_type,
			       size_t var_val_len, unsigned char *statP, oid * name,
			       size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDCEClearCount(int action, unsigned char *var_val, unsigned char var_val_type,
			  size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PLEDCEProfile(int action, unsigned char *var_val, unsigned char var_val_type,
		       size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static oid *objid;
	int size;
...
int
write_x25PLEDCERowStatus(int action, unsigned char *var_val, unsigned char var_val_type,
			 size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PLEDXEPacketSequencing(int action, unsigned char *var_val, unsigned char var_val_type,
				size_t var_val_len, unsigned char *statP, oid * name,
				size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDXEMaxActiveCircuits(int action, unsigned char *var_val, unsigned char var_val_type,
				 size_t var_val_len, unsigned char *statP, oid * name,
				 size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDXECallDeflectionSubscription(int action, unsigned char *var_val,
					  unsigned char var_val_type, size_t var_val_len,
					  unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDXERestartTime(int action, unsigned char *var_val, unsigned char var_val_type,
			   size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PLEDXERestartCount(int action, unsigned char *var_val, unsigned char var_val_type,
			    size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PLEDXEMinimumRecallTimer(int action, unsigned char *var_val, unsigned char var_val_type,
				  size_t var_val_len, unsigned char *statP, oid * name,
				  size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDXERegistrationTime(int action, unsigned char *var_val, unsigned char var_val_type,
				size_t var_val_len, unsigned char *statP, oid * name,
				size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDXERegistrationCount(int action, unsigned char *var_val, unsigned char var_val_type,
				 size_t var_val_len, unsigned char *statP, oid * name,
				 size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDXERegistrationPermitted(int action, unsigned char *var_val, unsigned char var_val_type,
				     size_t var_val_len, unsigned char *statP, oid * name,
				     size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEDXEPLEClientMOName(int action, unsigned char *var_val, unsigned char var_val_type,
			       size_t var_val_len, unsigned char *statP, oid * name,
			       size_t name_len)
{
	static oid *objid;
...
int
write_x25PLEDXEProfile(int action, unsigned char *var_val, unsigned char var_val_type,
		       size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static oid *objid;
	int size;
...
int
write_x25PLEDXERowStatus(int action, unsigned char *var_val, unsigned char var_val_type,
			 size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PLEIVMODTECallDeflectionSubscription(int action, unsigned char *var_val,
					      unsigned char var_val_type, size_t var_val_len,
					      unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEIVMODTECallTime(int action, unsigned char *var_val, unsigned char var_val_type,
			    size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PLEIVMODTEClearTime(int action, unsigned char *var_val, unsigned char var_val_type,
			     size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PLEIVMODTEClearCount(int action, unsigned char *var_val, unsigned char var_val_type,
			      size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PLEIVMODTEPacketSequencing(int action, unsigned char *var_val, unsigned char var_val_type,
				    size_t var_val_len, unsigned char *statP, oid * name,
				    size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEIVMODTEInterruptTime(int action, unsigned char *var_val, unsigned char var_val_type,
				 size_t var_val_len, unsigned char *statP, oid * name,
				 size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEIVMODTEMaxActiveCircuits(int action, unsigned char *var_val, unsigned char var_val_type,
				     size_t var_val_len, unsigned char *statP, oid * name,
				     size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEIVMODTEMinimumRecallTimer(int action, unsigned char *var_val,
				      unsigned char var_val_type, size_t var_val_len,
				      unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEIVMODTEResetTime(int action, unsigned char *var_val, unsigned char var_val_type,
			     size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PLEIVMODTEResetCount(int action, unsigned char *var_val, unsigned char var_val_type,
			      size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PLEIVMODTERestartTime(int action, unsigned char *var_val, unsigned char var_val_type,
			       size_t var_val_len, unsigned char *statP, oid * name,
			       size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEIVMODTERestartCount(int action, unsigned char *var_val, unsigned char var_val_type,
				size_t var_val_len, unsigned char *statP, oid * name,
				size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEIVMODTEWindowTime(int action, unsigned char *var_val, unsigned char var_val_type,
			      size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PLEIVMODTEDataTime(int action, unsigned char *var_val, unsigned char var_val_type,
			    size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PLEIVMODTEDataCount(int action, unsigned char *var_val, unsigned char var_val_type,
			     size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PLEIVMODTERejectTime(int action, unsigned char *var_val, unsigned char var_val_type,
			      size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PLEIVMODTERejectCount(int action, unsigned char *var_val, unsigned char var_val_type,
			       size_t var_val_len, unsigned char *statP, oid * name,
			       size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEIVMODTERegistrationTime(int action, unsigned char *var_val, unsigned char var_val_type,
				    size_t var_val_len, unsigned char *statP, oid * name,
				    size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEIVMODTERegistrationCount(int action, unsigned char *var_val, unsigned char var_val_type,
				     size_t var_val_len, unsigned char *statP, oid * name,
				     size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEIVMODTERegistrationPermitted(int action, unsigned char *var_val,
					 unsigned char var_val_type, size_t var_val_len,
					 unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25PLEIVMODTERowStatus(int action, unsigned char *var_val, unsigned char var_val_type,
			     size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PLEIVMODCERowStatus(int action, unsigned char *var_val, unsigned char var_val_type,
			     size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25VCPacketSequencing(int action, unsigned char *var_val, unsigned char var_val_type,
			    size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25VCPacketSizeIncoming(int action, unsigned char *var_val, unsigned char var_val_type,
			      size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25VCPacketSizeOutgoing(int action, unsigned char *var_val, unsigned char var_val_type,
			      size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25VCWindowSizeIncoming(int action, unsigned char *var_val, unsigned char var_val_type,
			      size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25VCWindowSizeOutgoing(int action, unsigned char *var_val, unsigned char var_val_type,
			      size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25VCThroughputClassIncoming(int action, unsigned char *var_val, unsigned char var_val_type,
				   size_t var_val_len, unsigned char *statP, oid * name,
				   size_t name_len)
{
	static long *long_ret;
...
int
write_x25VCThroughputClassOutgoing(int action, unsigned char *var_val, unsigned char var_val_type,
				   size_t var_val_len, unsigned char *statP, oid * name,
				   size_t name_len)
{
	static long *long_ret;
...
int
write_x25PVCDTELogicalChannel(int action, unsigned char *var_val, unsigned char var_val_type,
			      size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PVCDTERowStatus(int action, unsigned char *var_val, unsigned char var_val_type,
			 size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PVCDCELogicalChannel(int action, unsigned char *var_val, unsigned char var_val_type,
			      size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PVCDCEChargingDirection(int action, unsigned char *var_val, unsigned char var_val_type,
				 size_t var_val_len, unsigned char *statP, oid * name,
				 size_t name_len)
{
	static long *long_ret;
...
int
write_x25PVCDCERemoteDTEAddress(int action, unsigned char *var_val, unsigned char var_val_type,
				size_t var_val_len, unsigned char *statP, oid * name,
				size_t name_len)
{
	static u_char string[SPRINT_MAX_LEN];
...
int
write_x25PVCDCERemoteLogicalChannel(int action, unsigned char *var_val, unsigned char var_val_type,
				    size_t var_val_len, unsigned char *statP, oid * name,
				    size_t name_len)
{
	static long *long_ret;
...
int
write_x25PVCDCERowStatus(int action, unsigned char *var_val, unsigned char var_val_type,
			 size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PVCDXELogicalChannel(int action, unsigned char *var_val, unsigned char var_val_type,
			      size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25PVCDXERowStatus(int action, unsigned char *var_val, unsigned char var_val_type,
			 size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25SVCIVMOFastSelect(int action, unsigned char *var_val, unsigned char var_val_type,
			   size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25SVCIVMOPacketSizeIncoming(int action, unsigned char *var_val, unsigned char var_val_type,
				   size_t var_val_len, unsigned char *statP, oid * name,
				   size_t name_len)
{
	static long *long_ret;
...
int
write_x25SVCIVMOPacketSizeOutgoing(int action, unsigned char *var_val, unsigned char var_val_type,
				   size_t var_val_len, unsigned char *statP, oid * name,
				   size_t name_len)
{
	static long *long_ret;
...
int
write_x25SVCIVMOReverseCharging(int action, unsigned char *var_val, unsigned char var_val_type,
				size_t var_val_len, unsigned char *statP, oid * name,
				size_t name_len)
{
	static long *long_ret;
...
int
write_x25SVCIVMOThroughputClassIncoming(int action, unsigned char *var_val,
					unsigned char var_val_type, size_t var_val_len,
					unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25SVCIVMOThroughputClassOutgoing(int action, unsigned char *var_val,
					unsigned char var_val_type, size_t var_val_len,
					unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
...
int
write_x25SVCIVMOWindowSizeIncoming(int action, unsigned char *var_val, unsigned char var_val_type,
				   size_t var_val_len, unsigned char *statP, oid * name,
				   size_t name_len)
{
	static long *long_ret;
...
int
write_x25SVCIVMOWindowSizeOutgoing(int action, unsigned char *var_val, unsigned char var_val_type,
				   size_t var_val_len, unsigned char *statP, oid * name,
				   size_t name_len)
{
	static long *long_ret;
...
int
write_x25SVCIVMORowStatus(int action, unsigned char *var_val, unsigned char var_val_type,
			  size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25SVCIVMODTECallTime(int action, unsigned char *var_val, unsigned char var_val_type,
			    size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25SVCIVMODTEResetTime(int action, unsigned char *var_val, unsigned char var_val_type,
			     size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25SVCIVMODTEResetCount(int action, unsigned char *var_val, unsigned char var_val_type,
			      size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25SVCIVMODTEInterruptTime(int action, unsigned char *var_val, unsigned char var_val_type,
				 size_t var_val_len, unsigned char *statP, oid * name,
				 size_t name_len)
{
	static long *long_ret;
...
int
write_x25SVCIVMODTEClearTime(int action, unsigned char *var_val, unsigned char var_val_type,
			     size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25SVCIVMODTEClearCount(int action, unsigned char *var_val, unsigned char var_val_type,
			      size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25SVCIVMODTEWindowTime(int action, unsigned char *var_val, unsigned char var_val_type,
			      size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25SVCIVMODTEDataTime(int action, unsigned char *var_val, unsigned char var_val_type,
			    size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25SVCIVMODTEDataCount(int action, unsigned char *var_val, unsigned char var_val_type,
			     size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25SVCIVMODTERejectTime(int action, unsigned char *var_val, unsigned char var_val_type,
			      size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25SVCIVMODTERejectCount(int action, unsigned char *var_val, unsigned char var_val_type,
			       size_t var_val_len, unsigned char *statP, oid * name,
			       size_t name_len)
{
	static long *long_ret;
...
int
write_x25SVCIVMODTERowStatus(int action, unsigned char *var_val, unsigned char var_val_type,
			     size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25SVCIVMODXECallTime(int action, unsigned char *var_val, unsigned char var_val_type,
			    size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25SVCIVMODXEResetTime(int action, unsigned char *var_val, unsigned char var_val_type,
			     size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25SVCIVMODXEClearTime(int action, unsigned char *var_val, unsigned char var_val_type,
			     size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25SVCIVMODXEInterruptTime(int action, unsigned char *var_val, unsigned char var_val_type,
				 size_t var_val_len, unsigned char *statP, oid * name,
				 size_t name_len)
{
	static long *long_ret;
...
int
write_x25SVCIVMODXEResetCount(int action, unsigned char *var_val, unsigned char var_val_type,
			      size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25SVCIVMODXEClearCount(int action, unsigned char *var_val, unsigned char var_val_type,
			      size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25SVCIVMODXERowStatus(int action, unsigned char *var_val, unsigned char var_val_type,
			     size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25SVCIVMODXEWindowTime(int action, unsigned char *var_val, unsigned char var_val_type,
			      size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25SVCIVMODXEDataTime(int action, unsigned char *var_val, unsigned char var_val_type,
			    size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25SVCIVMODXEDataCount(int action, unsigned char *var_val, unsigned char var_val_type,
			     size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25SVCIVMODXERejectTime(int action, unsigned char *var_val, unsigned char var_val_type,
			      size_t var_val_len, unsigned char *statP, oid * name, size_t name_len)
{
	static long *long_ret;
	int size;
...
int
write_x25SVCIVMODXERejectCount(int action, unsigned char *var_val, unsigned char var_val_type,
			       size_t var_val_len, unsigned char *statP, oid * name,
			       size_t name_len)
{
	static long *long_ret;
