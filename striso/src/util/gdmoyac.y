/*****************************************************************************
 ...
 @(#) $Id: gdmoyac.y,v 0.9.2.3 2008-04-29 00:02:06 brian Exp $
...
#ident "@(#) $RCSfile: gdmoyac.y,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2008-04-29 00:02:06 $"

static char const ident[] = "$RCSfile: gdmoyac.y,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2008-04-29 00:02:06 $";
