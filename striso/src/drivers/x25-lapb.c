/*****************************************************************************
 ...
 @(#) $RCSfile: x25-lapb.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/04/12 20:36:01 $
 ...
 Last Modified $Date: 2006/04/12 20:36:01 $ by $Author: brian $
...
#ident "@(#) $RCSfile: x25-lapb.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/04/12 20:36:01 $"

static char const ident[] = "$RCSfile: x25-lapb.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/04/12 20:36:01 $";
