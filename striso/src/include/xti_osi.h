/*****************************************************************************
 ...
 @(#) $RCSfile: xti_osi.h,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2007/08/14 07:05:06 $
...
#ident "@(#) $RCSfile: xti_osi.h,v $ $Name:  $($Revision: 0.9.2.2 $) Copyright (c) 2001-2006 OpenSS7 Corporation."
