/*****************************************************************************
 ...
 @(#) $RCSfile: xot.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2008-10-30 18:31:41 $
 ...
 $Log: xot.c,v $
 Revision 0.9.2.4  2008-10-30 18:31:41  brian
 - rationalized drivers, modules and test programs

 Revision 0.9.2.3  2008-04-29 00:02:05  brian
 - updated headers for release

 Revision 0.9.2.2  2007/08/14 07:05:15  brian
 - GNUv3 header update
...
#ident "@(#) $RCSfile: xot.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2008-10-30 18:31:41 $"
...
#define XOT_REVISION	"OpenSS7 $RCSfile: xot.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2008-10-30 18:31:41 $"
...
#define MOD_ID		XOT_MOD_MOD_ID
#define MOD_NAME	XOT_MOD_NAME
#ifdef MODULE
#define MOD_BANNER	XOT_BANNER
#else				/* MODULE */
 ...
 */
static fastcall noinline __unlikely int
dl_error_ack(struct dl *dl, queue_t *q, mblk_t *msg, t_uscalar_t prim, t_scalar_t error)
{
	dl_error_ack_t *p;
	mblk_t *mp;
