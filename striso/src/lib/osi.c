/*****************************************************************************
 ...
 @(#) $RCSfile: osi.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/10/10 10:12:44 $
...
#ident "@(#) $RCSfile: osi.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/10/10 10:12:44 $"

static char const ident[] = "$RCSfile: osi.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/10/10 10:12:44 $";
