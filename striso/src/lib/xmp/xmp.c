/*****************************************************************************
 ...
 @(#) $RCSfile: xmp.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2008-04-29 00:02:03 $
 ...
 Last Modified $Date: 2008-04-29 00:02:03 $ by $Author: brian $

 -----------------------------------------------------------------------------

 $Log: xmp.c,v $
 Revision 0.9.2.2  2008-04-29 00:02:03  brian
...
#ident "@(#) $RCSfile: xmp.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2008-04-29 00:02:03 $"

static char const ident[] = "$RCSfile: xmp.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2008-04-29 00:02:03 $";
