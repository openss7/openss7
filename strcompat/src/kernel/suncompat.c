/*****************************************************************************
 ...
 @(#) $RCSfile: suncompat.c,v $ $Name:  $($Revision: 0.9.2.28 $) $Date: 2006/07/07 20:49:55 $
...
#ident "@(#) $RCSfile: suncompat.c,v $ $Name:  $($Revision: 0.9.2.28 $) $Date: 2006/07/07 20:49:55 $"
...
#define SUNCOMP_REVISION	"LfS $RCSfile: suncompat.c,v $ $Name:  $($Revision: 0.9.2.28 $) $Date: 2006/07/07 20:49:55 $"
