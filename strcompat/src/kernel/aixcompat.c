/*****************************************************************************
 ...
 @(#) $RCSfile: aixcompat.c,v $ $Name:  $($Revision: 0.9.2.22 $) $Date: 2006/07/02 12:17:53 $
 ...
 Last Modified $Date: 2006/07/02 12:17:53 $ by $Author: brian $

 *****************************************************************************/

#ident "@(#) $RCSfile: aixcompat.c,v $ $Name:  $($Revision: 0.9.2.22 $) $Date: 2006/07/02 12:17:53 $"
...
#define AIXCOMP_REVISION	"LfS $RCSfile: aixcompat.c,v $ $Name:  $($Revision: 0.9.2.22 $) $Date: 2006/07/02 12:17:53 $"
