/*****************************************************************************
 ...
 @(#) svr4ksyms.c,v (1.1.2.1) 2003/10/21 21:45:30
 ...
 Last Modified 2003/10/21 21:45:30 by brian

 *****************************************************************************/

#ident "@(#) svr4ksyms.c,v (1.1.2.1) 2003/10/21 21:45:30"

static char const ident[] = "svr4ksyms.c,v (1.1.2.1) 2003/10/21 21:45:30";
...
/* These are SVR4 symbols not directly associated with STREAMS.  Usually, Linux has an equivalent
   to all of these functions.  Some might not be too apparent, however.  When porting SVR4 STREAMS
   modules and drivers it might be necessary to configure for SVR4 compatibility to help with the
   initial port.  The driver should then be rewritten to use Linux kernel functions directly. */

EXPORT_SYMBOL_NOVERS(spl0);		/* svr4ddi.h */
EXPORT_SYMBOL_NOVERS(spl1);		/* svr4ddi.h */
EXPORT_SYMBOL_NOVERS(spl2);		/* svr4ddi.h */
EXPORT_SYMBOL_NOVERS(spl3);		/* svr4ddi.h */
EXPORT_SYMBOL_NOVERS(spl4);		/* svr4ddi.h */
EXPORT_SYMBOL_NOVERS(spl5);		/* svr4ddi.h */
EXPORT_SYMBOL_NOVERS(spl6);		/* svr4ddi.h */
...
#if 0
/* have to write these yet */
EXPORT_SYMBOL_NOVERS(itimeout);		/* svr4ddi.h *//* FIXME */
EXPORT_SYMBOL_NOVERS(makedev);		/* svr4ddi.h *//* FIXME */
EXPORT_SYMBOL_NOVERS(major);		/* svr4ddi.h *//* FIXME */
EXPORT_SYMBOL_NOVERS(minor);		/* svr4ddi.h *//* FIXME */
EXPORT_SYMBOL_NOVERS(sleep);		/* svr4ddi.h *//* FIXME */
EXPORT_SYMBOL_NOVERS(vtop);		/* svr4ddi.h *//* FIXME */
EXPORT_SYMBOL_NOVERS(wakeup);		/* svr4ddi.h *//* FIXME */
#endif
