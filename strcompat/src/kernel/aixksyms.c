/*****************************************************************************
 ...
 @(#) aixksyms.c,v (1.1.2.4) 2003/10/21 21:50:08
...
#ident "@(#) aixksyms.c,v (1.1.2.4) 2003/10/21 21:50:08"
...
/* these are AIX specific */
EXPORT_SYMBOL_NOVERS(mi_open_comm);	/* aixddi.h */
EXPORT_SYMBOL_NOVERS(mi_close_comm);	/* aixddi.h */
EXPORT_SYMBOL_NOVERS(mi_next_ptr);	/* aixddi.h */
EXPORT_SYMBOL_NOVERS(mi_prev_ptr);	/* aixddi.h */
EXPORT_SYMBOL_NOVERS(wantio);		/* aixddi.h */
EXPORT_SYMBOL_NOVERS(wantmsg);		/* aixddi.h */
#if 0
/* these are exported elsewhere 'cause they live in strsched.c and strreg.c */
EXPORT_SYMBOL_NOVERS(mi_bufcall);	/* aixddi.h see strsyms.c */
EXPORT_SYMBOL_NOVERS(str_install);	/* aixddi.h see strsyms.c */
#endif

#if 0
/* these are SVR4 functions, if you need them use CONFIG_STREAMS_COMPAT_SVR4 */
EXPORT_SYMBOL_NOVERS(splstr);		/* svr4ddi.h */
EXPORT_SYMBOL_NOVERS(splx);		/* svr4ddi.h */
#endif

#if 0
/* these are fairly common enhancements, you get these with CONFIG_STREAMS */
...
#if 0
/* these are basic stream functions, you get these with CONFIG_STREAMS */
