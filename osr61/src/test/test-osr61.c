/*****************************************************************************
 ...
 @(#) $RCSfile: test-osr61.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2007/08/14 09:06:53 $
 ...
 Last Modified $Date: 2007/08/14 09:06:53 $ by $Author: brian $

 -----------------------------------------------------------------------------

 $Log: test-osr61.c,v $
 Revision 0.9.2.3  2007/08/14 09:06:53  brian
 - GPLv3 header update
...
#ident "@(#) $RCSfile: test-osr61.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2007/08/14 09:06:53 $"

static char const ident[] = "$RCSfile: test-osr61.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2007/08/14 09:06:53 $";
...
#ifdef LFS
static char devname[256] = "/dev/streams/clone/osr";
#else
static char devname[256] = "/dev/osr";
#endif
