...
# =============================================================================
# 
# @(#) $RCSfile: modpost.sh,v $ $Name: OpenSS7-0_9_2 $($Revision: 0.9.2.17 $) $Date: 2006-11-03 10:39:13 $
#
# -----------------------------------------------------------------------------
#
...
version="3.0.0"
ident='$RCSfile: modpost.sh,v $ $Name: OpenSS7-0_9_2 $($Revision: 0.9.2.17 $) $Date: 2006-11-03 10:39:13 $'
