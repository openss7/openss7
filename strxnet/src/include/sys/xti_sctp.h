/*****************************************************************************
 ...
 @(#) $Id: xti_sctp.h,v 0.9.2.8 2006/10/19 12:48:33 brian Exp $
 ...
 Last Modified $Date: 2006/10/19 12:48:33 $ by $Author: brian $

 -----------------------------------------------------------------------------

 $Log: xti_sctp.h,v $
 Revision 0.9.2.8  2006/10/19 12:48:33  brian
...
#ident "@(#) $RCSfile: xti_sctp.h,v $ $Name:  $($Revision: 0.9.2.8 $) Copyright (c) 2001-2006 OpenSS7 Corporation."
