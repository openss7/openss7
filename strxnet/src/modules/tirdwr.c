/*****************************************************************************
 ...
 @(#) $RCSfile: tirdwr.c,v $ $Name:  $($Revision: 0.9.2.13 $) $Date: 2005/03/31 06:53:30 $
...
#ident "@(#) $RCSfile: tirdwr.c,v $ $Name:  $($Revision: 0.9.2.13 $) $Date: 2005/03/31 06:53:30 $"
...
#define TIRDWR_REVISION		"OpenSS7 $RCSfile: tirdwr.c,v $ $Name:  $($Revision: 0.9.2.13 $) $Date: 2005/03/31 06:53:30 $"
