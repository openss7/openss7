/*****************************************************************************
 ...
 @(#) $RCSfile: pthread.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2006/09/18 13:52:56 $
...
#ident "@(#) $RCSfile: pthread.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2006/09/18 13:52:56 $"

static char const ident[] = "$RCSfile: pthread.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2006/09/18 13:52:56 $";
