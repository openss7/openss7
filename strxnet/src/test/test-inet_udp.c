/*****************************************************************************
 ...
 @(#) $RCSfile: test-inet_udp.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2004/05/16 04:12:36 $
 ...
 Last Modified $Date: 2004/05/16 04:12:36 $ by <bidulock@openss7.org>
...
#ident "@(#) $RCSfile: test-inet_udp.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2004/05/16 04:12:36 $"

static char const ident[] = "$RCSfile: test-inet_udp.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2004/05/16 04:12:36 $";
