/*****************************************************************************
 ...
 @(#) $RCSfile: test-tirdwr.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/04/04 16:43:20 $
 ...
 Last Modified $Date: 2005/04/04 16:43:20 $ by <bidulock@openss7.org>

 *****************************************************************************/

#ident "@(#) $RCSfile: test-tirdwr.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/04/04 16:43:20 $"

static char const ident[] = "$RCSfile: test-tirdwr.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/04/04 16:43:20 $";
...
main(int argc, char *argv[])
{
	...
	for (;;) {
		...
		/* *INDENT-ON* */
		c = getopt_long_only(argc, argv, "f::so:t:mvhqVC?", long_options, &option_index);
#else				/* defined _GNU_SOURCE */
		c = getopt(argc, argv, "f::so:t:mvhqVC?");
