/*****************************************************************************
 ...
 @(#) $RCSfile: test-xnet.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2004/08/16 11:40:00 $
...
#ident "@(#) $RCSfile: test-xnet.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2004/08/16 11:40:00 $"

static char const ident[] = "$RCSfile: test-xnet.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2004/08/16 11:40:00 $";
