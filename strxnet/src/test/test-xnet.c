/*****************************************************************************
 ...
 @(#) $RCSfile: test-xnet.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2005/05/14 08:28:32 $
...
#ident "@(#) $RCSfile: test-xnet.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2005/05/14 08:28:32 $"

static char const ident[] = "$RCSfile: test-xnet.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2005/05/14 08:28:32 $";
