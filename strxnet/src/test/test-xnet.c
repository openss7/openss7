/*****************************************************************************
 ...
 @(#) $RCSfile: test-xnet.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/04/04 16:43:20 $
...
#ident "@(#) $RCSfile: test-xnet.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/04/04 16:43:20 $"

static char const ident[] = "$RCSfile: test-xnet.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/04/04 16:43:20 $";
