/*****************************************************************************
 ...
 @(#) $RCSfile: test-timod.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2004/08/16 11:39:59 $
 ...
 Last Modified $Date: 2004/08/16 11:39:59 $ by <bidulock@openss7.org>

 *****************************************************************************/

#ident "@(#) $RCSfile: test-timod.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2004/08/16 11:39:59 $"

static char const ident[] = "$RCSfile: test-timod.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2004/08/16 11:39:59 $";
...
-- TI_GETINFO IO control positive acknowledgement\n\
This test case test the execution of the TI_GETINFO IO control with positive\n\
results on using the timod module."
static int
test_case_2_1_top(int fd, int command)
{
	state = 0;
	if (do_signal(fd, __TEST_PUSH) != SUCCESS)
		return (FAILURE);
	state = 1;
	if (do_signal(fd, command) != SUCCESS)
		return (FAILURE);
	state = 2;
	if (do_signal(fd, __TEST_POP) != SUCCESS)
		return (FAILURE);
...
static int
test_case_2_1_bot(int fd, int signal, int expect)
{
	state = 0;
	start_tt(200);
	state = 1;
	if (get_event(fd) != signal)
		return (FAILURE);
	state = 2;
	if (do_signal(fd, expect) != SUCCESS)
		return (FAILURE);
	state = 3;
	start_tt(200);
	state = 4;
...
{
	return test_case_2_1_top(fd, __TEST_TI_GETINFO);
}
static int
...
Performing IO controls on the timod module\n\
-- TI_OPTMGMT IO control positive acknowledgement\n\
This test case test the execution of the TI_OPTMGMT IO control with positive\n\
results on using the timod module."
static int
test_case_2_1_2_top(int fd)
{
	return test_case_2_1_top(fd, __TEST_TI_OPTMGMT);
}
static int
test_case_2_1_2_bot(int fd)
{
	return test_case_2_1_bot(fd, __TEST_OPTMGMT_REQ, __TEST_OPTMGMT_ACK);
}

#define desc_case_2_1_3 "\
Performing IO controls on the timod module\n\
-- TI_BIND IO control positive acknowledgement\n\
This test case test the execution of the TI_BIND IO control with positive\n\
results on using the timod module."
static int
test_case_2_1_3_top(int fd)
{
	return test_case_2_1_top(fd, __TEST_TI_BIND);
}
static int
test_case_2_1_3_bot(int fd)
{
	return test_case_2_1_bot(fd, __TEST_BIND_REQ, __TEST_BIND_ACK);
}
...
{
	return test_case_2_1_top(fd, __TEST_TI_UNBIND);
}
static int
test_case_2_1_4_bot(int fd)
{
	return test_case_2_1_bot(fd, __TEST_UNBIND_REQ, __TEST_OK_ACK);
}

#define desc_case_2_1_5 "\
Performing IO controls on the timod module\n\
-- TI_GETMYNAME IO control positive acknowledgement\n\
This test case test the execution of the TI_GETMYNAME IO control with positive\n\
results on using the timod module."
static int
test_case_2_1_5_top(int fd)
{
	return test_case_2_1_top(fd, __TEST_TI_GETMYNAME);
}
static int
test_case_2_1_5_bot(int fd)
{
	return test_case_2_1_bot(fd, __TEST_ADDR_REQ, __TEST_ADDR_ACK);
}

#define desc_case_2_1_6 "\
Performing IO controls on the timod module\n\
-- TI_GETPEERNAME IO control positive acknowledgement\n\
This test case test the execution of the TI_GETPEERNAME IO control with positive\n\
results on using the timod module."
static int
test_case_2_1_6_top(int fd)
{
	return test_case_2_1_top(fd, __TEST_TI_GETPEERNAME);
}
static int
...
Performing IO controls on the timod module\n\
-- TI_SETMYNAME IO control positive acknowledgement\n\
This test case test the execution of the TI_SETMYNAME IO control with positive\n\
results on using the timod module."
static int
test_case_2_1_7_1_top(int fd)
{
	return test_case_2_1_top(fd, __TEST_TI_SETMYNAME);
}
static int
test_case_2_1_7_1_bot(int fd)
{
	return test_case_2_1_bot(fd, __TEST_CONN_RES, __TEST_OK_ACK);
}

#define desc_case_2_1_7_2 "\
Performing IO controls on the timod module\n\
-- TI_SETMYNAME (disconnect) IO control positive acknowledgement\n\
...
static int
test_case_2_1_7_2_top(int fd)
{
	return test_case_2_1_top(fd, __TEST_TI_SETMYNAME_DISC);
}
static int
test_case_2_1_7_2_bot(int fd)
{
...
Performing IO controls on the timod module\n\
-- TI_SETPEERNAME IO control positive acknowledgement\n\
This test case test the execution of the TI_SETPEERNAME IO control with positive\n\
results on using the timod module."
static int
test_case_2_1_8_1_top(int fd)
{
	return test_case_2_1_top(fd, __TEST_TI_SETPEERNAME);
}
static int
test_case_2_1_8_1_bot(int fd)
{
	return test_case_2_1_bot(fd, __TEST_CONN_REQ, __TEST_OK_ACK);
}

#define desc_case_2_1_8_2 "\
Performing IO controls on the timod module\n\
-- TI_SETPEERNAME (disconnect) IO control positive acknowledgement\n\
...
static int
test_case_2_1_8_2_top(int fd)
{
	return test_case_2_1_top(fd, __TEST_TI_SETPEERNAME_DISC);
}
static int
test_case_2_1_8_2_bot(int fd)
{
	return test_case_2_1_bot(fd, __TEST_DISCON_REQ, __TEST_OK_ACK);
}
...
results on using the timod module."
static int
test_case_2_1_9_top(int fd)
{
	return test_case_2_1_top(fd, __TEST_TI_SYNC);
}
static int
test_case_2_1_9_bot(int fd)
{
	return test_case_2_1_bot(fd, __TEST_INFO_REQ, __TEST_INFO_ACK);
}
...
Performing IO controls on the timod module\n\
-- TI_GETADDRS IO control positive acknowledgement\n\
This test case test the execution of the TI_GETADDRS IO control with positive\n\
results on using the timod module."
static int
test_case_2_1_10_top(int fd)
{
	return test_case_2_1_top(fd, __TEST_TI_GETADDRS);
}
static int
test_case_2_1_10_bot(int fd)
{
	return test_case_2_1_bot(fd, __TEST_ADDR_REQ, __TEST_ADDR_ACK);
}
...
Performing IO controls on the timod module\n\
-- TI_CAPABILITY IO control positive acknowledgement\n\
This test case test the execution of the TI_CAPABILITY IO control with positive\n\
results on using the timod module."
static int
test_case_2_1_11_top(int fd)
{
	return test_case_2_1_top(fd, __TEST_TI_CAPABILITY);
}
static int
test_case_2_1_11_bot(int fd)
{
	return test_case_2_1_bot(fd, __TEST_CAPABILITY_REQ, __TEST_CAPABILITY_ACK);
}

#define desc_case_2_2_1 "\
Performing IO controls on the timod module\n\
-- TI_GETINFO IO control negative acknowledgement\n\
This test case test the execution of the TI_GETINFO IO control with negative\n\
results on using the timod module."
static int
test_case_2_2_top(int fd, int command)
{
	state = 0;
	if (do_signal(fd, __TEST_PUSH) != SUCCESS)
		return (FAILURE);
	state = 1;
	if (do_signal(fd, command) == SUCCESS || last_errno != EPROTO)
		return (FAILURE);
	state = 2;
	if (do_signal(fd, __TEST_POP) != SUCCESS)
		return (FAILURE);
...
static int
test_case_2_2_bot(int fd, int signal, int expect)
{
	state = 0;
	start_tt(200);
	state = 1;
...
static int
test_case_2_2_1_top(int fd)
{
	return test_case_2_2_top(fd, __TEST_TI_GETINFO);
}
static int
test_case_2_2_1_bot(int fd)
{
...
Performing IO controls on the timod module\n\
-- TI_OPTMGMT IO control negative acknowledgement\n\
This test case test the execution of the TI_OPTMGMT IO control with negative\n\
results on using the timod module."
static int
test_case_2_2_2_top(int fd)
{
	return test_case_2_2_top(fd, __TEST_TI_OPTMGMT);
}
static int
test_case_2_2_2_bot(int fd)
{
	return test_case_2_2_bot(fd, __TEST_OPTMGMT_REQ, __TEST_ERROR_ACK);
}

#define desc_case_2_2_3 "\
Performing IO controls on the timod module\n\
-- TI_BIND IO control negative acknowledgement\n\
This test case test the execution of the TI_BIND IO control with negative\n\
results on using the timod module."
static int
test_case_2_2_3_top(int fd)
{
	return test_case_2_2_top(fd, __TEST_TI_BIND);
}
static int
test_case_2_2_3_bot(int fd)
{
	return test_case_2_2_bot(fd, __TEST_BIND_REQ, __TEST_ERROR_ACK);
}

#define desc_case_2_2_4 "\
Performing IO controls on the timod module\n\
-- TI_UNBIND IO control negative acknowledgement\n\
This test case test the execution of the TI_UNBIND IO control with negative\n\
results on using the timod module."
static int
test_case_2_2_4_top(int fd)
{
	return test_case_2_2_top(fd, __TEST_TI_UNBIND);
}
static int
test_case_2_2_4_bot(int fd)
{
	return test_case_2_2_bot(fd, __TEST_UNBIND_REQ, __TEST_ERROR_ACK);
}

#define desc_case_2_2_5 "\
Performing IO controls on the timod module\n\
-- TI_GETMYNAME IO control negative acknowledgement\n\
This test case test the execution of the TI_GETMYNAME IO control with negative\n\
results on using the timod module."
static int
test_case_2_2_5_top(int fd)
{
	return test_case_2_2_top(fd, __TEST_TI_GETMYNAME);
}
static int
test_case_2_2_5_bot(int fd)
{
	return test_case_2_2_bot(fd, __TEST_ADDR_REQ, __TEST_ERROR_ACK);
}

#define desc_case_2_2_6 "\
Performing IO controls on the timod module\n\
-- TI_GETPEERNAME IO control negative acknowledgement\n\
This test case test the execution of the TI_GETPEERNAME IO control with negative\n\
results on using the timod module."
static int
test_case_2_2_6_top(int fd)
{
	return test_case_2_2_top(fd, __TEST_TI_GETPEERNAME);
}
static int
test_case_2_2_6_bot(int fd)
{
	return test_case_2_2_bot(fd, __TEST_ADDR_REQ, __TEST_ERROR_ACK);
}
...
Performing IO controls on the timod module\n\
-- TI_SETMYNAME IO control negative acknowledgement\n\
This test case test the execution of the TI_SETMYNAME IO control with negative\n\
results on using the timod module."
static int
test_case_2_2_7_1_top(int fd)
{
	return test_case_2_2_top(fd, __TEST_TI_SETMYNAME);
}
static int
test_case_2_2_7_1_bot(int fd)
{
	return test_case_2_2_bot(fd, __TEST_CONN_RES, __TEST_ERROR_ACK);
}

#define desc_case_2_2_7_2 "\
Performing IO controls on the timod module\n\
-- TI_SETMYNAME (disconnect) IO control negative acknowledgement\n\
This test case test the execution of the TI_SETMYNAME (disconnect) IO control\n\
with negative results on using the timod module."
static int
test_case_2_2_7_2_top(int fd)
{
	return test_case_2_2_top(fd, __TEST_TI_SETMYNAME_DISC);
}
static int
test_case_2_2_7_2_bot(int fd)
{
...
Performing IO controls on the timod module\n\
-- TI_SETPEERNAME IO control negative acknowledgement\n\
This test case test the execution of the TI_SETPEERNAME IO control with negative\n\
results on using the timod module."
static int
test_case_2_2_8_1_top(int fd)
{
	return test_case_2_2_top(fd, __TEST_TI_SETPEERNAME);
}
static int
test_case_2_2_8_1_bot(int fd)
{
	return test_case_2_2_bot(fd, __TEST_CONN_REQ, __TEST_ERROR_ACK);
}

#define desc_case_2_2_8_2 "\
Performing IO controls on the timod module\n\
-- TI_SETPEERNAME (disconnect) IO control negative acknowledgement\n\
This test case test the execution of the TI_SETPEERNAME (disconnect) IO\n\
control with negative results on using the timod module."
static int
test_case_2_2_8_2_top(int fd)
{
	return test_case_2_2_top(fd, __TEST_TI_SETPEERNAME_DISC);
}
static int
test_case_2_2_8_2_bot(int fd)
{
	return test_case_2_2_bot(fd, __TEST_DISCON_REQ, __TEST_ERROR_ACK);
}
...
results on using the timod module."
static int
test_case_2_2_9_top(int fd)
{
	return test_case_2_2_top(fd, __TEST_TI_SYNC);
}
static int
test_case_2_2_9_bot(int fd)
{
	return test_case_2_2_bot(fd, __TEST_INFO_REQ, __TEST_ERROR_ACK);
}
...
Performing IO controls on the timod module\n\
-- TI_GETADDRS IO control negative acknowledgement\n\
This test case test the execution of the TI_GETADDRS IO control with negative\n\
results on using the timod module."
static int
test_case_2_2_10_top(int fd)
{
	return test_case_2_2_top(fd, __TEST_TI_GETADDRS);
}
static int
test_case_2_2_10_bot(int fd)
{
	return test_case_2_2_bot(fd, __TEST_ADDR_REQ, __TEST_ERROR_ACK);
}
...
Performing IO controls on the timod module\n\
-- TI_CAPABILITY IO control negative acknowledgement\n\
This test case test the execution of the TI_CAPABILITY IO control with negative\n\
results on using the timod module."
static int
test_case_2_2_11_top(int fd)
{
	return test_case_2_2_top(fd, __TEST_TI_CAPABILITY);
}
static int
test_case_2_2_11_bot(int fd)
{
	return test_case_2_2_bot(fd, __TEST_CAPABILITY_REQ, __TEST_ERROR_ACK);
}

#define desc_case_2_3 "\
Multiple process IO controls\n\
-- two child processes attempting same IO control\n\
...
test_case_2_3_top(int fd)
{
	...
	case 00:		/* the child */
		state = 3;
		if (do_signal(fd, __TEST_TI_GETINFO) == SUCCESS || last_errno == EPROTO)
			exit(SUCCESS);
		state = 4;
		exit(FAILURE);
	default:		/* the parent */
	{
		...
		int result;
		state = 5;
		if ((result = do_signal(fd, __TEST_TI_GETINFO)) != SUCCESS && last_errno != EPROTO)
			return (FAILURE);
		state = 6;
		...
		if (WIFEXITED(status)) {
			...
			state = 9;
			if ((result == SUCCESS && cresult == FAILURE) || (cresult == SUCCESS && result == FAILURE))
				break;
			state = 10;
			return (FAILURE);
		}
...
test_case_2_3_bot(int fd)
{
	...
	state = 9;
	if (do_signal(fd, __TEST_INFO_ACK) != SUCCESS)
		return (FAILURE);
	state = 10;
	start_tt(200);
	switch (get_event(fd)) {
...
static int
test_case_2_4_bot(int fd, int signal, int expect)
{
	state = 0;
	start_tt(200);
	state = 1;
...
{
	return test_case_2_4_top(fd, __TEST_TI_SETMYNAME_DATA);
}
static int
test_case_2_4_1_bot(int fd)
{
	return test_case_2_4_bot(fd, __TEST_CONN_RES, __TEST_OK_ACK);
}

#define desc_case_2_4_2 "\
IO controls with data\n\
-- TI_SETPEERNAME with data\n\
Tests that IO controls with optional data parts can be sent with data.\n\
This test case tests the TI_SETPEERNAME IO control."
static int
test_case_2_4_2_top(int fd)
{
	return test_case_2_4_top(fd, __TEST_TI_SETPEERNAME_DATA);
}
static int
test_case_2_4_2_bot(int fd)
{
	return test_case_2_4_bot(fd, __TEST_CONN_REQ, __TEST_OK_ACK);
}

#define desc_case_2_4_3 "\
IO controls with data\n\
-- TI_SETMYNAME (disconnect) with data\n\
Tests that IO controls with optional data parts can be sent with data.\n\
This test case tests the TI_SETMYNAME (disconnect) IO control."
static int
test_case_2_4_3_top(int fd)
{
	return test_case_2_4_top(fd, __TEST_TI_SETMYNAME_DISC_DATA);
}
static int
test_case_2_4_3_bot(int fd)
{
	return test_case_2_4_bot(fd, __TEST_DISCON_REQ, __TEST_OK_ACK);
}

#define desc_case_2_4_4 "\
IO controls with data\n\
-- TI_SETPEERNAME (disconnect) with data\n\
Tests that IO controls with optional data parts can be sent with data.\n\
This test case tests the TI_SETPEERNAME (disconnect) IO control."
static int
test_case_2_4_4_top(int fd)
{
	return test_case_2_4_top(fd, __TEST_TI_SETPEERNAME_DISC_DATA);
}
static int
test_case_2_4_4_bot(int fd)
{
	return test_case_2_4_bot(fd, __TEST_DISCON_REQ, __TEST_OK_ACK);
}

#define desc_case_3_1_1 "\
Non-IO control pass through of TPI messages\n\
-- T_INFO_REQ with positive acknowledgement.\n\
This test case test the pass through of T_INFO_REQ with positive\n\
acknowledgement."
static int
test_case_3_1_top(int fd, int signal, int expect)
{
	state = 0;
	if (do_signal(fd, __TEST_PUSH) != SUCCESS)
		return (FAILURE);
	...
	state = 2;
	start_tt(200);
	if (get_event(fd) == expect) {
		state = 3;
		if (do_signal(fd, __TEST_POP) != SUCCESS)
			return (FAILURE);
		state = 6;
		return (SUCCESS);
	} else if (last_event == TIMEOUT) {
		state = 4;
		return (FAILURE);
	}
	state = 5;
...
static int
test_case_3_1_bot(int fd, int signal, int expect)
{
	state = 0;
	start_tt(200);
	state = 1;
...
{
	return test_case_3_1_top(fd, __TEST_INFO_REQ, __TEST_INFO_ACK);
}
static int
test_case_3_1_1_bot(int fd)
{
	return test_case_3_1_bot(fd, __TEST_INFO_REQ, __TEST_INFO_ACK);
}

#define desc_case_3_1_2 "\
Non-IO control pass through of TPI messages\n\
-- T_CONN_REQ with positive acknowledgement.\n\
This test case test the pass through of T_CONN_REQ with positive\n\
acknowledgement."
static int
test_case_3_1_2_top(int fd)
{
	return test_case_3_1_top(fd, __TEST_CONN_REQ, __TEST_OK_ACK);
}
static int
test_case_3_1_2_bot(int fd)
{
	return test_case_3_1_bot(fd, __TEST_CONN_REQ, __TEST_OK_ACK);
}

#define desc_case_3_1_3 "\
Non-IO control pass through of TPI messages\n\
-- T_CONN_RES with positive acknowledgement.\n\
This test case test the pass through of T_CONN_RES with positive\n\
acknowledgement."
static int
test_case_3_1_3_top(int fd)
{
	return test_case_3_1_top(fd, __TEST_CONN_RES, __TEST_OK_ACK);
}
static int
test_case_3_1_3_bot(int fd)
{
	return test_case_3_1_bot(fd, __TEST_CONN_RES, __TEST_OK_ACK);
}

#define desc_case_3_1_4 "\
Non-IO control pass through of TPI messages\n\
-- T_DISCON_REQ with positive acknowledgement.\n\
This test case test the pass through of T_DISCON_REQ with positive\n\
acknowledgement."
static int
test_case_3_1_4_top(int fd)
{
	return test_case_3_1_top(fd, __TEST_DISCON_REQ, __TEST_OK_ACK);
}
static int
test_case_3_1_4_bot(int fd)
{
	return test_case_3_1_bot(fd, __TEST_DISCON_REQ, __TEST_OK_ACK);
}

#define desc_case_3_1_5 "\
Non-IO control pass through of TPI messages\n\
-- T_BIND_REQ with positive acknowledgement.\n\
This test case test the pass through of T_BIND_REQ with positive\n\
acknowledgement."
static int
test_case_3_1_5_top(int fd)
{
	return test_case_3_1_top(fd, __TEST_BIND_REQ, __TEST_BIND_ACK);
}
static int
test_case_3_1_5_bot(int fd)
{
	return test_case_3_1_bot(fd, __TEST_BIND_REQ, __TEST_BIND_ACK);
}

#define desc_case_3_1_6 "\
Non-IO control pass through of TPI messages\n\
-- T_UNBIND_REQ with positive acknowledgement.\n\
This test case test the pass through of T_UNBIND_REQ with positive\n\
acknowledgement."
static int
test_case_3_1_6_top(int fd)
{
	return test_case_3_1_top(fd, __TEST_UNBIND_REQ, __TEST_OK_ACK);
}
static int
test_case_3_1_6_bot(int fd)
{
	return test_case_3_1_bot(fd, __TEST_UNBIND_REQ, __TEST_OK_ACK);
}

#define desc_case_3_1_7 "\
Non-IO control pass through of TPI messages\n\
-- T_OPTMGMT_REQ with positive acknowledgement.\n\
This test case test the pass through of T_OPTMGMT_REQ with positive\n\
acknowledgement."
static int
test_case_3_1_7_top(int fd)
{
	return test_case_3_1_top(fd, __TEST_OPTMGMT_REQ, __TEST_OPTMGMT_ACK);
}
static int
test_case_3_1_7_bot(int fd)
{
	return test_case_3_1_bot(fd, __TEST_OPTMGMT_REQ, __TEST_OPTMGMT_ACK);
}

#define desc_case_3_1_8 "\
Non-IO control pass through of TPI messages\n\
-- T_ADDR_REQ with positive acknowledgement.\n\
This test case test the pass through of T_ADDR_REQ with positive\n\
acknowledgement."
static int
test_case_3_1_8_top(int fd)
{
	return test_case_3_1_top(fd, __TEST_ADDR_REQ, __TEST_ADDR_ACK);
}
static int
test_case_3_1_8_bot(int fd)
{
	return test_case_3_1_bot(fd, __TEST_ADDR_REQ, __TEST_ADDR_ACK);
}

#define desc_case_3_1_9 "\
Non-IO control pass through of TPI messages\n\
-- T_CAPABILITY_REQ with positive acknowledgement.\n\
This test case test the pass through of T_CAPABILITY_REQ with positive\n\
acknowledgement."
static int
test_case_3_1_9_top(int fd)
{
	return test_case_3_1_top(fd, __TEST_CAPABILITY_REQ, __TEST_CAPABILITY_ACK);
}
static int
test_case_3_1_9_bot(int fd)
{
	return test_case_3_1_bot(fd, __TEST_CAPABILITY_REQ, __TEST_CAPABILITY_ACK);
}

#define desc_case_3_2_1 "\
Non-IO control pass through of TPI messages\n\
-- T_INFO_REQ with negative acknowledgement.\n\
This test case test the pass through of T_INFO_REQ with negative\n\
acknowledgement."
static int
test_case_3_2_top(int fd, int signal)
{
	state = 0;
	if (do_signal(fd, __TEST_PUSH) != SUCCESS)
		return (FAILURE);
	...
	state = 2;
	start_tt(200);
	if (get_event(fd) == __TEST_ERROR_ACK) {
		state = 3;
		if (do_signal(fd, __TEST_POP) != SUCCESS)
			return (FAILURE);
		state = 6;
...
static int
test_case_3_2_bot(int fd, int signal)
{
	state = 0;
	start_tt(200);
	state = 1;
...
{
	return test_case_3_2_top(fd, __TEST_INFO_REQ);
}
static int
test_case_3_2_1_bot(int fd)
{
	return test_case_3_2_bot(fd, __TEST_INFO_REQ);
}

#define desc_case_3_2_2 "\
Non-IO control pass through of TPI messages\n\
-- T_CONN_REQ with negative acknowledgement.\n\
This test case test the pass through of T_CONN_REQ with negative\n\
acknowledgement."
static int
test_case_3_2_2_top(int fd)
{
	return test_case_3_2_top(fd, __TEST_CONN_REQ);
}
static int
test_case_3_2_2_bot(int fd)
{
	return test_case_3_2_bot(fd, __TEST_CONN_REQ);
}

#define desc_case_3_2_3 "\
Non-IO control pass through of TPI messages\n\
-- T_CONN_RES with negative acknowledgement.\n\
This test case test the pass through of T_CONN_RES with negative\n\
acknowledgement."
static int
test_case_3_2_3_top(int fd)
{
	return test_case_3_2_top(fd, __TEST_CONN_RES);
}
static int
test_case_3_2_3_bot(int fd)
{
	return test_case_3_2_bot(fd, __TEST_CONN_RES);
}

#define desc_case_3_2_4 "\
Non-IO control pass through of TPI messages\n\
-- T_DISCON_REQ with negative acknowledgement.\n\
This test case test the pass through of T_DISCON_REQ with negative\n\
acknowledgement."
static int
test_case_3_2_4_top(int fd)
{
	return test_case_3_2_top(fd, __TEST_DISCON_REQ);
}
static int
test_case_3_2_4_bot(int fd)
{
	return test_case_3_2_bot(fd, __TEST_DISCON_REQ);
}

#define desc_case_3_2_5 "\
Non-IO control pass through of TPI messages\n\
-- T_BIND_REQ with negative acknowledgement.\n\
This test case test the pass through of T_BIND_REQ with negative\n\
acknowledgement."
static int
test_case_3_2_5_top(int fd)
{
	return test_case_3_2_top(fd, __TEST_BIND_REQ);
}
static int
test_case_3_2_5_bot(int fd)
{
	return test_case_3_2_bot(fd, __TEST_BIND_REQ);
}

#define desc_case_3_2_6 "\
Non-IO control pass through of TPI messages\n\
-- T_UNBIND_REQ with negative acknowledgement.\n\
This test case test the pass through of T_UNBIND_REQ with negative\n\
acknowledgement."
static int
test_case_3_2_6_top(int fd)
{
	return test_case_3_2_top(fd, __TEST_UNBIND_REQ);
}
static int
test_case_3_2_6_bot(int fd)
{
	return test_case_3_2_bot(fd, __TEST_UNBIND_REQ);
}

#define desc_case_3_2_7 "\
Non-IO control pass through of TPI messages\n\
-- T_OPTMGMT_REQ with negative acknowledgement.\n\
This test case test the pass through of T_OPTMGMT_REQ with negative\n\
acknowledgement."
static int
test_case_3_2_7_top(int fd)
{
	return test_case_3_2_top(fd, __TEST_OPTMGMT_REQ);
}
static int
test_case_3_2_7_bot(int fd)
{
	return test_case_3_2_bot(fd, __TEST_OPTMGMT_REQ);
}

#define desc_case_3_2_8 "\
Non-IO control pass through of TPI messages\n\
-- T_ADDR_REQ with negative acknowledgement.\n\
This test case test the pass through of T_ADDR_REQ with negative\n\
acknowledgement."
static int
test_case_3_2_8_top(int fd)
{
	return test_case_3_2_top(fd, __TEST_ADDR_REQ);
}
static int
test_case_3_2_8_bot(int fd)
{
	return test_case_3_2_bot(fd, __TEST_ADDR_REQ);
}

#define desc_case_3_2_9 "\
Non-IO control pass through of TPI messages\n\
-- T_CAPABILITY_REQ with negative acknowledgement.\n\
This test case test the pass through of T_CAPABILITY_REQ with negative\n\
acknowledgement."
static int
test_case_3_2_9_top(int fd)
{
	return test_case_3_2_top(fd, __TEST_CAPABILITY_REQ);
}
static int
test_case_3_2_9_bot(int fd)
{
	return test_case_3_2_bot(fd, __TEST_CAPABILITY_REQ);
}
...
struct test_case {
	...
	&preamble_0, &test_case_1_1_bot, &postamble_0}, 0, 0}, {
		...
		&preamble_0, &test_case_2_1_1_top, &postamble_0}, {
	&preamble_0, &test_case_2_1_1_bot, &postamble_0}, 0, 0}, {
		"2.1.2", desc_case_2_1_2, {
		&preamble_0, &test_case_2_1_2_top, &postamble_0}, {
	&preamble_0, &test_case_2_1_2_bot, &postamble_0}, 0, 0}, {
		"2.1.3", desc_case_2_1_3, {
		&preamble_0, &test_case_2_1_3_top, &postamble_0}, {
	&preamble_0, &test_case_2_1_3_bot, &postamble_0}, 0, 0}, {
		"2.1.4", desc_case_2_1_4, {
		&preamble_0, &test_case_2_1_4_top, &postamble_0}, {
	&preamble_0, &test_case_2_1_4_bot, &postamble_0}, 0, 0}, {
		"2.1.5", desc_case_2_1_5, {
		&preamble_0, &test_case_2_1_5_top, &postamble_0}, {
	&preamble_0, &test_case_2_1_5_bot, &postamble_0}, 0, 0}, {
		"2.1.6", desc_case_2_1_6, {
		&preamble_0, &test_case_2_1_6_top, &postamble_0}, {
	&preamble_0, &test_case_2_1_6_bot, &postamble_0}, 0, 0}, {
		"2.1.7.1", desc_case_2_1_7_1, {
		&preamble_0, &test_case_2_1_7_1_top, &postamble_0}, {
	&preamble_0, &test_case_2_1_7_1_bot, &postamble_0}, 0, 0}, {
		"2.1.7.2", desc_case_2_1_7_2, {
		&preamble_0, &test_case_2_1_7_2_top, &postamble_0}, {
	&preamble_0, &test_case_2_1_7_2_bot, &postamble_0}, 0, 0}, {
		"2.1.8.1", desc_case_2_1_8_1, {
		&preamble_0, &test_case_2_1_8_1_top, &postamble_0}, {
	&preamble_0, &test_case_2_1_8_1_bot, &postamble_0}, 0, 0}, {
		"2.1.8.2", desc_case_2_1_8_2, {
		&preamble_0, &test_case_2_1_8_2_top, &postamble_0}, {
	&preamble_0, &test_case_2_1_8_2_bot, &postamble_0}, 0, 0}, {
#if 0
		"2.1.9", desc_case_2_1_9, {
		&preamble_0, &test_case_2_1_9_top, &postamble_0}, {
	&preamble_0, &test_case_2_1_9_bot, &postamble_0}, 0, 0}, {
#endif
		"2.1.10", desc_case_2_1_10, {
		&preamble_0, &test_case_2_1_10_top, &postamble_0}, {
	&preamble_0, &test_case_2_1_10_bot, &postamble_0}, 0, 0}, {
		"2.1.11", desc_case_2_1_11, {
		&preamble_0, &test_case_2_1_11_top, &postamble_0}, {
	&preamble_0, &test_case_2_1_11_bot, &postamble_0}, 0, 0}, {
		"2.2.1", desc_case_2_2_1, {
		&preamble_0, &test_case_2_2_1_top, &postamble_0}, {
	&preamble_0, &test_case_2_2_1_bot, &postamble_0}, 0, 0}, {
		"2.2.2", desc_case_2_2_2, {
		&preamble_0, &test_case_2_2_2_top, &postamble_0}, {
	&preamble_0, &test_case_2_2_2_bot, &postamble_0}, 0, 0}, {
		"2.2.3", desc_case_2_2_3, {
		&preamble_0, &test_case_2_2_3_top, &postamble_0}, {
	&preamble_0, &test_case_2_2_3_bot, &postamble_0}, 0, 0}, {
		"2.2.4", desc_case_2_2_4, {
		&preamble_0, &test_case_2_2_4_top, &postamble_0}, {
	&preamble_0, &test_case_2_2_4_bot, &postamble_0}, 0, 0}, {
		"2.2.5", desc_case_2_2_5, {
		&preamble_0, &test_case_2_2_5_top, &postamble_0}, {
	&preamble_0, &test_case_2_2_5_bot, &postamble_0}, 0, 0}, {
		"2.2.6", desc_case_2_2_6, {
		&preamble_0, &test_case_2_2_6_top, &postamble_0}, {
	&preamble_0, &test_case_2_2_6_bot, &postamble_0}, 0, 0}, {
		"2.2.7.1", desc_case_2_2_7_1, {
		&preamble_0, &test_case_2_2_7_1_top, &postamble_0}, {
	&preamble_0, &test_case_2_2_7_1_bot, &postamble_0}, 0, 0}, {
		"2.2.7.2", desc_case_2_2_7_2, {
		&preamble_0, &test_case_2_2_7_2_top, &postamble_0}, {
	&preamble_0, &test_case_2_2_7_2_bot, &postamble_0}, 0, 0}, {
		"2.2.8.1", desc_case_2_2_8_1, {
		&preamble_0, &test_case_2_2_8_1_top, &postamble_0}, {
	&preamble_0, &test_case_2_2_8_1_bot, &postamble_0}, 0, 0}, {
		"2.2.8.2", desc_case_2_2_8_2, {
		&preamble_0, &test_case_2_2_8_2_top, &postamble_0}, {
	&preamble_0, &test_case_2_2_8_2_bot, &postamble_0}, 0, 0}, {
#if 0
		"2.2.9", desc_case_2_2_9, {
		&preamble_0, &test_case_2_2_9_top, &postamble_0}, {
	&preamble_0, &test_case_2_2_9_bot, &postamble_0}, 0, 0}, {
#endif
		"2.2.10", desc_case_2_2_10, {
		&preamble_0, &test_case_2_2_10_top, &postamble_0}, {
	&preamble_0, &test_case_2_2_10_bot, &postamble_0}, 0, 0}, {
		"2.2.11", desc_case_2_2_11, {
		&preamble_0, &test_case_2_2_11_top, &postamble_0}, {
	&preamble_0, &test_case_2_2_11_bot, &postamble_0}, 0, 0}, {
		"2.3", desc_case_2_3, {
		&preamble_0, &test_case_2_3_top, &postamble_0}, {
	&preamble_0, &test_case_2_3_bot, &postamble_0}, 0, 0}, {
		"2.4.1", desc_case_2_4_1, {
		&preamble_0, &test_case_2_4_1_top, &postamble_0}, {
	&preamble_0, &test_case_2_4_1_bot, &postamble_0}, 0, 0}, {
		"2.4.2", desc_case_2_4_2, {
		&preamble_0, &test_case_2_4_2_top, &postamble_0}, {
	&preamble_0, &test_case_2_4_2_bot, &postamble_0}, 0, 0}, {
		"2.4.3", desc_case_2_4_3, {
		&preamble_0, &test_case_2_4_3_top, &postamble_0}, {
	&preamble_0, &test_case_2_4_3_bot, &postamble_0}, 0, 0}, {
		"2.4.4", desc_case_2_4_4, {
		&preamble_0, &test_case_2_4_4_top, &postamble_0}, {
	&preamble_0, &test_case_2_4_4_bot, &postamble_0}, 0, 0}, {
		"3.1.1", desc_case_3_1_1, {
		&preamble_0, &test_case_3_1_1_top, &postamble_0}, {
	&preamble_0, &test_case_3_1_1_bot, &postamble_0}, 0, 0}, {
		"3.1.2", desc_case_3_1_2, {
		&preamble_0, &test_case_3_1_2_top, &postamble_0}, {
	&preamble_0, &test_case_3_1_2_bot, &postamble_0}, 0, 0}, {
		"3.1.3", desc_case_3_1_3, {
		&preamble_0, &test_case_3_1_3_top, &postamble_0}, {
	&preamble_0, &test_case_3_1_3_bot, &postamble_0}, 0, 0}, {
		"3.1.4", desc_case_3_1_4, {
		&preamble_0, &test_case_3_1_4_top, &postamble_0}, {
	&preamble_0, &test_case_3_1_4_bot, &postamble_0}, 0, 0}, {
		"3.1.5", desc_case_3_1_5, {
		&preamble_0, &test_case_3_1_5_top, &postamble_0}, {
	&preamble_0, &test_case_3_1_5_bot, &postamble_0}, 0, 0}, {
		"3.1.6", desc_case_3_1_6, {
		&preamble_0, &test_case_3_1_6_top, &postamble_0}, {
	&preamble_0, &test_case_3_1_6_bot, &postamble_0}, 0, 0}, {
		"3.1.7", desc_case_3_1_7, {
		&preamble_0, &test_case_3_1_7_top, &postamble_0}, {
	&preamble_0, &test_case_3_1_7_bot, &postamble_0}, 0, 0}, {
		"3.1.8", desc_case_3_1_8, {
		&preamble_0, &test_case_3_1_8_top, &postamble_0}, {
	&preamble_0, &test_case_3_1_8_bot, &postamble_0}, 0, 0}, {
		"3.1.9", desc_case_3_1_9, {
		&preamble_0, &test_case_3_1_9_top, &postamble_0}, {
	&preamble_0, &test_case_3_1_9_bot, &postamble_0}, 0, 0}, {
		"3.2.1", desc_case_3_2_1, {
		&preamble_0, &test_case_3_2_1_top, &postamble_0}, {
	&preamble_0, &test_case_3_2_1_bot, &postamble_0}, 0, 0}, {
		"3.2.2", desc_case_3_2_2, {
		&preamble_0, &test_case_3_2_2_top, &postamble_0}, {
	&preamble_0, &test_case_3_2_2_bot, &postamble_0}, 0, 0}, {
		"3.2.3", desc_case_3_2_3, {
		&preamble_0, &test_case_3_2_3_top, &postamble_0}, {
	&preamble_0, &test_case_3_2_3_bot, &postamble_0}, 0, 0}, {
		"3.2.4", desc_case_3_2_4, {
		&preamble_0, &test_case_3_2_4_top, &postamble_0}, {
	&preamble_0, &test_case_3_2_4_bot, &postamble_0}, 0, 0}, {
		"3.2.5", desc_case_3_2_5, {
		&preamble_0, &test_case_3_2_5_top, &postamble_0}, {
	&preamble_0, &test_case_3_2_5_bot, &postamble_0}, 0, 0}, {
		"3.2.6", desc_case_3_2_6, {
		&preamble_0, &test_case_3_2_6_top, &postamble_0}, {
	&preamble_0, &test_case_3_2_6_bot, &postamble_0}, 0, 0}, {
		"3.2.7", desc_case_3_2_7, {
		&preamble_0, &test_case_3_2_7_top, &postamble_0}, {
	&preamble_0, &test_case_3_2_7_bot, &postamble_0}, 0, 0}, {
		"3.2.8", desc_case_3_2_8, {
		&preamble_0, &test_case_3_2_8_top, &postamble_0}, {
	&preamble_0, &test_case_3_2_8_bot, &postamble_0}, 0, 0}, {
		"3.2.9", desc_case_3_2_9, {
		&preamble_0, &test_case_3_2_9_top, &postamble_0}, {
	&preamble_0, &test_case_3_2_9_bot, &postamble_0}, 0, 0}, {
NULL,}};
	...
	if (begin_tests() == SUCCESS) {
		...
		if (summary && verbose) {
			...
			for (i = 0; i < (sizeof(tests) / sizeof(struct test_case)) && tests[i].numb; i++) {
				if (tests[i].run) {
					lockf(fileno(stdout), F_LOCK, 0);
					fprintf(stdout, "Test Case TIMOD:%-10s ", tests[i].numb);
					fflush(stdout);
					lockf(fileno(stdout), F_ULOCK, 0);
