/*****************************************************************************
 ...
 @(#) $RCSfile: test-inet_raw.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2005/04/04 16:43:19 $
...
#ident "@(#) $RCSfile: test-inet_raw.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2005/04/04 16:43:19 $"
