/*****************************************************************************
 ...
 @(#) $RCSfile: test-voip.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2007/08/14 08:46:45 $
 ...
 Last Modified $Date: 2007/08/14 08:46:45 $ by $Author: brian $
...
#ident "@(#) $RCSfile: test-voip.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2007/08/14 08:46:45 $"

static char const ident[] = "$RCSfile: test-voip.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2007/08/14 08:46:45 $";
