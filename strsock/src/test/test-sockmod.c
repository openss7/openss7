/*****************************************************************************
 ...
 @(#) $RCSfile: test-sockmod.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2007/08/14 05:17:27 $
...
#ident "@(#) $RCSfile: test-sockmod.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2007/08/14 05:17:27 $"

static char const ident[] = "$RCSfile: test-sockmod.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2007/08/14 05:17:27 $";
