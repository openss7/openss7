/*****************************************************************************
 ...
 @(#) $RCSfile: test-sockpath.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/09/18 00:10:37 $
...
#ident "@(#) $RCSfile: test-sockpath.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/09/18 00:10:37 $"

static char const ident[] = "$RCSfile: test-sockpath.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/09/18 00:10:37 $";
