/*****************************************************************************
 ...
 @(#) $RCSfile: test-socket.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2008-04-28 22:33:34 $
...
#ident "@(#) $RCSfile: test-socket.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2008-04-28 22:33:34 $"

static char const ident[] = "$RCSfile: test-socket.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2008-04-28 22:33:34 $";
