/*****************************************************************************
 ...
 @(#) $RCSfile: test-socklib.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2007/03/15 10:23:51 $
...
#ident "@(#) $RCSfile: test-socklib.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2007/03/15 10:23:51 $"

static char const ident[] = "$RCSfile: test-socklib.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2007/03/15 10:23:51 $";
