...
# =============================================================================
# 
# @(#) $RCSfile: ss7.m4,v $ $Name: OpenSS7-0_9_2 $($Revision: 0.9.2.24 $) $Date: 2008-09-28 16:50:56 $
#
# -----------------------------------------------------------------------------
#
...
dnl		    this will just not be set
	...
	if test -z "$ss7_cv_version" ; then
		...
		ss7_cv_version="$ss7_epoch:$ss7_version.$ss7_package${ss7_patchlevel:+.$ss7_patchlevel}-$ss7_release"
	    fi
	fi
    ])
