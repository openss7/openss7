...
set tics in
plot \
     'perftest_nb.dat' using 1:(1/$3) smooth unique title "Streams" with linespoints lt 5,\
     'perftest_nb.dat' using 1:(1/$4) smooth unique title "Linux" with linespoints lt 3,\
     'perftest_nb.dat' using 1:(1/$2) smooth unique title "LiS" with linespoints lt 2
