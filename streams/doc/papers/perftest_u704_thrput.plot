...
set output 'perftest_u704_thrput.fig'
set logscale
...
set tics in
plot \
     'perftest_u704.dat' using 1:($1*$3*8) smooth unique title "Streams" with linespoints lt 5,\
     'perftest_u704.dat' using 1:($1*$4*8) smooth unique title "Linux" with linespoints lt 3
