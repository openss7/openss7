...
set output 'perftest_u704_delay.fig'
set nologscale
...
set tics in
plot \
     'perftest_u704.dat' using 1:(1/$3) smooth unique title "Streams" with linespoints lt 5,\
     'perftest_u704.dat' using 1:(1/$4) smooth unique title "Linux" with linespoints lt 3
