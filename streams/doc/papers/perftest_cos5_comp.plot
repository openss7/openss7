...
set output 'perftest_cos5_comp.fig'
set nologscale
set logscale x
...
set tics in
plot \
     'perftest_cos5.dat' using 1:(($3/$4-1)*100) smooth unique title "Streams" with linespoints lt 5,\
     'perftest_cos5.dat' using 1:(($4/$4-1)*100) smooth unique title "Linux" with linespoints lt 3
