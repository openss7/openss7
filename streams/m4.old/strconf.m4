...
dnl =========================================================================
dnl
dnl @(#) $Id: strconf.m4,v 0.9 2004/04/23 04:02:07 brian Exp $
dnl
dnl =========================================================================
dnl
...
dnl =========================================================================
dnl
dnl Last Modified $Date: 2004/04/23 04:02:07 $ by $Author: brian $
dnl 
dnl =========================================================================
...
AC_DEFUN([_STRCONF_OPTIONS], [
    AC_ARG_WITH([base-major],
        AC_HELP_STRING([--with-base-major=MAJOR],
    ...
    AC_ARG_WITH([strconf-master],
        AC_HELP_STRING([--with-strconf-master=FILENAME],
...
AC_DEFUN([_STRCONF_SETUP], [
    STRCONF_CONFIGS=
    for strconf_tmp in `find $srcdir -type f -name "Config"`
    do
    ...
    STRCONF_MAJBASE=230
    STRCONF_CONFIG='include/sys/config.h'
    STRCONF_MODCONF='modconf.h'
    STRCONF_DRVCONF='drvrconf.mk'
    STRCONF_CONFMOD='conf.modules'
    STRCONF_MAKEDEV='devices.lst'
    STRCONF_MKNODES='src/util/strmakenodes.c'
    STRCONF_STSETUP='strsetup.conf'
#   STRCONF_STRLOAD='strload.conf'
...
#           eval "$STRCONF -b${STRCONF_MAJBASE} --strload=$STRCONF_STRLOAD $STRCONF_INPUT"
#       fi
    fi
])# _STRCONF_OUTPUT_CONFIG_COMMANDS
# =========================================================================
