/*****************************************************************************
 ...
 @(#) $RCSfile: strlookup.c,v $ $Name:  $($Revision: 0.9.2.53 $) $Date: 2007/12/15 20:19:55 $
 ...
 $Log: strlookup.c,v $
 Revision 0.9.2.53  2007/12/15 20:19:55  brian
 - updates

 Revision 0.9.2.52  2007/08/13 22:46:17  brian
 - GPLv3 header updates

 *****************************************************************************/

#ident "@(#) $RCSfile: strlookup.c,v $ $Name:  $($Revision: 0.9.2.53 $) $Date: 2007/12/15 20:19:55 $"
