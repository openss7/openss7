/*****************************************************************************
 ...
 @(#) $RCSfile: sock.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2004/05/08 19:21:15 $
...
#ident "@(#) $RCSfile: sock.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2004/05/08 19:21:15 $"
...
#define SOCKSYS_REVISION	"LfS $RCSFile$ $Name:  $($Revision: 0.9.2.5 $) $Date: 2004/05/08 19:21:15 $"
