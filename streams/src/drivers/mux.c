/*****************************************************************************
 ...
 @(#) $RCSfile: mux.c,v $ $Name:  $($Revision: 0.9.2.17 $) $Date: 2006/07/24 09:01:15 $
...
#ident "@(#) $RCSfile: mux.c,v $ $Name:  $($Revision: 0.9.2.17 $) $Date: 2006/07/24 09:01:15 $"
...
#define MUX_REVISION	"LfS $RCSfile: mux.c,v $ $Name:  $($Revision: 0.9.2.17 $) $Date: 2006/07/24 09:01:15 $"
