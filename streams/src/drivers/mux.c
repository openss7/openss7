/*****************************************************************************
 ...
 @(#) $RCSfile: mux.c,v $ $Name:  $($Revision: 0.9.2.18 $) $Date: 2006/07/25 06:39:07 $
...
#ident "@(#) $RCSfile: mux.c,v $ $Name:  $($Revision: 0.9.2.18 $) $Date: 2006/07/25 06:39:07 $"
...
#define MUX_REVISION	"LfS $RCSfile: mux.c,v $ $Name:  $($Revision: 0.9.2.18 $) $Date: 2006/07/25 06:39:07 $"
