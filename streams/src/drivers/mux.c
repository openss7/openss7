/*****************************************************************************
 ...
 @(#) $RCSfile: mux.c,v $ $Name:  $($Revision: 0.9.2.20 $) $Date: 2006/10/27 23:19:34 $
...
#ident "@(#) $RCSfile: mux.c,v $ $Name:  $($Revision: 0.9.2.20 $) $Date: 2006/10/27 23:19:34 $"
...
#define MUX_REVISION	"LfS $RCSfile: mux.c,v $ $Name:  $($Revision: 0.9.2.20 $) $Date: 2006/10/27 23:19:34 $"
