/*****************************************************************************
 ...
 @(#) $RCSfile: mux.c,v $ $Name:  $($Revision: 0.9.2.29 $) $Date: 2007/12/15 20:19:54 $
...
#ident "@(#) $RCSfile: mux.c,v $ $Name:  $($Revision: 0.9.2.29 $) $Date: 2007/12/15 20:19:54 $"
...
#define MUX_REVISION	"LfS $RCSfile: mux.c,v $ $Name:  $($Revision: 0.9.2.29 $) $Date: 2007/12/15 20:19:54 $"
