/*****************************************************************************
 ...
 @(#) $RCSfile: inet.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2004/05/14 08:00:05 $
...
#ident "@(#) $RCSfile: inet.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2004/05/14 08:00:05 $"

static char const ident[] = "$RCSfile: inet.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2004/05/14 08:00:05 $";
...
#define SS_REVISION	"LfS $RCSfile: inet.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2004/05/14 08:00:05 $"
