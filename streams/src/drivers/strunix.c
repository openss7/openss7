/*****************************************************************************
 ...
 @(#) $RCSfile: strunix.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2004/05/06 08:44:21 $
...
#ident "@(#) $RCSfile: strunix.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2004/05/06 08:44:21 $"
...
#define UNIX_REVISION	"LfS $RCSFile$ $Name:  $($Revision: 0.9.2.9 $) $Date: 2004/05/06 08:44:21 $"
