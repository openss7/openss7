/*****************************************************************************
 ...
 @(#) $RCSfile: socksys.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2004/06/12 23:20:10 $
...
#ident "@(#) $RCSfile: socksys.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2004/06/12 23:20:10 $"
...
#define SOCKSYS_REVISION	"LfS $RCSFile$ $Name:  $($Revision: 0.9.2.9 $) $Date: 2004/06/12 23:20:10 $"
