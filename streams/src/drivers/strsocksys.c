/*****************************************************************************
 ...
 @(#) strsocksys.c,v (0.9.2.6) 2003/10/21 21:50:21
...
#ident "@(#) strsocksys.c,v (0.9.2.6) 2003/10/21 21:50:21"
...
#define SOCKSYS_REVISION	"LfS strsocksys.c,v (0.9.2.6) 2003/10/21 21:50:21"
...
#endif
	if ((err = register_strdev(makedevice(major, 0), &socksys_cdev)) < 0)
		return (err);
	if (err > 0)
		major = err;
	return (0);
...
static void __exit socksys_exit(void)
{
	...
	if ((err = unregister_strdev(dev, &socksys_cdev)))
		return (void) (err);
	return (void) (0);
}
