...
usage(void)
{
        printf("usage: strModTable [-D<tokens>] [-f] [-L] [-M] [-H] [LISTENING ADDRESSES]\n"
...
main(int argc, char **argv)
{
        ...
        while ((ch = getopt(argc, argv, "D:fHLMx:")) != EOF)
                ...
                case 'H':
                        ...
                        init_agent("strModTable");      /* register our .conf handlers */
                        init_strModTable();
                        init_snmp("strModTable");
        ...
        init_agent("strModTable");

        /* init strModTable mib code */
        init_strModTable();

        /* read strModTable.conf files. */
        init_snmp("strModTable");
