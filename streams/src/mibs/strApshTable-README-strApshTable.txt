...
------------------------------------------------------------------------
  ...
  the strApshTable table.  The agent will start by looking for the right
  ...
  file defaults/table-strApshTable.m2d, and then re-running mib2c.
 ...
 Index(es) for the strApshTable table
  ------------------------------------------------------------
  The index(es) for the strApshTable table are:
...
************************************************************************
strApshTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the strApshTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: strApshTable_data_access.[c|h]
------------------------------------------------------------------------
  The strApshTable_data_access file contains the interface to your data in
  ...
  FUNC : strApshTable_indexes_set
  WHERE: strApshTable_data_access.c
  ...
  A simplified version of the pseudo-code looks like this:
     ...
     strApshTable_loop_init_context(loop)
  ...
  -----------------------------
    TODO : typedef strApshTable_loop_context
    WHERE: strApshTable_data_access.h
    ...
    definitions are used in examples later on.
      ...
      Linked list
      -----------
          typedef list_node strApshTable_loop_context;

      Array
      -----
          typedef integer strApshTable_loop_context;
  ...
  --------------
    TODO : Initialization
    FUNC : strApshTable_loop_init_data
    WHERE: strApshTable_data_access.c

    The strApshTable_loop_init_data function will be called during startup to
  ...
  ----------------------
    ...
    FUNC : strApshTable_loop_init_context
    WHERE: strApshTable_data_access.c
    ...
    strApshTable_loop_get_first and strApshTable_loop_get_next.
    ...
    earlier example loop contexts.
      ...
      File
      ----
          ref->loop_ctx = SNMP_MALLOC_TYPEDEF(strApshTable_loop_context);
          /* error checking here */
  ...
  --------
    ...
    FUNC : strApshTable_loop_get_first
    WHERE: strApshTable_data_access.c
    ...
    TODO : return raw data
    FUNC : strApshTable_loop_get_next
    WHERE: strApshTable_data_access.c
  ...
  -----------------------------
    ...
    FUNC : strApshTable_loop_save_position
    WHERE: strApshTable_data_access.c
  ...
  ---------------------------
    ...
    FUNC : strApshTable_loop_get_data
    WHERE: strApshTable_data_access.c
  ...
  --------------------------
    ...
    FUNC : strApshTable_loop_cleanup_context
    WHERE: strApshTable_data_access.c
...
File: strApshTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : strApshMajor_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : strApshLastMinor_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : strApshModules_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : strApshStatus_get



File: strApshTable_data_set.c
------------------------------------------------------------------------
  ...
  Set $m2c_table_dependencies = 0 in defaults/table-strApshTable.m2d
  ...
  FUNC : strApshName_check_index

  Validate index component
  ------------------------
  TODO : validate the specified index component
  FUNC : strApshMinor_check_index


  Validate index
  --------------
  TODO : check that all index components are valid
  FUNC : strApshTable_validate_index
  ...
  FUNC : strApshModules_check_value
  ...
  FUNC : strApshModules_undo_setup
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : strApshStatus_check_value
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      were generated for the strApshTable table.

To watch the flow of the strApshTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        strApshTable
        verbose:strApshTable
        internal:strApshTable

e.g.
        snmpd -f -Le -DstrApshTable,verbose:strApshTable,internal:strApshTable
