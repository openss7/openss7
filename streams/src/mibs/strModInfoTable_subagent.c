...
usage(void)
{
        printf("usage: strModInfoTable [-D<tokens>] [-f] [-L] [-M] [-H] [LISTENING ADDRESSES]\n"
...
main(int argc, char **argv)
{
        ...
        while ((ch = getopt(argc, argv, "D:fHLMx:")) != EOF)
                ...
                case 'H':
                        ...
                        init_agent("strModInfoTable");  /* register our .conf handlers */
                        init_strModInfoTable();
                        init_snmp("strModInfoTable");
        ...
        init_agent("strModInfoTable");

        /* init strModInfoTable mib code */
        init_strModInfoTable();

        /* read strModInfoTable.conf files. */
        init_snmp("strModInfoTable");
