...
usage(void)
{
        printf("usage: strApshTable [-D<tokens>] [-f] [-L] [-M] [-H] [LISTENING ADDRESSES]\n"
...
main(int argc, char **argv)
{
        ...
        while ((ch = getopt(argc, argv, "D:fHLMx:")) != EOF)
                ...
                case 'H':
                        ...
                        init_agent("strApshTable");     /* register our .conf handlers */
                        init_strApshTable();
                        init_snmp("strApshTable");
        ...
        init_agent("strApshTable");

        /* init strApshTable mib code */
        init_strApshTable();

        /* read strApshTable.conf files. */
        init_snmp("strApshTable");
