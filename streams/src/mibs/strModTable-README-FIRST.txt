...
begin with the strModTable prefix.
...
------------------------------------------------------------------------
  ...
  Editable: Optional
  Usage   : make -f strModTable_Makefile


  File    : strModTable_subagent.c
  ----------------------------------------------------------------------
...
should probably read these next:
   ...
   strModTable-README-strModTable.txt
