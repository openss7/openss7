...
begin with the strModStatTable prefix.
...
------------------------------------------------------------------------
  ...
  Editable: Optional
  Usage   : make -f strModStatTable_Makefile


  File    : strModStatTable_subagent.c
  ----------------------------------------------------------------------
...
should probably read these next:
   ...
   strModStatTable-README-strModStatTable.txt
...
------------------------------------------------------------------------
  ...
  File    : strModStatTable_interface.c
