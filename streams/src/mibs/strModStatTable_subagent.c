...
usage(void)
{
        printf("usage: strModStatTable [-D<tokens>] [-f] [-L] [-M] [-H] [LISTENING ADDRESSES]\n"
...
main(int argc, char **argv)
{
        ...
        while ((ch = getopt(argc, argv, "D:fHLMx:")) != EOF)
                ...
                case 'H':
                        ...
                        init_agent("strModStatTable");  /* register our .conf handlers */
                        init_strModStatTable();
                        init_snmp("strModStatTable");
        ...
        init_agent("strModStatTable");

        /* init strModStatTable mib code */
        init_strModStatTable();

        /* read strModStatTable.conf files. */
        init_snmp("strModStatTable");
