...
#include "strMIB_new.h"

/* 
 * strMIB_new_variables_oid:
 *   this is the top level oid that we want to register under.  This
 *   is essentially a prefix, with the suffix appearing in the
 *   variable below.
 */

oid strMIB_new_variables_oid[] = { };

/* 
 * variable4 strMIB_new_variables:
 *   this variable defines function callbacks and type return information 
 *   for the strMIB_new mib section 
 */

struct variable7 strMIB_new_variables[] = {
/*  magic number        , variable type , ro/rw , callback fn  , L, oidsuffix */
#define STRCLTIME		1
        {STRCLTIME, ASN_INTEGER, RWRITE, var_strMIB_new, 15,
         {, 3, 6, 1, 4, 1, 29591, 1, 1, 1, 1, 2, 1, 1}},
#define STRMAXAPUSH		2
        {STRMAXAPUSH, ASN_UNSIGNED, RWRITE, var_strMIB_new, 15,
         {, 3, 6, 1, 4, 1, 29591, 1, 1, 1, 1, 2, 1, 2}},
#define STRMAXMBLK		3
        {STRMAXMBLK, ASN_UNSIGNED, RWRITE, var_strMIB_new, 15,
         {, 3, 6, 1, 4, 1, 29591, 1, 1, 1, 1, 2, 1, 3}},
#define STRMAXSTRAMOD		4
        {STRMAXSTRAMOD, ASN_UNSIGNED, RWRITE, var_strMIB_new, 15,
         {, 3, 6, 1, 4, 1, 29591, 1, 1, 1, 1, 2, 1, 4}},
#define STRMAXSTRDEV		5
        {STRMAXSTRDEV, ASN_UNSIGNED, RONLY, var_strMIB_new, 15,
         {, 3, 6, 1, 4, 1, 29591, 1, 1, 1, 1, 2, 1, 5}},
#define STRMAXSTRMOD		6
        {STRMAXSTRMOD, ASN_UNSIGNED, RONLY, var_strMIB_new, 15,
         {, 3, 6, 1, 4, 1, 29591, 1, 1, 1, 1, 2, 1, 6}},
#define STRMSGPRIORITY		7
        {STRMSGPRIORITY, ASN_INTEGER, RWRITE, var_strMIB_new, 15,
         {, 3, 6, 1, 4, 1, 29591, 1, 1, 1, 1, 2, 1, 7}},
#define STRNBAND		8
        {STRNBAND, ASN_UNSIGNED, RONLY, var_strMIB_new, 15,
         {, 3, 6, 1, 4, 1, 29591, 1, 1, 1, 1, 2, 1, 8}},
#define STRNSTRMSGS		9
        {STRNSTRMSGS, ASN_UNSIGNED, RWRITE, var_strMIB_new, 15,
         {, 3, 6, 1, 4, 1, 29591, 1, 1, 1, 1, 2, 1, 9}},
#define STRNSTRPUSH		10
        {STRNSTRPUSH, ASN_UNSIGNED, RWRITE, var_strMIB_new, 15,
         {, 3, 6, 1, 4, 1, 29591, 1, 1, 1, 1, 2, 1, 10}},
#define STRHIWAT		11
        {STRHIWAT, ASN_UNSIGNED, RWRITE, var_strMIB_new, 15,
         {, 3, 6, 1, 4, 1, 29591, 1, 1, 1, 1, 2, 1, 11}},
#define STRLOWAT		12
        {STRLOWAT, ASN_UNSIGNED, RWRITE, var_strMIB_new, 15,
         {, 3, 6, 1, 4, 1, 29591, 1, 1, 1, 1, 2, 1, 12}},
#define STRMAXPSZ		13
        {STRMAXPSZ, ASN_INTEGER, RWRITE, var_strMIB_new, 15,
         {, 3, 6, 1, 4, 1, 29591, 1, 1, 1, 1, 2, 1, 13}},
#define STRMINPSZ		14
        {STRMINPSZ, ASN_INTEGER, RWRITE, var_strMIB_new, 15,
         {, 3, 6, 1, 4, 1, 29591, 1, 1, 1, 1, 2, 1, 14}},
#define STRREUSEFMODSW		15
        {STRREUSEFMODSW, ASN_INTEGER, RWRITE, var_strMIB_new, 15,
         {, 3, 6, 1, 4, 1, 29591, 1, 1, 1, 1, 2, 1, 15}},
#define STRRTIME		16
        {STRRTIME, ASN_INTEGER, RWRITE, var_strMIB_new, 15,
         {, 3, 6, 1, 4, 1, 29591, 1, 1, 1, 1, 2, 1, 16}},
#define STRSTRHOLD		17
        {STRSTRHOLD, ASN_INTEGER, RWRITE, var_strMIB_new, 15,
         {, 3, 6, 1, 4, 1, 29591, 1, 1, 1, 1, 2, 1, 17}},
#define STRSTRCTLSZ		18
        {STRSTRCTLSZ, ASN_UNSIGNED, RWRITE, var_strMIB_new, 15,
         {, 3, 6, 1, 4, 1, 29591, 1, 1, 1, 1, 2, 1, 18}},
#define STRSTRMSGSZ		19
        {STRSTRMSGSZ, ASN_UNSIGNED, RWRITE, var_strMIB_new, 15,
         {, 3, 6, 1, 4, 1, 29591, 1, 1, 1, 1, 2, 1, 19}},
#define STRSTRTHRESH		20
        {STRSTRTHRESH, ASN_UNSIGNED, RWRITE, var_strMIB_new, 15,
         {, 3, 6, 1, 4, 1, 29591, 1, 1, 1, 1, 2, 1, 20}},
#define STRLOWTHRESH		21
        {STRLOWTHRESH, ASN_UNSIGNED, RWRITE, var_strMIB_new, 15,
         {, 3, 6, 1, 4, 1, 29591, 1, 1, 1, 1, 2, 1, 21}},
#define STRMEDTHRESH		22
        {STRMEDTHRESH, ASN_UNSIGNED, RWRITE, var_strMIB_new, 15,
         {, 3, 6, 1, 4, 1, 29591, 1, 1, 1, 1, 2, 1, 22}},
#define STRIOCTIME		23
        {STRIOCTIME, ASN_INTEGER, RWRITE, var_strMIB_new, 15,
...
/** Initializes the strMIB_new module */
void
init_strMIB_new(void)
{

        DEBUGMSGTL(("strMIB_new", "Initializing\n"));

        /* register ourselves with the agent to handle our mib tree */
        REGISTER_MIB("strMIB_new", strMIB_new_variables, variable4, strMIB_new_variables_oid);
 ...
 */
unsigned char *
var_strMIB_new(struct variable *vp,
 ...
 *   The workings of this are basically the same as for var_strMIB_new above.
 */
unsigned char *
                ...
                u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
        ...
        case RESERVE1:
                if (var_val_type != ASN_INTEGER) {
                        fprintf(stderr, "write to strMIB_new not ASN_INTEGER\n");
                        return SNMP_ERR_WRONGTYPE;
                }
                if (var_val_len > sizeof(long)) {
                        fprintf(stderr, "write to strMIB_new: bad length\n");
                  ...
                  size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
        ...
        case RESERVE1:
                if (var_val_type != ASN_UNSIGNED) {
                        fprintf(stderr, "write to strMIB_new not ASN_UNSIGNED\n");
                        return SNMP_ERR_WRONGTYPE;
                }
                     ...
                     size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
        ...
        case RESERVE1:
                if (var_val_type != ASN_OCTET_STR) {
                        fprintf(stderr, "write to strMIB_new not ASN_OCTET_STR\n");
                        return SNMP_ERR_WRONGTYPE;
                }
