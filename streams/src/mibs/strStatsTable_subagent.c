...
usage(void)
{
        printf("usage: strStatsTable [-D<tokens>] [-f] [-L] [-M] [-H] [LISTENING ADDRESSES]\n"
...
main(int argc, char **argv)
{
        ...
        while ((ch = getopt(argc, argv, "D:fHLMx:")) != EOF)
                ...
                case 'H':
                        ...
                        init_agent("strStatsTable");    /* register our .conf handlers */
                        init_strStatsTable();
                        init_snmp("strStatsTable");
        ...
        init_agent("strStatsTable");

        /* init strStatsTable mib code */
        init_strStatsTable();

        /* read strStatsTable.conf files. */
        init_snmp("strStatsTable");
