/*****************************************************************************
 ...
 @(#) $RCSfile: strExtMIB.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2009-01-14 14:32:00 $
...
#ident "@(#) $RCSfile: strExtMIB.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2009-01-14 14:32:00 $"

static char const ident[] = "$RCSfile: strExtMIB.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2009-01-14 14:32:00 $";
...
oid strExtStrlogRecordTable_variables_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 1, 1000, 1, 1, 1, 2 };
...
#define   STREXTSTRLOGRECORDNEXTINDEX  1
	{(u_char) STREXTSTRLOGRECORDNEXTINDEX, ASN_UNSIGNED, RONLY, var_strExtStrlogRecordTable, 4, {1, 1, 1, 1}},
#define   STREXTSTRLOGRECORDTIMESTAMP  2
	{(u_char) STREXTSTRLOGRECORDTIMESTAMP, ASN_TIMETICKS, RONLY, var_strExtStrlogRecordTable, 5, {1, 1, 1, 2, 2}},
#define   STREXTSTRLOGRECORDMID  3
	{(u_char) STREXTSTRLOGRECORDMID, ASN_UNSIGNED, RWRITE, var_strExtStrlogRecordTable, 5, {1, 1, 1, 2, 3}},
#define   STREXTSTRLOGRECORDSID  4
	{(u_char) STREXTSTRLOGRECORDSID, ASN_UNSIGNED, RWRITE, var_strExtStrlogRecordTable, 5, {1, 1, 1, 2, 4}},
#define   STREXTSTRLOGRECORDLEVEL  5
	{(u_char) STREXTSTRLOGRECORDLEVEL, ASN_UNSIGNED, RWRITE, var_strExtStrlogRecordTable, 5, {1, 1, 1, 2, 5}},
#define   STREXTSTRLOGRECORDFLAGS  6
	{(u_char) STREXTSTRLOGRECORDFLAGS, ASN_BIT_STR, RWRITE, var_strExtStrlogRecordTable, 5, {1, 1, 1, 2, 6}},
#define   STREXTSTRLOGRECORDMSGSTRING  7
	{(u_char) STREXTSTRLOGRECORDMSGSTRING, ASN_OCTET_STR, RWRITE, var_strExtStrlogRecordTable, 5, {1, 1, 1, 2, 7}},
#define   STREXTSTRLOGRECORDROWSTATUS  8
	{(u_char) STREXTSTRLOGRECORDROWSTATUS, ASN_INTEGER, RWRITE, var_strExtStrlogRecordTable, 5, {1, 1, 1, 2, 8}},
#define   STRNLOGARGS           9
...
strExtStrlogRecordTable_create(void)
{
	...
	if (StorageNew != NULL) {
		...
		StorageNew->strExtStrlogRecordIndex = 0;
