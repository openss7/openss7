/*****************************************************************************
 ...
 @(#) $RCSfile: strMIB.c,v $ $Name:  $($Revision: 0.9.2.21 $) $Date: 2009-01-02 15:04:19 $
...
#ident "@(#) $RCSfile: strMIB.c,v $ $Name:  $($Revision: 0.9.2.21 $) $Date: 2009-01-02 15:04:19 $"

static char const ident[] = "$RCSfile: strMIB.c,v $ $Name:  $($Revision: 0.9.2.21 $) $Date: 2009-01-02 15:04:19 $";
...
strMIB_create(void)
{
	...
	DBUGMSGTL(("strMIB", "creating scalars...  "));
	if (StorageNew != NULL) {
...
strModTable_create(void)
{
	...
	DBUGMSGTL(("strModTable", "creating row...  "));
	if (StorageNew != NULL) {
...
strModInfoTable_create(void)
{
	...
	DBUGMSGTL(("strModInfoTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
strModStatTable_create(void)
{
	...
	DBUGMSGTL(("strModStatTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
strApshTable_create(void)
{
	...
	DBUGMSGTL(("strApshTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
strStatsTable_create(void)
{
	...
	DBUGMSGTL(("strStatsTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
