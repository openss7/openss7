/*****************************************************************************
 ...
 @(#) $RCSfile: strMIB.c,v $ $Name:  $($Revision: 0.9.2.20 $) $Date: 2008-12-31 16:04:53 $
...
#ident "@(#) $RCSfile: strMIB.c,v $ $Name:  $($Revision: 0.9.2.20 $) $Date: 2008-12-31 16:04:53 $"

static char const ident[] = "$RCSfile: strMIB.c,v $ $Name:  $($Revision: 0.9.2.20 $) $Date: 2008-12-31 16:04:53 $";
...
/*
 * init_strMIB(): Initialization routine.
...
/*
 * deinit_strMIB(): Deinitialization routine.
...
/*
 * parse_strMIB(): parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * var_strMIB(): locate variables in strMIB
 *
...
/*
 * strModTable_del(): delete a structure
 */
int
...
/*
 * parse_strModTable(): parse configuration file for strModTable
...
/*
 * strModInfoTable_del(): delete a structure
 */
int
...
/*
 * parse_strModInfoTable(): parse configuration file for strModInfoTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * strModStatTable_del(): delete a structure
 */
int
...
/*
 * parse_strModStatTable(): parse configuration file for strModStatTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * strApshTable_del(): delete a structure
 */
int
...
/*
 * parse_strApshTable(): parse configuration file for strApshTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * strStatsTable_del(): delete a structure
 */
int
...
/*
 * parse_strStatsTable(): parse configuration file for strStatsTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * var_strModTable(): locate variables in strModTable
...
/*
 * var_strModInfoTable(): locate variables in strModInfoTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_strMIB above.
 */
u_char *
...
/*
 * var_strModStatTable(): locate variables in strModStatTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_strMIB above.
 */
u_char *
...
/*
 * var_strApshTable(): locate variables in strApshTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_strMIB above.
 */
u_char *
...
/*
 * var_strStatsTable(): locate variables in strStatsTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_strMIB above.
 */
u_char *
...
write_strModName(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE1:
		...
		/* Note: ranges 1..8 */
		if (var_val_len > SPRINT_MAX_LEN || ((1 > var_val_len || var_val_len > 8))) {
...
write_strMsgPriority(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE1:
		...
		switch (set_value) {
		case STRMSGPRIORITY_TRUE:
		case STRMSGPRIORITY_FALSE:
			break;
		default:
...
write_strReuseFmodsw(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE1:
		...
		/* Note: default value 2 */
		switch (set_value) {
		case STRREUSEFMODSW_TRUE:
		case STRREUSEFMODSW_FALSE:
			break;
		default:
...
write_strStrhold(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE1:
		...
		/* Note: default value 2 */
		switch (set_value) {
		case STRSTRHOLD_TRUE:
		case STRSTRHOLD_FALSE:
			break;
		default:
...
write_strModRowStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE2:
		...
		case RS_CREATEANDWAIT:
			...
			vp = vars;
			if ((StorageNew = SNMP_MALLOC_STRUCT(strModTable_data)) == NULL) {
				/* XXX: free, zero vars */
				return SNMP_ERR_RESOURCEUNAVAILABLE;
			}
	...
	case UNDO:
		...
		case RS_CREATEANDWAIT:
			...
			hciptr = header_complex_find_entry(strModTableStorage, StorageNew);
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* strModTable_del() can handle NULL pointers. */
			break;
		}
		break;
	}
...
write_strApshRowStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE2:
		...
		case RS_CREATEANDWAIT:
			...
			vp = vars;
			if ((StorageNew = SNMP_MALLOC_STRUCT(strApshTable_data)) == NULL) {
				/* XXX: free, zero vars */
				return SNMP_ERR_RESOURCEUNAVAILABLE;
			}
	...
	case UNDO:
		...
		case RS_CREATEANDWAIT:
			/* row creation, so remove it again */
			hciptr = header_complex_find_entry(strApshTableStorage, StorageNew);
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* strApshTable_del() can handle NULL pointers. */
			break;
		}
		break;
	}
