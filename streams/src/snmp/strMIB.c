/*****************************************************************************
 ...
 @(#) $RCSfile: strMIB.c,v $ $Name:  $($Revision: 0.9.2.26 $) $Date: 2009-01-14 14:32:00 $
...
#ident "@(#) $RCSfile: strMIB.c,v $ $Name:  $($Revision: 0.9.2.26 $) $Date: 2009-01-14 14:32:00 $"

static char const ident[] = "$RCSfile: strMIB.c,v $ $Name:  $($Revision: 0.9.2.26 $) $Date: 2009-01-14 14:32:00 $";
...
#define   STRMODNAME            1
	{(u_char) STRMODNAME, ASN_OCTET_STR, RWRITE, var_strModTable, 6, {1, 1, 1, 1, 1, 2}},
#define   STRMODTYPE            2
...
#define   STRAPSHMAJOR          19
	{(u_char) STRAPSHMAJOR, ASN_UNSIGNED, RONLY, var_strApshTable, 6, {1, 1, 4, 1, 1, 2}},
#define   STRAPSHMODULES        20
	{(u_char) STRAPSHMODULES, ASN_OCTET_STR, RWRITE, var_strApshTable, 6, {1, 1, 4, 1, 1, 5}},
#define   STRAPSHROWSTATUS      21
	{(u_char) STRAPSHROWSTATUS, ASN_INTEGER, RWRITE, var_strApshTable, 6, {1, 1, 4, 1, 1, 6}},
...
var_strModTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	*var_len = 0;
	...
	/* This is where we do the value assignments for the mib results. */
	switch (vp->magic) {
	case (u_char) STRMODNAME:	/* Create */
		*write_method = write_strModName;
		if (!StorageTmp)
			break;
		*var_len = StorageTmp->strModNameLen;
		rval = (u_char *) StorageTmp->strModName;
		break;
...
write_strModName(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case FREE:		/* Release any resources that have been allocated */
		SNMP_FREE(string);
		break;
	case ACTION:		/* The variable has been stored in StorageTmp->strModName for you to use, and you have just been asked to do something with it.  Note that anything done here must be
