/*****************************************************************************
 ...
 @(#) $RCSfile: strMIB.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2007/12/15 20:20:08 $
...
#ident "@(#) $RCSfile: strMIB.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2007/12/15 20:20:08 $"
		   ...
		   u_char *statP, oid * name, size_t name_len)
{
	...
	if ((StorageTmp =
	     header_complex(strMIBStorage, NULL,
			    &name[sizeof(strMIB_variables_oid) / sizeof(oid) + 5 - 1], &newlen, 1,
			    NULL, NULL)) == NULL)
		return SNMP_ERR_NOSUCHNAME;	/* remove if you support creation here */
		    ...
		    u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE2:
		...
		if (StorageTmp == NULL) {
...
#if 0
			memdup((void *) &StorageNew->strModIdnum, vp->val.string,
			       vp->val_len);
			...
			vp = vp->next_variable;
#endif
			memdup((void *) &StorageNew->strApshName, vp->val.string,
			       vp->val_len);
