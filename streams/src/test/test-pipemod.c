/*****************************************************************************
 ...
 @(#) $RCSfile: test-pipemod.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2004/06/09 08:32:59 $
...
#ident "@(#) $RCSfile: test-pipemod.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2004/06/09 08:32:59 $"

static char const ident[] = "$RCSfile: test-pipemod.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2004/06/09 08:32:59 $";
