/*****************************************************************************
 ...
 @(#) $RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.16 $) $Date: 2005/10/07 09:34:28 $
...
#ident "@(#) $RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.16 $) $Date: 2005/10/07 09:34:28 $"

static char const ident[] = "$RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.16 $) $Date: 2005/10/07 09:34:28 $";
