/*****************************************************************************
 ...
 @(#) $RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.27 $) $Date: 2007/12/15 20:20:10 $
...
#ident "@(#) $RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.27 $) $Date: 2007/12/15 20:20:10 $"

static char const ident[] = "$RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.27 $) $Date: 2007/12/15 20:20:10 $";
