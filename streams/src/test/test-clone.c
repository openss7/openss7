/*****************************************************************************
 ...
 @(#) $RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.13 $) $Date: 2005/09/25 22:52:11 $
...
#ident "@(#) $RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.13 $) $Date: 2005/09/25 22:52:11 $"

static char const ident[] = "$RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.13 $) $Date: 2005/09/25 22:52:11 $";
