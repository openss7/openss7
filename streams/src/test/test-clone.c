/*****************************************************************************
 ...
 @(#) $RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.24 $) $Date: 2007/03/15 10:22:14 $
...
#ident "@(#) $RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.24 $) $Date: 2007/03/15 10:22:14 $"

static char const ident[] = "$RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.24 $) $Date: 2007/03/15 10:22:14 $";
