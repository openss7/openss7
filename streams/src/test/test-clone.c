/*****************************************************************************
 ...
 @(#) $RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.17 $) $Date: 2005/10/10 10:37:17 $
...
#ident "@(#) $RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.17 $) $Date: 2005/10/10 10:37:17 $"

static char const ident[] = "$RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.17 $) $Date: 2005/10/10 10:37:17 $";
