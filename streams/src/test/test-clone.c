/*****************************************************************************
 ...
 @(#) $RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2005/07/18 12:07:03 $
...
#ident "@(#) $RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2005/07/18 12:07:03 $"

static char const ident[] = "$RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2005/07/18 12:07:03 $";
