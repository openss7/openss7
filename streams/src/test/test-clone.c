/*****************************************************************************
 ...
 @(#) $RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.21 $) $Date: 2006/03/03 10:57:13 $
...
#ident "@(#) $RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.21 $) $Date: 2006/03/03 10:57:13 $"

static char const ident[] = "$RCSfile: test-clone.c,v $ $Name:  $($Revision: 0.9.2.21 $) $Date: 2006/03/03 10:57:13 $";
