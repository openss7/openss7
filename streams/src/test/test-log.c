/*****************************************************************************
 ...
 @(#) $RCSfile: test-log.c,v $ $Name:  $($Revision: 0.9.2.14 $) $Date: 2005/09/29 23:08:19 $
...
#ident "@(#) $RCSfile: test-log.c,v $ $Name:  $($Revision: 0.9.2.14 $) $Date: 2005/09/29 23:08:19 $"

static char const ident[] = "$RCSfile: test-log.c,v $ $Name:  $($Revision: 0.9.2.14 $) $Date: 2005/09/29 23:08:19 $";
