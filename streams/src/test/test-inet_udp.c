/*****************************************************************************
 ...
 @(#) $RCSfile: test-inet_udp.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2004/03/04 23:15:47 $
 ...
 Revision 0.9.2.1  2004/03/04 23:15:47  brian
 ...
 Revision 0.9  2004/03/04 23:15:47  brian
 - working up release directory
 - updated base files
 - added manual pages
 - added texi manual files
...
#ident "@(#) $RCSfile: test-inet_udp.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2004/03/04 23:15:47 $"
...
preamble_1(void)
{
	...
	for (;;) {
		...
		case 8:
			...
			state = 9;
		case 9:
			if (inet_bind_req(fd2, &addr2, 0) == FAILURE)
				break;
			state = 10;
		case 10:
