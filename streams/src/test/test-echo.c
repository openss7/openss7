/*****************************************************************************
 ...
 @(#) $RCSfile: test-echo.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2005/01/16 23:09:06 $
...
#ident "@(#) $RCSfile: test-echo.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2005/01/16 23:09:06 $"

static char const ident[] = "$RCSfile: test-echo.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2005/01/16 23:09:06 $";
