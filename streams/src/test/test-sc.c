/*****************************************************************************
 ...
 @(#) $RCSfile: test-sc.c,v $ $Name:  $($Revision: 0.9.2.14 $) $Date: 2005/09/29 23:08:20 $
...
#ident "@(#) $RCSfile: test-sc.c,v $ $Name:  $($Revision: 0.9.2.14 $) $Date: 2005/09/29 23:08:20 $"

static char const ident[] = "$RCSfile: test-sc.c,v $ $Name:  $($Revision: 0.9.2.14 $) $Date: 2005/09/29 23:08:20 $";
