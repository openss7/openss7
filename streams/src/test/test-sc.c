/*****************************************************************************
 ...
 @(#) $RCSfile: test-sc.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2005/07/18 12:07:05 $
...
#ident "@(#) $RCSfile: test-sc.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2005/07/18 12:07:05 $"

static char const ident[] = "$RCSfile: test-sc.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2005/07/18 12:07:05 $";
