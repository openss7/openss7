/*****************************************************************************
 ...
 @(#) $RCSfile: test-sc.c,v $ $Name:  $($Revision: 0.9.2.13 $) $Date: 2005/09/25 22:52:36 $
...
#ident "@(#) $RCSfile: test-sc.c,v $ $Name:  $($Revision: 0.9.2.13 $) $Date: 2005/09/25 22:52:36 $"

static char const ident[] = "$RCSfile: test-sc.c,v $ $Name:  $($Revision: 0.9.2.13 $) $Date: 2005/09/25 22:52:36 $";
