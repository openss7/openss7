/*****************************************************************************
 ...
 @(#) $RCSfile: test-sc.c,v $ $Name:  $($Revision: 0.9.2.12 $) $Date: 2005/09/10 18:16:42 $
...
#ident "@(#) $RCSfile: test-sc.c,v $ $Name:  $($Revision: 0.9.2.12 $) $Date: 2005/09/10 18:16:42 $"

static char const ident[] = "$RCSfile: test-sc.c,v $ $Name:  $($Revision: 0.9.2.12 $) $Date: 2005/09/10 18:16:42 $";
