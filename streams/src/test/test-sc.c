/*****************************************************************************
 ...
 @(#) $RCSfile: test-sc.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2005/05/15 23:57:08 $
...
#ident "@(#) $RCSfile: test-sc.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2005/05/15 23:57:08 $"

static char const ident[] = "$RCSfile: test-sc.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2005/05/15 23:57:08 $";
