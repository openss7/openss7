/*****************************************************************************
 ...
 @(#) $RCSfile: test-mux.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/10/02 10:34:49 $
...
#ident "@(#) $RCSfile: test-mux.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/10/02 10:34:49 $"

static char const ident[] = "$RCSfile: test-mux.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/10/02 10:34:49 $";
