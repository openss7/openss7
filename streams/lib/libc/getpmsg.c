/*****************************************************************************
 ...
 @(#) $RCSfile: getpmsg.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2005/05/11 20:10:36 $
...
#ident "@(#) $RCSfile: getpmsg.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2005/05/11 20:10:36 $"

static char const ident[] = "$RCSfile: getpmsg.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2005/05/11 20:10:36 $";
