/*****************************************************************************
 ...
 @(#) $RCSfile: getmsg.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2004/03/01 07:45:13 $
...
#ident "@(#) $RCSfile: getmsg.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2004/03/01 07:45:13 $"

static char const ident[] = "$RCSfile: getmsg.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2004/03/01 07:45:13 $";
