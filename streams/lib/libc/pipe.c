/*****************************************************************************
 ...
 @(#) $RCSfile: pipe.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2004/03/01 09:59:43 $
...
#ident "@(#) $RCSfile: pipe.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2004/03/01 09:59:43 $"

static char const ident[] = "$RCSfile: pipe.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2004/03/01 09:59:43 $";
