/*****************************************************************************
 ...
 @(#) $RCSfile: fdetach.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2004/05/14 08:00:04 $
...
#ident "@(#) $RCSfile: fdetach.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2004/05/14 08:00:04 $"

static char const ident[] = "$RCSfile: fdetach.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2004/05/14 08:00:04 $";
