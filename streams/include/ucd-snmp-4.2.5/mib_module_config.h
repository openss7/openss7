...
/* Define if compiling with the host/hr_utils module files.  */
#define USING_HOST_HR_UTILS_MODULE 1
 
/* Define if compiling with the host/hr_sensor module files.  */
#define USING_HOST_HR_SENSOR_MODULE 1
