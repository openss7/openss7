/*****************************************************************************
 ...
 @(#) $Id: lisddi.h,v 0.9.2.13 2005/05/14 08:34:36 brian Exp $
...
#ident "@(#) $RCSfile: lisddi.h,v $ $Name:  $($Revision: 0.9.2.13 $) $Date: 2005/05/14 08:34:36 $"
...
extern void lis_rw_read_lock_irqsave_fcn(lis_rw_lock_t *lock, int *flagp, char *file, int line);
...
extern void lis_rw_write_lock_irqsave_fcn(lis_rw_lock_t *lock, int *flagp, char *file, int line);
...
extern void lis_spin_lock_irqsave_fcn(lis_spin_lock_t *lock, int *flagp, char *file, int line);
...
extern void lis_spin_unlock_irqrestore_fcn(lis_spin_lock_t *lock, int *flagp, char *file, int line);
