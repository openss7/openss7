...
# =============================================================================
# 
# @(#) $RCSfile: modpost.sh,v $ $Name: OpenSS7-0_9_2 $($Revision: 0.9.2.23 $) $Date: 2008-04-10 18:00:50 $
#
# -----------------------------------------------------------------------------
#
...
version="3.0.0"
ident='$RCSfile: modpost.sh,v $ $Name: OpenSS7-0_9_2 $($Revision: 0.9.2.23 $) $Date: 2008-04-10 18:00:50 $'
