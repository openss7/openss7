/*****************************************************************************
 ...
 @(#) $Id: nettest_xti.h,v 1.1.1.8 2007/08/14 07:26:50 brian Exp $
 ...
 Last Modified $Date: 2007/08/14 07:26:50 $ by $Author: brian $

 -----------------------------------------------------------------------------

 $Log: nettest_xti.h,v $
 Revision 1.1.1.8  2007/08/14 07:26:50  brian
 - GPLv3 header update
...
#ident "@(#) $RCSfile: nettest_xti.h,v $ $Name:  $($Revision: 1.1.1.8 $) Copyright (c) 2001-2007 OpenSS7 Corporation."
...
struct xti_sctp_stream_request_struct {
	...
	int ipaddresses[8];		/* the IP addresses to which the recv side should bind to
