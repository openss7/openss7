/*****************************************************************************
 ...
 @(#) $Id: m2ua_as_ioctl.h,v 0.9.2.4 2007/08/14 08:34:06 brian Exp $
...
#ident "@(#) $RCSfile: m2ua_as_ioctl.h,v $ $Name:  $($Revision: 0.9.2.4 $) Copyright (c) 2001-2007 OpenSS7 Corporation."
