/*****************************************************************************
 ...
 @(#) $Id: m2ua_as_ioctl.h,v 0.9.2.5 2008-04-29 01:52:23 brian Exp $
...
#ident "@(#) $RCSfile: m2ua_as_ioctl.h,v $ $Name:  $($Revision: 0.9.2.5 $) Copyright (c) 2001-2008 OpenSS7 Corporation."
