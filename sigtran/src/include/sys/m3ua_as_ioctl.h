/*****************************************************************************
 ...
 @(#) $Id: m3ua_as_ioctl.h,v 0.9.2.2 2007/08/14 08:34:06 brian Exp $
...
#ident "@(#) $RCSfile: m3ua_as_ioctl.h,v $ $Name:  $($Revision: 0.9.2.2 $) Copyright (c) 2001-2007 OpenSS7 Corporation."
