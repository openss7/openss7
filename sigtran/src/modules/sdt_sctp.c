/*****************************************************************************
 ...
 @(#) $RCSfile: sdt_sctp.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2007/03/25 02:22:31 $
...
#ident "@(#) $RCSfile: sdt_sctp.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2007/03/25 02:22:31 $"
...
#define SDT_SCTP_REVISION	"OpenSS7 $RCSfile: sdt_sctp.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2007/03/25 02:22:31 $"
