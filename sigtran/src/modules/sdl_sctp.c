/*****************************************************************************
 ...
 @(#) $RCSfile: sdl_sctp.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/10/17 11:55:47 $
...
#ident "@(#) $RCSfile: sdl_sctp.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/10/17 11:55:47 $"
...
#define SDL_SCTP_REVISION	"OpenSS7 $RCSfile: sdl_sctp.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/10/17 11:55:47 $"
