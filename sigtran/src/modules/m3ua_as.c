/*****************************************************************************
 ...
 @(#) $RCSfile: m3ua_as.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/11/30 13:17:57 $
...
#ident "@(#) $RCSfile: m3ua_as.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/11/30 13:17:57 $"

static char const ident[] = "$RCSfile: m3ua_as.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/11/30 13:17:57 $";
...
#define M3UA_AS_REVISION	"OpenSS7 $RCSfile: m3ua_as.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/11/30 13:17:57 $"
