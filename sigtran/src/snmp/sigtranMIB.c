/*****************************************************************************
 ...
 @(#) $RCSfile: sigtranMIB.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2009-01-19 13:31:38 $
...
#ident "@(#) $RCSfile: sigtranMIB.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2009-01-19 13:31:38 $"

static char const ident[] = "$RCSfile: sigtranMIB.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2009-01-19 13:31:38 $";
...
write_sigtranSctpProfileName(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	if ((StorageTmp = header_complex(sigtranSctpProfileTableStorage, NULL, &name[15], &newlen, 1, NULL, NULL)) == NULL)
