...
struct m3uaSgpAgTable_data {
	...
	long m3uaSgpAgRegistrationPolicy;
	long m3uaSgpAgAspIdPolicy;
	long m3uaSgpAgProtocolPayloadId;
	long m3uaSgpAgIpPort;
	long m3uaSgpAgMinOstreams;
	long m3uaSgpAgMaxIstreams;
	long m3uaSgpAgStatus;
};
struct m3uaSgpSgTable_data {
	uint m3uaSgpSgTable_request;
	uint m3uaSgpSgTable_refs;
	ulong m3uaSgpAgIndex;
	ulong m3uaSgpSgIndex;
	uint8_t *m3uaSgpSgName;
	size_t m3uaSgpSgNameLen;
	long m3uaSgpSgStatus;
};
struct m3uaSgpAspTable_data {
	uint m3uaSgpAspTable_request;
	uint m3uaSgpAspTable_refs;
	ulong m3uaSgpAspIndex;
	uint8_t *m3uaSgpAspName;
	size_t m3uaSgpAspNameLen;
	long m3uaSgpAspOperationalState;
	long m3uaSgpAspUsageState;
	long m3uaSgpAspAdministrativeState;
	...
	long m3uaSgpAspAspState;
	oid *m3uaSgpAspSctpProfile;
	size_t m3uaSgpAspSctpProfileLen;
	ulong m3uaSgpAspMaxInitRetries;
	ulong m3uaSgpAspMaxPathRetrans;
	long m3uaSgpAspRtoMin;
	long m3uaSgpAspRtoMax;
	long m3uaSgpAspHeartbeatInterval;
	long m3uaSgpAspMaxLifeTime;
	long m3uaSgpAspTimerDivert;
	long m3uaSgpAspStatus;
};
...
extern oid m3uaRfc3332ProtocolVersion_oid[12];
extern oid m3uaTs102142ProtocolVersion_oid[12];
extern oid m3uaRfc4666ProtocolVersion_oid[12];
