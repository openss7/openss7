/*****************************************************************************
 ...
 @(#) $Id: m3uaSgpMIB.h,v 0.9.2.1 2008-12-27 10:01:52 brian Exp $
...
#ident "@(#) $RCSfile: m3uaSgpMIB.h,v $ $Name: OpenSS7-0_9_2 $($Revision: 0.9.2.1 $) Copyright (c) 2001-2008 OpenSS7 Corporation."
...
struct m3uaSgpAspTable_data {
	...
	char *m3uaSgpAspAlarmStatus;
	int m3uaSgpAspAlarmStatusLen;
	char *m3uaSgpAspProceduralStatus;
	int m3uaSgpAspProceduralStatusLen;
	char *m3uaSgpAspAvailabilityStatus;
