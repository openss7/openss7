/*****************************************************************************
 ...
 @(#) $Id: m2uaMIB.h,v 0.9.2.5 2009-01-04 13:16:09 brian Exp $
...
#ident "@(#) $RCSfile: m2uaMIB.h,v $ $Name:  $($Revision: 0.9.2.5 $) Copyright (c) 2008-2009 Monavacom Limited."
...
struct m2uaMIB_data {
	...
	ulong m2uaAsNextIndex;
	ulong m2uaIfNextIndex;
	ulong m2uaAspNextIndex;
	ulong m2uaSgNextIndex;
};
...
struct m2uaIfTable_data {
	...
	long m2uaIfAdministrativeState;
	long m2uaIfOperationalState;
	uint8_t *m2uaIfProceduralStatus;
	size_t m2uaIfProceduralStatusLen;
	long m2uaIfUsageState;
	oid *m2uaIfEquipment;
	size_t m2uaIfEquipmentLen;
	long m2uaIfMaxSifSize;
	long m2uaIfTransmissionRate;
	long m2uaIfCic;
...
struct m2uaAspSgTable_data {
	...
	long m2uaAspSgAspPort;
	long m2uaAspSgAspState;
	long m2uaAspSgAdministrativeState;
};
...
struct m2uaSgAspTable_data {
	...
	long m2uaSgAspPort;
	long m2uaSgAspState;
	long m2uaSgAspAdministrativeState;
	long m2uaSgAspOperationalState;
};
struct m2uaSgAspAsTable_data {
	...
	ulong m2uaAspIndex;
	ulong m2uaAsIndex;
	long m2uaSgAspAsRegistrationRequired;
	long m2uaSgAspAsState;
	long m2uaSgAspAsAdministrativeState;
	long m2uaSgAspAsOperationalState;
};
