...
m3uaSgpMIB_create(void)
{
	...
	DBUGMSGTL(("m3uaSgpMIB", "creating scalars...  "));
	if (StorageNew != NULL) {
...
m3uaSgpAgTable_create(void)
{
	...
	DBUGMSGTL(("m3uaSgpAgTable", "creating row...  "));
	if (StorageNew != NULL) {
...
m3uaSgpSgTable_create(void)
{
	...
	DBUGMSGTL(("m3uaSgpSgTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
m3uaSgpAspTable_create(void)
{
	...
	DBUGMSGTL(("m3uaSgpAspTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
m3uaSgpTable_create(void)
{
	...
	DBUGMSGTL(("m3uaSgpTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
