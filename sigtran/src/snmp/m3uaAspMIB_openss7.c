...
/*
 * parse_m3uaAspMIB(): parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * var_m3uaAspMIB(): locate variables in m3uaAspMIB
 *
...
/*
 * m3uaAspTable_del(): delete a structure
 */
int
...
/*
 * parse_m3uaAspTable(): parse configuration file for m3uaAspTable
...
/*
 * m3uaAspAgTable_del(): delete a structure
 */
int
...
/*
 * parse_m3uaAspAgTable(): parse configuration file for m3uaAspAgTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * m3uaAspSgTable_del(): delete a structure
 */
int
...
/*
 * parse_m3uaAspSgTable(): parse configuration file for m3uaAspSgTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * m3uaAspSgpTable_del(): delete a structure
 */
int
...
/*
 * parse_m3uaAspSgpTable(): parse configuration file for m3uaAspSgpTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * m3uaAspSpTable_del(): delete a structure
 */
int
...
/*
 * parse_m3uaAspSpTable(): parse configuration file for m3uaAspSpTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * m3uaAspMtTable_del(): delete a structure
 */
int
...
/*
 * parse_m3uaAspMtTable(): parse configuration file for m3uaAspMtTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * m3uaAspRsTable_del(): delete a structure
 */
int
...
/*
 * parse_m3uaAspRsTable(): parse configuration file for m3uaAspRsTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * m3uaAspRlTable_del(): delete a structure
 */
int
...
/*
 * parse_m3uaAspRlTable(): parse configuration file for m3uaAspRlTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * m3uaAspRtTable_del(): delete a structure
 */
int
...
/*
 * parse_m3uaAspRtTable(): parse configuration file for m3uaAspRtTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * m3uaAspRcTable_del(): delete a structure
 */
int
...
/*
 * parse_m3uaAspRcTable(): parse configuration file for m3uaAspRcTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * m3uaAspAsTable_del(): delete a structure
 */
int
...
/*
 * parse_m3uaAspAsTable(): parse configuration file for m3uaAspAsTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * m3uaAspAfTable_del(): delete a structure
 */
int
...
/*
 * parse_m3uaAspAfTable(): parse configuration file for m3uaAspAfTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * var_m3uaAspTable(): locate variables in m3uaAspTable
...
/*
 * var_m3uaAspAgTable(): locate variables in m3uaAspAgTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_m3uaAspMIB above.
 */
u_char *
...
/*
 * var_m3uaAspSgTable(): locate variables in m3uaAspSgTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_m3uaAspMIB above.
 */
u_char *
...
/*
 * var_m3uaAspSgpTable(): locate variables in m3uaAspSgpTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_m3uaAspMIB above.
 */
u_char *
...
/*
 * var_m3uaAspSpTable(): locate variables in m3uaAspSpTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_m3uaAspMIB above.
 */
u_char *
...
/*
 * var_m3uaAspMtTable(): locate variables in m3uaAspMtTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_m3uaAspMIB above.
 */
u_char *
...
/*
 * var_m3uaAspRsTable(): locate variables in m3uaAspRsTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_m3uaAspMIB above.
 */
u_char *
...
/*
 * var_m3uaAspRlTable(): locate variables in m3uaAspRlTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_m3uaAspMIB above.
 */
u_char *
...
/*
 * var_m3uaAspRtTable(): locate variables in m3uaAspRtTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_m3uaAspMIB above.
 */
u_char *
...
/*
 * var_m3uaAspRcTable(): locate variables in m3uaAspRcTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_m3uaAspMIB above.
 */
u_char *
...
/*
 * var_m3uaAspAsTable(): locate variables in m3uaAspAsTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_m3uaAspMIB above.
 */
u_char *
...
/*
 * var_m3uaAspAfTable(): locate variables in m3uaAspAfTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_m3uaAspMIB above.
 */
u_char *
...
write_m3uaAspStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE2:
		...
		case RS_CREATEANDWAIT:
			...
			vp = vars;
			if ((StorageNew = SNMP_MALLOC_STRUCT(m3uaAspTable_data)) == NULL) {
				/* XXX: free, zero vars */
				return SNMP_ERR_RESOURCEUNAVAILABLE;
			}
	...
	case UNDO:
		...
		case RS_CREATEANDWAIT:
			...
			hciptr = header_complex_find_entry(m3uaAspTableStorage, StorageNew);
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* m3uaAspTable_del() can handle NULL pointers. */
			break;
		}
		break;
	}
...
write_m3uaAspAgStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE2:
		...
		case RS_CREATEANDWAIT:
			...
			vp = vars;
			if ((StorageNew = SNMP_MALLOC_STRUCT(m3uaAspAgTable_data)) == NULL) {
				/* XXX: free, zero vars */
				return SNMP_ERR_RESOURCEUNAVAILABLE;
			}
	...
	case UNDO:
		...
		case RS_CREATEANDWAIT:
			/* row creation, so remove it again */
			hciptr = header_complex_find_entry(m3uaAspAgTableStorage, StorageNew);
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* m3uaAspAgTable_del() can handle NULL pointers. */
			break;
		}
		break;
	}
...
write_m3uaAspSgStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE2:
		...
		case RS_CREATEANDWAIT:
			...
			vp = vars;
			if ((StorageNew = SNMP_MALLOC_STRUCT(m3uaAspSgTable_data)) == NULL) {
				/* XXX: free, zero vars */
				return SNMP_ERR_RESOURCEUNAVAILABLE;
			}
			StorageNew->m3uaAspAgIndex = *vp->val.integer;
	...
	case UNDO:
		...
		case RS_CREATEANDWAIT:
			/* row creation, so remove it again */
			hciptr = header_complex_find_entry(m3uaAspSgTableStorage, StorageNew);
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* m3uaAspSgTable_del() can handle NULL pointers. */
			break;
		}
		break;
	}
...
write_m3uaAspSgpStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE2:
		...
		case RS_CREATEANDWAIT:
			...
			vp = vars;
			if ((StorageNew = SNMP_MALLOC_STRUCT(m3uaAspSgpTable_data)) == NULL) {
				/* XXX: free, zero vars */
				return SNMP_ERR_RESOURCEUNAVAILABLE;
			}
			StorageNew->m3uaAspAgIndex = *vp->val.integer;
	...
	case UNDO:
		...
		case RS_CREATEANDWAIT:
			/* row creation, so remove it again */
			hciptr = header_complex_find_entry(m3uaAspSgpTableStorage, StorageNew);
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* m3uaAspSgpTable_del() can handle NULL pointers. */
			break;
		}
		break;
	}
...
write_m3uaAspSpStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE2:
		...
		case RS_CREATEANDWAIT:
			...
			vp = vars;
			if ((StorageNew = SNMP_MALLOC_STRUCT(m3uaAspSpTable_data)) == NULL) {
				/* XXX: free, zero vars */
				return SNMP_ERR_RESOURCEUNAVAILABLE;
			}
	...
	case UNDO:
		...
		case RS_CREATEANDWAIT:
			/* row creation, so remove it again */
			hciptr = header_complex_find_entry(m3uaAspSpTableStorage, StorageNew);
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* m3uaAspSpTable_del() can handle NULL pointers. */
			break;
		}
		break;
	}
...
write_m3uaAspMtStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE2:
		...
		case RS_CREATEANDWAIT:
			...
			vp = vars;
			if ((StorageNew = SNMP_MALLOC_STRUCT(m3uaAspMtTable_data)) == NULL) {
				/* XXX: free, zero vars */
				return SNMP_ERR_RESOURCEUNAVAILABLE;
			}
			StorageNew->m3uaAspSpIndex = *vp->val.integer;
	...
	case UNDO:
		...
		case RS_CREATEANDWAIT:
			/* row creation, so remove it again */
			hciptr = header_complex_find_entry(m3uaAspMtTableStorage, StorageNew);
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* m3uaAspMtTable_del() can handle NULL pointers. */
			break;
		}
		break;
	}
...
write_m3uaAspRsStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE2:
		...
		case RS_CREATEANDWAIT:
			...
			vp = vars;
			if ((StorageNew = SNMP_MALLOC_STRUCT(m3uaAspRsTable_data)) == NULL) {
				/* XXX: free, zero vars */
				return SNMP_ERR_RESOURCEUNAVAILABLE;
			}
			StorageNew->m3uaAspSpIndex = *vp->val.integer;
	...
	case UNDO:
		...
		case RS_CREATEANDWAIT:
			/* row creation, so remove it again */
			hciptr = header_complex_find_entry(m3uaAspRsTableStorage, StorageNew);
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* m3uaAspRsTable_del() can handle NULL pointers. */
			break;
		}
		break;
	}
...
write_m3uaAspRtStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE2:
		...
		case RS_CREATEANDWAIT:
			...
			vp = vars;
			if ((StorageNew = SNMP_MALLOC_STRUCT(m3uaAspRtTable_data)) == NULL) {
				/* XXX: free, zero vars */
				return SNMP_ERR_RESOURCEUNAVAILABLE;
			}
			StorageNew->m3uaAspSpIndex = *vp->val.integer;
	...
	case UNDO:
		...
		case RS_CREATEANDWAIT:
			/* row creation, so remove it again */
			hciptr = header_complex_find_entry(m3uaAspRtTableStorage, StorageNew);
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* m3uaAspRtTable_del() can handle NULL pointers. */
			break;
		}
		break;
	}
...
write_m3uaAspRcStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE2:
		...
		case RS_CREATEANDWAIT:
			...
			vp = vars;
			if ((StorageNew = SNMP_MALLOC_STRUCT(m3uaAspRcTable_data)) == NULL) {
				/* XXX: free, zero vars */
				return SNMP_ERR_RESOURCEUNAVAILABLE;
			}
			StorageNew->m3uaAspIndex = *vp->val.integer;
	...
	case UNDO:
		...
		case RS_CREATEANDWAIT:
			/* row creation, so remove it again */
			hciptr = header_complex_find_entry(m3uaAspRcTableStorage, StorageNew);
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* m3uaAspRcTable_del() can handle NULL pointers. */
			break;
		}
		break;
	}
