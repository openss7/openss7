/*****************************************************************************
 ...
 @(#) $RCSfile: sua_msg.h,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2008-04-29 01:52:21 $
...
#ident "@(#) $RCSfile: sua_msg.h,v $ $Name:  $($Revision: 0.9.2.4 $) Copyright (c) 2001-2008 OpenSS7 Corporation."
