/*****************************************************************************
 ...
 @(#) $RCSfile: m3ua_msg.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2007/06/17 02:00:50 $
...
#ident "@(#) $RCSfile: m3ua_msg.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2007/06/17 02:00:50 $"
...
int m3ua_decode_parms(mp, m3ua_results)
	mblk_t *mp;
