/*****************************************************************************
 ...
 @(#) $RCSfile: ua_tri.h,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2008-04-29 01:52:22 $
...
#ident "@(#) $RCSfile: ua_tri.h,v $ $Name:  $($Revision: 0.9.2.3 $) Copyright (c) 2001-2008 OpenSS7 Corporation."
