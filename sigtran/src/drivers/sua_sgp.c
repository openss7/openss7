/*****************************************************************************
 ...
 @(#) $RCSfile: sua_sgp.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/10/17 11:55:43 $
...
#ident "@(#) $RCSfile: sua_sgp.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/10/17 11:55:43 $"
 ...
 *  -------------------------------------------------------------------------
 */
static int sua_recv_clns_cldt(sgp_t * sgp, mblk_t * msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 *  -------------------------------------------------------------------------
 */
static int sua_recv_clns_cldr(sgp_t * sgp, mblk_t * msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 *  -------------------------------------------------------------------------
 */
static int sua_recv_cons_core(sgp_t * sgp, mblk_t * msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 *  -------------------------------------------------------------------------
 */
static int sua_recv_cons_coak(sgp_t * sgp, mblk_t * msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 *  -------------------------------------------------------------------------
 */
static int sua_recv_cons_coref(sgp_t * sgp, mblk_t * msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 *  -------------------------------------------------------------------------
 */
static int sua_recv_cons_relre(sgp_t * sgp, mblk_t * msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 *  -------------------------------------------------------------------------
 */
static int sua_recv_cons_relco(sgp_t * sgp, mblk_t * msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 *  -------------------------------------------------------------------------
 */
static int sua_recv_cons_resco(sgp_t * sgp, mblk_t * msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 *  -------------------------------------------------------------------------
 */
static int sua_recv_cons_resre(sgp_t * sgp, mblk_t * msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 *  -------------------------------------------------------------------------
 */
static int sua_recv_cons_codt(sgp_t * sgp, mblk_t * msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 *  -------------------------------------------------------------------------
 */
static int sua_recv_cons_coda(sgp_t * sgp, mblk_t * msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 *  -------------------------------------------------------------------------
 */
static int sua_recv_cons_coerr(sgp_t * sgp, mblk_t * msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 *  -------------------------------------------------------------------------
 */
static int sua_recv_cons_coit(sgp_t * sgp, mblk_t * msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 *  -------------------------------------------------------------------------
 */
static int sua_recv_duna(sgp_t * sgp, mblk_t * msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 *  -------------------------------------------------------------------------
 */
static int sua_recv_dava(sgp_t * sgp, mblk_t * msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 *  -------------------------------------------------------------------------
 */
static int sua_recv_daud(sgp_t * sgp, mblk_t * msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 *  -------------------------------------------------------------------------
 */
static int sua_recv_scon(sgp_t * sgp, mblk_t * msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 *  -------------------------------------------------------------------------
 */
static int sua_recv_dupu(sgp_t * sgp, mblk_t * msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 *  -------------------------------------------------------------------------
 */
static int sua_recv_drst(sgp_t * sgp, mblk_t * msg)
{
	(void) q;
	(void) msg;
	return (-EOPNOTSUPP);
 ...
 *  -------------------------------------------------------------------------
 */
static int sua_recv_reg_req(sgp_t * sgp, mblk_t * msg)
{
	(void) msg;
 ...
 *  -------------------------------------------------------------------------
 */
static int sua_recv_reg_rsp(sgp_t * sgp, mblk_t * msg)
{
	(void) msg;
 ...
 *  -------------------------------------------------------------------------
 */
static int sua_recv_dereg_req(sgp_t * sgp, mblk_t * msg)
{
	(void) msg;
	if (Q_MODE(q) & Q_MODE_SG)
		/* return error unexpected message */
 ...
 *  -------------------------------------------------------------------------
 */
static int sua_recv_dereg_rsp(sgp_t * sgp, mblk_t * msg)
{
	(void) msg;
	if (Q_MODE(q) & Q_MODE_AS)
		/* return error unexpected message */
...
int sua_recv_msg(sgp_t * sgp, mblk_t * msg)
{
