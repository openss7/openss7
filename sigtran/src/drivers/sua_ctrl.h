/*****************************************************************************
 ...
 @(#) $RCSfile: sua_ctrl.h,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2008-04-29 01:52:21 $
...
#ident "@(#) $RCSfile: sua_ctrl.h,v $ $Name:  $($Revision: 0.9.2.4 $) Copyright (c) 2001-2008 OpenSS7 Corporation."
...
static inline int
m_error_reply(queue_t *q, mblk_t *pdu, int r_error, int w_error)
{
	mblk_t *mp;
