/*****************************************************************************
 ...
 @(#) $RCSfile: tokqnx.c,v $ $Name:  $($Revision: 1.1.1.1.12.5 $) $Date: 2008-04-29 08:33:11 $
 ...
 $Log: tokqnx.c,v $
 Revision 1.1.1.1.12.5  2008-04-29 08:33:11  brian
...
#ident "@(#) $RCSfile: tokqnx.c,v $ $Name:  $($Revision: 1.1.1.1.12.5 $) $Date: 2008-04-29 08:33:11 $"

static char const ident[] = "$RCSfile: tokqnx.c,v $ $Name:  $($Revision: 1.1.1.1.12.5 $) $Date: 2008-04-29 08:33:11 $";
...
int far
buf_ready(p_lan_id, p_pnid1, p_pnid2, p_pnid3)
...
net_reg(int net_id)
{
	...
	if (Send(net, &msg.reg, &msg.reg_reply, sizeof(msg.reg), sizeof(msg.reg_reply)) == -1) {
...
STATIC int
tok_attach_lpa(queue_t *q, unsigned long id)
{
