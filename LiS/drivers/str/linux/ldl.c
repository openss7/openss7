/*****************************************************************************
 ...
 @(#) $RCSfile: ldl.c,v $ $Name:  $($Revision: 1.1.1.5.4.12 $) $Date: 2008-09-22 20:30:53 $
 ...
 $Log: ldl.c,v $
 Revision 1.1.1.5.4.12  2008-09-22 20:30:53  brian
 - added module version and truncated logs

 Revision 1.1.1.5.4.11  2008-04-29 08:33:12  brian
 - update headers for Affero release

 *****************************************************************************/

#ident "@(#) $RCSfile: ldl.c,v $ $Name:  $($Revision: 1.1.1.5.4.12 $) $Date: 2008-09-22 20:30:53 $"

static char const ident[] = "$RCSfile: ldl.c,v $ $Name:  $($Revision: 1.1.1.5.4.12 $) $Date: 2008-09-22 20:30:53 $";
 ...
 */
STATIC INLINE int
reuse_msg(msgb_t * mp, dl_ushort size)
{
	msgb_t *bp;
 ...
 */
STATIC INLINE void
make_dl_ok_ack(msgb_t * mp, dl_ulong primitive)
{
	dl_ok_ack_t *ackp;
 ...
 */
STATIC INLINE void
make_dl_error_ack(msgb_t * mp, dl_ulong primitive, dl_ulong err, dl_ulong uerr)
{
	dl_error_ack_t *ackp;
 ...
 */
STATIC INLINE int
do_ok_ack(struct dl *dl, msgb_t ** mp, dl_ulong primitive)
{
 ...
 */
STATIC int
reply_error_ack(struct dl *dl, msgb_t * mp, dl_ulong primitive, dl_ulong err, dl_ulong uerr)
{
