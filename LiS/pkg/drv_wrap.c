/*****************************************************************************
 ...
 @(#) $RCSfile: drv_wrap.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2006/10/27 22:38:58 $
...
#ident "@(#) $RCSfile: drv_wrap.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2006/10/27 22:38:58 $"

static char const ident[] = "$RCSfile: drv_wrap.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2006/10/27 22:38:58 $";
