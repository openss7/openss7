...
# =============================================================================
# 
# @(#) $RCSfile: iso.m4,v $ $Name: OpenSS7-0_9_2 $($Revision: 0.9.2.21 $) $Date: 2008-09-28 16:50:56 $
#
# -----------------------------------------------------------------------------
#
...
dnl		    this will just not be set
	...
	if test -z "$iso_cv_version" ; then
		...
		iso_cv_version="$iso_epoch:$iso_version.$iso_package${iso_patchlevel:+.$iso_patchlevel}-$iso_release"
	    fi
	fi
    ])
