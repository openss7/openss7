/*****************************************************************************
 ...
 @(#) $RCSfile: test-pipe.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2005/10/23 05:01:27 $
...
#ident "@(#) $RCSfile: test-pipe.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2005/10/23 05:01:27 $"

static char const ident[] = "$RCSfile: test-pipe.c,v $ $Name:  $($Revision: 1.1.2.1 $) $Date: 2005/10/23 05:01:27 $";
