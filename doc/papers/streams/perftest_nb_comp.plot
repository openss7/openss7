...
set tics in
plot \
     'perftest_nb.dat' using 1:(($3/$4-1)*100) smooth unique title "Streams" with linespoints lt 5,\
     'perftest_nb.dat' using 1:(($4/$4-1)*100) smooth unique title "Linux" with linespoints lt 3,\
     'perftest_nb.dat' using 1:(($2/$4-1)*100) smooth unique title "LiS" with linespoints lt 2
