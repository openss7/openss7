...
set tics in
plot \
     'perftest_fc6.dat' using 1:($1*$3*8) smooth unique title "Streams" with linespoints lt 5,\
     'perftest_fc6.dat' using 1:($1*$4*8) smooth unique title "Linux" with linespoints lt 3,\
     'perftest_fc6.dat' using 1:($1*$2*8) smooth unique title "LiS" with linespoints lt 2
