/*****************************************************************************
 ...
 @(#) $Id: tc.h,v 0.9.2.2 2007/08/14 12:17:06 brian Exp $
 ...
 Last Modified $Date: 2007/08/14 12:17:06 $ by $Author: brian $

 -----------------------------------------------------------------------------

 $Log: tc.h,v $
 Revision 0.9.2.2  2007/08/14 12:17:06  brian
...
#ident "@(#) $RCSfile: tc.h,v $ $Name:  $($Revision: 0.9.2.2 $) Copyright (c) 2001-2007 OpenSS7 Corporation."
