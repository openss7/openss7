/*****************************************************************************
 ...
 @(#) $Id: tc.h,v 0.9.2.1 2007/08/03 13:02:47 brian Exp $
 ...
 Last Modified $Date: 2007/08/03 13:02:47 $ by $Author: brian $

 -----------------------------------------------------------------------------

 $Log: tc.h,v $
 Revision 0.9.2.1  2007/08/03 13:02:47  brian
...
#ident "@(#) $RCSfile: tc.h,v $ $Name:  $($Revision: 0.9.2.1 $) Copyright (c) 2001-2007 OpenSS7 Corporation."
