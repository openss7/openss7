/*****************************************************************************
 ...
 @(#) $RCSfile: tcapOmMIB.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2009-01-02 15:04:16 $
...
#ident "@(#) $RCSfile: tcapOmMIB.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2009-01-02 15:04:16 $"

static char const ident[] = "$RCSfile: tcapOmMIB.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2009-01-02 15:04:16 $";
...
tcapOmMIB_create(void)
{
	...
	DBUGMSGTL(("tcapOmMIB", "creating scalars...  "));
	if (StorageNew != NULL) {
...
tcapOmNodeTable_create(void)
{
	...
	DBUGMSGTL(("tcapOmNodeTable", "creating row...  "));
	if (StorageNew != NULL) {
...
tcapOmNodeCurrentTable_create(void)
{
	...
	DBUGMSGTL(("tcapOmNodeCurrentTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
tcapOmNode5minIntTable_create(void)
{
	...
	DBUGMSGTL(("tcapOmNode5minIntTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
tcapOmNode15minIntTable_create(void)
{
	...
	DBUGMSGTL(("tcapOmNode15minIntTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
tcapOmMsgsTable_create(void)
{
	...
	DBUGMSGTL(("tcapOmMsgsTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
tcapOmMsgsCurrentTable_create(void)
{
	...
	DBUGMSGTL(("tcapOmMsgsCurrentTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
tcapOmMsgs5minIntTable_create(void)
{
	...
	DBUGMSGTL(("tcapOmMsgs5minIntTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
tcapOmMsgs15minIntTable_create(void)
{
	...
	DBUGMSGTL(("tcapOmMsgs15minIntTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
tcapOmAETable_create(void)
{
	...
	DBUGMSGTL(("tcapOmAETable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
tcapOmAECurrentTable_create(void)
{
	...
	DBUGMSGTL(("tcapOmAECurrentTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
tcapOmAE5minIntTable_create(void)
{
	...
	DBUGMSGTL(("tcapOmAE5minIntTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
tcapOmAE15minIntTable_create(void)
{
	...
	DBUGMSGTL(("tcapOmAE15minIntTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
tcapOmTcTable_create(void)
{
	...
	DBUGMSGTL(("tcapOmTcTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
tcapOmTcCurrentTable_create(void)
{
	...
	DBUGMSGTL(("tcapOmTcCurrentTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
tcapOmTc5minIntTable_create(void)
{
	...
	DBUGMSGTL(("tcapOmTc5minIntTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
tcapOmTc15minIntTable_create(void)
{
	...
	DBUGMSGTL(("tcapOmTc15minIntTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
tcapOmDevelRecvTable_create(void)
{
	...
	DBUGMSGTL(("tcapOmDevelRecvTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
tcapOmDevelRecvCurrentTable_create(void)
{
	...
	DBUGMSGTL(("tcapOmDevelRecvCurrentTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
tcapOmDevelRecv5minIntTable_create(void)
{
	...
	DBUGMSGTL(("tcapOmDevelRecv5minIntTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
tcapOmDevelRecv15minIntTable_create(void)
{
	...
	DBUGMSGTL(("tcapOmDevelRecv15minIntTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
tcapOmDevelSentTable_create(void)
{
	...
	DBUGMSGTL(("tcapOmDevelSentTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
tcapOmDevelSentCurrentTable_create(void)
{
	...
	DBUGMSGTL(("tcapOmDevelSentCurrentTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
tcapOmDevelSent5minIntTable_create(void)
{
	...
	DBUGMSGTL(("tcapOmDevelSent5minIntTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
tcapOmDevelSent15minIntTable_create(void)
{
	...
	DBUGMSGTL(("tcapOmDevelSent15minIntTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
