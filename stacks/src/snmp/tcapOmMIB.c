/*****************************************************************************
 ...
 @(#) $RCSfile: tcapOmMIB.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2009-01-10 17:09:22 $
 ...
 Last Modified $Date: 2009-01-10 17:09:22 $ by $Author: brian $
...
#ident "@(#) $RCSfile: tcapOmMIB.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2009-01-10 17:09:22 $"

static char const ident[] = "$RCSfile: tcapOmMIB.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2009-01-10 17:09:22 $";
...
#if defined MODULE
	if (sa_readfd != 0) {
		register_readfd(sa_readfd, tcapOmMIB_fd_handler, (void *) 0);
		register_exceptfd(sa_readfd, tcapOmMIB_fd_handler, (void *) 1);
	}
#if defined MASTER
	tcapOmMIBold_signal_handler = external_signal_handler[0];
	external_signal_handler[0] = &tcapOmMIB_loop_handler;
...
#if defined MODULE
#if defined MASTER
	external_signal_handler[0] = tcapOmMIBold_signal_handler;
#endif				/* defined MASTER */
	if (sa_readfd != 0) {
...
{
	if (!StorageTmp || StorageTmp->tcapOmNodeTable_request == sa_request)
		return;
...
var_tcapOmNodeTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	StorageTmp = header_complex(tcapOmNodeTableStorage, vp, name, length, exact, var_len, write_method);
...
{
	if (!StorageTmp || StorageTmp->tcapOmNodeCurrentTable_request == sa_request)
		return;
...
var_tcapOmNodeCurrentTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_tcapOmNodeCurrentTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(tcapOmNodeCurrentTableStorage, vp, name, length, exact, var_len, write_method);
...
{
	if (!StorageTmp || StorageTmp->tcapOmNode5minIntTable_request == sa_request)
		return;
...
var_tcapOmNode5minIntTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_tcapOmNode5minIntTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(tcapOmNode5minIntTableStorage, vp, name, length, exact, var_len, write_method);
...
{
	if (!StorageTmp || StorageTmp->tcapOmNode15minIntTable_request == sa_request)
		return;
...
var_tcapOmNode15minIntTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_tcapOmNode15minIntTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(tcapOmNode15minIntTableStorage, vp, name, length, exact, var_len, write_method);
...
{
	if (!StorageTmp || StorageTmp->tcapOmMsgsTable_request == sa_request)
		return;
...
var_tcapOmMsgsTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_tcapOmMsgsTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(tcapOmMsgsTableStorage, vp, name, length, exact, var_len, write_method);
...
{
	if (!StorageTmp || StorageTmp->tcapOmMsgsCurrentTable_request == sa_request)
		return;
...
var_tcapOmMsgsCurrentTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_tcapOmMsgsCurrentTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(tcapOmMsgsCurrentTableStorage, vp, name, length, exact, var_len, write_method);
...
{
	if (!StorageTmp || StorageTmp->tcapOmMsgs5minIntTable_request == sa_request)
		return;
...
var_tcapOmMsgs5minIntTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_tcapOmMsgs5minIntTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(tcapOmMsgs5minIntTableStorage, vp, name, length, exact, var_len, write_method);
...
{
	if (!StorageTmp || StorageTmp->tcapOmMsgs15minIntTable_request == sa_request)
		return;
...
var_tcapOmMsgs15minIntTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_tcapOmMsgs15minIntTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(tcapOmMsgs15minIntTableStorage, vp, name, length, exact, var_len, write_method);
...
{
	if (!StorageTmp || StorageTmp->tcapOmAETable_request == sa_request)
		return;
...
var_tcapOmAETable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_tcapOmAETable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(tcapOmAETableStorage, vp, name, length, exact, var_len, write_method);
...
{
	if (!StorageTmp || StorageTmp->tcapOmAECurrentTable_request == sa_request)
		return;
...
var_tcapOmAECurrentTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_tcapOmAECurrentTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(tcapOmAECurrentTableStorage, vp, name, length, exact, var_len, write_method);
...
{
	if (!StorageTmp || StorageTmp->tcapOmAE5minIntTable_request == sa_request)
		return;
...
var_tcapOmAE5minIntTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_tcapOmAE5minIntTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(tcapOmAE5minIntTableStorage, vp, name, length, exact, var_len, write_method);
...
{
	if (!StorageTmp || StorageTmp->tcapOmAE15minIntTable_request == sa_request)
		return;
...
var_tcapOmAE15minIntTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_tcapOmAE15minIntTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(tcapOmAE15minIntTableStorage, vp, name, length, exact, var_len, write_method);
...
{
	if (!StorageTmp || StorageTmp->tcapOmTcTable_request == sa_request)
		return;
...
var_tcapOmTcTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_tcapOmTcTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(tcapOmTcTableStorage, vp, name, length, exact, var_len, write_method);
...
{
	if (!StorageTmp || StorageTmp->tcapOmTcCurrentTable_request == sa_request)
		return;
...
var_tcapOmTcCurrentTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_tcapOmTcCurrentTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(tcapOmTcCurrentTableStorage, vp, name, length, exact, var_len, write_method);
...
{
	if (!StorageTmp || StorageTmp->tcapOmTc5minIntTable_request == sa_request)
		return;
...
var_tcapOmTc5minIntTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_tcapOmTc5minIntTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(tcapOmTc5minIntTableStorage, vp, name, length, exact, var_len, write_method);
...
{
	if (!StorageTmp || StorageTmp->tcapOmTc15minIntTable_request == sa_request)
		return;
...
var_tcapOmTc15minIntTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_tcapOmTc15minIntTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(tcapOmTc15minIntTableStorage, vp, name, length, exact, var_len, write_method);
...
{
	if (!StorageTmp || StorageTmp->tcapOmDevelRecvTable_request == sa_request)
		return;
...
var_tcapOmDevelRecvTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_tcapOmDevelRecvTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(tcapOmDevelRecvTableStorage, vp, name, length, exact, var_len, write_method);
...
{
	if (!StorageTmp || StorageTmp->tcapOmDevelRecvCurrentTable_request == sa_request)
		return;
...
var_tcapOmDevelRecvCurrentTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_tcapOmDevelRecvCurrentTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(tcapOmDevelRecvCurrentTableStorage, vp, name, length, exact, var_len, write_method);
...
{
	if (!StorageTmp || StorageTmp->tcapOmDevelRecv5minIntTable_request == sa_request)
		return;
...
var_tcapOmDevelRecv5minIntTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_tcapOmDevelRecv5minIntTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(tcapOmDevelRecv5minIntTableStorage, vp, name, length, exact, var_len, write_method);
...
{
	if (!StorageTmp || StorageTmp->tcapOmDevelRecv15minIntTable_request == sa_request)
		return;
...
var_tcapOmDevelRecv15minIntTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_tcapOmDevelRecv15minIntTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(tcapOmDevelRecv15minIntTableStorage, vp, name, length, exact, var_len, write_method);
...
{
	if (!StorageTmp || StorageTmp->tcapOmDevelSentTable_request == sa_request)
		return;
...
var_tcapOmDevelSentTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_tcapOmDevelSentTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(tcapOmDevelSentTableStorage, vp, name, length, exact, var_len, write_method);
...
{
	if (!StorageTmp || StorageTmp->tcapOmDevelSentCurrentTable_request == sa_request)
		return;
...
var_tcapOmDevelSentCurrentTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_tcapOmDevelSentCurrentTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(tcapOmDevelSentCurrentTableStorage, vp, name, length, exact, var_len, write_method);
...
{
	if (!StorageTmp || StorageTmp->tcapOmDevelSent5minIntTable_request == sa_request)
		return;
...
var_tcapOmDevelSent5minIntTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_tcapOmDevelSent5minIntTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(tcapOmDevelSent5minIntTableStorage, vp, name, length, exact, var_len, write_method);
...
{
	if (!StorageTmp || StorageTmp->tcapOmDevelSent15minIntTable_request == sa_request)
		return;
...
var_tcapOmDevelSent15minIntTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_tcapOmDevelSent15minIntTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(tcapOmDevelSent15minIntTableStorage, vp, name, length, exact, var_len, write_method);
 ...
 */
void
tcapOmMIB_loop_handler(int dummy)
{
...
char sa_logfile[256] = "/var/log/tcapommib.log";
char sa_pidfile[256] = "/var/run/tcapommib.pid";
char sa_sysctlf[256] = "/etc/tcapommib.conf";
...
Options:\n\
    ...
    -l, --log-file [LOGFILE]\n\
        log to log file name LOGFILE.  [default: /var/log/tcapommib.log]\n\
    -L, --log-stderr\n\
    ...
    -n, --nodaemon\n\
        run in the foreground.\n\
    -n, --name NAME\n\
        use NAME for configuration file base.  [default: tcapommib]\n\
    -p, --port PORTNUM\n\
        listen on port number PORTNUM.  [default: 161]\n\
    -p, --pidfile PIDFILE\n\
        write daemon pid to PIDFILE.  [default: /var/run/tcapommib.pid]\n\
    -P, --pidfile PIDFILE\n\
        write daemon pid to PIDFILE.  [default: /var/run/tcapommib.pid]\n\
    -q, --quiet\n\
...
sa_init_logging(int argc, char *argv[])
{
	...
	if (sa_logsyslog) {
		...
		snmp_enable_syslog_ident("tcapOmMIB", LOG_DAEMON);
		...
		closelog();
#if defined LOG_PERROR
		openlog("tcapOmMIB", LOG_PID | LOG_CONS | LOG_NDELAY | (sa_logstderr ? LOG_PERROR : 0), MY_FACILITY(0));
#else				/* defined LOG_PERROR */
		openlog("tcapOmMIB", LOG_PID | LOG_CONS | LOG_NDELAY, MY_FACILITY(0));
#endif				/* defined LOG_PERROR */
	}
	if (sa_logcallog) {
		snmp_enable_calllog();
