/*****************************************************************************
 ...
 @(#) $RCSfile: tcapOmMIB.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2009-01-04 13:16:06 $
...
#ident "@(#) $RCSfile: tcapOmMIB.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2009-01-04 13:16:06 $"

static char const ident[] = "$RCSfile: tcapOmMIB.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2009-01-04 13:16:06 $";
...
#endif				/* defined MASTER */
/**
 * @fn void tcapOmMIB_readfd_handler(int fd, void *dummy)
 ...
 */
void
tcapOmMIB_readfd_handler(int fd, void *dummy)
{
