/*****************************************************************************
 ...
 @(#) $RCSfile: mtpOmMIB.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2009-01-10 17:09:18 $
 ...
 Last Modified $Date: 2009-01-10 17:09:18 $ by $Author: brian $
...
#ident "@(#) $RCSfile: mtpOmMIB.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2009-01-10 17:09:18 $"

static char const ident[] = "$RCSfile: mtpOmMIB.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2009-01-10 17:09:18 $";
...
#if defined MODULE
	if (sa_readfd != 0) {
		register_readfd(sa_readfd, mtpOmMIB_fd_handler, (void *) 0);
		register_exceptfd(sa_readfd, mtpOmMIB_fd_handler, (void *) 1);
	}
#if defined MASTER
	mtpOmMIBold_signal_handler = external_signal_handler[0];
	external_signal_handler[0] = &mtpOmMIB_loop_handler;
...
#if defined MODULE
#if defined MASTER
	external_signal_handler[0] = mtpOmMIBold_signal_handler;
#endif				/* defined MASTER */
	if (sa_readfd != 0) {
...
mtpOmMIB_create(void)
{
	...
	DEBUGMSGTL(("mtpOmMIB", "creating scalars...  "));
	if (StorageNew != NULL) {
...
mtpOmMIB_destroy(struct mtpOmMIB_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmMIB", "deleting scalars...  "));
...
mtpOmSpTable_create(void)
{
	...
	DEBUGMSGTL(("mtpOmSpTable", "creating row...  "));
	if (StorageNew != NULL) {
...
mtpOmSpTable_duplicate(struct mtpOmSpTable_data *thedata)
{
	...
	DEBUGMSGTL(("mtpOmSpTable", "duplicating row...  "));
	if (StorageNew != NULL) {
	}
      done:
	DEBUGMSGTL(("mtpOmSpTable", "done.\n"));
...
mtpOmSpTable_destroy(struct mtpOmSpTable_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmSpTable", "deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel);
		*thedata = StorageDel;
	}
...
mtpOmSpInt5minTable_create(void)
{
	...
	DEBUGMSGTL(("mtpOmSpInt5minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
		StorageNew->mtpSpId = 0;
...
mtpOmSpInt5minTable_duplicate(struct mtpOmSpInt5minTable_data *thedata)
{
	...
	DEBUGMSGTL(("mtpOmSpInt5minTable", "duplicating row...  "));
	if (StorageNew != NULL) {
	}
      done:
	DEBUGMSGTL(("mtpOmSpInt5minTable", "done.\n"));
...
mtpOmSpInt5minTable_destroy(struct mtpOmSpInt5minTable_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmSpInt5minTable", "deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel);
		*thedata = StorageDel;
	}
...
mtpOmSpInt15minTable_create(void)
{
	...
	DEBUGMSGTL(("mtpOmSpInt15minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
		StorageNew->mtpSpId = 0;
...
mtpOmSpInt15minTable_duplicate(struct mtpOmSpInt15minTable_data *thedata)
{
	...
	DEBUGMSGTL(("mtpOmSpInt15minTable", "duplicating row...  "));
	if (StorageNew != NULL) {
	}
      done:
	DEBUGMSGTL(("mtpOmSpInt15minTable", "done.\n"));
...
mtpOmSpInt15minTable_destroy(struct mtpOmSpInt15minTable_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmSpInt15minTable", "deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel);
		*thedata = StorageDel;
	}
...
mtpOmSpSiTable_create(void)
{
	...
	DEBUGMSGTL(("mtpOmSpSiTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
		StorageNew->mtpSpId = 0;
...
mtpOmSpSiTable_duplicate(struct mtpOmSpSiTable_data *thedata)
{
	...
	DEBUGMSGTL(("mtpOmSpSiTable", "duplicating row...  "));
	if (StorageNew != NULL) {
	}
      done:
	DEBUGMSGTL(("mtpOmSpSiTable", "done.\n"));
...
mtpOmSpSiTable_destroy(struct mtpOmSpSiTable_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmSpSiTable", "deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel);
		*thedata = StorageDel;
	}
...
mtpOmSpSiInt5minTable_create(void)
{
	...
	DEBUGMSGTL(("mtpOmSpSiInt5minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
		StorageNew->mtpSpId = 0;
...
mtpOmSpSiInt5minTable_duplicate(struct mtpOmSpSiInt5minTable_data *thedata)
{
	...
	DEBUGMSGTL(("mtpOmSpSiInt5minTable", "duplicating row...  "));
	if (StorageNew != NULL) {
	}
      done:
	DEBUGMSGTL(("mtpOmSpSiInt5minTable", "done.\n"));
...
mtpOmSpSiInt5minTable_destroy(struct mtpOmSpSiInt5minTable_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmSpSiInt5minTable", "deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel);
		*thedata = StorageDel;
	}
...
mtpOmSpSiInt15minTable_create(void)
{
	...
	DEBUGMSGTL(("mtpOmSpSiInt15minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
		StorageNew->mtpSpId = 0;
		StorageNew->mtpOmSpSiCode = 0;
...
mtpOmSpSiInt15minTable_duplicate(struct mtpOmSpSiInt15minTable_data *thedata)
{
	...
	DEBUGMSGTL(("mtpOmSpSiInt15minTable", "duplicating row...  "));
	if (StorageNew != NULL) {
	}
      done:
	DEBUGMSGTL(("mtpOmSpSiInt15minTable", "done.\n"));
...
mtpOmSpSiInt15minTable_destroy(struct mtpOmSpSiInt15minTable_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmSpSiInt15minTable", "deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel);
		*thedata = StorageDel;
	}
...
mtpOmSpStudyTable_create(void)
{
	...
	DEBUGMSGTL(("mtpOmSpStudyTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmSpStudyTable_duplicate(struct mtpOmSpStudyTable_data *thedata)
{
	...
	DEBUGMSGTL(("mtpOmSpStudyTable", "duplicating row...  "));
	if (StorageNew != NULL) {
	}
      done:
	DEBUGMSGTL(("mtpOmSpStudyTable", "done.\n"));
...
mtpOmSpStudyTable_destroy(struct mtpOmSpStudyTable_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmSpStudyTable", "deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel);
		*thedata = StorageDel;
	}
...
mtpOmSpStudyInt5minTable_create(void)
{
	...
	DEBUGMSGTL(("mtpOmSpStudyInt5minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmSpStudyInt5minTable_duplicate(struct mtpOmSpStudyInt5minTable_data *thedata)
{
	...
	DEBUGMSGTL(("mtpOmSpStudyInt5minTable", "duplicating row...  "));
	if (StorageNew != NULL) {
	}
      done:
	DEBUGMSGTL(("mtpOmSpStudyInt5minTable", "done.\n"));
...
mtpOmSpStudyInt5minTable_destroy(struct mtpOmSpStudyInt5minTable_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmSpStudyInt5minTable", "deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel);
		*thedata = StorageDel;
	}
...
mtpOmSpStudyInt15minTable_create(void)
{
	...
	DEBUGMSGTL(("mtpOmSpStudyInt15minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
		StorageNew->mtpOmSpStudyId = 0;
...
mtpOmSpStudyInt15minTable_duplicate(struct mtpOmSpStudyInt15minTable_data *thedata)
{
	...
	DEBUGMSGTL(("mtpOmSpStudyInt15minTable", "duplicating row...  "));
	if (StorageNew != NULL) {
	}
      done:
	DEBUGMSGTL(("mtpOmSpStudyInt15minTable", "done.\n"));
...
mtpOmSpStudyInt15minTable_destroy(struct mtpOmSpStudyInt15minTable_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmSpStudyInt15minTable", "deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel);
		*thedata = StorageDel;
	}
...
mtpOmSpStudyMapTable_create(void)
{
	...
	DEBUGMSGTL(("mtpOmSpStudyMapTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
		StorageNew->mtpSpId = 0;
		StorageNew->mtpOmSpSiCode = 0;
...
mtpOmSpStudyMapTable_duplicate(struct mtpOmSpStudyMapTable_data *thedata)
{
	...
	DEBUGMSGTL(("mtpOmSpStudyMapTable", "duplicating row...  "));
	if (StorageNew != NULL) {
	}
      done:
	DEBUGMSGTL(("mtpOmSpStudyMapTable", "done.\n"));
...
mtpOmSpStudyMapTable_destroy(struct mtpOmSpStudyMapTable_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmSpStudyMapTable", "deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel);
		*thedata = StorageDel;
	}
...
mtpOmRsTable_create(void)
{
	...
	DEBUGMSGTL(("mtpOmRsTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
		StorageNew->mtpSpId = 0;
...
mtpOmRsTable_duplicate(struct mtpOmRsTable_data *thedata)
{
	...
	DEBUGMSGTL(("mtpOmRsTable", "duplicating row...  "));
	if (StorageNew != NULL) {
	}
      done:
	DEBUGMSGTL(("mtpOmRsTable", "done.\n"));
...
mtpOmRsTable_destroy(struct mtpOmRsTable_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmRsTable", "deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel);
		*thedata = StorageDel;
	}
...
mtpOmRsInt5minTable_create(void)
{
	...
	DEBUGMSGTL(("mtpOmRsInt5minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
		StorageNew->mtpSpId = 0;
		StorageNew->mtpRsId = 0;
...
mtpOmRsInt5minTable_duplicate(struct mtpOmRsInt5minTable_data *thedata)
{
	...
	DEBUGMSGTL(("mtpOmRsInt5minTable", "duplicating row...  "));
	if (StorageNew != NULL) {
	}
      done:
	DEBUGMSGTL(("mtpOmRsInt5minTable", "done.\n"));
...
mtpOmRsInt5minTable_destroy(struct mtpOmRsInt5minTable_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmRsInt5minTable", "deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel);
		*thedata = StorageDel;
	}
...
mtpOmRsInt15minTable_create(void)
{
	...
	DEBUGMSGTL(("mtpOmRsInt15minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
		StorageNew->mtpSpId = 0;
		StorageNew->mtpRsId = 0;
...
mtpOmRsInt15minTable_duplicate(struct mtpOmRsInt15minTable_data *thedata)
{
	...
	DEBUGMSGTL(("mtpOmRsInt15minTable", "duplicating row...  "));
	if (StorageNew != NULL) {
	}
      done:
	DEBUGMSGTL(("mtpOmRsInt15minTable", "done.\n"));
...
mtpOmRsInt15minTable_destroy(struct mtpOmRsInt15minTable_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmRsInt15minTable", "deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel);
		*thedata = StorageDel;
	}
...
mtpOmRsSiTable_create(void)
{
	...
	DEBUGMSGTL(("mtpOmRsSiTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
		StorageNew->mtpSpId = 0;
		StorageNew->mtpRsId = 0;
...
mtpOmRsSiTable_duplicate(struct mtpOmRsSiTable_data *thedata)
{
	...
	DEBUGMSGTL(("mtpOmRsSiTable", "duplicating row...  "));
	if (StorageNew != NULL) {
	}
      done:
	DEBUGMSGTL(("mtpOmRsSiTable", "done.\n"));
...
mtpOmRsSiTable_destroy(struct mtpOmRsSiTable_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmRsSiTable", "deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel);
		*thedata = StorageDel;
	}
...
mtpOmRsSiInt5minTable_create(void)
{
	...
	DEBUGMSGTL(("mtpOmRsSiInt5minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
		StorageNew->mtpSpId = 0;
		StorageNew->mtpRsId = 0;
...
mtpOmRsSiInt5minTable_duplicate(struct mtpOmRsSiInt5minTable_data *thedata)
{
	...
	DEBUGMSGTL(("mtpOmRsSiInt5minTable", "duplicating row...  "));
	if (StorageNew != NULL) {
	}
      done:
	DEBUGMSGTL(("mtpOmRsSiInt5minTable", "done.\n"));
...
mtpOmRsSiInt5minTable_destroy(struct mtpOmRsSiInt5minTable_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmRsSiInt5minTable", "deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel);
		*thedata = StorageDel;
	}
...
mtpOmRsSiInt15minTable_create(void)
{
	...
	DEBUGMSGTL(("mtpOmRsSiInt15minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
		StorageNew->mtpSpId = 0;
		StorageNew->mtpRsId = 0;
...
mtpOmRsSiInt15minTable_duplicate(struct mtpOmRsSiInt15minTable_data *thedata)
{
	...
	DEBUGMSGTL(("mtpOmRsSiInt15minTable", "duplicating row...  "));
	if (StorageNew != NULL) {
	}
      done:
	DEBUGMSGTL(("mtpOmRsSiInt15minTable", "done.\n"));
...
mtpOmRsSiInt15minTable_destroy(struct mtpOmRsSiInt15minTable_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmRsSiInt15minTable", "deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel);
		*thedata = StorageDel;
	}
...
mtpOmLsTable_create(void)
{
	...
	DEBUGMSGTL(("mtpOmLsTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
		StorageNew->mtpSpId = 0;
...
mtpOmLsTable_duplicate(struct mtpOmLsTable_data *thedata)
{
	...
	DEBUGMSGTL(("mtpOmLsTable", "duplicating row...  "));
	if (StorageNew != NULL) {
	}
      done:
	DEBUGMSGTL(("mtpOmLsTable", "done.\n"));
...
mtpOmLsTable_destroy(struct mtpOmLsTable_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmLsTable", "deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel);
		*thedata = StorageDel;
	}
...
mtpOmLsInt5minTable_create(void)
{
	...
	DEBUGMSGTL(("mtpOmLsInt5minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
		StorageNew->mtpSpId = 0;
		StorageNew->mtpLsId = 0;
...
mtpOmLsInt5minTable_duplicate(struct mtpOmLsInt5minTable_data *thedata)
{
	...
	DEBUGMSGTL(("mtpOmLsInt5minTable", "duplicating row...  "));
	if (StorageNew != NULL) {
	}
      done:
	DEBUGMSGTL(("mtpOmLsInt5minTable", "done.\n"));
...
mtpOmLsInt5minTable_destroy(struct mtpOmLsInt5minTable_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmLsInt5minTable", "deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel);
		*thedata = StorageDel;
	}
...
mtpOmLsInt15minTable_create(void)
{
	...
	DEBUGMSGTL(("mtpOmLsInt15minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
		StorageNew->mtpSpId = 0;
		StorageNew->mtpLsId = 0;
...
mtpOmLsInt15minTable_duplicate(struct mtpOmLsInt15minTable_data *thedata)
{
	...
	DEBUGMSGTL(("mtpOmLsInt15minTable", "duplicating row...  "));
	if (StorageNew != NULL) {
	}
      done:
	DEBUGMSGTL(("mtpOmLsInt15minTable", "done.\n"));
...
mtpOmLsInt15minTable_destroy(struct mtpOmLsInt15minTable_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmLsInt15minTable", "deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel);
		*thedata = StorageDel;
	}
...
mtpOmSlStatsTable_create(void)
{
	...
	DEBUGMSGTL(("mtpOmSlStatsTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmSlStatsTable_duplicate(struct mtpOmSlStatsTable_data *thedata)
{
	...
	DEBUGMSGTL(("mtpOmSlStatsTable", "duplicating row...  "));
	if (StorageNew != NULL) {
	}
      done:
	DEBUGMSGTL(("mtpOmSlStatsTable", "done.\n"));
...
mtpOmSlStatsTable_destroy(struct mtpOmSlStatsTable_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmSlStatsTable", "deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel);
		*thedata = StorageDel;
	}
...
mtpOmSlL3Table_create(void)
{
	...
	DEBUGMSGTL(("mtpOmSlL3Table", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
		StorageNew->mtpSpId = 0;
		StorageNew->mtpLsId = 0;
...
mtpOmSlL3Table_duplicate(struct mtpOmSlL3Table_data *thedata)
{
	...
	DEBUGMSGTL(("mtpOmSlL3Table", "duplicating row...  "));
	if (StorageNew != NULL) {
	}
      done:
	DEBUGMSGTL(("mtpOmSlL3Table", "done.\n"));
...
mtpOmSlL3Table_destroy(struct mtpOmSlL3Table_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmSlL3Table", "deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel);
		*thedata = StorageDel;
	}
...
mtpOmSlL3Int5minTable_create(void)
{
	...
	DEBUGMSGTL(("mtpOmSlL3Int5minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
		StorageNew->mtpSpId = 0;
		StorageNew->mtpLsId = 0;
...
mtpOmSlL3Int5minTable_duplicate(struct mtpOmSlL3Int5minTable_data *thedata)
{
	...
	DEBUGMSGTL(("mtpOmSlL3Int5minTable", "duplicating row...  "));
	if (StorageNew != NULL) {
	}
      done:
	DEBUGMSGTL(("mtpOmSlL3Int5minTable", "done.\n"));
...
mtpOmSlL3Int5minTable_destroy(struct mtpOmSlL3Int5minTable_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmSlL3Int5minTable", "deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel);
		*thedata = StorageDel;
	}
...
mtpOmSlL3Int15minTable_create(void)
{
	...
	DEBUGMSGTL(("mtpOmSlL3Int15minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
		StorageNew->mtpSpId = 0;
		StorageNew->mtpLsId = 0;
...
mtpOmSlL3Int15minTable_duplicate(struct mtpOmSlL3Int15minTable_data *thedata)
{
	...
	DEBUGMSGTL(("mtpOmSlL3Int15minTable", "duplicating row...  "));
	if (StorageNew != NULL) {
	}
      done:
	DEBUGMSGTL(("mtpOmSlL3Int15minTable", "done.\n"));
...
mtpOmSlL3Int15minTable_destroy(struct mtpOmSlL3Int15minTable_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmSlL3Int15minTable", "deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel);
		*thedata = StorageDel;
	}
...
mtpOmSlL2Table_create(void)
{
	...
	DEBUGMSGTL(("mtpOmSlL2Table", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
		StorageNew->mtpSpId = 0;
		StorageNew->mtpLsId = 0;
...
mtpOmSlL2Table_duplicate(struct mtpOmSlL2Table_data *thedata)
{
	...
	DEBUGMSGTL(("mtpOmSlL2Table", "duplicating row...  "));
	if (StorageNew != NULL) {
	}
      done:
	DEBUGMSGTL(("mtpOmSlL2Table", "done.\n"));
...
mtpOmSlL2Table_destroy(struct mtpOmSlL2Table_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmSlL2Table", "deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel);
		*thedata = StorageDel;
	}
...
mtpOmSlL2Int5minTable_create(void)
{
	...
	DEBUGMSGTL(("mtpOmSlL2Int5minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
		StorageNew->mtpSpId = 0;
		StorageNew->mtpLsId = 0;
...
mtpOmSlL2Int5minTable_duplicate(struct mtpOmSlL2Int5minTable_data *thedata)
{
	...
	DEBUGMSGTL(("mtpOmSlL2Int5minTable", "duplicating row...  "));
	if (StorageNew != NULL) {
	}
      done:
	DEBUGMSGTL(("mtpOmSlL2Int5minTable", "done.\n"));
...
mtpOmSlL2Int5minTable_destroy(struct mtpOmSlL2Int5minTable_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmSlL2Int5minTable", "deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel);
		*thedata = StorageDel;
	}
...
mtpOmSlL2Int15minTable_create(void)
{
	...
	DEBUGMSGTL(("mtpOmSlL2Int15minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
		StorageNew->mtpSpId = 0;
		StorageNew->mtpLsId = 0;
...
mtpOmSlL2Int15minTable_duplicate(struct mtpOmSlL2Int15minTable_data *thedata)
{
	...
	DEBUGMSGTL(("mtpOmSlL2Int15minTable", "duplicating row...  "));
	if (StorageNew != NULL) {
	}
      done:
	DEBUGMSGTL(("mtpOmSlL2Int15minTable", "done.\n"));
...
mtpOmSlL2Int15minTable_destroy(struct mtpOmSlL2Int15minTable_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmSlL2Int15minTable", "deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel);
		*thedata = StorageDel;
	}
...
mtpOmSdtStatsTable_create(void)
{
	...
	DEBUGMSGTL(("mtpOmSdtStatsTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
		StorageNew->mtpMsId = 0;
...
mtpOmSdtStatsTable_duplicate(struct mtpOmSdtStatsTable_data *thedata)
{
	...
	DEBUGMSGTL(("mtpOmSdtStatsTable", "duplicating row...  "));
	if (StorageNew != NULL) {
	}
      done:
	DEBUGMSGTL(("mtpOmSdtStatsTable", "done.\n"));
...
mtpOmSdtStatsTable_destroy(struct mtpOmSdtStatsTable_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmSdtStatsTable", "deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel);
		*thedata = StorageDel;
	}
...
mtpOmSdlStatsTable_create(void)
{
	...
	DEBUGMSGTL(("mtpOmSdlStatsTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
		StorageNew->mtpMsId = 0;
		StorageNew->mtpSpId = 0;
...
mtpOmSdlStatsTable_duplicate(struct mtpOmSdlStatsTable_data *thedata)
{
	...
	DEBUGMSGTL(("mtpOmSdlStatsTable", "duplicating row...  "));
	if (StorageNew != NULL) {
	}
      done:
	DEBUGMSGTL(("mtpOmSdlStatsTable", "done.\n"));
...
mtpOmSdlStatsTable_destroy(struct mtpOmSdlStatsTable_data **thedata)
{
	...
	DEBUGMSGTL(("mtpOmSdlStatsTable", "deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
...
/**
 * @fn void refresh_mtpOmSpTable(void)
...
/**
 * @fn void refresh_mtpOmSpTable_row(struct mtpOmSpTable_data *StorageTmp)
...
{
	if (!StorageTmp || StorageTmp->mtpOmSpTable_request == sa_request)
		return;
...
var_mtpOmSpTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	StorageTmp = header_complex(mtpOmSpTableStorage, vp, name, length, exact, var_len, write_method);
...
/**
 * @fn void refresh_mtpOmSpInt5minTable(void)
...
/**
 * @fn void refresh_mtpOmSpInt5minTable_row(struct mtpOmSpInt5minTable_data *StorageTmp)
...
{
	if (!StorageTmp || StorageTmp->mtpOmSpInt5minTable_request == sa_request)
		return;
...
var_mtpOmSpInt5minTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_mtpOmSpInt5minTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(mtpOmSpInt5minTableStorage, vp, name, length, exact, var_len, write_method);
...
/**
 * @fn void refresh_mtpOmSpInt15minTable(void)
...
/**
 * @fn void refresh_mtpOmSpInt15minTable_row(struct mtpOmSpInt15minTable_data *StorageTmp)
...
{
	if (!StorageTmp || StorageTmp->mtpOmSpInt15minTable_request == sa_request)
		return;
...
var_mtpOmSpInt15minTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_mtpOmSpInt15minTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(mtpOmSpInt15minTableStorage, vp, name, length, exact, var_len, write_method);
...
/**
 * @fn void refresh_mtpOmSpSiTable(void)
...
/**
 * @fn void refresh_mtpOmSpSiTable_row(struct mtpOmSpSiTable_data *StorageTmp)
...
{
	if (!StorageTmp || StorageTmp->mtpOmSpSiTable_request == sa_request)
		return;
...
var_mtpOmSpSiTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_mtpOmSpSiTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(mtpOmSpSiTableStorage, vp, name, length, exact, var_len, write_method);
...
/**
 * @fn void refresh_mtpOmSpSiInt5minTable(void)
...
/**
 * @fn void refresh_mtpOmSpSiInt5minTable_row(struct mtpOmSpSiInt5minTable_data *StorageTmp)
...
{
	if (!StorageTmp || StorageTmp->mtpOmSpSiInt5minTable_request == sa_request)
		return;
...
var_mtpOmSpSiInt5minTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_mtpOmSpSiInt5minTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(mtpOmSpSiInt5minTableStorage, vp, name, length, exact, var_len, write_method);
...
/**
 * @fn void refresh_mtpOmSpSiInt15minTable(void)
...
/**
 * @fn void refresh_mtpOmSpSiInt15minTable_row(struct mtpOmSpSiInt15minTable_data *StorageTmp)
...
{
	if (!StorageTmp || StorageTmp->mtpOmSpSiInt15minTable_request == sa_request)
		return;
...
var_mtpOmSpSiInt15minTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_mtpOmSpSiInt15minTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(mtpOmSpSiInt15minTableStorage, vp, name, length, exact, var_len, write_method);
...
/**
 * @fn void refresh_mtpOmSpStudyTable(void)
...
/**
 * @fn void refresh_mtpOmSpStudyTable_row(struct mtpOmSpStudyTable_data *StorageTmp)
...
{
	if (!StorageTmp || StorageTmp->mtpOmSpStudyTable_request == sa_request)
		return;
...
var_mtpOmSpStudyTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_mtpOmSpStudyTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(mtpOmSpStudyTableStorage, vp, name, length, exact, var_len, write_method);
...
/**
 * @fn void refresh_mtpOmSpStudyInt5minTable(void)
...
/**
 * @fn void refresh_mtpOmSpStudyInt5minTable_row(struct mtpOmSpStudyInt5minTable_data *StorageTmp)
...
{
	if (!StorageTmp || StorageTmp->mtpOmSpStudyInt5minTable_request == sa_request)
		return;
...
var_mtpOmSpStudyInt5minTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_mtpOmSpStudyInt5minTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(mtpOmSpStudyInt5minTableStorage, vp, name, length, exact, var_len, write_method);
...
/**
 * @fn void refresh_mtpOmSpStudyInt15minTable(void)
...
/**
 * @fn void refresh_mtpOmSpStudyInt15minTable_row(struct mtpOmSpStudyInt15minTable_data *StorageTmp)
...
{
	if (!StorageTmp || StorageTmp->mtpOmSpStudyInt15minTable_request == sa_request)
		return;
...
var_mtpOmSpStudyInt15minTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_mtpOmSpStudyInt15minTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(mtpOmSpStudyInt15minTableStorage, vp, name, length, exact, var_len, write_method);
...
/**
 * @fn void refresh_mtpOmSpStudyMapTable(void)
...
/**
 * @fn void refresh_mtpOmSpStudyMapTable_row(struct mtpOmSpStudyMapTable_data *StorageTmp)
...
{
	if (!StorageTmp || StorageTmp->mtpOmSpStudyMapTable_request == sa_request)
		return;
...
var_mtpOmSpStudyMapTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_mtpOmSpStudyMapTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(mtpOmSpStudyMapTableStorage, vp, name, length, exact, var_len, write_method);
...
/**
 * @fn void refresh_mtpOmRsTable(void)
...
/**
 * @fn void refresh_mtpOmRsTable_row(struct mtpOmRsTable_data *StorageTmp)
...
{
	if (!StorageTmp || StorageTmp->mtpOmRsTable_request == sa_request)
		return;
...
var_mtpOmRsTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_mtpOmRsTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(mtpOmRsTableStorage, vp, name, length, exact, var_len, write_method);
...
/**
 * @fn void refresh_mtpOmRsInt5minTable(void)
...
/**
 * @fn void refresh_mtpOmRsInt5minTable_row(struct mtpOmRsInt5minTable_data *StorageTmp)
...
{
	if (!StorageTmp || StorageTmp->mtpOmRsInt5minTable_request == sa_request)
		return;
...
var_mtpOmRsInt5minTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_mtpOmRsInt5minTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(mtpOmRsInt5minTableStorage, vp, name, length, exact, var_len, write_method);
...
/**
 * @fn void refresh_mtpOmRsInt15minTable(void)
...
/**
 * @fn void refresh_mtpOmRsInt15minTable_row(struct mtpOmRsInt15minTable_data *StorageTmp)
...
{
	if (!StorageTmp || StorageTmp->mtpOmRsInt15minTable_request == sa_request)
		return;
...
var_mtpOmRsInt15minTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_mtpOmRsInt15minTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(mtpOmRsInt15minTableStorage, vp, name, length, exact, var_len, write_method);
...
/**
 * @fn void refresh_mtpOmRsSiTable(void)
...
/**
 * @fn void refresh_mtpOmRsSiTable_row(struct mtpOmRsSiTable_data *StorageTmp)
...
{
	if (!StorageTmp || StorageTmp->mtpOmRsSiTable_request == sa_request)
		return;
...
var_mtpOmRsSiTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_mtpOmRsSiTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(mtpOmRsSiTableStorage, vp, name, length, exact, var_len, write_method);
...
/**
 * @fn void refresh_mtpOmRsSiInt5minTable(void)
...
/**
 * @fn void refresh_mtpOmRsSiInt5minTable_row(struct mtpOmRsSiInt5minTable_data *StorageTmp)
...
{
	if (!StorageTmp || StorageTmp->mtpOmRsSiInt5minTable_request == sa_request)
		return;
...
var_mtpOmRsSiInt5minTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_mtpOmRsSiInt5minTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(mtpOmRsSiInt5minTableStorage, vp, name, length, exact, var_len, write_method);
...
/**
 * @fn void refresh_mtpOmRsSiInt15minTable(void)
...
/**
 * @fn void refresh_mtpOmRsSiInt15minTable_row(struct mtpOmRsSiInt15minTable_data *StorageTmp)
...
{
	if (!StorageTmp || StorageTmp->mtpOmRsSiInt15minTable_request == sa_request)
		return;
...
var_mtpOmRsSiInt15minTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_mtpOmRsSiInt15minTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(mtpOmRsSiInt15minTableStorage, vp, name, length, exact, var_len, write_method);
...
/**
 * @fn void refresh_mtpOmLsTable(void)
...
/**
 * @fn void refresh_mtpOmLsTable_row(struct mtpOmLsTable_data *StorageTmp)
...
{
	if (!StorageTmp || StorageTmp->mtpOmLsTable_request == sa_request)
		return;
...
var_mtpOmLsTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_mtpOmLsTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(mtpOmLsTableStorage, vp, name, length, exact, var_len, write_method);
...
/**
 * @fn void refresh_mtpOmLsInt5minTable(void)
...
/**
 * @fn void refresh_mtpOmLsInt5minTable_row(struct mtpOmLsInt5minTable_data *StorageTmp)
...
{
	if (!StorageTmp || StorageTmp->mtpOmLsInt5minTable_request == sa_request)
		return;
...
var_mtpOmLsInt5minTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_mtpOmLsInt5minTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(mtpOmLsInt5minTableStorage, vp, name, length, exact, var_len, write_method);
...
/**
 * @fn void refresh_mtpOmLsInt15minTable(void)
...
/**
 * @fn void refresh_mtpOmLsInt15minTable_row(struct mtpOmLsInt15minTable_data *StorageTmp)
...
{
	if (!StorageTmp || StorageTmp->mtpOmLsInt15minTable_request == sa_request)
		return;
...
var_mtpOmLsInt15minTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_mtpOmLsInt15minTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(mtpOmLsInt15minTableStorage, vp, name, length, exact, var_len, write_method);
...
/**
 * @fn void refresh_mtpOmSlStatsTable(void)
...
/**
 * @fn void refresh_mtpOmSlStatsTable_row(struct mtpOmSlStatsTable_data *StorageTmp)
...
{
	if (!StorageTmp || StorageTmp->mtpOmSlStatsTable_request == sa_request)
		return;
...
var_mtpOmSlStatsTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_mtpOmSlStatsTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(mtpOmSlStatsTableStorage, vp, name, length, exact, var_len, write_method);
...
/**
 * @fn void refresh_mtpOmSlL3Table(void)
...
/**
 * @fn void refresh_mtpOmSlL3Table_row(struct mtpOmSlL3Table_data *StorageTmp)
...
{
	if (!StorageTmp || StorageTmp->mtpOmSlL3Table_request == sa_request)
		return;
...
var_mtpOmSlL3Table(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_mtpOmSlL3Table();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(mtpOmSlL3TableStorage, vp, name, length, exact, var_len, write_method);
...
/**
 * @fn void refresh_mtpOmSlL3Int5minTable(void)
...
/**
 * @fn void refresh_mtpOmSlL3Int5minTable_row(struct mtpOmSlL3Int5minTable_data *StorageTmp)
...
{
	if (!StorageTmp || StorageTmp->mtpOmSlL3Int5minTable_request == sa_request)
		return;
...
var_mtpOmSlL3Int5minTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_mtpOmSlL3Int5minTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(mtpOmSlL3Int5minTableStorage, vp, name, length, exact, var_len, write_method);
...
/**
 * @fn void refresh_mtpOmSlL3Int15minTable(void)
...
/**
 * @fn void refresh_mtpOmSlL3Int15minTable_row(struct mtpOmSlL3Int15minTable_data *StorageTmp)
...
{
	if (!StorageTmp || StorageTmp->mtpOmSlL3Int15minTable_request == sa_request)
		return;
...
var_mtpOmSlL3Int15minTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_mtpOmSlL3Int15minTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(mtpOmSlL3Int15minTableStorage, vp, name, length, exact, var_len, write_method);
...
/**
 * @fn void refresh_mtpOmSlL2Table(void)
...
/**
 * @fn void refresh_mtpOmSlL2Table_row(struct mtpOmSlL2Table_data *StorageTmp)
...
{
	if (!StorageTmp || StorageTmp->mtpOmSlL2Table_request == sa_request)
		return;
...
var_mtpOmSlL2Table(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_mtpOmSlL2Table();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(mtpOmSlL2TableStorage, vp, name, length, exact, var_len, write_method);
...
/**
 * @fn void refresh_mtpOmSlL2Int5minTable(void)
...
/**
 * @fn void refresh_mtpOmSlL2Int5minTable_row(struct mtpOmSlL2Int5minTable_data *StorageTmp)
...
{
	if (!StorageTmp || StorageTmp->mtpOmSlL2Int5minTable_request == sa_request)
		return;
...
var_mtpOmSlL2Int5minTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_mtpOmSlL2Int5minTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(mtpOmSlL2Int5minTableStorage, vp, name, length, exact, var_len, write_method);
...
/**
 * @fn void refresh_mtpOmSlL2Int15minTable(void)
...
/**
 * @fn void refresh_mtpOmSlL2Int15minTable_row(struct mtpOmSlL2Int15minTable_data *StorageTmp)
...
{
	if (!StorageTmp || StorageTmp->mtpOmSlL2Int15minTable_request == sa_request)
		return;
...
var_mtpOmSlL2Int15minTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_mtpOmSlL2Int15minTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(mtpOmSlL2Int15minTableStorage, vp, name, length, exact, var_len, write_method);
...
/**
 * @fn void refresh_mtpOmSdtStatsTable(void)
...
/**
 * @fn void refresh_mtpOmSdtStatsTable_row(struct mtpOmSdtStatsTable_data *StorageTmp)
...
{
	if (!StorageTmp || StorageTmp->mtpOmSdtStatsTable_request == sa_request)
		return;
...
var_mtpOmSdtStatsTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_mtpOmSdtStatsTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(mtpOmSdtStatsTableStorage, vp, name, length, exact, var_len, write_method);
...
/**
 * @fn void refresh_mtpOmSdlStatsTable(void)
...
/**
 * @fn void refresh_mtpOmSdlStatsTable_row(struct mtpOmSdlStatsTable_data *StorageTmp)
...
{
	if (!StorageTmp || StorageTmp->mtpOmSdlStatsTable_request == sa_request)
		return;
...
var_mtpOmSdlStatsTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_mtpOmSdlStatsTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	StorageTmp = header_complex(mtpOmSdlStatsTableStorage, vp, name, length, exact, var_len, write_method);
...
write_mtpOmSpSiStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case ACTION:
		...
		case RS_ACTIVE:
			...
			if (old_value != RS_ACTIVE) {
				...
				if (!mtpOmSpSiTable_consistent(StorageTmp)) {
	...
	case COMMIT:
		...
		case RS_CREATEANDGO:
			...
			if (mtpOmSpSiTable_consistent(StorageNew)) {
...
write_mtpOmSpStudyStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case ACTION:
		...
		case RS_ACTIVE:
			...
			if (old_value != RS_ACTIVE) {
				/* check that activation is possible */
				if (!mtpOmSpStudyTable_consistent(StorageTmp)) {
	...
	case COMMIT:
		...
		case RS_CREATEANDGO:
			/* row creation, set final state */
			/* check if row is ready, otherwise leave at RS_NOTREADY */
			if (mtpOmSpStudyTable_consistent(StorageNew)) {
				/* XXX: commit creation to underlying device */
				/* XXX: activate with underlying device */
...
write_mtpOmSpStudyMapStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case ACTION:
		...
		case RS_ACTIVE:
			...
			if (old_value != RS_ACTIVE) {
				/* check that activation is possible */
				if (!mtpOmSpStudyMapTable_consistent(StorageTmp)) {
	...
	case COMMIT:
		...
		case RS_CREATEANDGO:
			/* row creation, set final state */
			/* check if row is ready, otherwise leave at RS_NOTREADY */
			if (mtpOmSpStudyMapTable_consistent(StorageNew)) {
				/* XXX: commit creation to underlying device */
				/* XXX: activate with underlying device */
...
write_mtpOmRsSiStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case ACTION:
		...
		case RS_ACTIVE:
			...
			if (old_value != RS_ACTIVE) {
				/* check that activation is possible */
				if (!mtpOmRsSiTable_consistent(StorageTmp)) {
	...
	case COMMIT:
		...
		case RS_CREATEANDGO:
			/* row creation, set final state */
			/* check if row is ready, otherwise leave at RS_NOTREADY */
			if (mtpOmRsSiTable_consistent(StorageNew)) {
				/* XXX: commit creation to underlying device */
				/* XXX: activate with underlying device */
 ...
 */
void
mtpOmMIB_loop_handler(int dummy)
{
...
char sa_logfile[256] = "/var/log/mtpommib.log";
char sa_pidfile[256] = "/var/run/mtpommib.pid";
char sa_sysctlf[256] = "/etc/mtpommib.conf";
