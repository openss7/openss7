/*****************************************************************************
 ...
 @(#) $RCSfile: mtpOmMIB.c,v $ $Name:  $($Revision: 0.9.2.12 $) $Date: 2009-01-19 13:31:47 $
...
#ident "@(#) $RCSfile: mtpOmMIB.c,v $ $Name:  $($Revision: 0.9.2.12 $) $Date: 2009-01-19 13:31:47 $"

static char const ident[] = "$RCSfile: mtpOmMIB.c,v $ $Name:  $($Revision: 0.9.2.12 $) $Date: 2009-01-19 13:31:47 $";
...
write_mtpOmRsSiValidIntervals(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	if ((StorageTmp = header_complex(mtpOmRsSiTableStorage, NULL, &name[16], &newlen, 1, NULL, NULL)) == NULL)
