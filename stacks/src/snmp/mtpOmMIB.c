/*****************************************************************************
 ...
 @(#) $RCSfile: mtpOmMIB.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2009-01-02 15:04:13 $
...
#ident "@(#) $RCSfile: mtpOmMIB.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2009-01-02 15:04:13 $"

static char const ident[] = "$RCSfile: mtpOmMIB.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2009-01-02 15:04:13 $";
...
mtpOmMIB_create(void)
{
	...
	DBUGMSGTL(("mtpOmMIB", "creating scalars...  "));
	if (StorageNew != NULL) {
...
mtpOmSpTable_create(void)
{
	...
	DBUGMSGTL(("mtpOmSpTable", "creating row...  "));
	if (StorageNew != NULL) {
...
mtpOmSpInt5minTable_create(void)
{
	...
	DBUGMSGTL(("mtpOmSpInt5minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmSpInt15minTable_create(void)
{
	...
	DBUGMSGTL(("mtpOmSpInt15minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmSpSiTable_create(void)
{
	...
	DBUGMSGTL(("mtpOmSpSiTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmSpSiInt5minTable_create(void)
{
	...
	DBUGMSGTL(("mtpOmSpSiInt5minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmSpSiInt15minTable_create(void)
{
	...
	DBUGMSGTL(("mtpOmSpSiInt15minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmSpStudyTable_create(void)
{
	...
	DBUGMSGTL(("mtpOmSpStudyTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmSpStudyInt5minTable_create(void)
{
	...
	DBUGMSGTL(("mtpOmSpStudyInt5minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmSpStudyInt15minTable_create(void)
{
	...
	DBUGMSGTL(("mtpOmSpStudyInt15minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmSpStudyMapTable_create(void)
{
	...
	DBUGMSGTL(("mtpOmSpStudyMapTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmRsTable_create(void)
{
	...
	DBUGMSGTL(("mtpOmRsTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmRsInt5minTable_create(void)
{
	...
	DBUGMSGTL(("mtpOmRsInt5minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmRsInt15minTable_create(void)
{
	...
	DBUGMSGTL(("mtpOmRsInt15minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmRsSiTable_create(void)
{
	...
	DBUGMSGTL(("mtpOmRsSiTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmRsSiInt5minTable_create(void)
{
	...
	DBUGMSGTL(("mtpOmRsSiInt5minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmRsSiInt15minTable_create(void)
{
	...
	DBUGMSGTL(("mtpOmRsSiInt15minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmLsTable_create(void)
{
	...
	DBUGMSGTL(("mtpOmLsTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmLsInt5minTable_create(void)
{
	...
	DBUGMSGTL(("mtpOmLsInt5minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmLsInt15minTable_create(void)
{
	...
	DBUGMSGTL(("mtpOmLsInt15minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmSlStatsTable_create(void)
{
	...
	DBUGMSGTL(("mtpOmSlStatsTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmSlL3Table_create(void)
{
	...
	DBUGMSGTL(("mtpOmSlL3Table", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmSlL3Int5minTable_create(void)
{
	...
	DBUGMSGTL(("mtpOmSlL3Int5minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmSlL3Int15minTable_create(void)
{
	...
	DBUGMSGTL(("mtpOmSlL3Int15minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmSlL2Table_create(void)
{
	...
	DBUGMSGTL(("mtpOmSlL2Table", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmSlL2Int5minTable_create(void)
{
	...
	DBUGMSGTL(("mtpOmSlL2Int5minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmSlL2Int15minTable_create(void)
{
	...
	DBUGMSGTL(("mtpOmSlL2Int15minTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmSdtStatsTable_create(void)
{
	...
	DBUGMSGTL(("mtpOmSdtStatsTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
mtpOmSdlStatsTable_create(void)
{
	...
	DBUGMSGTL(("mtpOmSdlStatsTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
