/*****************************************************************************
 ...
 @(#) $RCSfile: mtpOmMIB.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2009-01-04 13:16:03 $
...
#ident "@(#) $RCSfile: mtpOmMIB.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2009-01-04 13:16:03 $"

static char const ident[] = "$RCSfile: mtpOmMIB.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2009-01-04 13:16:03 $";
...
#endif				/* defined MASTER */
/**
 * @fn void mtpOmMIB_readfd_handler(int fd, void *dummy)
 ...
 */
void
mtpOmMIB_readfd_handler(int fd, void *dummy)
{
