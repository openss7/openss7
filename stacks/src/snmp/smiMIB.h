/*****************************************************************************
 ...
 @(#) $Id: smiMIB.h,v 0.9.2.1 2009-01-04 13:16:00 brian Exp $
...
#ident "@(#) $RCSfile: smiMIB.h,v $ $Name: OpenSS7-0_9_2 $($Revision: 0.9.2.1 $) Copyright (c) 2008-2009 Monavacom Limited."
...
struct discriminatorTable_data {
	...
	uint8_t *discriminatorId;
	size_t discriminatorIdLen;
	uint8_t *discriminatorConstruct;
	size_t discriminatorConstructLen;
	long discriminatorAdministrativeState;
	long discriminatorOperationalState;
	uint8_t *discriminatorAvailabilityStatus;
	size_t discriminatorAvailabilityStatusLen;
	long discriminatorStartTime;
	long discriminatorStopTime;
	uint8_t *discriminatorIntervalsOfDay;
	size_t discriminatorIntervalsOfDayLen;
	uint8_t *discriminatorWeekMask;
	size_t discriminatorWeekMaskLen;
	oid *discriminatorSchedulerName;
	size_t discriminatorSchedulerNameLen;
	long discriminatorEntryStatus;
};
struct eventForwardingDiscriminatorTable_data {
	...
	uint8_t *activeDestination;
	size_t activeDestinationLen;
	uint8_t *backUpDestinationList;
	size_t backUpDestinationListLen;
	long confirmedMode;
	long eventForwardingDiscriminatorEntryStatus;
};
struct logTable_data {
	...
	uint8_t *logId;
	size_t logIdLen;
	uint8_t *logDiscriminatorConstruct;
	size_t logDiscriminatorConstructLen;
	long logAdministrativeState;
	long logOperationalState;
	uint8_t *logAvailabilityStatus;
	size_t logAvailabilityStatusLen;
	long logFullAction;
	ulong maxLogSize;
	long currentLogSize;
	long numberOfRecords;
	uint8_t *capacityAlarmThreshold;
	size_t capacityAlarmThresholdLen;
	long logStartTime;
	long logStopTime;
	uint8_t *logIntervalsOfDay;
	size_t logIntervalsOfDayLen;
	uint8_t *logWeekMask;
	size_t logWeekMaskLen;
	oid *logSchedulerName;
...
struct eventLogRecordTable_data {
	...
	uint8_t *logRecordId;
	size_t logRecordIdLen;
	oid *managedObjectClass;
	size_t managedObjectClassLen;
	oid *managedObjectInstance;
	size_t managedObjectInstanceLen;
	oid *eventType;
	size_t eventTypeLen;
	long eventTimes;
	long eventNotificationIdentifier;
	uint8_t *eventCorrelatedNotifications;
	size_t eventCorrelatedNotificationsLen;
	uint8_t *eventAdditionalText;
	size_t eventAdditionalTextLen;
	uint8_t *eventAdditionalInformation;
...
struct alarmRecordTable_data {
	...
	uint8_t *logRecordId;
	size_t logRecordIdLen;
	oid *alarmRecordProbableCause;
	size_t alarmRecordProbableCauseLen;
	long alarmRecordPerceivedSeverity;
	oid *alarmRecordSpecificProblems;
	size_t alarmRecordSpecificProblemsLen;
	long alarmRecordBackedUpStatus;
	oid *alarmRecordBackUpObject;
	size_t alarmRecordBackUpObjectLen;
	long alarmRecordTrendIndication;
	uint8_t *alarmRecordThresholdInfo;
	size_t alarmRecordThresholdInfoLen;
	uint8_t *alarmRecordStateChangeDefinition;
	size_t alarmRecordStateChangeDefinitionLen;
	uint8_t *alarmRecordMonitoredAttributes;
	size_t alarmRecordMonitoredAttributesLen;
	oid *alarmRecordProposedRepairActions;
...
struct attributeValueChangeRecordTable_data {
	...
	uint8_t *logRecordId;
	size_t logRecordIdLen;
	uint8_t *attributeValueChangeRecordDefinition;
	size_t attributeValueChangeRecordDefinitionLen;
	long attributeValueChangeSourceIndicator;
	oid *attributeValueChangeAttributeIdentifierList;
...
struct objectCreationRecordTable_data {
	...
	uint8_t *logRecordId;
	size_t logRecordIdLen;
	long objectCreationSourceIndicator;
	oid *objectCreationAttributeIdentifierList;
...
struct objectDeletionRecordTable_data {
	...
	uint8_t *logRecordId;
	size_t logRecordIdLen;
	long objectDeletionSourceIndicator;
	oid *objectDeletionAttributeIdentifierList;
...
struct relationshipChangeRecordTable_data {
	...
	uint8_t *logRecordId;
	size_t logRecordIdLen;
	uint8_t *relationshipChangeRecordDefinition;
	size_t relationshipChangeRecordDefinitionLen;
	long relationshipChangeSourceIndicator;
	oid *relationshipChangeAttributeIdentifierList;
...
struct securityAlarmReportRecordTable_data {
	...
	uint8_t *logRecordId;
	size_t logRecordIdLen;
	oid *securityAlarmRecordCause;
	size_t securityAlarmRecordCauseLen;
	long securityAlarmRecordSeverity;
	oid *securityAlarmRecordDetector;
	size_t securityAlarmRecordDetectorLen;
	uint8_t *securityServiceUser;
	size_t securityServiceUserLen;
	uint8_t *securityServiceProvider;
...
struct stateChangeRecordTable_data {
	...
	uint8_t *logRecordId;
	size_t logRecordIdLen;
	uint8_t *stateChangeRecordDefinition;
	size_t stateChangeRecordDefinitionLen;
	long stateChangeSourceIndicator;
	oid *stateChangeAttributeIdentifierList;
...
/* notifications */
extern oid attributeValueChange_oid[11];
extern oid communicationsAlarm_oid[11];
extern oid environmentalAlarm_oid[11];
extern oid equipmentAlarm_oid[11];
extern oid integrityViolation_oid[11];
extern oid objectCreation_oid[11];
extern oid objectDeletion_oid[11];
extern oid operationalViolation_oid[11];
extern oid physicalViolation_oid[11];
extern oid processingErrorAlarm_oid[11];
extern oid qualityofServiceAlarm_oid[11];
extern oid relationshipChange_oid[11];
extern oid securityServiceOrMechanismViolation_oid[11];
extern oid stateChange_oid[11];
extern oid timeDomainViolation_oid[11];
extern oid communicationsInformation_oid[11];
...
extern oid attributeValueChangeType_oid[12];
extern oid communicationsAlarmType_oid[12];
extern oid environmentalAlarmType_oid[12];
extern oid equipmentAlarmType_oid[12];
extern oid integrityViolationType_oid[12];
extern oid objectCreationType_oid[12];
extern oid objectDeletionType_oid[12];
extern oid operationalViolationType_oid[12];
extern oid physicalViolationType_oid[12];
extern oid processingErrorAlarmType_oid[12];
extern oid qualityofServiceAlarmType_oid[12];
extern oid relationshipChangeType_oid[12];
extern oid securityServiceOrMechanismViolationType_oid[12];
extern oid stateChangeType_oid[12];
extern oid timeDomainViolationType_oid[12];
...
void refresh_discriminatorTable(void);
...
void refresh_eventForwardingDiscriminatorTable(void);
...
void refresh_logRecordTable(void);
...
void refresh_eventLogRecordTable(void);
...
void refresh_alarmRecordTable(void);
...
void refresh_attributeValueChangeRecordTable(void);
...
void refresh_objectCreationRecordTable(void);
...
void refresh_objectDeletionRecordTable(void);
...
void refresh_relationshipChangeRecordTable(void);
...
void refresh_securityAlarmReportRecordTable(void);
...
void refresh_stateChangeRecordTable(void);
