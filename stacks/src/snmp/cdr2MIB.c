/*****************************************************************************
 ...
 @(#) $RCSfile: cdr2MIB.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2009-01-04 13:16:00 $
...
#ident "@(#) $RCSfile: cdr2MIB.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2009-01-04 13:16:00 $"

static char const ident[] = "$RCSfile: cdr2MIB.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2009-01-04 13:16:00 $";
...
#endif				/* defined MASTER */
/**
 * @fn void cdr2MIB_readfd_handler(int fd, void *dummy)
 ...
 */
void
cdr2MIB_readfd_handler(int fd, void *dummy)
{
