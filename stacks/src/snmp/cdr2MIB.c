/*****************************************************************************
 ...
 @(#) $RCSfile: cdr2MIB.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2009-01-02 15:04:10 $
 ...
 Last Modified $Date: 2009-01-02 15:04:10 $ by $Author: brian $
...
#ident "@(#) $RCSfile: cdr2MIB.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2009-01-02 15:04:10 $"

static char const ident[] = "$RCSfile: cdr2MIB.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2009-01-02 15:04:10 $";
 ...
 */
oid blockRecordNotification_oid[] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 0 };
oid callDetailRecordNotification_oid[] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 0 };
oid fileCreationNotification_oid[] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 0 };
oid blockRecordNotificationR2_oid[] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 0 };
oid callDetailRecordNotificationR2_oid[] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 0 };

/*
 * Oids accessible only for notify defined in this MIB.
 */
oid fileName_oid[] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 1, 1 };
oid reasonForOutput_oid[] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 1, 1 };
oid sequenceNumber_oid[] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 1, 1 };
oid callRecord_oid[] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 1, 1 };

/*
 * Other oids defined in this MIB.
 */
oid cdrParameterGroup_oid[] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 2, 2 };
oid cdrNotificationGroup_oid[] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 2, 2 };
oid cdr1NotificationGroup_oid[] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 2, 2 };
oid cdr2NotificationGroup_oid[] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 2, 2 };
oid cdr2MandatoryCallRecordFields_oid[] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 2, 2 };
oid cdrMandatoryGroups_oid[] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 2, 2 };
oid cdr1ConditionalGroups_oid[] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 2, 2 };
oid cdr2MandatoryGroups_oid[] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 2, 2 };
oid cd1RecordFormatGroup_oid[] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 2, 2 };
oid cdr2ConditionalFieldsGroup_oid[] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 2, 2 };
oid cdr2Conformances_oid[] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 2, 2 };
...
cdr2MIB_create(void)
{
	...
	DBUGMSGTL(("cdr2MIB", "creating scalars...  "));
	if (StorageNew != NULL) {
...
cdr2MIB_destroy(struct cdr2MIB_data **thedata)
{
	...
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel->fileName);
		StorageDel->fileNameLen = 0;
...
callDetailDataTable_create(void)
{
	...
	DBUGMSGTL(("callDetailDataTable", "creating row...  "));
	if (StorageNew != NULL) {
...
simpleUsageMeteringControlTable_create(void)
{
	...
	DBUGMSGTL(("simpleUsageMeteringControlTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
configurableSimpleUsageMeteringControlTable_create(void)
{
	...
	DBUGMSGTL(("configurableSimpleUsageMeteringControlTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
blockGeneratingLogTable_create(void)
{
	...
	DBUGMSGTL(("blockGeneratingLogTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
fileGeneratingLogTable_create(void)
{
	...
	DBUGMSGTL(("fileGeneratingLogTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
callDetailLogRecordTable_create(void)
{
	...
	DBUGMSGTL(("callDetailLogRecordTable", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
configurableSimpleUsageMeteringControlR2Table_create(void)
{
	...
	DBUGMSGTL(("configurableSimpleUsageMeteringControlR2Table", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
blockGeneratingLogR2Table_create(void)
{
	...
	DBUGMSGTL(("blockGeneratingLogR2Table", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
...
callDetailLogRecordR2Table_create(void)
{
	...
	DBUGMSGTL(("callDetailLogRecordR2Table", "creating row...  "));
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
