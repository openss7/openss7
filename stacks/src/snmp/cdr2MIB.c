/*****************************************************************************
 ...
 @(#) $RCSfile: cdr2MIB.c,v $ $Name:  $($Revision: 0.9.2.11 $) $Date: 2009-01-19 13:31:40 $
 ...
 Last Modified $Date: 2009-01-19 13:31:40 $ by $Author: brian $

 -----------------------------------------------------------------------------

 $Log: cdr2MIB.c,v $
 Revision 0.9.2.11  2009-01-19 13:31:40  brian
 - updating standalone agents

 Revision 0.9.2.10  2009-01-16 20:44:52  brian
...
#ident "@(#) $RCSfile: cdr2MIB.c,v $ $Name:  $($Revision: 0.9.2.11 $) $Date: 2009-01-19 13:31:40 $"

static char const ident[] = "$RCSfile: cdr2MIB.c,v $ $Name:  $($Revision: 0.9.2.11 $) $Date: 2009-01-19 13:31:40 $";
 ...
 */
oid blockRecordNotification_oid[12] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 0, 1 };
oid callDetailRecordNotification_oid[12] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 0, 2 };
oid fileCreationNotification_oid[12] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 0, 3 };
oid blockRecordNotificationR2_oid[12] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 0, 4 };
oid callDetailRecordNotificationR2_oid[12] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 0, 5 };

/*
 * Oids accessible only for notify defined in this MIB.
 */
oid fileName_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 1, 1, 1 };
oid reasonForOutput_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 1, 1, 2 };
oid sequenceNumber_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 1, 1, 3 };
oid callRecord_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 1, 1, 4 };

/*
 * Other oids defined in this MIB.
 */
oid cdrParameterGroup_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 2, 2, 1 };
oid cdrNotificationGroup_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 2, 2, 2 };
oid cdr1NotificationGroup_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 2, 2, 3 };
oid cdr2NotificationGroup_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 2, 2, 4 };
oid cdr2MandatoryCallRecordFields_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 2, 2, 5 };
oid cdrMandatoryGroups_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 2, 2, 6 };
oid cdr1ConditionalGroups_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 2, 2, 7 };
oid cdr2MandatoryGroups_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 2, 2, 8 };
oid cd1RecordFormatGroup_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 2, 2, 9 };
oid cdr2ConditionalFieldsGroup_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 2, 2, 10 };
oid cdr2Conformances_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 17, 825, 2, 2, 2, 11 };
...
init_cdr2MIB(void)
{
	...
	DEBUGMSGTL(("cdr2MIB", "init_cdr2MIB: initializing...  "));
	...
	if (my_readfd >= 0) {
		register_readfd(my_readfd, cdr2MIB_fd_handler, (void *) 0);
		register_exceptfd(my_readfd, cdr2MIB_fd_handler, (void *) 1);
	}
	cdr2MIBold_signal_handler = external_signal_handler[SIGCHLD];
	external_signal_handler[SIGCHLD] = &cdr2MIB_loop_handler;
...
deinit_cdr2MIB(void)
{
	DEBUGMSGTL(("cdr2MIB", "deinit_cdr2MIB: deinitializating...  "));
	external_signal_handler[SIGCHLD] = cdr2MIBold_signal_handler;
	if (my_readfd >= 0) {
...
{
	DEBUGMSGTL(("cdr2MIB", "term_cdr2MIB: terminating...  "));
	deinit_cdr2MIB();
	DEBUGMSGTL(("cdr2MIB", "done.\n"));
	return 0;
}
...
cdr2MIB_create(void)
{
	...
	DEBUGMSGTL(("cdr2MIB", "cdr2MIB_create: creating scalars...  "));
	if (StorageNew != NULL) {
...
cdr2MIB_destroy(struct cdr2MIB_data **thedata)
{
	...
	DEBUGMSGTL(("cdr2MIB", "cdr2MIB_destroy: deleting scalars...  "));
...
{
	DEBUGMSGTL(("cdr2MIB", "cdr2MIB_add: adding data...  "));
	if (thedata)
...
parse_cdr2MIB(const char *token, char *line)
{
	...
	DEBUGMSGTL(("cdr2MIB", "parse_cdr2MIB: parsing config...  "));
	if (StorageTmp == NULL) {
...
store_cdr2MIB(int majorID, int minorID, void *serverarg, void *clientarg)
{
	...
	DEBUGMSGTL(("cdr2MIB", "store_cdr2MIB: storing data...  "));
	refresh_cdr2MIB(1);
...
refresh_cdr2MIB(int force)
{
	...
	if (!force && cdr2MIB_refresh == 0)
		return;
	DEBUGMSGTL(("cdr2MIB", "refresh_cdr2MIB: refreshing...  "));
...
var_cdr2MIB(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	DEBUGMSGTL(("cdr2MIB", "var_cdr2MIB: lookup up varbind...  "));
	if (header_generic(vp, name, length, exact, var_len, write_method) == MATCH_FAILED)
		return NULL;
	/* Refresh the MIB values if required. */
	refresh_cdr2MIB(0);
	if ((StorageTmp = cdr2MIBStorage) == NULL) {
		DEBUGMSGTL(("cdr2MIB", "no datastructure.\n"));
		return NULL;
	}
	*write_method = NULL;
	*var_len = 0;
	...
	if (rval)
		DEBUGMSGTL(("cdr2MIB", "found.\n"));
	else
		DEBUGMSGTL(("cdr2MIB", "not found.\n"));
	return (rval);
}
...
callDetailDataTable_destroy(struct callDetailDataTable_data **thedata)
{
	...
	DEBUGMSGTL(("cdr2MIB", "callDetailDataTable_destroy: deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
...
callDetailDataTable_add(struct callDetailDataTable_data *thedata)
{
	...
	DEBUGMSGTL(("cdr2MIB", "callDetailDataTable_add: adding data...  "));
	if (thedata) {
	...
	DEBUGMSGTL(("cdr2MIB", "registered an entry.\n"));
	return SNMPERR_SUCCESS;
}
...
callDetailDataTable_del(struct callDetailDataTable_data *thedata)
{
	...
	DEBUGMSGTL(("cdr2MIB", "callDetailDataTable_data: deleting data...  "));
	if ((StorageDel = thedata) != NULL) {
...
parse_callDetailDataTable(const char *token, char *line)
{
	...
	DEBUGMSGTL(("cdr2MIB", "parse_callDetailDataTable: parsing config...  "));
	if (StorageTmp == NULL) {
		config_perror("malloc failure");
		return;
	}
	/* XXX: remove individual columns if not persistent */
	SNMP_FREE(StorageTmp->callDetailDataId);
...
store_callDetailDataTable(int majorID, int minorID, void *serverarg, void *clientarg)
{
	...
	DEBUGMSGTL(("cdr2MIB", "store_callDetailDataTable: storing data...  "));
...
simpleUsageMeteringControlTable_destroy(struct simpleUsageMeteringControlTable_data **thedata)
{
	...
	DEBUGMSGTL(("cdr2MIB", "simpleUsageMeteringControlTable_destroy: deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
...
simpleUsageMeteringControlTable_add(struct simpleUsageMeteringControlTable_data *thedata)
{
	...
	DEBUGMSGTL(("cdr2MIB", "simpleUsageMeteringControlTable_add: adding data...  "));
	if (thedata) {
		/* add the index variables to the varbind list, which is used by header_complex to index the data */
		/* controlObjectId */
...
simpleUsageMeteringControlTable_del(struct simpleUsageMeteringControlTable_data *thedata)
{
	...
	DEBUGMSGTL(("cdr2MIB", "simpleUsageMeteringControlTable_data: deleting data...  "));
	if ((StorageDel = thedata) != NULL) {
		struct header_complex_index *hciptr;
...
parse_simpleUsageMeteringControlTable(const char *token, char *line)
{
	...
	DEBUGMSGTL(("cdr2MIB", "parse_simpleUsageMeteringControlTable: parsing config...  "));
	if (StorageTmp == NULL) {
		config_perror("malloc failure");
		return;
	}
	/* XXX: remove individual columns if not persistent */
	SNMP_FREE(StorageTmp->controlObjectId);
...
store_simpleUsageMeteringControlTable(int majorID, int minorID, void *serverarg, void *clientarg)
{
	...
	DEBUGMSGTL(("cdr2MIB", "store_simpleUsageMeteringControlTable: storing data...  "));
...
configurableSimpleUsageMeteringControlTable_destroy(struct configurableSimpleUsageMeteringControlTable_data **thedata)
{
	...
	DEBUGMSGTL(("cdr2MIB", "configurableSimpleUsageMeteringControlTable_destroy: deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel->controlObjectId);
		StorageDel->controlObjectIdLen = 0;
...
configurableSimpleUsageMeteringControlTable_add(struct configurableSimpleUsageMeteringControlTable_data *thedata)
{
	...
	DEBUGMSGTL(("cdr2MIB", "configurableSimpleUsageMeteringControlTable_add: adding data...  "));
	if (thedata) {
		/* add the index variables to the varbind list, which is used by header_complex to index the data */
		/* controlObjectId */
		snmp_varlist_add_variable(&vars, NULL, 0, ASN_OCTET_STR, (u_char *) thedata->controlObjectId, thedata->controlObjectIdLen);
...
configurableSimpleUsageMeteringControlTable_del(struct configurableSimpleUsageMeteringControlTable_data *thedata)
{
	...
	DEBUGMSGTL(("cdr2MIB", "configurableSimpleUsageMeteringControlTable_data: deleting data...  "));
	if ((StorageDel = thedata) != NULL) {
		struct header_complex_index *hciptr;
...
parse_configurableSimpleUsageMeteringControlTable(const char *token, char *line)
{
	...
	DEBUGMSGTL(("cdr2MIB", "parse_configurableSimpleUsageMeteringControlTable: parsing config...  "));
	if (StorageTmp == NULL) {
		config_perror("malloc failure");
		return;
	}
...
store_configurableSimpleUsageMeteringControlTable(int majorID, int minorID, void *serverarg, void *clientarg)
{
	...
	DEBUGMSGTL(("cdr2MIB", "store_configurableSimpleUsageMeteringControlTable: storing data...  "));
...
blockGeneratingLogTable_destroy(struct blockGeneratingLogTable_data **thedata)
{
	...
	DEBUGMSGTL(("cdr2MIB", "blockGeneratingLogTable_destroy: deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
...
blockGeneratingLogTable_add(struct blockGeneratingLogTable_data *thedata)
{
	...
	DEBUGMSGTL(("cdr2MIB", "blockGeneratingLogTable_add: adding data...  "));
	if (thedata) {
		/* add the index variables to the varbind list, which is used by header_complex to index the data */
		/* logId */
...
blockGeneratingLogTable_del(struct blockGeneratingLogTable_data *thedata)
{
	...
	DEBUGMSGTL(("cdr2MIB", "blockGeneratingLogTable_data: deleting data...  "));
	if ((StorageDel = thedata) != NULL) {
		struct header_complex_index *hciptr;
...
parse_blockGeneratingLogTable(const char *token, char *line)
{
	...
	DEBUGMSGTL(("cdr2MIB", "parse_blockGeneratingLogTable: parsing config...  "));
	if (StorageTmp == NULL) {
		config_perror("malloc failure");
		return;
	}
...
store_blockGeneratingLogTable(int majorID, int minorID, void *serverarg, void *clientarg)
{
	...
	DEBUGMSGTL(("cdr2MIB", "store_blockGeneratingLogTable: storing data...  "));
...
fileGeneratingLogTable_destroy(struct fileGeneratingLogTable_data **thedata)
{
	...
	DEBUGMSGTL(("cdr2MIB", "fileGeneratingLogTable_destroy: deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel->logId);
		StorageDel->logIdLen = 0;
...
fileGeneratingLogTable_add(struct fileGeneratingLogTable_data *thedata)
{
	...
	DEBUGMSGTL(("cdr2MIB", "fileGeneratingLogTable_add: adding data...  "));
	if (thedata) {
		/* add the index variables to the varbind list, which is used by header_complex to index the data */
		/* logId */
		snmp_varlist_add_variable(&vars, NULL, 0, ASN_OCTET_STR, (u_char *) thedata->logId, thedata->logIdLen);
...
fileGeneratingLogTable_del(struct fileGeneratingLogTable_data *thedata)
{
	...
	DEBUGMSGTL(("cdr2MIB", "fileGeneratingLogTable_data: deleting data...  "));
	if ((StorageDel = thedata) != NULL) {
		struct header_complex_index *hciptr;
...
parse_fileGeneratingLogTable(const char *token, char *line)
{
	...
	DEBUGMSGTL(("cdr2MIB", "parse_fileGeneratingLogTable: parsing config...  "));
	if (StorageTmp == NULL) {
		config_perror("malloc failure");
		return;
	}
...
store_fileGeneratingLogTable(int majorID, int minorID, void *serverarg, void *clientarg)
{
	...
	DEBUGMSGTL(("cdr2MIB", "store_fileGeneratingLogTable: storing data...  "));
...
callDetailLogRecordTable_destroy(struct callDetailLogRecordTable_data **thedata)
{
	...
	DEBUGMSGTL(("cdr2MIB", "callDetailLogRecordTable_destroy: deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel->logId);
		StorageDel->logIdLen = 0;
...
callDetailLogRecordTable_add(struct callDetailLogRecordTable_data *thedata)
{
	...
	DEBUGMSGTL(("cdr2MIB", "callDetailLogRecordTable_add: adding data...  "));
	if (thedata) {
		/* add the index variables to the varbind list, which is used by header_complex to index the data */
		/* logId */
		snmp_varlist_add_variable(&vars, NULL, 0, ASN_OCTET_STR, (u_char *) thedata->logId, thedata->logIdLen);
...
callDetailLogRecordTable_del(struct callDetailLogRecordTable_data *thedata)
{
	...
	DEBUGMSGTL(("cdr2MIB", "callDetailLogRecordTable_data: deleting data...  "));
	if ((StorageDel = thedata) != NULL) {
		struct header_complex_index *hciptr;
...
parse_callDetailLogRecordTable(const char *token, char *line)
{
	...
	DEBUGMSGTL(("cdr2MIB", "parse_callDetailLogRecordTable: parsing config...  "));
	if (StorageTmp == NULL) {
		config_perror("malloc failure");
		return;
	}
	...
	SNMP_FREE(StorageTmp->networkProviderId);
	...
	SNMP_FREE(StorageTmp->seizureTime);
	...
	SNMP_FREE(StorageTmp->answerTime);
	...
	SNMP_FREE(StorageTmp->partialTime);
	...
	SNMP_FREE(StorageTmp->eventTime);
	...
	SNMP_FREE(StorageTmp->callingPartyNumber);
	...
	SNMP_FREE(StorageTmp->calledPartyNumber);
	...
	SNMP_FREE(StorageTmp->redirectingNumber);
	...
	SNMP_FREE(StorageTmp->redirectionNumber);
	...
	SNMP_FREE(StorageTmp->originalCalledNumber);
	...
	SNMP_FREE(StorageTmp->callingPartyNumberNotScreened);
	...
	SNMP_FREE(StorageTmp->operatorSpecific1Number);
	...
	SNMP_FREE(StorageTmp->operatorSpecific2Number);
	...
	SNMP_FREE(StorageTmp->operatorSpecific3Number);
	...
	SNMP_FREE(StorageTmp->bearerService);
	...
	SNMP_FREE(StorageTmp->callIdentificationNumber);
	...
	SNMP_FREE(StorageTmp->supplementaryServices);
	...
	SNMP_FREE(StorageTmp->personalUserId);
	...
	SNMP_FREE(StorageTmp->chargedDirectoryNumber);
	...
	SNMP_FREE(StorageTmp->accountCodeInput);
	...
	SNMP_FREE(StorageTmp->iNServiceCode);
	...
	SNMP_FREE(StorageTmp->queueTimeStamp);
	...
	SNMP_FREE(StorageTmp->serviceSpecificINInformation);
	...
	SNMP_FREE(StorageTmp->exchangeInfo);
	...
	SNMP_FREE(StorageTmp->relatedCallNumber);
	...
	SNMP_FREE(StorageTmp->cDRPurpose);
	...
	SNMP_FREE(StorageTmp->physicalLineCode);
	...
	SNMP_FREE(StorageTmp->receivedDigits);
	...
	SNMP_FREE(StorageTmp->operatorSpecific1AdditionalNumber);
	...
	SNMP_FREE(StorageTmp->operatorSpecific2AdditionalNumber);
	...
	SNMP_FREE(StorageTmp->operatorSpecific3AdditionalNumber);
	...
	SNMP_FREE(StorageTmp->callingPartyCategory);
	...
	SNMP_FREE(StorageTmp->chargeInformation);
	...
	SNMP_FREE(StorageTmp->accessDelivery);
	...
	SNMP_FREE(StorageTmp->trunkGroupOutgoing);
	...
	SNMP_FREE(StorageTmp->trunkGroupIncoming);
	...
	SNMP_FREE(StorageTmp->fallbackBearerService);
	...
	SNMP_FREE(StorageTmp->teleservice);
	...
	SNMP_FREE(StorageTmp->standardExtensions);
	...
	SNMP_FREE(StorageTmp->recordExtensions);
	...
	SNMP_FREE(StorageTmp->bPartyCategory);
	...
	SNMP_FREE(StorageTmp->carrierId);
...
store_callDetailLogRecordTable(int majorID, int minorID, void *serverarg, void *clientarg)
{
	...
	DEBUGMSGTL(("cdr2MIB", "store_callDetailLogRecordTable: storing data...  "));
...
configurableSimpleUsageMeteringControlR2Table_destroy(struct configurableSimpleUsageMeteringControlR2Table_data **thedata)
{
	...
	DEBUGMSGTL(("cdr2MIB", "configurableSimpleUsageMeteringControlR2Table_destroy: deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel->controlObjectId);
		StorageDel->controlObjectIdLen = 0;
...
configurableSimpleUsageMeteringControlR2Table_add(struct configurableSimpleUsageMeteringControlR2Table_data *thedata)
{
	...
	DEBUGMSGTL(("cdr2MIB", "configurableSimpleUsageMeteringControlR2Table_add: adding data...  "));
	if (thedata) {
		/* add the index variables to the varbind list, which is used by header_complex to index the data */
		/* controlObjectId */
		snmp_varlist_add_variable(&vars, NULL, 0, ASN_OCTET_STR, (u_char *) thedata->controlObjectId, thedata->controlObjectIdLen);
...
configurableSimpleUsageMeteringControlR2Table_del(struct configurableSimpleUsageMeteringControlR2Table_data *thedata)
{
	...
	DEBUGMSGTL(("cdr2MIB", "configurableSimpleUsageMeteringControlR2Table_data: deleting data...  "));
	if ((StorageDel = thedata) != NULL) {
		struct header_complex_index *hciptr;
...
parse_configurableSimpleUsageMeteringControlR2Table(const char *token, char *line)
{
	...
	DEBUGMSGTL(("cdr2MIB", "parse_configurableSimpleUsageMeteringControlR2Table: parsing config...  "));
	if (StorageTmp == NULL) {
		config_perror("malloc failure");
		return;
	}
...
store_configurableSimpleUsageMeteringControlR2Table(int majorID, int minorID, void *serverarg, void *clientarg)
{
	...
	DEBUGMSGTL(("cdr2MIB", "store_configurableSimpleUsageMeteringControlR2Table: storing data...  "));
...
blockGeneratingLogR2Table_destroy(struct blockGeneratingLogR2Table_data **thedata)
{
	...
	DEBUGMSGTL(("cdr2MIB", "blockGeneratingLogR2Table_destroy: deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel->logId);
		StorageDel->logIdLen = 0;
		SNMP_FREE(StorageDel);
...
blockGeneratingLogR2Table_add(struct blockGeneratingLogR2Table_data *thedata)
{
	...
	DEBUGMSGTL(("cdr2MIB", "blockGeneratingLogR2Table_add: adding data...  "));
	if (thedata) {
		/* add the index variables to the varbind list, which is used by header_complex to index the data */
		/* logId */
		snmp_varlist_add_variable(&vars, NULL, 0, ASN_OCTET_STR, (u_char *) thedata->logId, thedata->logIdLen);
...
blockGeneratingLogR2Table_del(struct blockGeneratingLogR2Table_data *thedata)
{
	...
	DEBUGMSGTL(("cdr2MIB", "blockGeneratingLogR2Table_data: deleting data...  "));
	if ((StorageDel = thedata) != NULL) {
		struct header_complex_index *hciptr;
...
parse_blockGeneratingLogR2Table(const char *token, char *line)
{
	...
	DEBUGMSGTL(("cdr2MIB", "parse_blockGeneratingLogR2Table: parsing config...  "));
	if (StorageTmp == NULL) {
		config_perror("malloc failure");
		return;
	}
...
store_blockGeneratingLogR2Table(int majorID, int minorID, void *serverarg, void *clientarg)
{
	...
	DEBUGMSGTL(("cdr2MIB", "store_blockGeneratingLogR2Table: storing data...  "));
...
callDetailLogRecordR2Table_destroy(struct callDetailLogRecordR2Table_data **thedata)
{
	...
	DEBUGMSGTL(("cdr2MIB", "callDetailLogRecordR2Table_destroy: deleting row...  "));
	if ((StorageDel = *thedata) != NULL) {
		SNMP_FREE(StorageDel->logId);
		StorageDel->logIdLen = 0;
		SNMP_FREE(StorageDel->logRecordId);
...
callDetailLogRecordR2Table_add(struct callDetailLogRecordR2Table_data *thedata)
{
	...
	DEBUGMSGTL(("cdr2MIB", "callDetailLogRecordR2Table_add: adding data...  "));
	if (thedata) {
		/* add the index variables to the varbind list, which is used by header_complex to index the data */
		/* logId */
		snmp_varlist_add_variable(&vars, NULL, 0, ASN_OCTET_STR, (u_char *) thedata->logId, thedata->logIdLen);
...
callDetailLogRecordR2Table_del(struct callDetailLogRecordR2Table_data *thedata)
{
	...
	DEBUGMSGTL(("cdr2MIB", "callDetailLogRecordR2Table_data: deleting data...  "));
	if ((StorageDel = thedata) != NULL) {
		struct header_complex_index *hciptr;
...
parse_callDetailLogRecordR2Table(const char *token, char *line)
{
	...
	DEBUGMSGTL(("cdr2MIB", "parse_callDetailLogRecordR2Table: parsing config...  "));
	if (StorageTmp == NULL) {
		config_perror("malloc failure");
		return;
	}
	...
	SNMP_FREE(StorageTmp->lastUpdate);
	...
	SNMP_FREE(StorageTmp->eventOrder);
	...
	SNMP_FREE(StorageTmp->clngPtyNbr);
	...
	SNMP_FREE(StorageTmp->chargeNbr);
	...
	SNMP_FREE(StorageTmp->clldPtyNbr);
	...
	SNMP_FREE(StorageTmp->origLnInfo);
	...
	SNMP_FREE(StorageTmp->ingCallStart);
	...
	SNMP_FREE(StorageTmp->ingCreatConnCplt);
	...
	SNMP_FREE(StorageTmp->ingAddrCplt);
	...
	SNMP_FREE(StorageTmp->ingCallAns);
	...
	SNMP_FREE(StorageTmp->ingCallRls);
	...
	SNMP_FREE(StorageTmp->egrCallStart);
	...
	SNMP_FREE(StorageTmp->egrCreatConnCplt);
	...
	SNMP_FREE(StorageTmp->egrAddrCplt);
	...
	SNMP_FREE(StorageTmp->egrCallAns);
	...
	SNMP_FREE(StorageTmp->egrCallRls);
	...
	SNMP_FREE(StorageTmp->chkptFirst);
	...
	SNMP_FREE(StorageTmp->chkptLast);
	...
	SNMP_FREE(StorageTmp->ingGateName);
	...
	SNMP_FREE(StorageTmp->egrGateName);
	...
	SNMP_FREE(StorageTmp->ingTgName);
	...
	SNMP_FREE(StorageTmp->egrTgName);
	...
	SNMP_FREE(StorageTmp->origGateIp);
	...
	SNMP_FREE(StorageTmp->termGateIp);
	...
	SNMP_FREE(StorageTmp->h323ConfId);
	...
	SNMP_FREE(StorageTmp->dialedNbr);
	...
	SNMP_FREE(StorageTmp->calledNbr);
	...
	SNMP_FREE(StorageTmp->transNetSelCarr);
	...
	SNMP_FREE(StorageTmp->ingRlsCauseIntrnl);
	...
	SNMP_FREE(StorageTmp->egrRlsCauseIntrnl);
	...
	SNMP_FREE(StorageTmp->egrClldNbr);
	...
	SNMP_FREE(StorageTmp->egrCnndNbr);
	...
	SNMP_FREE(StorageTmp->ingCallidExtrnl);
	...
	SNMP_FREE(StorageTmp->egrCallidExtrnl);
	...
	SNMP_FREE(StorageTmp->ingChargeInfo);
	...
	SNMP_FREE(StorageTmp->egrChargeInfo);
	...
	SNMP_FREE(StorageTmp->ingPrtlInd);
	...
	SNMP_FREE(StorageTmp->ingLastDvrtLnDigs);
	...
	SNMP_FREE(StorageTmp->j7IngAddlPtyCat);
	...
	SNMP_FREE(StorageTmp->j7IngChgAreaInfo);
	...
	SNMP_FREE(StorageTmp->j7IngFwdCallInd);
	...
	SNMP_FREE(StorageTmp->j7EgrAddlPtyCat);
	...
	SNMP_FREE(StorageTmp->j7EgrChgAreaInfo);
	...
	SNMP_FREE(StorageTmp->j7EgrBkwCallInd);
	...
	SNMP_FREE(StorageTmp->j7CarrInfoXfer);
	...
	SNMP_FREE(StorageTmp->ingSs7GnrcParm);
	...
	SNMP_FREE(StorageTmp->egrSs7GnrcParm);
	...
	SNMP_FREE(StorageTmp->ingCasCrctSzr);
	...
	SNMP_FREE(StorageTmp->egrCasCrctSzr);
	...
	SNMP_FREE(StorageTmp->ingCtryAddrType);
	...
	SNMP_FREE(StorageTmp->egrCtryAddrType);
	...
	SNMP_FREE(StorageTmp->ingAnsLctim);
	...
	SNMP_FREE(StorageTmp->egrAnsLctim);
	...
	SNMP_FREE(StorageTmp->routeList);
...
store_callDetailLogRecordR2Table(int majorID, int minorID, void *serverarg, void *clientarg)
{
	...
	DEBUGMSGTL(("cdr2MIB", "store_callDetailLogRecordR2Table: storing data...  "));
...
var_callDetailDataTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	while ((StorageTmp = header_complex(callDetailDataTableStorage, vp, name, length, exact, var_len, write_method)))
		if ((StorageTmp = refresh_callDetailDataTable_row(StorageTmp, 0)) || exact)
			break;
	*write_method = NULL;
	*var_len = 0;
	rval = NULL;
...
var_simpleUsageMeteringControlTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	while ((StorageTmp = header_complex(simpleUsageMeteringControlTableStorage, vp, name, length, exact, var_len, write_method)))
		if ((StorageTmp = refresh_simpleUsageMeteringControlTable_row(StorageTmp, 0)) || exact)
			break;
	*write_method = NULL;
	*var_len = 0;
	rval = NULL;
...
var_configurableSimpleUsageMeteringControlTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	while ((StorageTmp = header_complex(configurableSimpleUsageMeteringControlTableStorage, vp, name, length, exact, var_len, write_method)))
		if ((StorageTmp = refresh_configurableSimpleUsageMeteringControlTable_row(StorageTmp, 0)) || exact)
			break;
	*write_method = NULL;
	*var_len = 0;
	rval = NULL;
...
var_blockGeneratingLogTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	while ((StorageTmp = header_complex(blockGeneratingLogTableStorage, vp, name, length, exact, var_len, write_method)))
		if ((StorageTmp = refresh_blockGeneratingLogTable_row(StorageTmp, 0)) || exact)
			break;
	*write_method = NULL;
	*var_len = 0;
	rval = NULL;
...
var_fileGeneratingLogTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	while ((StorageTmp = header_complex(fileGeneratingLogTableStorage, vp, name, length, exact, var_len, write_method)))
		if ((StorageTmp = refresh_fileGeneratingLogTable_row(StorageTmp, 0)) || exact)
			break;
	*write_method = NULL;
	*var_len = 0;
	rval = NULL;
...
var_callDetailLogRecordTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	while ((StorageTmp = header_complex(callDetailLogRecordTableStorage, vp, name, length, exact, var_len, write_method)))
		if ((StorageTmp = refresh_callDetailLogRecordTable_row(StorageTmp, 0)) || exact)
			break;
	*write_method = NULL;
	*var_len = 0;
	rval = NULL;
...
var_configurableSimpleUsageMeteringControlR2Table(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	while ((StorageTmp = header_complex(configurableSimpleUsageMeteringControlR2TableStorage, vp, name, length, exact, var_len, write_method)))
		if ((StorageTmp = refresh_configurableSimpleUsageMeteringControlR2Table_row(StorageTmp, 0)) || exact)
			break;
	*write_method = NULL;
	*var_len = 0;
	rval = NULL;
...
var_blockGeneratingLogR2Table(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	while ((StorageTmp = header_complex(blockGeneratingLogR2TableStorage, vp, name, length, exact, var_len, write_method)))
		if ((StorageTmp = refresh_blockGeneratingLogR2Table_row(StorageTmp, 0)) || exact)
			break;
	*write_method = NULL;
	*var_len = 0;
	rval = NULL;
...
var_callDetailLogRecordR2Table(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	while ((StorageTmp = header_complex(callDetailLogRecordR2TableStorage, vp, name, length, exact, var_len, write_method)))
		if ((StorageTmp = refresh_callDetailLogRecordR2Table_row(StorageTmp, 0)) || exact)
			break;
	*write_method = NULL;
	*var_len = 0;
	rval = NULL;
...
write_creationTriggerList(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	if ((StorageTmp = header_complex(simpleUsageMeteringControlTableStorage, NULL, &name[15], &newlen, 1, NULL, NULL)) == NULL)
...
write_samplingRate(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	if ((StorageTmp = header_complex(configurableSimpleUsageMeteringControlTableStorage, NULL, &name[15], &newlen, 1, NULL, NULL)) == NULL)
		return SNMP_ERR_NOSUCHNAME;	/* remove if you support creation here */
...
write_blockGeneratingLogMaxBlockSize(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	if ((StorageTmp = header_complex(blockGeneratingLogTableStorage, NULL, &name[15], &newlen, 1, NULL, NULL)) == NULL)
		return SNMP_ERR_NOSUCHNAME;	/* remove if you support creation here */
...
write_timesOfDay(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	if ((StorageTmp = header_complex(fileGeneratingLogTableStorage, NULL, &name[15], &newlen, 1, NULL, NULL)) == NULL)
		return SNMP_ERR_NOSUCHNAME;	/* remove if you support creation here */
...
write_configurationR2Mask(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	if ((StorageTmp = header_complex(configurableSimpleUsageMeteringControlR2TableStorage, NULL, &name[15], &newlen, 1, NULL, NULL)) == NULL)
		return SNMP_ERR_NOSUCHNAME;	/* remove if you support creation here */
...
write_blockGeneratingLogVersion(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	if ((StorageTmp = header_complex(blockGeneratingLogR2TableStorage, NULL, &name[15], &newlen, 1, NULL, NULL)) == NULL)
		return SNMP_ERR_NOSUCHNAME;	/* remove if you support creation here */
	if (StorageTmp == NULL)
		return SNMP_ERR_NOSUCHNAME;	/* remove if you support creation here */
	switch (action) {
...
write_simpleUsageMeteringControlEntryStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	DEBUGMSGTL(("cdr2MIB", "write_simpleUsageMeteringControlEntryStatus entering action=%d...  \n", action));
	...
	case RESERVE2:
		...
		case RS_CREATEANDWAIT:
			...
			if (vp->val_len > SPRINT_MAX_LEN || ((1 > vp->val_len || vp->val_len > 32))) {
				snmp_log(MY_FACILITY(LOG_NOTICE), "index controlObjectId: bad length\n");
				snmp_free_varbind(vars);
				return SNMP_ERR_INCONSISTENTNAME;
			}
			vp = vp->next_variable;
...
write_configurationRowStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	DEBUGMSGTL(("cdr2MIB", "write_configurationRowStatus entering action=%d...  \n", action));
...
write_blockGeneratingLogRowStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	DEBUGMSGTL(("cdr2MIB", "write_blockGeneratingLogRowStatus entering action=%d...  \n", action));
...
write_fileGeneratingLogEntryStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	DEBUGMSGTL(("cdr2MIB", "write_fileGeneratingLogEntryStatus entering action=%d...  \n", action));
...
write_configurationR2Status(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	DEBUGMSGTL(("cdr2MIB", "write_configurationR2Status entering action=%d...  \n", action));
...
send_blockRecordNotification_v2trap(struct variable_list *vars)
{
	...
	DEBUGMSGTL(("cdr2MIB", "send_blockRecordNotification_v2trap: sending trap...  "));
...
send_callDetailRecordNotification_v2trap(struct variable_list *vars)
{
	...
	DEBUGMSGTL(("cdr2MIB", "send_callDetailRecordNotification_v2trap: sending trap...  "));
	trap.next_variable = vars;
	trap.name = snmpTrapOID_oid;
	trap.name_length = sizeof(snmpTrapOID_oid) / sizeof(oid);
	trap.type = ASN_OBJECT_ID;
...
send_fileCreationNotification_v2trap(struct variable_list *vars)
{
	...
	DEBUGMSGTL(("cdr2MIB", "send_fileCreationNotification_v2trap: sending trap...  "));
	trap.next_variable = vars;
	trap.name = snmpTrapOID_oid;
	trap.name_length = sizeof(snmpTrapOID_oid) / sizeof(oid);
	trap.type = ASN_OBJECT_ID;
...
send_blockRecordNotificationR2_v2trap(struct variable_list *vars)
{
	...
	DEBUGMSGTL(("cdr2MIB", "send_blockRecordNotificationR2_v2trap: sending trap...  "));
	trap.next_variable = vars;
	trap.name = snmpTrapOID_oid;
	trap.name_length = sizeof(snmpTrapOID_oid) / sizeof(oid);
	trap.type = ASN_OBJECT_ID;
...
send_callDetailRecordNotificationR2_v2trap(struct variable_list *vars)
{
	...
	DEBUGMSGTL(("cdr2MIB", "send_callDetailRecordNotificationR2_v2trap: sending trap...  "));
	trap.next_variable = vars;
	trap.name = snmpTrapOID_oid;
	trap.name_length = sizeof(snmpTrapOID_oid) / sizeof(oid);
	trap.type = ASN_OBJECT_ID;
 ...
 */
void
cdr2MIB_loop_handler(int sig)
{
	DEBUGMSGTL(("cdr2MIB", "cdr2MIB_loop_handler: executing loop handler...  "));
	...
	if (cdr2MIBold_signal_handler != NULL)
		(*cdr2MIBold_signal_handler) (sig);
	DEBUGMSGTL(("cdr2MIB", "done.\n"));
}
...
{
	DEBUGMSGTL(("cdr2MIB", "cdr2MIB_fd_handler: executing fd handler...  "));
