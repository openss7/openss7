/*****************************************************************************
 ...
 @(#) $RCSfile: cdr2MIB.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2009-01-02 15:46:39 $
 ...
 Last Modified $Date: 2009-01-02 15:46:39 $ by $Author: brian $
...
#ident "@(#) $RCSfile: cdr2MIB.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2009-01-02 15:46:39 $"

static char const ident[] = "$RCSfile: cdr2MIB.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2009-01-02 15:46:39 $";
...
blockGeneratingLogR2Table_create(void)
{
	...
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
		StorageNew->blockGeneratingLogVersion = version1;
...
write_configurationRowStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* configurableSimpleUsageMeteringControlTable_destroy() can handle NULL
			   pointers. */
			break;
		}
		break;
...
write_configurationR2Status(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* configurableSimpleUsageMeteringControlR2Table_destroy() can handle NULL
			   pointers. */
			break;
		}
		break;
