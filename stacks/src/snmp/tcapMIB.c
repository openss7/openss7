/*****************************************************************************
 ...
 @(#) $RCSfile: tcapMIB.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2008-12-31 16:04:47 $
...
#ident "@(#) $RCSfile: tcapMIB.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2008-12-31 16:04:47 $"

static char const ident[] = "$RCSfile: tcapMIB.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2008-12-31 16:04:47 $";
...
/*
 * init_tcapMIB(): Initialization routine.
...
/*
 * deinit_tcapMIB(): Deinitialization routine.
...
/*
 * parse_tcapMIB(): parses .conf file entries needed to configure the mib.
 */
void
...
refresh_tcapMIB(void)
{
	if (tcapMIBStorage == NULL) {
		...
		if ((StorageNew = SNMP_MALLOC_STRUCT(tcapMIB_data)) == NULL)
			return;
...
/*
 * var_tcapMIB(): locate variables in tcapMIB
 *
