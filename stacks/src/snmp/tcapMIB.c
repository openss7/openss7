...
static const char sa_program[] = "tcapmib";
...
static char sa_logfile[256] = "/var/log/tcapmib.log";
static char sa_pidfile[256] = "/var/run/tcapmib.pid";
static char sa_sysctlf[256] = "/etc/tcapmib.conf";
...
static volatile int tcapMIB_refresh = 1;

/* 
 * tcapMIB_variables_oid:
...
/* 
 * variable2 tcapMIB_variables:
 *   this variable defines function callbacks and type return information 
 *   for the tcapMIB mib section 
 */
...
static struct tcapMIB_data *tcapMIBStorage = NULL;
...
/*
 * tcapMIB_add(): adds a structure node for scalars
 */
int
...
{
	size_t tmpint;
	struct tcapMIB_data *StorageTmp = SNMP_MALLOC_STRUCT(tcapMIB_data);
...
store_tcapMIB(int majorID, int minorID, void *serverarg, void *clientarg)
{
	...
	/* XXX: if (StorageTmp->tcapMIBStorageType == ST_NONVOLATILE) { */
...
/**
 * refresh_tcapMIB: refresh tcapMIB scalars
 *
...
refresh_tcapMIB(void)
{
	if (tcapMIBStorage == NULL) {
		if ((tcapMIBStorage = SNMP_MALLOC_STRUCT(tcapMIB_data)) == NULL)
			return;
