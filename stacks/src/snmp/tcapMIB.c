/*****************************************************************************
 ...
 @(#) $RCSfile: tcapMIB.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2009-01-02 15:04:16 $
...
#ident "@(#) $RCSfile: tcapMIB.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2009-01-02 15:04:16 $"

static char const ident[] = "$RCSfile: tcapMIB.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2009-01-02 15:04:16 $";
...
tcapMIB_create(void)
{
	...
	DBUGMSGTL(("tcapMIB", "creating scalars...  "));
	if (StorageNew != NULL) {
