/*****************************************************************************
 ...
 @(#) $RCSfile: ss7MIB.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2009-01-02 15:04:16 $
...
#ident "@(#) $RCSfile: ss7MIB.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2009-01-02 15:04:16 $"

static char const ident[] = "$RCSfile: ss7MIB.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2009-01-02 15:04:16 $";
...
write_ss7NetworkProtocolVersion(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE1:
		...
		if (1 > var_val_len || var_val_len > sizeof(uint32_t)) {
