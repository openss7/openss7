/*****************************************************************************
 ...
 @(#) $RCSfile: ss7MIB.c,v $ $Name:  $($Revision: 0.9.2.12 $) $Date: 2009-01-19 13:31:51 $
...
#ident "@(#) $RCSfile: ss7MIB.c,v $ $Name:  $($Revision: 0.9.2.12 $) $Date: 2009-01-19 13:31:51 $"

static char const ident[] = "$RCSfile: ss7MIB.c,v $ $Name:  $($Revision: 0.9.2.12 $) $Date: 2009-01-19 13:31:51 $";
...
write_ss7NetworkProtocolVariant(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	if ((StorageTmp = header_complex(ss7NetworkTableStorage, NULL, &name[15], &newlen, 1, NULL, NULL)) == NULL)
...
write_ss7NetworkRowStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case ACTION:
		...
		case RS_ACTIVE:
			...
			if (old_value != RS_ACTIVE) {
				...
				if (!ss7NetworkTable_consistent(StorageTmp)) {
	...
	case COMMIT:
		...
		case RS_CREATEANDGO:
			...
			if (ss7NetworkTable_consistent(StorageNew)) {
