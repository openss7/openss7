/*****************************************************************************
 ...
 @(#) $RCSfile: ss7MIB.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2009-01-04 13:16:06 $
...
#ident "@(#) $RCSfile: ss7MIB.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2009-01-04 13:16:06 $"

static char const ident[] = "$RCSfile: ss7MIB.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2009-01-04 13:16:06 $";
	...
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
		{
			...
			if ((StorageNew->ss7NetworkProtocolVariant = snmp_duplicate_objid(tmpoid, 15))) {
				StorageNew->ss7NetworkProtocolVariantLen = 15 * sizeof(oid);
			}
		}
...
/**
 * @fn void refresh_ss7NetworkTable(void)
...
/**
 * @fn void refresh_ss7NetworkTable_row(struct ss7NetworkTable_data *StorageTmp)
...
#endif				/* defined MASTER */
/**
 * @fn void ss7MIB_readfd_handler(int fd, void *dummy)
 ...
 */
void
ss7MIB_readfd_handler(int fd, void *dummy)
{
