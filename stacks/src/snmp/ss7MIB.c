/*****************************************************************************
 ...
 @(#) $RCSfile: ss7MIB.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2009-01-10 17:09:22 $
...
#ident "@(#) $RCSfile: ss7MIB.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2009-01-10 17:09:22 $"

static char const ident[] = "$RCSfile: ss7MIB.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2009-01-10 17:09:22 $";
...
#endif				/* defined MODULE */
	/* initialize the associated mibs */
	init_x400pMIB();
	init_mtpMIB();
	init_mtpOmMIB();
	init_sccpMIB();
...
{
	if (!StorageTmp || StorageTmp->ss7NetworkTable_request == sa_request)
		return;
