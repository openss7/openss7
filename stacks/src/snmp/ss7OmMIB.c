...
static const char sa_program[] = "ss7ommib";
...
static char sa_logfile[256] = "/var/log/ss7ommib.log";
static char sa_pidfile[256] = "/var/run/ss7ommib.pid";
static char sa_sysctlf[256] = "/etc/ss7ommib.conf";
...
static volatile int ss7OmMIB_refresh = 1;
...
static struct ss7OmMIB_data *ss7OmMIBStorage = NULL;
...
refresh_ss7OmMIB(void)
{
	if (ss7OmMIBStorage == NULL) {
		if ((ss7OmMIBStorage = SNMP_MALLOC_STRUCT(ss7OmMIB_data)) == NULL)
			return;
