/*****************************************************************************
 ...
 @(#) $RCSfile: ss7OmMIB.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2009-01-04 13:16:06 $
...
#ident "@(#) $RCSfile: ss7OmMIB.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2009-01-04 13:16:06 $"

static char const ident[] = "$RCSfile: ss7OmMIB.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2009-01-04 13:16:06 $";
...
#if defined MASTER
	ss7OmMIBold_signal_handler = external_signal_handler[0];
	external_signal_handler[0] = &ss7OmMIB_loop_handler;
...
#if defined MODULE
#if defined MASTER
	external_signal_handler[0] = ss7OmMIBold_signal_handler;
#endif				/* defined MASTER */
	if (sa_readfd != 0) {
 ...
 */
void
ss7OmMIB_loop_handler(int dummy)
{
...
#endif				/* defined MASTER */
/**
 * @fn void ss7OmMIB_readfd_handler(int fd, void *dummy)
 ...
 */
void
ss7OmMIB_readfd_handler(int fd, void *dummy)
{
