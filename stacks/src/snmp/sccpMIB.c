/*****************************************************************************
 ...
 @(#) $RCSfile: sccpMIB.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2009-01-10 17:09:19 $
...
#ident "@(#) $RCSfile: sccpMIB.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2009-01-10 17:09:19 $"

static char const ident[] = "$RCSfile: sccpMIB.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2009-01-10 17:09:19 $";
...
#if defined MASTER
	sccpMIBold_signal_handler = external_signal_handler[0];
	external_signal_handler[0] = &sccpMIB_loop_handler;
...
#if defined MODULE
#if defined MASTER
	external_signal_handler[0] = sccpMIBold_signal_handler;
#endif				/* defined MASTER */
	if (sa_readfd != 0) {
...
{
	if (!StorageTmp || StorageTmp->sccpNetworkEntityTable_request == sa_request)
		return;
...
{
	if (!StorageTmp || StorageTmp->sccpSapNameTable_request == sa_request)
		return;
...
{
	if (!StorageTmp || StorageTmp->sccpAccessPointTable_request == sa_request)
		return;
...
{
	if (!StorageTmp || StorageTmp->sccpLinkageTable_request == sa_request)
		return;
...
{
	if (!StorageTmp || StorageTmp->sccpSclcTable_request == sa_request)
		return;
...
{
	if (!StorageTmp || StorageTmp->sccpScocTable_request == sa_request)
		return;
...
{
	if (!StorageTmp || StorageTmp->sccpScrcTable_request == sa_request)
		return;
...
{
	if (!StorageTmp || StorageTmp->sccpEntitySetTable_request == sa_request)
		return;
...
{
	if (!StorageTmp || StorageTmp->sccpEntitySetSapTable_request == sa_request)
		return;
...
{
	if (!StorageTmp || StorageTmp->sccpConcernedAreaTable_request == sa_request)
		return;
...
{
	if (!StorageTmp || StorageTmp->sccpRemoteSCCPTable_request == sa_request)
		return;
...
{
	if (!StorageTmp || StorageTmp->sccpGtConversionRuleTable_request == sa_request)
		return;
...
{
	if (!StorageTmp || StorageTmp->sccpAddressInfoTable_request == sa_request)
		return;
...
{
	if (!StorageTmp || StorageTmp->sccpGtTranslatorTable_request == sa_request)
		return;
...
{
	if (!StorageTmp || StorageTmp->sccpGtRuleTable_request == sa_request)
		return;
...
{
	if (!StorageTmp || StorageTmp->sccpSrvtTable_request == sa_request)
		return;
 ...
 */
void
sccpMIB_loop_handler(int dummy)
{
