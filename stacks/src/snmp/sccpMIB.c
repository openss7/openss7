/*****************************************************************************
 ...
 @(#) $RCSfile: sccpMIB.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2009-01-04 13:16:04 $
...
#ident "@(#) $RCSfile: sccpMIB.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2009-01-04 13:16:04 $"

static char const ident[] = "$RCSfile: sccpMIB.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2009-01-04 13:16:04 $";
...
#endif				/* defined MASTER */
/**
 * @fn void sccpMIB_readfd_handler(int fd, void *dummy)
 ...
 */
void
sccpMIB_readfd_handler(int fd, void *dummy)
{
