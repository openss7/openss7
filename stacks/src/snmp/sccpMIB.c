/*****************************************************************************
 ...
 @(#) $RCSfile: sccpMIB.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2009-01-02 15:46:42 $
...
#ident "@(#) $RCSfile: sccpMIB.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2009-01-02 15:46:42 $"

static char const ident[] = "$RCSfile: sccpMIB.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2009-01-02 15:46:42 $";
...
sccpLinkageTable_create(void)
{
	...
	if (StorageNew != NULL) {
		/* XXX: fill in default row values here into StorageNew */
		StorageNew->sccpOperationalProtocols = (uint8_t *) strdup("{ class ( 0 ) , class1 ( 1 ) , class2 ( 2 ) , class3 ( 3 ) }");
		...
		StorageNew->sccpp = 8;
		StorageNew->sccpImportanceLevelCR = (uint8_t *) strdup("'0204'X");
		StorageNew->sccpImportanceLevelCRLen = strlen("'0204'X");
		StorageNew->sccpImportanceLevelCC = (uint8_t *) strdup("'0304'X");
		StorageNew->sccpImportanceLevelCCLen = strlen("'0304'X");
		StorageNew->sccpImportanceLevelCREF = (uint8_t *) strdup("'0204'X");
		StorageNew->sccpImportanceLevelCREFLen = strlen("'0204'X");
		StorageNew->sccpImportanceLevelDT1 = (uint8_t *) strdup("'0406'X");
		StorageNew->sccpImportanceLevelDT1Len = strlen("'0406'X");
		StorageNew->sccpImportanceLevelDT2 = (uint8_t *) strdup("'0406'X");
		StorageNew->sccpImportanceLevelDT2Len = strlen("'0406'X");
		StorageNew->sccpImportanceLevelAK = (uint8_t *) strdup("'0600'X");
		StorageNew->sccpImportanceLevelAKLen = strlen("'0600'X");
		StorageNew->sccpImportanceLevelIT = (uint8_t *) strdup("'0600'X");
		StorageNew->sccpImportanceLevelITLen = strlen("'0600'X");
		StorageNew->sccpImportanceLevelED = (uint8_t *) strdup("'0700'X");
		StorageNew->sccpImportanceLevelEDLen = strlen("'0700'X");
		StorageNew->sccpImportanceLevelEA = (uint8_t *) strdup("'0700'X");
		StorageNew->sccpImportanceLevelEALen = strlen("'0700'X");
		StorageNew->sccpImportanceLevelRSR = (uint8_t *) strdup("'0600'X");
		StorageNew->sccpImportanceLevelRSRLen = strlen("'0600'X");
		StorageNew->sccpImportanceLevelRSC = (uint8_t *) strdup("'0600'X");
		StorageNew->sccpImportanceLevelRSCLen = strlen("'0600'X");
		StorageNew->sccpImportanceLevelERR = (uint8_t *) strdup("'0700'X");
		StorageNew->sccpImportanceLevelERRLen = strlen("'0700'X");
		StorageNew->sccpImportanceLevelRLC = (uint8_t *) strdup("'0400'X");
		StorageNew->sccpImportanceLevelRLCLen = strlen("'0400'X");
		StorageNew->sccpImportanceLevelRLSD = (uint8_t *) strdup("'0606'X");
		StorageNew->sccpImportanceLevelRLSDLen = strlen("'0606'X");
		StorageNew->sccpImportanceLevelUDT = (uint8_t *) strdup("'0406'X");
		StorageNew->sccpImportanceLevelUDTLen = strlen("'0406'X");
		StorageNew->sccpImportanceLevelUDTS = (uint8_t *) strdup("'0300'X");
		StorageNew->sccpImportanceLevelUDTSLen = strlen("'0300'X");
		StorageNew->sccpImportanceLevelXUDT = (uint8_t *) strdup("'0406'X");
		StorageNew->sccpImportanceLevelXUDTLen = strlen("'0406'X");
		StorageNew->sccpImportanceLevelXUDTS = (uint8_t *) strdup("'0300'X");
		StorageNew->sccpImportanceLevelXUDTSLen = strlen("'0300'X");
		StorageNew->sccpImportanceLevelLUDT = (uint8_t *) strdup("'0406'X");
		StorageNew->sccpImportanceLevelLUDTLen = strlen("'0406'X");
		StorageNew->sccpImportanceLevelLUDTS = (uint8_t *) strdup("'0300'X");
