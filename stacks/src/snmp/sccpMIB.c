/*****************************************************************************
 ...
 @(#) $RCSfile: sccpMIB.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2008-12-31 16:04:46 $
...
#ident "@(#) $RCSfile: sccpMIB.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2008-12-31 16:04:46 $"

static char const ident[] = "$RCSfile: sccpMIB.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2008-12-31 16:04:46 $";
...
/*
 * parse_sccpMIB(): parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * var_sccpMIB(): locate variables in sccpMIB
 *
...
/*
 * sccpNetworkEntityTable_del(): delete a structure
 */
int
...
/*
 * parse_sccpNetworkEntityTable(): parse configuration file for sccpNetworkEntityTable
...
/*
 * sccpSapNameTable_del(): delete a structure
 */
int
...
/*
 * parse_sccpSapNameTable(): parse configuration file for sccpSapNameTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * sccpAccessPointTable_del(): delete a structure
 */
int
...
/*
 * parse_sccpAccessPointTable(): parse configuration file for sccpAccessPointTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * sccpLinkageTable_del(): delete a structure
 */
int
...
/*
 * parse_sccpLinkageTable(): parse configuration file for sccpLinkageTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * sccpSclcTable_del(): delete a structure
 */
int
...
/*
 * parse_sccpSclcTable(): parse configuration file for sccpSclcTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * sccpScocTable_del(): delete a structure
 */
int
...
/*
 * parse_sccpScocTable(): parse configuration file for sccpScocTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * sccpScrcTable_del(): delete a structure
 */
int
...
/*
 * parse_sccpScrcTable(): parse configuration file for sccpScrcTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * sccpEntitySetTable_del(): delete a structure
 */
int
...
/*
 * parse_sccpEntitySetTable(): parse configuration file for sccpEntitySetTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * sccpEntitySetSapTable_del(): delete a structure
 */
int
...
/*
 * parse_sccpEntitySetSapTable(): parse configuration file for sccpEntitySetSapTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * sccpConcernedAreaTable_del(): delete a structure
 */
int
...
/*
 * parse_sccpConcernedAreaTable(): parse configuration file for sccpConcernedAreaTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * sccpRemoteSCCPTable_del(): delete a structure
 */
int
...
/*
 * parse_sccpRemoteSCCPTable(): parse configuration file for sccpRemoteSCCPTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * sccpGtConversionRuleTable_del(): delete a structure
 */
int
...
/*
 * parse_sccpGtConversionRuleTable(): parse configuration file for sccpGtConversionRuleTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * sccpAddressInfoTable_del(): delete a structure
 */
int
...
/*
 * parse_sccpAddressInfoTable(): parse configuration file for sccpAddressInfoTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * sccpGtTranslatorTable_del(): delete a structure
 */
int
...
/*
 * parse_sccpGtTranslatorTable(): parse configuration file for sccpGtTranslatorTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * sccpGtRuleTable_del(): delete a structure
 */
int
...
/*
 * parse_sccpGtRuleTable(): parse configuration file for sccpGtRuleTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * sccpSrvtTable_del(): delete a structure
 */
int
...
/*
 * parse_sccpSrvtTable(): parse configuration file for sccpSrvtTable
 * parses .conf file entries needed to configure the mib.
 */
void
...
/*
 * var_sccpNetworkEntityTable(): locate variables in sccpNetworkEntityTable
...
/*
 * var_sccpSapNameTable(): locate variables in sccpSapNameTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_sccpMIB above.
 */
u_char *
...
/*
 * var_sccpAccessPointTable(): locate variables in sccpAccessPointTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_sccpMIB above.
 */
u_char *
...
/*
 * var_sccpLinkageTable(): locate variables in sccpLinkageTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_sccpMIB above.
 */
u_char *
...
/*
 * var_sccpSclcTable(): locate variables in sccpSclcTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_sccpMIB above.
 */
u_char *
...
/*
 * var_sccpScocTable(): locate variables in sccpScocTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_sccpMIB above.
 */
u_char *
...
/*
 * var_sccpScrcTable(): locate variables in sccpScrcTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_sccpMIB above.
 */
u_char *
...
/*
 * var_sccpEntitySetTable(): locate variables in sccpEntitySetTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_sccpMIB above.
 */
u_char *
...
/*
 * var_sccpEntitySetSapTable(): locate variables in sccpEntitySetSapTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_sccpMIB above.
 */
u_char *
...
/*
 * var_sccpConcernedAreaTable(): locate variables in sccpConcernedAreaTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_sccpMIB above.
 */
u_char *
...
/*
 * var_sccpRemoteSCCPTable(): locate variables in sccpRemoteSCCPTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_sccpMIB above.
 */
u_char *
...
/*
 * var_sccpGtConversionRuleTable(): locate variables in sccpGtConversionRuleTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_sccpMIB above.
 */
u_char *
...
/*
 * var_sccpAddressInfoTable(): locate variables in sccpAddressInfoTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_sccpMIB above.
 */
u_char *
...
/*
 * var_sccpGtTranslatorTable(): locate variables in sccpGtTranslatorTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_sccpMIB above.
 */
u_char *
...
/*
 * var_sccpGtRuleTable(): locate variables in sccpGtRuleTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_sccpMIB above.
 */
u_char *
...
/*
 * var_sccpSrvtTable(): locate variables in sccpSrvtTable
 * Handle this table separately from the scalar value case.  The workings of this are basically the
 * same as for var_sccpMIB above.
 */
u_char *
...
write_sccpLUDTandLUDTSSupported(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE1:
		...
		switch (set_value) {
		case SCCPLUDTANDLUDTSSUPPORTED_TRUE:
		case SCCPLUDTANDLUDTSSUPPORTED_FALSE:
			break;
		default:
...
write_sccpSsAvailableAfterSpRestart(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE1:
		...
		switch (set_value) {
		case SCCPSSAVAILABLEAFTERSPRESTART_TRUE:
		case SCCPSSAVAILABLEAFTERSPRESTART_FALSE:
			break;
		default:
...
write_sccpTraceRequested(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE1:
		...
		switch (set_value) {
		case SCCPTRACEREQUESTED_TRUE:
		case SCCPTRACEREQUESTED_FALSE:
			break;
		default:
...
write_sccpMtpBackwardRoutingRequested(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE1:
		...
		/* Note: default value 2 */
		switch (set_value) {
		case SCCPMTPBACKWARDROUTINGREQUESTED_TRUE:
		case SCCPMTPBACKWARDROUTINGREQUESTED_FALSE:
			break;
		default:
...
write_sccpRowStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE2:
		...
		case RS_CREATEANDWAIT:
			/* creation */
			vars = NULL;
			snmp_varlist_add_variable(&vars, NULL, 0, ASN_UNSIGNED, NULL, 0);	/* sccpNetworkEntityId 
												 */
			...
			vp = vars;
			if ((StorageNew = SNMP_MALLOC_STRUCT(sccpNetworkEntityTable_data)) == NULL) {
				/* XXX: free, zero vars */
				return SNMP_ERR_RESOURCEUNAVAILABLE;
			}
	...
	case UNDO:
		...
		case RS_CREATEANDWAIT:
			...
			hciptr = header_complex_find_entry(sccpNetworkEntityTableStorage, StorageNew);
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* sccpNetworkEntityTable_del() can handle NULL pointers. */
			break;
		}
		break;
	}
...
write_sccpSapNameRowStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE2:
		...
		case RS_CREATEANDWAIT:
			...
			snmp_varlist_add_variable(&vars, NULL, 0, ASN_UNSIGNED, NULL, 0);	/* sccpNetworkEntityId 
												 */
			snmp_varlist_add_variable(&vars, NULL, 0, ASN_UNSIGNED, NULL, 0);	/* sccpSapId 
												 */
			...
			vp = vars;
			if ((StorageNew = SNMP_MALLOC_STRUCT(sccpSapNameTable_data)) == NULL) {
				/* XXX: free, zero vars */
				return SNMP_ERR_RESOURCEUNAVAILABLE;
			}
			StorageNew->sccpNetworkEntityId = *vp->val.integer;
	...
	case UNDO:
		...
		case RS_CREATEANDWAIT:
			/* row creation, so remove it again */
			hciptr = header_complex_find_entry(sccpSapNameTableStorage, StorageNew);
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* sccpSapNameTable_del() can handle NULL pointers. */
			break;
		}
		break;
	}
...
write_sccpAccessPointRowStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE2:
		...
		case RS_CREATEANDWAIT:
			...
			vp = vars;
			if ((StorageNew = SNMP_MALLOC_STRUCT(sccpAccessPointTable_data)) == NULL) {
				/* XXX: free, zero vars */
				return SNMP_ERR_RESOURCEUNAVAILABLE;
			}
			StorageNew->sccpNetworkEntityId = *vp->val.integer;
	...
	case UNDO:
		...
		case RS_CREATEANDWAIT:
			/* row creation, so remove it again */
			hciptr = header_complex_find_entry(sccpAccessPointTableStorage, StorageNew);
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* sccpAccessPointTable_del() can handle NULL pointers. */
			break;
		}
		break;
	}
...
write_sccpLinkageRowStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE2:
		...
		case RS_CREATEANDWAIT:
			...
			snmp_varlist_add_variable(&vars, NULL, 0, ASN_UNSIGNED, NULL, 0);	/* sccpNetworkEntityId 
												 */
			snmp_varlist_add_variable(&vars, NULL, 0, ASN_UNSIGNED, NULL, 0);	/* sccpLinkageId 
												 */
			...
			vp = vars;
			if ((StorageNew = SNMP_MALLOC_STRUCT(sccpLinkageTable_data)) == NULL) {
				/* XXX: free, zero vars */
				return SNMP_ERR_RESOURCEUNAVAILABLE;
			}
			StorageNew->sccpNetworkEntityId = *vp->val.integer;
			...
			/* XXX: fill in default row values here into StorageNew */
			StorageNew->sccpOperationalProtocols = (uint8_t *) strdup("\x0F"); /* { class ( 0 ) , class1 ( 1 ) , class2 ( 2 ) , class3 ( 3 ) } */
			StorageNew->sccpOperationalProtocolsLen = strlen("\x0F");
			StorageNew->sccpNrOfRestrictionLevels = 8;
			StorageNew->sccpNrOfSubLevels = 4;
			StorageNew->sccpCLS = 8;
			StorageNew->sccpp = 8;
			StorageNew->sccpImportanceLevelCR = (uint8_t *) strdup("\x02\x04");
			StorageNew->sccpImportanceLevelCRLen = strlen("\x02\x04");
			StorageNew->sccpImportanceLevelCC = (uint8_t *) strdup("\x03\x04");
			StorageNew->sccpImportanceLevelCCLen = strlen("\x03\x04");
			StorageNew->sccpImportanceLevelCREF = (uint8_t *) strdup("\x02\x04");
			StorageNew->sccpImportanceLevelCREFLen = strlen("\x02\x04");
			StorageNew->sccpImportanceLevelDT1 = (uint8_t *) strdup("\x04\x06");
			StorageNew->sccpImportanceLevelDT1Len = strlen("\x04\x06");
			StorageNew->sccpImportanceLevelDT2 = (uint8_t *) strdup("\x04\x06");
			StorageNew->sccpImportanceLevelDT2Len = strlen("\x04\x06");
			StorageNew->sccpImportanceLevelAK = (uint8_t *) strdup("\x06\x00");
			StorageNew->sccpImportanceLevelAKLen = strlen("\x06\x00");
			StorageNew->sccpImportanceLevelIT = (uint8_t *) strdup("\x06\x00");
			StorageNew->sccpImportanceLevelITLen = strlen("\x06\x00");
			StorageNew->sccpImportanceLevelED = (uint8_t *) strdup("\x07\x00");
			StorageNew->sccpImportanceLevelEDLen = strlen("\x07\x00");
			StorageNew->sccpImportanceLevelEA = (uint8_t *) strdup("\x07\x00");
			StorageNew->sccpImportanceLevelEALen = strlen("\x07\x00");
			StorageNew->sccpImportanceLevelRSR = (uint8_t *) strdup("\x06\x00");
			StorageNew->sccpImportanceLevelRSRLen = strlen("\x06\x00");
			StorageNew->sccpImportanceLevelRSC = (uint8_t *) strdup("\x06\x00");
			StorageNew->sccpImportanceLevelRSCLen = strlen("\x06\x00");
			StorageNew->sccpImportanceLevelERR = (uint8_t *) strdup("\x07\x00");
			StorageNew->sccpImportanceLevelERRLen = strlen("\x07\x00");
			StorageNew->sccpImportanceLevelRLC = (uint8_t *) strdup("\x04\x00");
			StorageNew->sccpImportanceLevelRLCLen = strlen("\x04\x00");
			StorageNew->sccpImportanceLevelRLSD = (uint8_t *) strdup("\x06\x06");
			StorageNew->sccpImportanceLevelRLSDLen = strlen("\x06\x06");
			StorageNew->sccpImportanceLevelUDT = (uint8_t *) strdup("\x04\x06");
			StorageNew->sccpImportanceLevelUDTLen = strlen("\x04\x06");
			StorageNew->sccpImportanceLevelUDTS = (uint8_t *) strdup("\x03\x00");
			StorageNew->sccpImportanceLevelUDTSLen = strlen("\x03\x00");
			StorageNew->sccpImportanceLevelXUDT = (uint8_t *) strdup("\x04\x06");
			StorageNew->sccpImportanceLevelXUDTLen = strlen("\x04\x06");
			StorageNew->sccpImportanceLevelXUDTS = (uint8_t *) strdup("\x03\x00");
			StorageNew->sccpImportanceLevelXUDTSLen = strlen("\x03\x00");
			StorageNew->sccpImportanceLevelLUDT = (uint8_t *) strdup("\x04\x06");
			StorageNew->sccpImportanceLevelLUDTLen = strlen("\x04\x06");
			StorageNew->sccpImportanceLevelLUDTS = (uint8_t *) strdup("\x03\x00");
			StorageNew->sccpImportanceLevelLUDTSLen = strlen("\x03\x00");
	...
	case UNDO:
		...
		case RS_CREATEANDWAIT:
			/* row creation, so remove it again */
			hciptr = header_complex_find_entry(sccpLinkageTableStorage, StorageNew);
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* sccpLinkageTable_del() can handle NULL pointers. */
			break;
		}
		break;
	}
...
write_sccpSclcRowStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE2:
		...
		case RS_CREATEANDWAIT:
			...
			vp = vars;
			if ((StorageNew = SNMP_MALLOC_STRUCT(sccpSclcTable_data)) == NULL) {
				/* XXX: free, zero vars */
				return SNMP_ERR_RESOURCEUNAVAILABLE;
			}
			StorageNew->sccpNetworkEntityId = *vp->val.integer;
	...
	case UNDO:
		...
		case RS_CREATEANDWAIT:
			/* row creation, so remove it again */
			hciptr = header_complex_find_entry(sccpSclcTableStorage, StorageNew);
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* sccpSclcTable_del() can handle NULL pointers. */
			break;
		}
		break;
	}
...
write_sccpScocRowStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE2:
		...
		case RS_CREATEANDWAIT:
			...
			vp = vars;
			if ((StorageNew = SNMP_MALLOC_STRUCT(sccpScocTable_data)) == NULL) {
				/* XXX: free, zero vars */
				return SNMP_ERR_RESOURCEUNAVAILABLE;
			}
			StorageNew->sccpNetworkEntityId = *vp->val.integer;
	...
	case UNDO:
		...
		case RS_CREATEANDWAIT:
			/* row creation, so remove it again */
			hciptr = header_complex_find_entry(sccpScocTableStorage, StorageNew);
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* sccpScocTable_del() can handle NULL pointers. */
			break;
		}
		break;
	}
...
write_sccpScrcRowStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE2:
		...
		case RS_CREATEANDWAIT:
			...
			vp = vars;
			if ((StorageNew = SNMP_MALLOC_STRUCT(sccpScrcTable_data)) == NULL) {
				/* XXX: free, zero vars */
				return SNMP_ERR_RESOURCEUNAVAILABLE;
			}
			StorageNew->sccpNetworkEntityId = *vp->val.integer;
	...
	case UNDO:
		...
		case RS_CREATEANDWAIT:
			/* row creation, so remove it again */
			hciptr = header_complex_find_entry(sccpScrcTableStorage, StorageNew);
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* sccpScrcTable_del() can handle NULL pointers. */
			break;
		}
		break;
	}
...
write_sccpEntitySetRowStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE2:
		...
		case RS_CREATEANDWAIT:
			...
			vp = vars;
			if ((StorageNew = SNMP_MALLOC_STRUCT(sccpEntitySetTable_data)) == NULL) {
				/* XXX: free, zero vars */
				return SNMP_ERR_RESOURCEUNAVAILABLE;
			}
			StorageNew->sccpNetworkEntityId = *vp->val.integer;
	...
	case UNDO:
		...
		case RS_CREATEANDWAIT:
			/* row creation, so remove it again */
			hciptr = header_complex_find_entry(sccpEntitySetTableStorage, StorageNew);
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* sccpEntitySetTable_del() can handle NULL pointers. */
			break;
		}
		break;
	}
...
write_sccpEntitySetSapRowStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE2:
		...
		case RS_CREATEANDWAIT:
			...
			vp = vars;
			if ((StorageNew = SNMP_MALLOC_STRUCT(sccpEntitySetSapTable_data)) == NULL) {
				/* XXX: free, zero vars */
				return SNMP_ERR_RESOURCEUNAVAILABLE;
			}
			StorageNew->sccpNetworkEntityId = *vp->val.integer;
	...
	case UNDO:
		...
		case RS_CREATEANDWAIT:
			/* row creation, so remove it again */
			hciptr = header_complex_find_entry(sccpEntitySetSapTableStorage, StorageNew);
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* sccpEntitySetSapTable_del() can handle NULL pointers. */
			break;
		}
		break;
	}
...
write_sccpConcernedAreaRowStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE2:
		...
		case RS_CREATEANDWAIT:
			...
			vp = vars;
			if ((StorageNew = SNMP_MALLOC_STRUCT(sccpConcernedAreaTable_data)) == NULL) {
				/* XXX: free, zero vars */
				return SNMP_ERR_RESOURCEUNAVAILABLE;
			}
			StorageNew->sccpNetworkEntityId = *vp->val.integer;
	...
	case UNDO:
		...
		case RS_CREATEANDWAIT:
			/* row creation, so remove it again */
			hciptr = header_complex_find_entry(sccpConcernedAreaTableStorage, StorageNew);
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* sccpConcernedAreaTable_del() can handle NULL pointers. */
			break;
		}
		break;
	}
...
write_sccpRemoteSCCPRowStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE2:
		...
		case RS_CREATEANDWAIT:
			...
			vp = vars;
			if ((StorageNew = SNMP_MALLOC_STRUCT(sccpRemoteSCCPTable_data)) == NULL) {
				/* XXX: free, zero vars */
				return SNMP_ERR_RESOURCEUNAVAILABLE;
			}
			StorageNew->sccpNetworkEntityId = *vp->val.integer;
	...
	case UNDO:
		...
		case RS_CREATEANDWAIT:
			/* row creation, so remove it again */
			hciptr = header_complex_find_entry(sccpRemoteSCCPTableStorage, StorageNew);
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* sccpRemoteSCCPTable_del() can handle NULL pointers. */
			break;
		}
		break;
	}
...
write_sccpGtConversionRuleRowStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE2:
		...
		case RS_CREATEANDWAIT:
			...
			vp = vars;
			if ((StorageNew = SNMP_MALLOC_STRUCT(sccpGtConversionRuleTable_data)) == NULL) {
				/* XXX: free, zero vars */
				return SNMP_ERR_RESOURCEUNAVAILABLE;
			}
			StorageNew->sccpNetworkEntityId = *vp->val.integer;
	...
	case UNDO:
		...
		case RS_CREATEANDWAIT:
			/* row creation, so remove it again */
			hciptr = header_complex_find_entry(sccpGtConversionRuleTableStorage, StorageNew);
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* sccpGtConversionRuleTable_del() can handle NULL pointers. */
			break;
		}
		break;
	}
...
write_sccpAddressInfoRowStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE2:
		...
		case RS_CREATEANDWAIT:
			...
			vp = vars;
			if ((StorageNew = SNMP_MALLOC_STRUCT(sccpAddressInfoTable_data)) == NULL) {
				/* XXX: free, zero vars */
				return SNMP_ERR_RESOURCEUNAVAILABLE;
			}
			StorageNew->sccpNetworkEntityId = *vp->val.integer;
	...
	case UNDO:
		...
		case RS_CREATEANDWAIT:
			/* row creation, so remove it again */
			hciptr = header_complex_find_entry(sccpAddressInfoTableStorage, StorageNew);
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* sccpAddressInfoTable_del() can handle NULL pointers. */
			break;
		}
		break;
	}
...
write_sccpGtTranslatorRowStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE2:
		...
		case RS_CREATEANDWAIT:
			...
			vp = vars;
			if ((StorageNew = SNMP_MALLOC_STRUCT(sccpGtTranslatorTable_data)) == NULL) {
				/* XXX: free, zero vars */
				return SNMP_ERR_RESOURCEUNAVAILABLE;
			}
			StorageNew->sccpNetworkEntityId = *vp->val.integer;
	...
	case UNDO:
		...
		case RS_CREATEANDWAIT:
			/* row creation, so remove it again */
			hciptr = header_complex_find_entry(sccpGtTranslatorTableStorage, StorageNew);
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* sccpGtTranslatorTable_del() can handle NULL pointers. */
			break;
		}
		break;
	}
...
write_sccpGtRuleRowStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE2:
		...
		case RS_CREATEANDWAIT:
			...
			vp = vars;
			if ((StorageNew = SNMP_MALLOC_STRUCT(sccpGtRuleTable_data)) == NULL) {
				/* XXX: free, zero vars */
				return SNMP_ERR_RESOURCEUNAVAILABLE;
			}
			StorageNew->sccpNetworkEntityId = *vp->val.integer;
	...
	case UNDO:
		...
		case RS_CREATEANDWAIT:
			/* row creation, so remove it again */
			hciptr = header_complex_find_entry(sccpGtRuleTableStorage, StorageNew);
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* sccpGtRuleTable_del() can handle NULL pointers. */
			break;
		}
		break;
	}
...
write_sccpRouteTestRowStatus(int action, u_char *var_val, u_char var_val_type, size_t var_val_len, u_char *statP, oid * name, size_t name_len)
{
	...
	case RESERVE2:
		...
		case RS_CREATEANDWAIT:
			...
			vp = vars;
			if ((StorageNew = SNMP_MALLOC_STRUCT(sccpSrvtTable_data)) == NULL) {
				/* XXX: free, zero vars */
				return SNMP_ERR_RESOURCEUNAVAILABLE;
			}
			StorageNew->sccpNetworkEntityId = *vp->val.integer;
	...
	case UNDO:
		...
		case RS_CREATEANDWAIT:
			/* row creation, so remove it again */
			hciptr = header_complex_find_entry(sccpSrvtTableStorage, StorageNew);
	...
	case COMMIT:
		...
		case RS_DESTROY:
			...
			/* sccpSrvtTable_del() can handle NULL pointers. */
			break;
		}
		break;
	}
