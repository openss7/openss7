/*****************************************************************************
 ...
 @(#) $Id: sccpMIB.h,v 0.9.2.3 2008-12-31 16:04:47 brian Exp $
...
#ident "@(#) $RCSfile: sccpMIB.h,v $ $Name:  $($Revision: 0.9.2.3 $) Copyright (c) 2001-2008 OpenSS7 Corporation."
...
struct sccpNetworkEntityTable_data {
	...
	uint32_t sccpCommunicationsEntityId;
...
struct sccpAccessPointTable_data {
	...
	uint32_t sccpConcernedAreaPointer;
	uint32_t sccpLinkagePointer;
