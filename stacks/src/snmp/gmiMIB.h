/*****************************************************************************
 ...
 @(#) $Id: gmiMIB.h,v 0.9.2.1 2009-01-04 13:16:00 brian Exp $
...
#ident "@(#) $RCSfile: gmiMIB.h,v $ $Name: OpenSS7-0_9_2 $($Revision: 0.9.2.1 $) Copyright (c) 2008-2009 Monavacom Limited."
...
struct applicationProcessTable_data {
	...
	uint8_t *applicationProcessId;
	size_t applicationProcessIdLen;
	oid *applicationProcessTitle;
	size_t applicationProcessTitleLen;
	uint8_t *supportEntityNames;
	size_t supportEntityNamesLen;
	long applicationProcessOperationalState;
};
...
struct clProtocolMachineTable_data {
	...
	struct counter64 totalRemoteSAPs;
};
...
struct sap2Table_data {
	...
	uint8_t *sap2UserEntityNames;
	size_t sap2UserEntityNamesLen;
	uint8_t *sap2providerEntityNames;
...
struct singlePeerConnectionTable_data {
	...
	uint8_t *underlyingConnectionNames;
	size_t underlyingConnectionNamesLen;
	uint8_t *supportedConnectionNames;
...
void refresh_applicationProcessTable(void);
...
void refresh_communicationsInformationRecordTable(void);
...
void refresh_subsystemTable(void);
