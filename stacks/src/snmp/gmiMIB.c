/*****************************************************************************
 ...
 @(#) $RCSfile: gmiMIB.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2009-01-19 13:31:41 $
 ...
 $Log: gmiMIB.c,v $
 Revision 0.9.2.5  2009-01-19 13:31:41  brian
...
#ident "@(#) $RCSfile: gmiMIB.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2009-01-19 13:31:41 $"

static char const ident[] = "$RCSfile: gmiMIB.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2009-01-19 13:31:41 $";
 ...
 */
oid tmnInformationType_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 9, 3, 5, 1, 3, 1 };
oid tmnInformationData_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 9, 3, 5, 1, 3, 2 };

/*
 * Other oids defined in this MIB.
 */
oid communicationsInformationType_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 9, 3, 5, 1, 4, 1 };
oid gmiBasicCompliance_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 9, 3, 5, 2, 1, 1 };
oid gmiApplicationProcessP1Package_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 9, 3, 5, 2, 2, 1 };
oid gmiCommunicationsEntityP1Package_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 9, 3, 5, 2, 2, 2 };
oid gmiCommunicationsInformationRecordP1Package_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 9, 3, 5, 2, 2, 3 };
oid gmiInformationDataPackagePackage_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 9, 3, 5, 2, 2, 4 };
oid gmiClProtocolMachineP1Package_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 9, 3, 5, 2, 2, 5 };
oid gmiClProtocolMachineP2Package_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 9, 3, 5, 2, 2, 6 };
oid gmiCoProtocolMachineP1Package_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 9, 3, 5, 2, 2, 7 };
oid gmiSap1P1Package_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 9, 3, 5, 2, 2, 8 };
oid gmiSap2P1Package_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 9, 3, 5, 2, 2, 9 };
oid gmiSinglePeerConnectionP1Package_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 9, 3, 5, 2, 2, 10 };
oid gmiSinglePeerConnectionP2Package_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 9, 3, 5, 2, 2, 11 };
oid gmiSubsystemP1Package_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 9, 3, 5, 2, 2, 12 };
oid gmiParametersGroup_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 9, 3, 5, 2, 2, 13 };
oid gmiNotificationsGroup_oid[13] = { 1, 3, 6, 1, 4, 1, 29591, 9, 3, 5, 2, 2, 14 };
