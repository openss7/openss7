/*****************************************************************************
 ...
 @(#) $RCSfile: gmiMIB.c,v $ $Name: OpenSS7-0_9_2 $($Revision: 0.9.2.1 $) $Date: 2009-01-04 13:16:00 $
...
#ident "@(#) $RCSfile: gmiMIB.c,v $ $Name: OpenSS7-0_9_2 $($Revision: 0.9.2.1 $) $Date: 2009-01-04 13:16:00 $"

static char const ident[] = "$RCSfile: gmiMIB.c,v $ $Name: OpenSS7-0_9_2 $($Revision: 0.9.2.1 $) $Date: 2009-01-04 13:16:00 $";
 ...
 */
oid gmiMIB_variables_oid[] = { 1, 3, 6, 1, 4, 1, 29591, 9, 3, 5 };
...
#define   APPLICATIONPROCESSTITLE  (4 % 256)
	{APPLICATIONPROCESSTITLE, ASN_OBJECT_ID, RONLY, var_applicationProcessTable, 6, {1, 2, 1, 1, 1, 2}},
#define   SUPPORTENTITYNAMES    (5 % 256)
	{SUPPORTENTITYNAMES, ASN_OCTET_STR, RONLY, var_applicationProcessTable, 6, {1, 2, 1, 1, 1, 3}},
#define   APPLICATIONPROCESSOPERATIONALSTATE  (6 % 256)
	{APPLICATIONPROCESSOPERATIONALSTATE, ASN_INTEGER, RONLY, var_applicationProcessTable, 6, {1, 2, 1, 1, 1, 4}},
#define   SUBSYSTEMID           (9 % 256)
	{SUBSYSTEMID, ASN_OCTET_STR, RONLY, var_communicationsEntityTable, 6, {1, 2, 9, 1, 1, 1}},
#define   LOCALSAPNAMES         (11 % 256)
	{LOCALSAPNAMES, ASN_OCTET_STR, RONLY, var_communicationsEntityTable, 6, {1, 2, 2, 1, 1, 2}},
#define   COMMUNICATIONSENTITYOPERATIONALSTATE  (12 % 256)
	{COMMUNICATIONSENTITYOPERATIONALSTATE, ASN_INTEGER, RONLY, var_communicationsEntityTable, 6, {1, 2, 2, 1, 1, 3}},
#define   INFORMATIONTYPE       (17 % 256)
	{INFORMATIONTYPE, ASN_OBJECT_ID, RONLY, var_communicationsInformationRecordTable, 6, {1, 2, 3, 1, 1, 1}},
#define   INFORMATIONDATA       (18 % 256)
	{INFORMATIONDATA, ASN_OCTET_STR, RONLY, var_communicationsInformationRecordTable, 6, {1, 2, 3, 1, 1, 2}},
#define   SUBSYSTEMID           (21 % 256)
	{SUBSYSTEMID, ASN_OCTET_STR, RONLY, var_clProtocolMachineTable, 6, {1, 2, 9, 1, 1, 1}},
#define   CLPROTOCOLMACHINEOPERATIONALSTATE  (24 % 256)
	{CLPROTOCOLMACHINEOPERATIONALSTATE, ASN_INTEGER, RONLY, var_clProtocolMachineTable, 6, {1, 2, 4, 1, 1, 2}},
#define   TOTALREMOTESAPS       (25 % 256)
	{TOTALREMOTESAPS, ASN_COUNTER64, RONLY, var_clProtocolMachineTable, 6, {1, 2, 4, 1, 1, 3}},
#define   SUBSYSTEMID           (28 % 256)
	{SUBSYSTEMID, ASN_OCTET_STR, RONLY, var_coProtocolMachineTable, 6, {1, 2, 9, 1, 1, 1}},
#define   COPROTOCOLMACHINEOPERATIONALSTATE  (31 % 256)
	{COPROTOCOLMACHINEOPERATIONALSTATE, ASN_INTEGER, RONLY, var_coProtocolMachineTable, 6, {1, 2, 5, 1, 1, 2}},
#define   SUBSYSTEMID           (34 % 256)
	{SUBSYSTEMID, ASN_OCTET_STR, RONLY, var_sap1Table, 6, {1, 2, 9, 1, 1, 1}},
#define   SAP1ADDRESS           (37 % 256)
	{SAP1ADDRESS, ASN_UNSIGNED, RONLY, var_sap1Table, 6, {1, 2, 6, 1, 1, 2}},
#define   SAP1USERENTITYNAMES   (38 % 256)
	{SAP1USERENTITYNAMES, ASN_OCTET_STR, RONLY, var_sap1Table, 6, {1, 2, 6, 1, 1, 3}},
#define   SUBSYSTEMID           (41 % 256)
	{SUBSYSTEMID, ASN_OCTET_STR, RONLY, var_sap2Table, 6, {1, 2, 9, 1, 1, 1}},
#define   SAP2ADDRESS           (43 % 256)
	{SAP2ADDRESS, ASN_OPAQUE, RONLY, var_sap2Table, 6, {1, 2, 7, 1, 1, 2}},
#define   SAP2USERENTITYNAMES   (44 % 256)
	{SAP2USERENTITYNAMES, ASN_OCTET_STR, RONLY, var_sap2Table, 6, {1, 2, 7, 1, 1, 3}},
#define   SAP2PROVIDERENTITYNAMES  (45 % 256)
	{SAP2PROVIDERENTITYNAMES, ASN_OCTET_STR, RONLY, var_sap2Table, 6, {1, 2, 7, 1, 1, 4}},
#define   SUBSYSTEMID           (48 % 256)
	{SUBSYSTEMID, ASN_OCTET_STR, RONLY, var_singlePeerConnectionTable, 6, {1, 2, 9, 1, 1, 1}},
#define   UNDERLYINGCONNECTIONNAMES  (52 % 256)
	{UNDERLYINGCONNECTIONNAMES, ASN_OCTET_STR, RONLY, var_singlePeerConnectionTable, 6, {1, 2, 8, 1, 1, 2}},
#define   SUPPORTEDCONNECTIONNAMES  (53 % 256)
	{SUPPORTEDCONNECTIONNAMES, ASN_OCTET_STR, RONLY, var_singlePeerConnectionTable, 6, {1, 2, 8, 1, 1, 3}},
#define   SUBSYSTEMID           (56 % 256)
	{SUBSYSTEMID, ASN_OCTET_STR, RONLY, var_subsystemTable, 6, {1, 2, 9, 1, 1, 1}},
};
...
{
	if (StorageTmp->applicationProcessTable_request == sa_request)
		return;
...
var_applicationProcessTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	if ((StorageTmp = header_complex(applicationProcessTableStorage, vp, name, length, exact, var_len, write_method)) == NULL)
		return NULL;
	refresh_applicationProcessTable_row(StorageTmp);
	/* This is where we do the value assignments for the mib results. */
	switch (vp->magic) {
	case APPLICATIONPROCESSTITLE:
		*write_method = NULL;	/* read-only */
		*var_len = StorageTmp->applicationProcessTitleLen;
		return (u_char *) StorageTmp->applicationProcessTitle;
	case SUPPORTENTITYNAMES:
		*write_method = NULL;	/* read-only */
		*var_len = StorageTmp->supportEntityNamesLen;
		return (u_char *) StorageTmp->supportEntityNames;
	case APPLICATIONPROCESSOPERATIONALSTATE:
		*write_method = NULL;	/* read-only */
		*var_len = sizeof(StorageTmp->applicationProcessOperationalState);
		return (u_char *) &StorageTmp->applicationProcessOperationalState;
	default:
		ERROR_MSG("");
	}
	return NULL;
...
var_communicationsEntityTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	case LOCALSAPNAMES:
		...
		*var_len = StorageTmp->localSapNamesLen;
		return (u_char *) StorageTmp->localSapNames;
...
{
	if (StorageTmp->communicationsInformationRecordTable_request == sa_request)
		return;
...
var_communicationsInformationRecordTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_communicationsInformationRecordTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	if ((StorageTmp = header_complex(communicationsInformationRecordTableStorage, vp, name, length, exact, var_len, write_method)) == NULL)
		return NULL;
	...
	case INFORMATIONTYPE:
		*write_method = NULL;	/* read-only */
		*var_len = StorageTmp->informationTypeLen;
		return (u_char *) StorageTmp->informationType;
	case INFORMATIONDATA:
		*write_method = NULL;	/* read-only */
		*var_len = StorageTmp->informationDataLen;
		return (u_char *) StorageTmp->informationData;
	default:
		ERROR_MSG("");
	}
	return NULL;
...
var_clProtocolMachineTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	case TOTALREMOTESAPS:
		*write_method = NULL;	/* read-only */
		*var_len = sizeof(StorageTmp->totalRemoteSAPs);
		return (u_char *) &StorageTmp->totalRemoteSAPs;
	default:
		ERROR_MSG("");
	}
	return NULL;
...
var_singlePeerConnectionTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	case SUPPORTEDCONNECTIONNAMES:
		*write_method = NULL;	/* read-only */
		*var_len = StorageTmp->supportedConnectionNamesLen;
		return (u_char *) StorageTmp->supportedConnectionNames;
	default:
		ERROR_MSG("");
	}
	return NULL;
...
{
	if (StorageTmp->subsystemTable_request == sa_request)
		return;
...
var_subsystemTable(struct variable *vp, oid * name, size_t *length, int exact, size_t *var_len, WriteMethod ** write_method)
{
	...
	refresh_subsystemTable();
	/* This assumes you have registered all your data properly with header_complex_add() somewhere before this. */
	if ((StorageTmp = header_complex(subsystemTableStorage, vp, name, length, exact, var_len, write_method)) == NULL)
		return NULL;
	...
	case SUBSYSTEMID:
		...
		*var_len = StorageTmp->subsystemIdLen;
		return (u_char *) StorageTmp->subsystemId;
	default:
		ERROR_MSG("");
	}
	return NULL;
...
#endif				/* defined MASTER */
/**
 * @fn void gmiMIB_readfd_handler(int fd, void *dummy)
 ...
 */
void
gmiMIB_readfd_handler(int fd, void *dummy)
{
