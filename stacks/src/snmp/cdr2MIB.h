/*****************************************************************************
 ...
 @(#) $Id: cdr2MIB.h,v 0.9.2.4 2009-01-02 15:04:11 brian Exp $
 ...
 Last Modified $Date: 2009-01-02 15:04:11 $ by $Author: brian $
...
#ident "@(#) $RCSfile: cdr2MIB.h,v $ $Name:  $($Revision: 0.9.2.4 $) Copyright (c) 2008-2009 Monavacom Limited."
...
/* notifications */
extern oid blockRecordNotification_oid[];
extern oid callDetailRecordNotification_oid[];
extern oid fileCreationNotification_oid[];
extern oid blockRecordNotificationR2_oid[];
extern oid callDetailRecordNotificationR2_oid[];

/* scalars accessible only for notify */
extern oid fileName_oid[];
extern oid reasonForOutput_oid[];
extern oid sequenceNumber_oid[];
extern oid callRecord_oid[];

/* object id definitions */
extern oid cdrParameterGroup_oid[];
extern oid cdrNotificationGroup_oid[];
extern oid cdr1NotificationGroup_oid[];
extern oid cdr2NotificationGroup_oid[];
extern oid cdr2MandatoryCallRecordFields_oid[];
extern oid cdrMandatoryGroups_oid[];
extern oid cdr1ConditionalGroups_oid[];
extern oid cdr2MandatoryGroups_oid[];
extern oid cd1RecordFormatGroup_oid[];
extern oid cdr2ConditionalFieldsGroup_oid[];
extern oid cdr2Conformances_oid[];
