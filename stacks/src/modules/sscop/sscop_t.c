/*****************************************************************************
 ...
 @(#) $RCSfile: sscop_t.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2005/07/05 22:45:55 $
...
#ident "@(#) $RCSfile: sscop_t.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2005/07/05 22:45:55 $"
...
#define SSCOP_TPI_REVISION	"OpenSS7 $RCSfile: sscop_t.c,v $ $Name:  $ ($Revision: 0.9.2.9 $) $Date: 2005/07/05 22:45:55 $"
