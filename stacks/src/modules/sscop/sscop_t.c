/*****************************************************************************
 ...
 @(#) $RCSfile: sscop_t.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2005/05/14 08:31:10 $
...
#ident "@(#) $RCSfile: sscop_t.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2005/05/14 08:31:10 $"
...
#define SSCOP_TPI_REVISION	"OpenSS7 $RCSfile: sscop_t.c,v $ $Name:  $ ($Revision: 0.9.2.8 $) $Date: 2005/05/14 08:31:10 $"
