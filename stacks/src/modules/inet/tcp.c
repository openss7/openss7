/*****************************************************************************
 ...
 @(#) $RCSfile: tcp.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/09/25 20:15:49 $
 ...
 Last Modified $Date: 2006/09/25 20:15:49 $ by $Author: brian $
...
#ident "@(#) $RCSfile: tcp.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/09/25 20:15:49 $"

static char const ident[] = "$RCSfile: tcp.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/09/25 20:15:49 $";
...
#define TCP_REVISION	"OpenSS7 $RCSfile: tcp.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/09/25 20:15:49 $"
