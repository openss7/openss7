/*****************************************************************************
 ...
 @(#) $RCSfile: hdlc.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2005/04/09 09:41:44 $
 ...
 Last Modified $Date: 2005/04/09 09:41:44 $ by $Author: brian $

 *****************************************************************************/

#ident "@(#) $RCSfile: hdlc.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2005/04/09 09:41:44 $"
...
#define HDLC_REVISION	"LfS $RCSfile: hdlc.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2005/04/09 09:41:44 $"
