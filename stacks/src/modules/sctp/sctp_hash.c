/*****************************************************************************
 ...
 @(#) $RCSfile: sctp_hash.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2005/07/13 12:01:37 $
...
#ident "@(#) $RCSfile: sctp_hash.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2005/07/13 12:01:37 $"

static char const ident[] = "$RCSfile: sctp_hash.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2005/07/13 12:01:37 $";
