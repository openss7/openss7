/*****************************************************************************
 ...
 @(#) $RCSfile: sctp_hash.c,v $ $Name:  $($Revision: 0.9 $) $Date: 2004/01/17 08:21:59 $
...
#ident "@(#) $RCSfile: sctp_hash.c,v $ $Name:  $($Revision: 0.9 $) $Date: 2004/01/17 08:21:59 $"

static char const ident[] = "$RCSfile: sctp_hash.c,v $ $Name:  $($Revision: 0.9 $) $Date: 2004/01/17 08:21:59 $";
