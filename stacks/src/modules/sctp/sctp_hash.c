/*****************************************************************************
 ...
 @(#) $RCSfile: sctp_hash.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2005/03/08 19:30:25 $
 ...
 Last Modified $Date: 2005/03/08 19:30:25 $ by $Author: brian $

 *****************************************************************************/

#ident "@(#) $RCSfile: sctp_hash.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2005/03/08 19:30:25 $"

static char const ident[] = "$RCSfile: sctp_hash.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2005/03/08 19:30:25 $";
