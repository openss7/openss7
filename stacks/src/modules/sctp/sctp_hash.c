/*****************************************************************************
 ...
 @(#) $RCSfile: sctp_hash.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2006/10/27 22:57:18 $
...
#ident "@(#) $RCSfile: sctp_hash.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2006/10/27 22:57:18 $"

static char const ident[] = "$RCSfile: sctp_hash.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2006/10/27 22:57:18 $";
