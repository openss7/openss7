/*****************************************************************************
 ...
 @(#) $RCSfile: sctp_hash.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2006/09/26 00:52:31 $
...
#ident "@(#) $RCSfile: sctp_hash.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2006/09/26 00:52:31 $"

static char const ident[] = "$RCSfile: sctp_hash.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2006/09/26 00:52:31 $";
