/*****************************************************************************
 ...
 @(#) $RCSfile: sctp.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/05/14 08:31:04 $
...
#ident "@(#) $RCSfile: sctp.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/05/14 08:31:04 $"

static char const ident[] = "$RCSfile: sctp.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/05/14 08:31:04 $";
...
#define SCTP_REVISION	"LfS $RCSfile: sctp.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/05/14 08:31:04 $"
