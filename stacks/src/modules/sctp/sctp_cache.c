/*****************************************************************************
 ...
 @(#) $RCSfile: sctp_cache.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2005/03/08 19:30:23 $
 ...
 Last Modified $Date: 2005/03/08 19:30:23 $ by $Author: brian $

 *****************************************************************************/

#ident "@(#) $RCSfile: sctp_cache.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2005/03/08 19:30:23 $"

static char const ident[] = "$RCSfile: sctp_cache.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2005/03/08 19:30:23 $";
