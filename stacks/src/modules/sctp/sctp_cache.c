/*****************************************************************************
 ...
 @(#) $RCSfile: sctp_cache.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2004/08/26 23:38:06 $
...
#ident "@(#) $RCSfile: sctp_cache.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2004/08/26 23:38:06 $"

static char const ident[] = "$RCSfile: sctp_cache.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2004/08/26 23:38:06 $";
