/*****************************************************************************
 ...
 @(#) $RCSfile: sctp_output.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2005/03/08 19:30:29 $
 ...
 Last Modified $Date: 2005/03/08 19:30:29 $ by $Author: brian $

 *****************************************************************************/

#ident "@(#) $RCSfile: sctp_output.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2005/03/08 19:30:29 $"

static char const ident[] = "$RCSfile: sctp_output.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2005/03/08 19:30:29 $";
