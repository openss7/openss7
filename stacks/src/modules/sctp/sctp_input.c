/*****************************************************************************
 ...
 @(#) $RCSfile: sctp_input.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2005/05/14 08:31:05 $
...
#ident "@(#) $RCSfile: sctp_input.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2005/05/14 08:31:05 $"

static char const ident[] = "$RCSfile: sctp_input.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2005/05/14 08:31:05 $";
