/*****************************************************************************
 ...
 @(#) $RCSfile: sctp_route.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/07/05 22:45:40 $
...
#ident "@(#) $RCSfile: sctp_route.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/07/05 22:45:40 $"

static char const ident[] = "$RCSfile: sctp_route.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/07/05 22:45:40 $";
