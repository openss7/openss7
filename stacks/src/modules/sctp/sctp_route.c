/*****************************************************************************
 ...
 @(#) $RCSfile: sctp_route.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2005/03/08 19:30:30 $
 ...
 Last Modified $Date: 2005/03/08 19:30:30 $ by $Author: brian $

 *****************************************************************************/

#ident "@(#) $RCSfile: sctp_route.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2005/03/08 19:30:30 $"

static char const ident[] = "$RCSfile: sctp_route.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2005/03/08 19:30:30 $";
