/*****************************************************************************
 ...
 @(#) $RCSfile: sctp_cookie.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2005/03/08 19:30:24 $
 ...
 Last Modified $Date: 2005/03/08 19:30:24 $ by $Author: brian $

 *****************************************************************************/

#ident "@(#) $RCSfile: sctp_cookie.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2005/03/08 19:30:24 $"

static char const ident[] = "$RCSfile: sctp_cookie.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2005/03/08 19:30:24 $";
