/*****************************************************************************
 ...
 @(#) $RCSfile: sctp_msg.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/05/14 08:31:05 $
...
#ident "@(#) $RCSfile: sctp_msg.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/05/14 08:31:05 $"

static char const ident[] = "$RCSfile: sctp_msg.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/05/14 08:31:05 $";
