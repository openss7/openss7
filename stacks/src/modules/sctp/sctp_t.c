/*****************************************************************************
 ...
 @(#) $RCSfile: sctp_t.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2005/07/13 12:01:38 $
...
#ident "@(#) $RCSfile: sctp_t.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2005/07/13 12:01:38 $"

static char const ident[] = "$RCSfile: sctp_t.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2005/07/13 12:01:38 $";
