/*****************************************************************************
 ...
 @(#) $RCSfile: sctp_t.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/03/08 19:30:31 $
 ...
 Last Modified $Date: 2005/03/08 19:30:31 $ by $Author: brian $

 *****************************************************************************/

#ident "@(#) $RCSfile: sctp_t.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/03/08 19:30:31 $"

static char const ident[] = "$RCSfile: sctp_t.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/03/08 19:30:31 $";
