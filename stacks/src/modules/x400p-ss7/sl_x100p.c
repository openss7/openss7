/*****************************************************************************
 ...
 @(#) $RCSfile: sl_x100p.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2005/05/10 18:05:57 $
...
#ident "@(#) $RCSfile: sl_x100p.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2005/05/10 18:05:57 $"
...
#define SL_X100P_REVISION	"OpenSS7 $RCSfile: sl_x100p.c,v $ $Name:  $ ($Revision: 0.9.2.9 $) $Date: 2005/05/10 18:05:57 $"
