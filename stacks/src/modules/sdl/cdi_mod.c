/*****************************************************************************
 ...
 @(#) $RCSfile: cdi_mod.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/05/14 08:31:07 $
...
#ident "@(#) $RCSfile: cdi_mod.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/05/14 08:31:07 $"

static char const ident[] = "$RCSfile: cdi_mod.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/05/14 08:31:07 $";
...
#define CDI_REVISION	"OpenSS7 $RCSfile: cdi_mod.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/05/14 08:31:07 $"
