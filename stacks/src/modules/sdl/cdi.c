/*****************************************************************************
 ...
 @(#) $RCSfile: cdi.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2005/05/14 08:31:07 $
...
#ident "@(#) $RCSfile: cdi.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2005/05/14 08:31:07 $"

static char const ident[] = "$RCSfile: cdi.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2005/05/14 08:31:07 $";
