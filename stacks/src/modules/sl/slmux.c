/*****************************************************************************
 ...
 @(#) $RCSfile: slmux.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2007/08/12 16:20:29 $
...
#ident "@(#) $RCSfile: slmux.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2007/08/12 16:20:29 $"

static char const ident[] = "$RCSfile: slmux.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2007/08/12 16:20:29 $";
