/*****************************************************************************
 ...
 @(#) $RCSfile: sdt_ch.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2007/07/21 20:22:01 $
 ...
 Last Modified $Date: 2007/07/21 20:22:01 $ by $Author: brian $
...
#ident "@(#) $RCSfile: sdt_ch.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2007/07/21 20:22:01 $"

static char const ident[] = "$RCSfile: sdt_ch.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2007/07/21 20:22:01 $";
