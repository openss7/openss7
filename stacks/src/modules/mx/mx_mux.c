/*****************************************************************************
 ...
 @(#) $RCSfile: mx_mux.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2007/08/15 05:19:31 $
...
#ident "@(#) $RCSfile: mx_mux.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2007/08/15 05:19:31 $"
...
#define MX_MUX_REVISION		"LfS $RCSfile: mx_mux.c,v $ $Name:  $ ($Revision: 0.9.2.7 $) $Date: 2007/08/15 05:19:31 $"
