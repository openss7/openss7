/*****************************************************************************
 ...
 @(#) $RCSfile: tirdwr.c,v $ $Name:  $($Revision: 0.9.2.10 $) $Date: 2005/05/14 08:31:16 $
 ...
 Last Modified $Date: 2005/05/14 08:31:16 $ by $Author: brian $

 *****************************************************************************/

#ident "@(#) $RCSfile: tirdwr.c,v $ $Name:  $($Revision: 0.9.2.10 $) $Date: 2005/05/14 08:31:16 $"
...
#define TIRDWR_REVISION		"OpenSS7 $RCSfile: tirdwr.c,v $ $Name:  $($Revision: 0.9.2.10 $) $Date: 2005/05/14 08:31:16 $"
