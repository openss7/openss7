/*****************************************************************************
 ...
 @(#) $RCSfile: mtp_sm.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2007/08/14 12:18:03 $
...
#ident "@(#) $RCSfile: mtp_sm.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2007/08/14 12:18:03 $"

static char const ident[] = "$RCSfile: mtp_sm.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2007/08/14 12:18:03 $";
