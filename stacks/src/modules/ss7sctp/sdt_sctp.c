/*****************************************************************************
 ...
 @(#) $RCSfile: sdt_sctp.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2005/05/14 08:31:09 $
...
#ident "@(#) $RCSfile: sdt_sctp.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2005/05/14 08:31:09 $"
...
#define SDT_SCTP_REVISION	"OpenSS7 $RCSfile: sdt_sctp.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2005/05/14 08:31:09 $"
