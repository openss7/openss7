/*****************************************************************************
 ...
 @(#) $RCSfile: tua.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2005/05/14 08:31:17 $
...
#ident "@(#) $RCSfile: tua.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2005/05/14 08:31:17 $"
...
#define TUA_REVISION	"OpenSS7 $RCSfile: tua.c,v $ $Name:  $ ($Revision: 0.9.2.8 $) $Date: 2005/05/14 08:31:17 $"
