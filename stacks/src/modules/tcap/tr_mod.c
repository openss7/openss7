/*****************************************************************************
 ...
 @(#) $RCSfile: tr_mod.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2007/08/03 13:02:54 $
...
#ident "@(#) $RCSfile: tr_mod.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2007/08/03 13:02:54 $"

static char const ident[] = "$RCSfile: tr_mod.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2007/08/03 13:02:54 $";
...
#define TR_REVISION	"OpenSS7 $RCSfile: tr_mod.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2007/08/03 13:02:54 $"
...
#define TCAP_CLS_CNTX_CONS	0x60	/* context-specific constructor - class 1 form 1 - 0110 0000 */
#define TCAP_CLS_APPL_PRIM	0x80	/* application-wide primitive - class 2 form 0 - 1000 0000 */
#define TCAP_CLS_APPL_CONS	0xa0	/* application-wide constructor - class 2 form 1 - 1010 0000 */
