/*****************************************************************************
 ...
 @(#) $RCSfile: xtcap.c,v $ $Name: OpenSS7-0_9_2 $($Revision: 0.9.2.1 $) $Date: 2009-03-05 15:54:30 $
 ...
 Last Modified $Date: 2009-03-05 15:54:30 $ by $Author: brian $

 -----------------------------------------------------------------------------

 $Log: xtcap.c,v $
 Revision 0.9.2.1  2009-03-05 15:54:30  brian
 - added new files for map library

 *****************************************************************************/

#ident "@(#) $RCSfile: xtcap.c,v $ $Name: OpenSS7-0_9_2 $($Revision: 0.9.2.1 $) $Date: 2009-03-05 15:54:30 $"

static char const ident[] = "$RCSfile: xtcap.c,v $ $Name: OpenSS7-0_9_2 $($Revision: 0.9.2.1 $) $Date: 2009-03-05 15:54:30 $";
