/*****************************************************************************
 ...
 @(#) $RCSfile: x400config.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2007/08/19 11:57:41 $
...
#ident "@(#) $RCSfile: x400config.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2007/08/19 11:57:41 $"

static char const ident[] = "$RCSfile: x400config.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2007/08/19 11:57:41 $";
...
", "x400conf", PACKAGE, VERSION, "$Revision: 0.9.2.2 $ $Date: 2007/08/19 11:57:41 $");
}
