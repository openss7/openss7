/*****************************************************************************
 ...
 @(#) $RCSfile: x400pconf.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2008-04-29 07:11:33 $
...
#ident "@(#) $RCSfile: x400pconf.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2008-04-29 07:11:33 $"

static char const ident[] = "$RCSfile: x400pconf.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2008-04-29 07:11:33 $";
...
", "x400pconf", PACKAGE, VERSION, "$Revision: 0.9.2.3 $ $Date: 2008-04-29 07:11:33 $");
}
