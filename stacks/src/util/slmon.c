/*****************************************************************************
 ...
 @(#) $RCSfile: slmon.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2008-04-29 07:11:33 $
...
#ident "@(#) $RCSfile: slmon.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2008-04-29 07:11:33 $"

static char const ident[] = "$RCSfile: slmon.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2008-04-29 07:11:33 $";
...
output_header(void)
{
	...
	ftimestamp();
	fprint_time(stdout);
	fprintf(stdout, " # SS7MON $Id: slmon.c,v 0.9.2.7 2008-04-29 07:11:33 brian Exp $ Output File Header\n");
	uname(&uts);
	fprint_time(stdout);
...
", NAME, PACKAGE, VERSION, "$Revision: 0.9.2.7 $ $Date: 2008-04-29 07:11:33 $");
}
