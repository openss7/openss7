/*****************************************************************************
 ...
 @(#) $Id: xmap_gsm_at.h,v 0.9.2.1 2009-03-13 11:20:25 brian Exp $
...
#ident "@(#) $RCSfile: xmap_gsm_at.h,v $ $Name: OpenSS7-0_9_2 $($Revision: 0.9.2.1 $) Copyright (c) 2008-2009 Monavacon Limited."
