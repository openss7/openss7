/*****************************************************************************
 ...
 @(#) $Id: mtp2_ioctl.h,v 0.9.2.7 2009-01-10 17:09:12 brian Exp $
 ...
 Last Modified $Date: 2009-01-10 17:09:12 $ by $Author: brian $

 -----------------------------------------------------------------------------

 $Log: mtp2_ioctl.h,v $
 Revision 0.9.2.7  2009-01-10 17:09:12  brian
 - updated agents
...
#ident "@(#) $RCSfile: mtp2_ioctl.h,v $ $Name:  $($Revision: 0.9.2.7 $) Copyright (c) 2001-2008 OpenSS7 Corporation."
