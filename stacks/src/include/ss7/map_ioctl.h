/*****************************************************************************
 ...
 @(#) $Id: map_ioctl.h,v 0.9.2.1 2009-03-05 15:51:26 brian Exp $
...
#ident "@(#) $RCSfile: map_ioctl.h,v $ $Name: OpenSS7-0_9_2 $($Revision: 0.9.2.1 $) Copyright (c) 2008-2009 Monavacon Limited."
