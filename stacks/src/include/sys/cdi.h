/*****************************************************************************
 ...
 @(#) $Id: cdi.h,v 0.9.2.5 2008-10-30 13:36:58 brian Exp $
 ...
 Last Modified $Date: 2008-10-30 13:36:58 $ by $Author: brian $

 -----------------------------------------------------------------------------

 $Log: cdi.h,v $
 Revision 0.9.2.5  2008-10-30 13:36:58  brian
...
#ident "@(#) $RCSfile: cdi.h,v $ $Name:  $($Revision: 0.9.2.5 $) Copyright (c) 2001-2008 OpenSS7 Corporation."
