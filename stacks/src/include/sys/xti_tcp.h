/*****************************************************************************
 ...
 @(#) $RCSfile: xti_tcp.h,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2004/09/02 09:31:14 $
...
#ident "@(#) $RCSfile: xti_tcp.h,v $ $Name:  $($Revision: 0.9.2.2 $) Copyright (c) 1997-2004 OpenSS7 Corporation."
