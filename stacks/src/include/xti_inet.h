/*****************************************************************************
 ...
 @(#) $RCSfile: xti_inet.h,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2005/05/14 08:30:43 $
...
#ident "@(#) $RCSfile: xti_inet.h,v $ $Name:  $($Revision: 0.9.2.3 $) Copyright (c) 1997-2004 OpenSS7 Corporation."
