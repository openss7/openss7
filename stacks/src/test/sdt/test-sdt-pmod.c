/*****************************************************************************
 ...
 @(#) $RCSfile: test-sdt-pmod.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2008-04-29 07:11:30 $
...
#ident "@(#) $RCSfile: test-sdt-pmod.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2008-04-29 07:11:30 $"

static char const ident[] = "$RCSfile: test-sdt-pmod.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2008-04-29 07:11:30 $";
...
", "test-sdt-pmod", PACKAGE, VERSION, "$Revision: 0.9.2.4 $ $Date: 2008-04-29 07:11:30 $");
}
