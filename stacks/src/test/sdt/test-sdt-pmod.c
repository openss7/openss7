/*****************************************************************************
 ...
 @(#) $RCSfile: test-sdt-pmod.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2007/08/12 15:20:18 $
 ...
 Last Modified $Date: 2007/08/12 15:20:18 $ by $Author: brian $
...
#ident "@(#) $RCSfile: test-sdt-pmod.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2007/08/12 15:20:18 $"

static char const ident[] = "$RCSfile: test-sdt-pmod.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2007/08/12 15:20:18 $";
