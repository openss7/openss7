/*****************************************************************************
 ...
 @(#) $RCSfile: test-sctp_n.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2006/03/03 12:06:13 $
...
#ident "@(#) $RCSfile: test-sctp_n.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2006/03/03 12:06:13 $"

static char const ident[] = "$RCSfile: test-sctp_n.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2006/03/03 12:06:13 $";
