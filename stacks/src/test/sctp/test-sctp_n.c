/*****************************************************************************
 ...
 @(#) $RCSfile: test-sctp_n.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2006/09/26 00:52:38 $
...
#ident "@(#) $RCSfile: test-sctp_n.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2006/09/26 00:52:38 $"

static char const ident[] = "$RCSfile: test-sctp_n.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2006/09/26 00:52:38 $";
