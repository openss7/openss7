/*****************************************************************************
 ...
 @(#) $RCSfile: test-interop.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2007/03/12 02:23:24 $
...
#ident "@(#) $RCSfile: test-interop.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2007/03/12 02:23:24 $"

static char const ident[] = "$RCSfile: test-interop.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2007/03/12 02:23:24 $";
