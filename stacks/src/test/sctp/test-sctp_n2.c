/*****************************************************************************
 ...
 @(#) $RCSfile: test-sctp_n2.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/09/26 00:52:38 $
...
#ident "@(#) $RCSfile: test-sctp_n2.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/09/26 00:52:38 $"

static char const ident[] = "$RCSfile: test-sctp_n2.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2006/09/26 00:52:38 $";
