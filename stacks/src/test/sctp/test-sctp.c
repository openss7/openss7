/*****************************************************************************
 ...
 @(#) $RCSfile: test-sctp.c,v $ $Name:  $($Revision: 0.9.2.10 $) $Date: 2008-04-29 07:11:28 $
 ...
 $Log: test-sctp.c,v $
 Revision 0.9.2.10  2008-04-29 07:11:28  brian
...
#ident "@(#) $RCSfile: test-sctp.c,v $ $Name:  $($Revision: 0.9.2.10 $) $Date: 2008-04-29 07:11:28 $"

static char const ident[] = "$RCSfile: test-sctp.c,v $ $Name:  $($Revision: 0.9.2.10 $) $Date: 2008-04-29 07:11:28 $";
...
", "test-sctp", PACKAGE, VERSION, "$Revision: 0.9.2.10 $ $Date: 2008-04-29 07:11:28 $");
}
