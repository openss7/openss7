/*****************************************************************************
 ...
 @(#) $RCSfile: test-sctp.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2007/03/12 09:34:00 $
 ...
 Last Modified $Date: 2007/03/12 09:34:00 $ by $Author: brian $
...
#ident "@(#) $RCSfile: test-sctp.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2007/03/12 09:34:00 $"

static char const ident[] = "$RCSfile: test-sctp.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2007/03/12 09:34:00 $";
