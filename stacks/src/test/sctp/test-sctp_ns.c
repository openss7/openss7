/*****************************************************************************
 ...
 @(#) $RCSfile: test-sctp_ns.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2008-04-29 07:11:29 $
...
#ident "@(#) $RCSfile: test-sctp_ns.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2008-04-29 07:11:29 $"

static char const ident[] = "$RCSfile: test-sctp_ns.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2008-04-29 07:11:29 $";
...
", "test-sctp_ns", PACKAGE, VERSION, "$Revision: 0.9.2.9 $ $Date: 2008-04-29 07:11:29 $");
}
