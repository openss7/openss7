/*****************************************************************************
 ...
 @(#) $RCSfile: test-sctp_ns.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2007/03/12 09:34:02 $
...
#ident "@(#) $RCSfile: test-sctp_ns.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2007/03/12 09:34:02 $"

static char const ident[] = "$RCSfile: test-sctp_ns.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2007/03/12 09:34:02 $";
