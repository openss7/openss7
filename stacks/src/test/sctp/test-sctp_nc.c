/*****************************************************************************
 ...
 @(#) $RCSfile: test-sctp_nc.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2007/03/12 02:23:25 $
...
#ident "@(#) $RCSfile: test-sctp_nc.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2007/03/12 02:23:25 $"

static char const ident[] = "$RCSfile: test-sctp_nc.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2007/03/12 02:23:25 $";
