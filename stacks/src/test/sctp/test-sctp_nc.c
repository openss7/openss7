/*****************************************************************************
 ...
 @(#) $RCSfile: test-sctp_nc.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2007/08/19 11:57:03 $
 ...
 Last Modified $Date: 2007/08/19 11:57:03 $ by $Author: brian $
...
#ident "@(#) $RCSfile: test-sctp_nc.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2007/08/19 11:57:03 $"

static char const ident[] = "$RCSfile: test-sctp_nc.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2007/08/19 11:57:03 $";
...
", "test-sctp_nc", PACKAGE, VERSION, "$Revision: 0.9.2.8 $ $Date: 2007/08/19 11:57:03 $");
}
