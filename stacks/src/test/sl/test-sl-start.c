/*****************************************************************************
 ...
 @(#) $RCSfile: test-sl-start.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2007/09/06 10:57:48 $
...
#ident "@(#) $RCSfile: test-sl-start.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2007/09/06 10:57:48 $"
