/*****************************************************************************
 ...
 @(#) $RCSfile: test-sctp_ns.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2005/05/14 08:31:27 $
...
#ident "@(#) $RCSfile: test-sctp_ns.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2005/05/14 08:31:27 $"

static char const ident[] = "$RCSfile: test-sctp_ns.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2005/05/14 08:31:27 $";
