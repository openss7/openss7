/*****************************************************************************
 ...
 @(#) $RCSfile: test-sctp_ns.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2007/08/19 11:56:32 $
 ...
 Last Modified $Date: 2007/08/19 11:56:32 $ by $Author: brian $

 -----------------------------------------------------------------------------

 $Log: test-sctp_ns.c,v $
 Revision 0.9.2.7  2007/08/19 11:56:32  brian
...
#ident "@(#) $RCSfile: test-sctp_ns.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2007/08/19 11:56:32 $"

static char const ident[] = "$RCSfile: test-sctp_ns.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2007/08/19 11:56:32 $";
...
", "test-sctp_ns", PACKAGE, VERSION, "$Revision: 0.9.2.7 $ $Date: 2007/08/19 11:56:32 $");
}
