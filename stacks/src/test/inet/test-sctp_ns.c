/*****************************************************************************
 ...
 @(#) $RCSfile: test-sctp_ns.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2008-04-29 07:11:26 $
...
#ident "@(#) $RCSfile: test-sctp_ns.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2008-04-29 07:11:26 $"

static char const ident[] = "$RCSfile: test-sctp_ns.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2008-04-29 07:11:26 $";
...
", "test-sctp_ns", PACKAGE, VERSION, "$Revision: 0.9.2.8 $ $Date: 2008-04-29 07:11:26 $");
}
