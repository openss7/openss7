/*****************************************************************************
 ...
 @(#) $RCSfile: test-udps.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2007/03/12 09:33:49 $
...
#ident "@(#) $RCSfile: test-udps.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2007/03/12 09:33:49 $"

static char const ident[] = "$RCSfile: test-udps.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2007/03/12 09:33:49 $";
