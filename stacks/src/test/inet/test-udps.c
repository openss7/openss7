/*****************************************************************************
 ...
 @(#) $RCSfile: test-udps.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2005/05/14 08:31:28 $
...
#ident "@(#) $RCSfile: test-udps.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2005/05/14 08:31:28 $"

static char const ident[] = "$RCSfile: test-udps.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2005/05/14 08:31:28 $";
