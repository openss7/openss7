/*****************************************************************************
 ...
 @(#) $RCSfile: test-sctp_nc.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2008-10-30 18:31:26 $
 ...
 Revision 0.9.2.9  2008-10-30 18:31:26  brian
...
#ident "@(#) $RCSfile: test-sctp_nc.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2008-10-30 18:31:26 $"

static char const ident[] = "$RCSfile: test-sctp_nc.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2008-10-30 18:31:26 $";
...
main(int argc, char **argv)
{
	...
	char **hostlp = &hostl;
	char **hostrp = &hostr;
	short portl = TEST_PORT_NUMBER + 0;
