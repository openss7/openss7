/*****************************************************************************
 ...
 @(#) $RCSfile: test-sctp.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2007/08/14 12:19:28 $
...
#ident "@(#) $RCSfile: test-sctp.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2007/08/14 12:19:28 $"

static char const ident[] = "$RCSfile: test-sctp.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2007/08/14 12:19:28 $";
