/*****************************************************************************
 ...
 @(#) $RCSfile: test-sctp.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2007/08/19 11:56:31 $
 ...
 $Log: test-sctp.c,v $
 Revision 0.9.2.8  2007/08/19 11:56:31  brian
 - move stdbool.h, obviate need for YFLAGS, general workup

 Revision 0.9.2.7  2007/08/14 12:19:28  brian
 ...
 Revision 0.9.2.4  2005/05/14 08:31:27  brian
 - copyright header correction

 *****************************************************************************/

#ident "@(#) $RCSfile: test-sctp.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2007/08/19 11:56:31 $"

static char const ident[] = "$RCSfile: test-sctp.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2007/08/19 11:56:31 $";
...
", "test-sctp", PACKAGE, VERSION, "$Revision: 0.9.2.8 $ $Date: 2007/08/19 11:56:31 $");
}
