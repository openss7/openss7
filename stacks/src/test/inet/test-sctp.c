/*****************************************************************************
 ...
 @(#) $RCSfile: test-sctp.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2005/05/13 11:15:49 $
...
#ident "@(#) $RCSfile: test-sctp.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2005/05/13 11:15:49 $"

static char const ident[] = "$RCSfile: test-sctp.c,v $ $Name:  $($Revision: 0.9.2.3 $) $Date: 2005/05/13 11:15:49 $";
