/*****************************************************************************
 ...
 @(#) $RCSfile: test-sdl-pmod.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2007/08/12 15:20:17 $
 ...
 Last Modified $Date: 2007/08/12 15:20:17 $ by $Author: brian $
...
#ident "@(#) $RCSfile: test-sdl-pmod.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2007/08/12 15:20:17 $"

static char const ident[] = "$RCSfile: test-sdl-pmod.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2007/08/12 15:20:17 $";
