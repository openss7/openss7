/*****************************************************************************
 ...
 @(#) $RCSfile: test-x400p-sl.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2005/01/27 06:24:31 $
...
#ident "@(#) $RCSfile: test-x400p-sl.c,v $ $Name:  $($Revision: 0.9.2.2 $) $Date: 2005/01/27 06:24:31 $"
