/*****************************************************************************
 ...
 @(#) $RCSfile: test-x400p-sdl.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2004/02/22 18:14:56 $
...
#ident "@(#) $RCSfile: test-x400p-sdl.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2004/02/22 18:14:56 $"
