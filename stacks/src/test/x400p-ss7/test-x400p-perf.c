/*****************************************************************************
 ...
 @(#) $RCSfile: test-x400p-perf.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2007/08/19 11:57:29 $
 ...
 Revision 0.9.2.6  2006/03/07 01:17:44  brian
 - 64bit issues
...
#ident "@(#) $RCSfile: test-x400p-perf.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2007/08/19 11:57:29 $"

static char const ident[] = "$RCSfile: test-x400p-perf.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2007/08/19 11:57:29 $";
