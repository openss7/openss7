/*****************************************************************************
 ...
 @(#) $RCSfile: test-x400p-perf.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2005/05/14 08:31:39 $
...
#ident "@(#) $RCSfile: test-x400p-perf.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2005/05/14 08:31:39 $"

static char const ident[] = "$RCSfile: test-x400p-perf.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2005/05/14 08:31:39 $";
