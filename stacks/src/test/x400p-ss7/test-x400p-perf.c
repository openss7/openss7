/*****************************************************************************
 ...
 @(#) $RCSfile: test-x400p-perf.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2006/03/07 01:17:44 $
 ...
 Last Modified $Date: 2006/03/07 01:17:44 $ by $Author: brian $
...
#ident "@(#) $RCSfile: test-x400p-perf.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2006/03/07 01:17:44 $"

static char const ident[] = "$RCSfile: test-x400p-perf.c,v $ $Name:  $($Revision: 0.9.2.6 $) $Date: 2006/03/07 01:17:44 $";
