/*****************************************************************************
 ...
 @(#) $RCSfile: test-x400p-perf.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2007/08/14 12:20:13 $
...
#ident "@(#) $RCSfile: test-x400p-perf.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2007/08/14 12:20:13 $"

static char const ident[] = "$RCSfile: test-x400p-perf.c,v $ $Name:  $($Revision: 0.9.2.7 $) $Date: 2007/08/14 12:20:13 $";
