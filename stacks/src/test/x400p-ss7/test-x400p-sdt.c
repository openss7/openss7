/*****************************************************************************
 ...
 @(#) $RCSfile: test-x400p-sdt.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2005/05/14 08:31:40 $
...
#ident "@(#) $RCSfile: test-x400p-sdt.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2005/05/14 08:31:40 $"

static char const ident[] = "$RCSfile: test-x400p-sdt.c,v $ $Name:  $($Revision: 0.9.2.4 $) $Date: 2005/05/14 08:31:40 $";
