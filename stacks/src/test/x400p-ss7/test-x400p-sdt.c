/*****************************************************************************
 ...
 @(#) $RCSfile: test-x400p-sdt.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2008-04-29 07:11:32 $
 ...
 Revision 0.9.2.9  2008-04-29 07:11:32  brian
...
#ident "@(#) $RCSfile: test-x400p-sdt.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2008-04-29 07:11:32 $"

static char const ident[] = "$RCSfile: test-x400p-sdt.c,v $ $Name:  $($Revision: 0.9.2.9 $) $Date: 2008-04-29 07:11:32 $";
...
", NAME, PACKAGE, VERSION, "$Revision: 0.9.2.9 $ $Date: 2008-04-29 07:11:32 $");
}
