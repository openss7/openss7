/*****************************************************************************
 ...
 @(#) $RCSfile: test-x400p-sdt.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2007/08/19 11:57:29 $
 ...
 Last Modified $Date: 2007/08/19 11:57:29 $ by $Author: brian $

 -----------------------------------------------------------------------------

 $Log: test-x400p-sdt.c,v $
 Revision 0.9.2.8  2007/08/19 11:57:29  brian
 ...
 Revision 0.9.2.5  2006/03/04 13:00:43  brian
...
#ident "@(#) $RCSfile: test-x400p-sdt.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2007/08/19 11:57:29 $"

static char const ident[] = "$RCSfile: test-x400p-sdt.c,v $ $Name:  $($Revision: 0.9.2.8 $) $Date: 2007/08/19 11:57:29 $";
...
do_tests(void)
{
	...
	printf("DAEDR/DAEDT start in 5 seconds\n");
	sleep(5);
	sdt_daedt_start(pfd[0]);
	sdt_daedt_start(pfd[1]);
	sdt_daedr_start(pfd[0]);
	sdt_daedr_start(pfd[1]);

	printf("Configs in 5 seconds\n");
	sleep(5);
	sdt_config(pfd[0]);
	sdt_config(pfd[1]);
	sdt_stats(pfd[0]);
	...
	printf("Disable one in 5 seconds\n");
	sleep(5);
	disable_req(pfd[0]);
	printf("Disable other in 5 seconds\n");
	sleep(5);
	disable_req(pfd[1]);

	printf("Detach one in 5 seconds\n");
	sleep(5);
	detach_req(pfd[1]);
	printf("Detach other in 5 seconds\n");
	sleep(5);
	detach_req(pfd[0]);

	printf("Close in 5 seconds\n");
	sleep(5);
...
", NAME, PACKAGE, VERSION, "$Revision: 0.9.2.8 $ $Date: 2007/08/19 11:57:29 $");
}
