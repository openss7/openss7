/*****************************************************************************
 ...
 @(#) $RCSfile: test-tirdwr.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2004/05/12 08:01:41 $
...
#ident "@(#) $RCSfile: test-tirdwr.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2004/05/12 08:01:41 $"

static char const ident[] = "$RCSfile: test-tirdwr.c,v $ $Name:  $($Revision: 0.9.2.1 $) $Date: 2004/05/12 08:01:41 $";
