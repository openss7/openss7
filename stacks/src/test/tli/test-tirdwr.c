/*****************************************************************************
 ...
 @(#) $RCSfile: test-tirdwr.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/05/13 11:15:54 $
...
#ident "@(#) $RCSfile: test-tirdwr.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/05/13 11:15:54 $"

static char const ident[] = "$RCSfile: test-tirdwr.c,v $ $Name:  $($Revision: 0.9.2.5 $) $Date: 2005/05/13 11:15:54 $";
