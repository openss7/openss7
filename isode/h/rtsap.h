...
#ifndef __ISODE_RTSAP_H__
#define __ISODE_RTSAP_H__
...
struct RtSAPturn {			/* RT-TURN-{GIVE,PLEASE}.INDICATION */
	int rtu_please;			/* T = RT-TURN-PLEASE.INDICATION NIL =
...
struct RtSAPabort {			/* RT-{U,P}-ABORT.INDICATION */
	int rta_peer;			/* T = RT-U-ABORT.INDICATION NIL = RT-P-ABORT.INDICATION */

	int rta_reason;			/* reason */
	/* begin UNOFFICIAL */
#define	RTS_ADDRESS	5		/* Address unknown */
#define	RTS_REFUSED	6		/* Connect request refused on this network connection */
...
int RtSelectMask();			/* map reliable transfer descriptors for select() */
