...
#ifndef __ISODE_TSAP_H__
#define __ISODE_TSAP_H__
...
#define	DR_BASE		0x80
#define	DR_NORMAL	(DR_BASE + 0)	/* NORMAL disconnect by SESSION entity */
#define	DR_REMOTE	(DR_BASE + 1)	/* Remote TRANSPORT entity congested at connect request
					   time */
#define	DR_CONNECT	(DR_BASE + 2)	/* Connection negotiation failed */
#define	DR_DUPLICATE	(DR_BASE + 3)	/* Duplicate source reference detected for the same pair of 
					   NSAPs */
...
#define	DR_REFUSED	(DR_BASE + 8)	/* Connect request refused on this network connection */
#define	DR_LENGTH	(DR_BASE + 10)	/* Header or parameter length invalid */
...
#define	DR_SESSION	2		/* Session entity not attached to TSAP */
