...
#ifndef __ISODE_FTAM_H__
#define __ISODE_FTAM_H__
...
#define	FS_PRO_PDU	1017		/* Specific PDU request inconsistent with the current
					   requested access */
...
#define	FS_SEL_CREOLD	3021		/* Override deleted and recreated file with old attributes */
...
#define	FS_SEL_VIOLATES	3028		/* Requested access violates permitted actions */
#define	FS_SEL_NOTAVAIL	3029		/* Functional unit not available for requested access */
