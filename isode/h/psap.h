...
#ifndef __ISODE_PSAP_H__
#define __ISODE_PSAP_H__
...
typedef unsigned char PElementClass;

typedef unsigned char PElementForm;

typedef unsigned short PElementID;		/* 0..16383 are meaningful (14 bits) */
...
typedef unsigned char byte, *PElementData;
