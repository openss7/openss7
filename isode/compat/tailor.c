...
static struct bind {
	...
	"localname", &isodename, 0,
	    ...
	    "tsb_communities", &_tsb_config, 0, "tsb_default_address", &tsb_default_address, 0,
#ifdef  X25
	    ...
	    "rpoa", &rpoa_default, 0, "x25level", &x25debug, 0, "x25file", &_x25_log.ll_file, 0,
#ifdef CAMTEC_CCL
	    "x25_outgoing_port", &x25_outgoing_port_str, 0,
#endif
#ifdef CCUR_X25
	    "x25_communities", &_x25_line_config, 0, "x25_default_line", &x25_default_line, 0,
#endif				/* CCUR_X25 */
#ifdef	ULTRIX_X25
...
#endif
#ifdef _AIX
	    "x25_route", &aix_x25_route, 0, "x25_linkname", &aix_x25_linkname, 0,
#endif
#endif				/* X25 */
	    "nsap_default_stack", &_nsap_default_stack, 0, "local_nsap", &local_nsap, 0,
#ifdef TP4
#ifdef TLI_TP
	    "tli_cots_dev", &tli_cots_dev, 0, "tli_clts_dev", &tli_clts_dev, 0,
#ifdef ICL_TLI
...
#endif
#ifdef XTI_TP
	    "xti_tp4_ident", &xti_tp4_ident, 0, "xti_tp0_ident", &xti_tp0_ident, 0,
#endif
#endif
"ses_abort_timer", &_ses_ab_timer, 0,
	    "ses_disconnect_timer", &_ses_dn_timer, 0,
	    "ses_refuse_timer", &_ses_rf_timer, 0,
	    "ns_enable", &usens, 0, "ns_address", &ns_address, 0, NULL};
