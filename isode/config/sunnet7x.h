...
#ifndef __CONFIG_SUNNET7X_H__
#define __CONFIG_SUNNET7X_H__

#ident "@(#) $RCSfile$ $Name$($Revision$) Copyright (c) 2001-2007 OpenSS7 Corporation."

/* sunlink7.h - site configuration file for SunLink OSI and X.25 7.0 on SunOS 4 */
