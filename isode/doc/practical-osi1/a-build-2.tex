...
\begin{bwslide}
\ctitle	{REMOTE OPERATIONS SPECIFICATION}
...
\begin{bwslide}
\ctitle	{REMOTE OPERATIONS STUB-GENERATOR}
...
\begin{bwslide}
\ctitle	{EXAMPLE:\\ STUB DEFINITIONS}\small
...
\begin{bwslide}
\ctitle	{EXAMPLE:\\ STUB DEFINITIONS (cont.)}\small
...
\begin{bwslide}
\ctitle	{A SOLUTION\\STRUCTURE GENERATOR}
...
%
%\begin{nrtc}
%\item	AN IDEAL FACILITY WOULD SUPPORT THE \verb"DEFAULT" AND
...
\begin{bwslide}
\ctitle	{PRESENTATION ELEMENT PARSER}
