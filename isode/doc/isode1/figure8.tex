...
\setbox\graph=\vtop{%
  ...
  \vbox to0pt{\hbox{%
    ...
    \rlap{\kern  0.375in\lower 0.791in\hbox to 0pt{\hss ISO TS\hss}}%
    \special{pa 375 1500}%
    \special{pa 375 1000}%
    \special{fp}%
    \special{pa 400 1100}%
    ...
    \special{pa 375 1000}%
    \special{fp}%
    \rlap{\kern  5.125in\lower 0.791in\hbox to 0pt{\hss ISO TS\hss}}%
    ...
    \special{pa 1250 3833}%
    \special{fp}%
    \rlap{\kern  2.750in\lower 4.124in\hbox to 0pt{\hss TS-BRIDGE HOST\hss}}%
    \kern  5.501in
  }\vss}%
  \kern  4.125in
}
