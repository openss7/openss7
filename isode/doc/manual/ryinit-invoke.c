...
case OK:			/* got a result/error response */
	...
	{
		register struct type_MODULE_result *res = (struct type_MODULE_result *) out;
...
/* do something with ``res'' here... */
	...
	{
		register struct type_MODULE_parameter *parm = (struct type_MODULE_parameter *) out;
...
/* do something with ``parm'' here... */
	...
	default:
		adios(NULLCP, "unknown result/error returned (%d)", response);
		/* NOTREACHED */
	}
	break;
