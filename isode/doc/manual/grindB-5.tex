\File{grindB\-5.c},{22:23},{Jun 12 1988}
...
\L{\LB{}}
\L{\LB{    sd = rts \-\> rts\_sd;}}
\L{\LB{\C{}\/*  do authentication using rts \-\> rts\_data here... *\/\CE{}}}
\L{\LB{    RTSFREE (rts);}}
\L{\LB{    }}
\L{\LB{\C{}\/* read command line arguments here... *\/\CE{}}}
\L{\LB{}}
\L{\LB{\C{}\/* could use RTS\_BUSY, RTS\_VALIDATE, or RTS\_MODE instead and then exit *\/\CE{}}}
\L{\LB{}}
\L{\LB{    \K{if} (RtBeginResponse (sd, RTS\_ACCEPT, NULLPE, rti) == NOTOK)}}
\L{\LB{}\Tab{8}{error (\S{}\"RT\-BEGIN.RESPONSE: \%s\"\SE{}, RtErrString (rta \-\> rta\_reason));}}
\L{\LB{}}
