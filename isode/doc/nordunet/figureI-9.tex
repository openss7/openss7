...
\setbox\graph=\vtop{%
  ...
  \vbox to0pt{\hbox{%
    ...
    \special{pa 3000 1750}%
    \special{fp}%
    \rlap{\kern  3.375in\lower 1.666in\hbox to 0pt{\hss \xx ???\hss}}%
    ...
    \special{pa 3000 2250}%
    \special{fp}%
    \rlap{\kern  3.375in\lower 2.041in\hbox to 0pt{\hss SPP\hss}}%
    ...
    \special{pa 4750 1750}%
    \special{fp}%
    \rlap{\kern  5.125in\lower 1.666in\hbox to 0pt{\hss \xx ???\hss}}%
    ...
    \special{pa 4750 2250}%
    \special{fp}%
    \rlap{\kern  5.125in\lower 2.041in\hbox to 0pt{\hss SPP\hss}}%
    \special{pa 375 2250}%
    \special{pa 375 3250}%
