...
\setbox\graph=\vtop{%
  ...
  \vbox to0pt{\hbox{%
    ...
    \special{pa 3000 2250}%
    \special{fp}%
    \rlap{\kern  3.375in\lower 1.833in\hbox to 0pt{\hss TP0\hss}}%
    \rlap{\kern  3.375in\lower 1.999in\hbox to 0pt{\hss X.25\hss}}%
    ...
    \special{pa 4750 2250}%
    \special{fp}%
    \rlap{\kern  5.125in\lower 1.833in\hbox to 0pt{\hss TP0\hss}}%
    \rlap{\kern  5.125in\lower 1.999in\hbox to 0pt{\hss X.25\hss}}%
    \special{pa 375 2250}%
    \special{pa 375 3250}%
