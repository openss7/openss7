...
#ifndef __CL_H_FTAM_H__
#define __CL_H_FTAM_H__
...
#define	FS_PRO_BASE	1000		/* Protocol and supporting service related diagnostics */
...
#define	FS_ACS_CNTPSAP	2019		/* Contents type list cut by Presentation service */
...
#define	FS_SEL_CREOLD	3021		/* Create override deleted and recreated file with old
					   attributes */
#define	FS_SEL_CRENEW	3022		/* Create override deleted and recreated file with new
					   attributes */
...
#define	FS_ACC_FUNIT	5035		/* Functional unit invalid in processing mode */
...
#define	FA_PERM_DELETE		0x0080	/* delete-file */
	...
	char *fe_aet;			/* actually, could be EXTERNAL, but we support only
					   GraphicString for now */
...
#define	FA_AVAIL_DEFER	1		/* deferred */
	...
	int fa_permitted;		/* permitted-actions, same as fe_actions, plus: */
...
struct FTAMabort {			/* F-{U,P}-ABORT.INDICATION */
	int fta_peer;			/* T = F-U-ABORT.INDICATION NIL = F-P-ABORT.INDICATION */
