%{
#ifndef lint
static char *rcsid = "$Header: /xtel/isode/isode/others/quipu/uips/pod/RCS/conf_read.y,v 9.0 1992/06/16 12:44:54 isode Rel $";
#endif

/*
 * $Header: /xtel/isode/isode/others/quipu/uips/pod/RCS/conf_read.y,v 9.0 1992/06/16 12:44:54 isode Rel $
 */
...
%%
 ...
 filter_item  : '(' OID match STRING ')'
					{$$ = make_item_filter($2, $3, $4);}
	      ;

 assertion    : '(' filt_type filter filter filter_list ')'
				{$$ = make_parent_filter($2, $3, $4, $5);}
	      | '(' NOT filter ')'
				{$$ = make_parent_filter($2, $3,
							 (filt_struct *) 0,
							 (filt_struct *) 0);}
	      | filter_item	{$$ = $1;}
	      ;
