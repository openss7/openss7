...
specialSyntaxHandlers()
{
	...
	set_attribute_syntax(str2syntax("DN"), (IFP) dn_enc, (IFP) dn_dec, (IFP) str2dnX,
			     de_dn_print, (IFP) dn_cpy, dn_cmp, dn_free, NULLCP, NULLIFP, TRUE);
	...
	set_attribute_syntax(str2syntax("FacsimileTelephoneNumber"), (IFP) de_fax_enc,
			     ...
			     (IFP) de_fax_cpy, de_fax_cmp, de_fax_free, NULLCP, NULLIFP, TRUE);

	/* modify syntax handler for rfc822 mail attribute to allow for JNT ordering */
